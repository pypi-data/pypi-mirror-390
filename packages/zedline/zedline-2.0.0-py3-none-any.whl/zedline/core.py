...
class zedlineAPI:
    ...
    def create(self, api, password, key):
        return self._send_request(api, password, "", key, method="CREATE")

    def update(self, api, password, data, key):
        return self._send_request(api, password, data, key, method="UPDATE")

    def delete(self, api, password, key):
        return self._send_request(api, password, "", key, method="DELETE")
