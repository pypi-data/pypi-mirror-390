...
- w (string | number; optional):
    ...
    def __init__(
        ...
        emptySymbol: typing.Optional[ComponentType] = None,
        fullSymbol: typing.Optional[ComponentType] = None,
        fractions: typing.Optional[NumberType] = None,
...
setattr(Rating, "__init__", _explicitize_args(Rating.__init__))
