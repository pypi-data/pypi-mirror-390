...
- wrapperProps (dict with strings as keys and values of type boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        maxTags: typing.Optional[NumberType] = None,
...
setattr(TagsInput, "__init__", _explicitize_args(TagsInput.__init__))
