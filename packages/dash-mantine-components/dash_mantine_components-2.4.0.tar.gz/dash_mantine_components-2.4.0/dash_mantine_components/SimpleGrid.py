...
- w (string | number; optional):
    ...
    def __init__(
        ...
        spacing: typing.Optional[typing.Union[NumberType, Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
...
setattr(SimpleGrid, "__init__", _explicitize_args(SimpleGrid.__init__))
