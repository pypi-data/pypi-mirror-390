...
- w (string | number; optional):
    ...
    def __init__(
        ...
        bulletSize: typing.Optional[typing.Union[str, NumberType]] = None,
        align: typing.Optional[Literal["left", "right"]] = None,
        lineWidth: typing.Optional[typing.Union[str, NumberType]] = None,
...
setattr(Timeline, "__init__", _explicitize_args(Timeline.__init__))
