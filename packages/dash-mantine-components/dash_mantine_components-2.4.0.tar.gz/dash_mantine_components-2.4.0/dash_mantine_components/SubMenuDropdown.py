...
class SubMenuDropdown(Component):
    """A SubMenuDropdown component.
Sub MenuDropdown
...
- w (string | number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SubMenuDropdown, self).__init__(children=children, **args)

setattr(SubMenuDropdown, "__init__", _explicitize_args(SubMenuDropdown.__init__))
