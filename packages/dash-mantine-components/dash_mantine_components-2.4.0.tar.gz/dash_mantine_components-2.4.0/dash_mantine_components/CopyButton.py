...
- w (string | number; optional):
    ...
    _children_props = ['copiedChildren']
    _base_nodes = ['copiedChildren', 'children']
    ...
    def __init__(
        ...
        copiedColor: typing.Optional[typing.Union[Literal["dark"], Literal["gray"], Literal["red"], Literal["pink"], Literal["grape"], Literal["violet"], Literal["indigo"], Literal["blue"], Literal["cyan"], Literal["green"], Literal["lime"], Literal["yellow"], Literal["orange"], Literal["teal"]]] = None,
        ...
        copiedChildren: typing.Optional[ComponentType] = None,
...
setattr(CopyButton, "__init__", _explicitize_args(CopyButton.__init__))
