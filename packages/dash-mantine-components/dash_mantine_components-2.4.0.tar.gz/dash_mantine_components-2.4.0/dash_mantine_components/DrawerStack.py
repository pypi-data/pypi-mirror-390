...
class DrawerStack(Component):
    """A DrawerStack component.
...
- toggle (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DrawerStack, self).__init__(children=children, **args)

setattr(DrawerStack, "__init__", _explicitize_args(DrawerStack.__init__))
