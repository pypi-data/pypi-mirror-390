...
- wrap (boolean; optional):
    ...
    def __init__(
        ...
        completedIcon: typing.Optional[ComponentType] = None,
        progressIcon: typing.Optional[ComponentType] = None,
        ...
        iconSize: typing.Optional[typing.Union[str, NumberType]] = None,
        contentPadding: typing.Optional[typing.Union[NumberType, Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
...
setattr(Stepper, "__init__", _explicitize_args(Stepper.__init__))
