...
class SubMenuTarget(Component):
    """A SubMenuTarget component.
Sub MenuTarget
...
- boxWrapperProps (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SubMenuTarget, self).__init__(children=children, **args)

setattr(SubMenuTarget, "__init__", _explicitize_args(SubMenuTarget.__init__))
