...
- w (string | number; optional):
    ...
    def __init__(
        ...
        value: typing.Optional[typing.Tuple[NumberType, NumberType]] = None,
        ...
        minRange: typing.Optional[NumberType] = None,
        maxRange: typing.Optional[NumberType] = None,
        ...
        pushOnOverlap: typing.Optional[bool] = None,
