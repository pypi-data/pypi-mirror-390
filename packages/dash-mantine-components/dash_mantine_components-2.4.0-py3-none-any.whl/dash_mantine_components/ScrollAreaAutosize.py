...
class ScrollAreaAutosize(Component):
    """A ScrollAreaAutosize component.
ScrollArea
...
- w (string | number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ScrollAreaAutosize, self).__init__(children=children, **args)

setattr(ScrollAreaAutosize, "__init__", _explicitize_args(ScrollAreaAutosize.__init__))
