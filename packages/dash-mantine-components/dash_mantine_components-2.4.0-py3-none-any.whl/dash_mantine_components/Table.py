...
- withTableBorder (boolean; optional):
    ...
    Data = TypedDict(
        "Data",
            {
            "head": NotRequired[typing.Sequence[ComponentType]],
            "body": NotRequired[typing.Sequence[typing.Sequence[ComponentType]]],
            "foot": NotRequired[typing.Sequence[ComponentType]],
    ...
    def __init__(
        ...
        horizontalSpacing: typing.Optional[typing.Union[NumberType, Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        verticalSpacing: typing.Optional[typing.Union[NumberType, Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
