...
- zIndex (string | number; optional):
    ...
    def __init__(
        ...
        backgroundOpacity: typing.Optional[NumberType] = None,
        ...
        blur: typing.Optional[typing.Union[str, NumberType]] = None,
