...
"""
    ...
    def __init__(
        ...
        offLabel: typing.Optional[ComponentType] = None,
        onLabel: typing.Optional[ComponentType] = None,
        ...
        withThumbIndicator: typing.Optional[bool] = None,
