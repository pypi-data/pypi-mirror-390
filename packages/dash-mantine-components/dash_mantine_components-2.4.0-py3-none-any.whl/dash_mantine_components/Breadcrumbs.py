...
- w (string | number; optional):
    ...
    def __init__(
        ...
        separatorMargin: typing.Optional[typing.Union[NumberType, Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
...
setattr(Breadcrumbs, "__init__", _explicitize_args(Breadcrumbs.__init__))
