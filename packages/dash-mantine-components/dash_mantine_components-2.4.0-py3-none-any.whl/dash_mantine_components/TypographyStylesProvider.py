...
- w (string | number; optional):
    ...
    def __init__(
        ...
        fz: typing.Optional[typing.Union[NumberType, Literal["h1"], Literal["h2"], Literal["h3"], Literal["h4"], Literal["h5"], Literal["h6"], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        fw: typing.Optional[typing.Union[Literal["bold"], Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["normal"], Literal["bolder"], Literal["lighter"]]] = None,
        ...
        lh: typing.Optional[typing.Union[NumberType, Literal["h1"], Literal["h2"], Literal["h3"], Literal["h4"], Literal["h5"], Literal["h6"], Literal["xs"], Literal["sm"], Literal["md"], Literal["lg"], Literal["xl"]]] = None,
        ...
        bgr: typing.Optional[typing.Union[Literal["repeat"], Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["no-repeat"], Literal["repeat-x"], Literal["repeat-y"], Literal["round"], Literal["space"]]] = None,
        bga: typing.Optional[typing.Union[Literal["local"], Literal["fixed"], Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["scroll"]]] = None,
...
setattr(TypographyStylesProvider, "__init__", _explicitize_args(TypographyStylesProvider.__init__))
