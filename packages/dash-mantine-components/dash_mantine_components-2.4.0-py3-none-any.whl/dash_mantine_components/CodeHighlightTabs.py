...
- withHeader (boolean; optional):
    ...
    def __init__(
        ...
        activeTab: typing.Optional[NumberType] = None,
        withHeader: typing.Optional[bool] = None,
        copyLabel: typing.Optional[str] = None,
        copiedLabel: typing.Optional[str] = None,
        maxCollapsedHeight: typing.Optional[typing.Union[str, NumberType]] = None,
...
setattr(CodeHighlightTabs, "__init__", _explicitize_args(CodeHighlightTabs.__init__))
