...
本文档诚实说明daml-rag-framework的**限制、约束和不适用场景**。了解这些限制对于正确使用框架至关重要。
...
| 场景 | daml-rag-framework | 传统RAG | 纯LLM |
|------|----------|---------|-------|
| 实时响应 | ❌ | ✅ | ✅ |
| 垂直领域 | ✅ | ⚠️ | ❌ |
| 成本效率 | ✅ | ⚠️ | ❌ |
