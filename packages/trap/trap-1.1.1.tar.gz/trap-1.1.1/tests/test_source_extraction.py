...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("tests/data/lofar1/GRB201006A_final_2min_srcs-t0000-image-pb.fits", True, 221),
        ("tests/data/lofar1/GRB201006A_final_2min_srcs-t0001-image-pb.fits", True, 218),
        ("tests/data/lofar1/GRB201006A_final_2min_srcs-t0002-image-pb.fits", True, 218),
    ],
)
