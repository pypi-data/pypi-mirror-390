...
def construct_varmetric(db_engine: sqlalchemy.engine.base.Engine) -> pd.DataFrame:
    ...
    These properties are:
        ...
        - nr_datapoints
            ...
            If a source was not detected, nor force-fitted in a specific image the flux value is NaN.
    ...
    sigma_rms_min = int_flux_first_src / images.loc[im_ids].rms_min.values
    sigma_rms_max = int_flux_first_src / images.loc[im_ids].rms_max.values
