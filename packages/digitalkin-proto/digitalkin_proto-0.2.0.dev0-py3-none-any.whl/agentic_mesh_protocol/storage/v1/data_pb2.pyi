...
class DataType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    DATA_TYPE_OUTPUT: _ClassVar[DataType]
    DATA_TYPE_VIEW: _ClassVar[DataType]
    DATA_TYPE_LOGS: _ClassVar[DataType]
    DATA_TYPE_OTHER: _ClassVar[DataType]
DATA_TYPE_UNSPECIFIED: DataType
DATA_TYPE_OUTPUT: DataType
DATA_TYPE_VIEW: DataType
