...
class EmailClient:
    ...
    def convert_message_to_dict(self, msg) -> dict:
        ...
        email_dict = {
            ...
            'subject': msg['subject'],
            'date': msg['date'],
            'content': msg.get_payload(decode=True).decode() if msg.is_multipart() else msg.get_payload()
        }
        return email_dict
...
if __name__ == "__main__":
    ...
    parser.add_argument('--condition', type=str, help='Search condition for emails')
    ...
    with open(output_path, 'w') as json_file:
        json.dump(unread_emails, json_file, indent=4)
