...
class EMEModel(Model):
    ...
    def __deepcopy__(self, memo: dict | None = None) -> "EMEModel":
        return EMEModel(
            self.eme_grid_spec,
            self.medium,
    ...
    def data_file_for(self, component: Component) -> pathlib.Path | None:
    ...
    def simulation_data_for(self, component: Component) -> tidy3d.EMESimulationData | None:
