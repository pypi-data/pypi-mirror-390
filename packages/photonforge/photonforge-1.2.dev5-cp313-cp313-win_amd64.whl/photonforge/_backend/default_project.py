...
def phase_modulator(
    *,
    ...
    """
    model = _pf.AnalyticWaveguideModel(n_eff=n_eff, n_group=n_group, length=length)
...
def cw_laser(
    *,
    power: _pft.Power = 1,
    rel_intensity_noise: _pft.annotate(_pft.NonNegativeFloat, units="1/Hz") = 0,
...
def dm_laser(
    *,
    ...
    gain_compression_factor: _pft.annotate(_pft.NonNegativeFloat, units="m³") = 1.0e-23,
    transparency_carrier_density: _pft.annotate(_pft.NonNegativeFloat, units="m⁻³") = 1.1e24,
    differential_gain: _pft.annotate(_pft.NonNegativeFloat, units="m³/s") = 2.5e-20,
    ...
    active_region_volume: _pft.annotate(_pft.PositiveFloat, units="m³") = 1.5e-16,
    photon_energy: _pft.annotate(_pft.NonNegativeFloat, units="J") = 1.28e-19,
    elementary_charge: _pft.annotate(_pft.PositiveFloat, units="C") = 1.602176634e-19,
    rel_intensity_noise: _pft.annotate(_pft.NonNegativeFloat, units="1/Hz") = 0,
    linewidth: _pft.Frequency = 0,
    reflection: complex = 0,
    seed: _pft.NonNegativeInt | None = None,
...
def signal_source(
    *,
    ...
    fwhm: _pft.NonNegativeFloat = 0.5,
