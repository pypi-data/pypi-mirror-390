...
__all__ = ["ProductSearchRefinementValue"]


class ProductSearchRefinementValue(BaseModel):
    hit_count: int = FieldInfo(alias="hitCount")
    ...
    presentation_id: Optional[str] = FieldInfo(alias="presentationId", default=None)
    """
