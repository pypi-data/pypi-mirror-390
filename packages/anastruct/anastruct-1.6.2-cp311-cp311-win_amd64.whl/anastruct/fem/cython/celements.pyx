...
@lru_cache(32000)
def det_moment(double kl, double kr, double qi, double q, double x, double EI, double L):
    """
...
@lru_cache(32000)
def det_shear(double kl, double kr, double qi, double q, double x, double EI, double L):
    """
    See notebook in: anastruct/fem/background/primary_m_v.ipynb
