class MapStyle:
    def __init__(self,
        ...
        self.partial_alert = partial_alert
    ...
    def __repr__(self):
        return f"MapStyle(no_data: {self.no_data}, partial_alert: {self.partial_alert}, air_raid: {self.air_raid}, " \
