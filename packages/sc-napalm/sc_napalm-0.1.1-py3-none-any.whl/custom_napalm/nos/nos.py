...
class SCNOSDriver(NetworkDriver, SCBaseNetconfDriver):
    ...
    def get_config(self, retrieve="all", full=False, sanitized=False, format="text") -> napalm_models.ConfigDict:
        """
            ...
            for c in self._xpath(i, ".//dn-trans:channel"):
                ...
                if self._text(c, ".//dn-trans:receive-power"):
                    i_channels[self._text(c, ".//dn-trans:lane")] = {
                        ...
                        "laser_bias_current": self._text(c, ".//dn-trans:laser-bias-current"),
                    }
    ...
    def _get_optic_subtype(self, i):
        ...
        if eth_pmd == "ETH_UNDEFINED":
            ...
            raise ValueError(f"ETH_UNDEFINED {i[0].text} speed {speed} WAVELENGTH {self._text(i, './/dn-trans:wavelength')}")
