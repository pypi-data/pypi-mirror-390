...
Note: This module name 'numbers' may shadow Python's built-in 'numbers' module.
      Consider importing with an alias: `import numbers as num_utils`
...
Usage Example:
    ```python
    import src.numbers as num_utils  # Use alias to avoid stdlib conflict
