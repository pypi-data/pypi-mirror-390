    ...
    async def summarize_document(
        ...
        async with self.semaphore:
            ...
            try:
                ...
                # Add .md extension to URL if it doesn't already have a file extension
                link_url = url if "." in url.split("/")[-1] else f"{url}.md"
                formatted_summary = f"Title: [{title}]({link_url})\nKeywords: {page_summary.keywords}\nSummary: {page_summary.concise_summary}\n\n"
