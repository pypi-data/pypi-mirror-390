...
class DarsPackageManager:
    def __init__(self, version: str = "1.0.0"):
        ...
        self.local_dir = self.getAppdataDir("dars")

    def getAppdataDir(self, app_name="dars"):
        ...
        darsDir = os.path.join(basedir, app_name, "dpm_components")
        os.makedirs(darsDir, exist_ok=True)
        return darsDir
