...
from ..context_analyzer import get_movement_opinion
...
def cmd_quick_start(card_id, comment="Started working on this"):
    ...
    # Get source list name for context
    source_list = client.get_list(card.idList) if hasattr(card, 'idList') else None
    source_list_name = source_list.name if source_list else "Unknown List"
    ...
    # Get contextual analysis of the movement
    opinion = get_movement_opinion(card, source_list_name, in_progress_list.name)
    print(opinion)
...
def cmd_quick_test(card_id, comment="Ready for testing"):
    ...
    # Get contextual analysis of the movement
    opinion = get_movement_opinion(card, source_list_name, testing_list.name)
    print(opinion)
...
def cmd_quick_done(card_id, comment="Completed and verified"):
    ...
    # Get contextual analysis of the movement
    opinion = get_movement_opinion(card, source_list_name, done_list.name)
    print(opinion)
