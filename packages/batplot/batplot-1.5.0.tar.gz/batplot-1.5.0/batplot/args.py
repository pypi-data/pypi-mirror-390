...
def _print_general_help() -> None:
    ...
    msg = (
        ...
        "  • Interactive mode: -i / --inter / --interactive flag opens a menu for styling, ranges, fonts, export, sessions\n\n"
    "How to run (basics):\n"
    "  [XY curves]\n"
...
def _print_xy_help() -> None:
    msg = (
        ...
        "Tips and options:\n"
        "[XY plot]\n"
    "  --interactive / --inter / -i : open interactive menu for styling, ranges, fonts, export, sessions\n"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("-i", "--inter", "--interactive", action="store_true", dest="interactive", help=argparse.SUPPRESS)
