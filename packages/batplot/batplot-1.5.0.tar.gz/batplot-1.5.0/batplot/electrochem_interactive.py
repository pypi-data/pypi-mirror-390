...
def electrochem_interactive_menu(fig, ax, cycle_lines: Dict[int, Dict[str, Optional[object]]], file_path=None):
    ...
    def _update_tick_visibility():
        ...
        try:
            ...
            pass
        # Do NOT reposition labels here - keep commands independent
        # Label repositioning should only happen when explicitly requested
        # (e.g., font changes, axis title toggles) not on every tick change
    ...
    def restore_state():
        ...
        try:
            # Disable layout engine first to prevent matplotlib from moving labels
            try:
            ...
            try:
                ...
                pass
            # Restore labelpads (for title positioning) and skip repositioning if successful
    ...
    while True:
        ...
        if key == 'q':
            ...
            try:
                ...
                base_path = choose_save_path([file_path] if file_path else [])
            ...
            try:
                ...
                # Choose base path (terminal cwd vs file directories)
                folder = choose_save_path([file_path] if file_path else [])
