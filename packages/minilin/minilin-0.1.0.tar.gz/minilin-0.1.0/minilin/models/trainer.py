...
class SimpleDataset(Dataset):
    ...
    def __init__(self, samples: List[Dict[str, Any]], tokenizer=None, max_length: int = 128):
    ...
    def __getitem__(self, idx):
        ...
        if self.tokenizer:
            ...
            if isinstance(label, str):
                label = hash(label) % 100  # Simple hash for demo
...
class Trainer:
    ...
    def train(
        ...
        **kwargs
        ...
        # Build label map
        self._build_label_map(train_data)
        ...
        # Create datasets
        train_dataset = SimpleDataset(train_data, self.tokenizer)
        val_dataset = SimpleDataset(val_data, self.tokenizer)
    ...
    def _build_label_map(self, samples: List[Dict[str, Any]]):
        ...
        logger.info(f"Built label map with {len(self.label_map)} classes")
