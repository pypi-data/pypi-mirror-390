...
Refer to the Terraform Registry for docs: [`aws_networkfirewall_firewall_transit_gateway_attachment_accepter`](https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/networkfirewall_firewall_transit_gateway_attachment_accepter).
'''
...
class NetworkfirewallFirewallTransitGatewayAttachmentAccepter(
    ...
    def __init__(
        ...
        *,
        ...
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/networkfirewall_firewall_transit_gateway_attachment_accepter#timeouts NetworkfirewallFirewallTransitGatewayAttachmentAccepter#timeouts}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
