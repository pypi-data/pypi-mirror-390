...
try:
    ...
    #stellar_file = "cb19_miles_stellar_grids_with_remnants.fits"#################################

    # The metallicities of the stellar grids in units of Z_Solar
    metallicities = np.array([0.005, 0.02, 0.2, 0.4, 1., 2.5, 5.])
    #metallicities = np.array([0.001, 0.002, 0.005, 0.01, 0.02, 0.04, 0.06,#################################
    #                          0.08, 0.1, 0.14, 0.17, 0.2, 0.3, 0.4, 0.6])
    ...
    #raw_stellar_grid = fits.open(grid_dir + "/" + stellar_file)[1:16]#################################
