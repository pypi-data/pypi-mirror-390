...
is_standalone_build = not os.path.exists('/home/even/gdal/3.12/build/swig/python')

if is_standalone_build:
    include_dirs = []
    library_dirs = []
else:
    include_dirs = ['/home/even/gdal/3.12/build/port', '/home/even/gdal/3.12/port', '/home/even/gdal/3.12/build/gcore', '/home/even/gdal/3.12/gcore', '/home/even/gdal/3.12/alg', '/home/even/gdal/3.12/ogr/', '/home/even/gdal/3.12/ogr/ogrsf_frmts', '/home/even/gdal/3.12/gnm', '/home/even/gdal/3.12/apps']
    library_dirs = ['/home/even/gdal/3.12/build']
libraries = ['gdal']
