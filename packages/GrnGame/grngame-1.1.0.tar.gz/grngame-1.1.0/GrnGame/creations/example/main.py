...
def dessiner_perso(perso):
    ...
    G.dessiner_image(f"./assets/{frame_num}.png", perso["x"], perso["y"], 32, 32, sens=sens)
...
def update_jeu():
    ...
    # Dessin du fond
    G.dessiner_image("./assets/fond.png", 0, 0, 192, 151)
    ...
    for p in persos:
        ...
        dessiner_perso(p)
        G.dessiner_mot("./assets/police", f"VIES:{p['vie']}", p["x"] + 5, p["y"] + 3, 0.50, 0.65)
