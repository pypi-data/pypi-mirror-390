...
from .structures import Gestionnaire, GestionnaireEntrees, FondActualiser, UpdateCallbackType

def configurer_signatures(jeu):
    """Configure toutes les signatures de fonctions pour la bibliothèque C"""
    
    # Initialisation
    jeu.initialisation.argtypes = [c_int, c_int, c_float, c_int, c_char_p, c_char_p, 
                                    c_bool, c_bool, c_int, c_int, c_int, c_char_p,c_char_p]
