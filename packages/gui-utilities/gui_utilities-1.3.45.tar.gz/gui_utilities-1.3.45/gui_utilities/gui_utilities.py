...
from PyQt6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QLineEdit, QComboBox, QDialog, QToolButton, QWidgetAction, QCheckBox, QTableWidget, QHeaderView, QApplication, QStyle, QStyledItemDelegate, QTextDocument
...
def create_combo_box(
    ...
    if math_expression:
        ...
        combo_box.setItemDelegate(RichTextDelegate(combo_box))
        combo_box.clear()
