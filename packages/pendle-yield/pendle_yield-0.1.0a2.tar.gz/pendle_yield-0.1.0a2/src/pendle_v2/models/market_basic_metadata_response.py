...
T = TypeVar("T", bound="MarketBasicMetadataResponse")


@_attrs_define
class MarketBasicMetadataResponse:
    """
    Attributes:
        id (str):
        chain_id (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        market_basic_metadata_response = cls(
            id=id,
            chain_id=chain_id,
            address=address,
            symbol=symbol,
        ...
        market_basic_metadata_response.additional_properties = d
        return market_basic_metadata_response
