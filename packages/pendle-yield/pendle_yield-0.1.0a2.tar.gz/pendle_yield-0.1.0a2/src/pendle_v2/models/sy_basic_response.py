...
T = TypeVar("T", bound="SyBasicResponse")


@_attrs_define
class SyBasicResponse:
    """
    Attributes:
        id (str):
        chain_id (float):
        ...
        simple_icon (str):
        pro_name (str):
        accounting_asset_type (float):
        accounting_asset (str): Accounting asset id
        underlying_asset (str): Underlying asset id
        reward_tokens (list[str]): Reward token ids
        input_tokens (list[str]): Input token ids
        output_tokens (list[str]): Output token ids
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        accounting_asset_type = self.accounting_asset_type
        ...
        field_dict.update(
            {
                ...
                "proName": pro_name,
                "accountingAssetType": accounting_asset_type,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        accounting_asset_type = d.pop("accountingAssetType")

        accounting_asset = d.pop("accountingAsset")

        underlying_asset = d.pop("underlyingAsset")

        reward_tokens = cast(list[str], d.pop("rewardTokens"))

        input_tokens = cast(list[str], d.pop("inputTokens"))

        output_tokens = cast(list[str], d.pop("outputTokens"))
        ...
        sy_basic_response = cls(
            ...
            pro_name=pro_name,
            accounting_asset_type=accounting_asset_type,
        ...
        sy_basic_response.additional_properties = d
        return sy_basic_response
