...
from ...models.market_apy_histories_response import MarketApyHistoriesResponse
from ...models.markets_controller_market_apy_history_time_frame import MarketsControllerMarketApyHistoryTimeFrame
...
def _get_kwargs(
    ...
    *,
    time_frame: Union[
        Unset, MarketsControllerMarketApyHistoryTimeFrame
    ] = MarketsControllerMarketApyHistoryTimeFrame.HOUR,
...
) -> Optional[MarketApyHistoriesResponse]:
    if response.status_code == 200:
        response_200 = MarketApyHistoriesResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[MarketApyHistoriesResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get market historical apy data by address

    Args:
        chain_id (float):
        address (str):
        time_frame (Union[Unset, MarketsControllerMarketApyHistoryTimeFrame]):  Default:
            MarketsControllerMarketApyHistoryTimeFrame.HOUR.
