...
from ...models.markets_controller_market_apy_history_v2_time_frame import MarketsControllerMarketApyHistoryV2TimeFrame
...
def _get_kwargs(
    ...
    *,
    time_frame: Union[
        Unset, MarketsControllerMarketApyHistoryV2TimeFrame
    ] = MarketsControllerMarketApyHistoryV2TimeFrame.HOUR,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v2/{chain_id}/markets/{address}/apy-history",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get market historical apy data by address in CSV format

    Args:
        chain_id (float):
        address (str):
        time_frame (Union[Unset, MarketsControllerMarketApyHistoryV2TimeFrame]):  Default:
            MarketsControllerMarketApyHistoryV2TimeFrame.HOUR.
