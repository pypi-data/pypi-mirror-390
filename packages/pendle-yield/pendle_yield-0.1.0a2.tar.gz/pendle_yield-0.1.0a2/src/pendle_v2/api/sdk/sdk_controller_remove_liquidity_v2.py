...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v2/sdk/{chain_id}/markets/{market}/remove-liquidity",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Single-sided liquidity removal, get back either tokens or PT

     Single-sided liquidity removal, get back either tokens or PT, callable regardless of the market's
    expiry.
