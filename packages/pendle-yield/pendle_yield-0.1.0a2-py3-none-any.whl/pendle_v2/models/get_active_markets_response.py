...
T = TypeVar("T", bound="GetActiveMarketsResponse")


@_attrs_define
class GetActiveMarketsResponse:
    """
    Attributes:
        markets (list['MarketData']): active market list Example: [{'name': 'crvUSD', 'address':
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_active_markets_response = cls(
            markets=markets,
        )

        get_active_markets_response.additional_properties = d
        return get_active_markets_response
