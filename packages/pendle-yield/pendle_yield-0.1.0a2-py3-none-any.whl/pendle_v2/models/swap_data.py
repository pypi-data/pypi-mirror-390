...
class SwapData:
    ...
    Attributes:
        ...
        effective_apy (Union[Unset, float]):
    """

    amount_out: str
    price_impact: float
    implied_apy: Union[Unset, "ImpliedApy"] = UNSET
    effective_apy: Union[Unset, float] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if effective_apy is not UNSET:
            field_dict["effectiveApy"] = effective_apy
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        effective_apy = d.pop("effectiveApy", UNSET)
        ...
        swap_data.additional_properties = d
        return swap_data
