...
from ...models.prices_controller_ohlcv_v2_time_frame import PricesControllerOhlcvV2TimeFrame
...
def _get_kwargs(
    ...
    address: str,
    *,
    time_frame: Union[Unset, PricesControllerOhlcvV2TimeFrame] = PricesControllerOhlcvV2TimeFrame.HOUR,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v2/{chain_id}/prices/{address}/ohlcv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        chain_id (float):
        address (str):
        time_frame (Union[Unset, PricesControllerOhlcvV2TimeFrame]):  Default:
            PricesControllerOhlcvV2TimeFrame.HOUR.
