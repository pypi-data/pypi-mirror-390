...
from ...models.prices_controller_volume_by_market_time_frame import PricesControllerVolumeByMarketTimeFrame
from ...models.prices_controller_volume_by_market_type import PricesControllerVolumeByMarketType
...
def _get_kwargs(
    ...
    address: str,
    *,
    time_frame: Union[Unset, PricesControllerVolumeByMarketTimeFrame] = PricesControllerVolumeByMarketTimeFrame.HOUR,
    timestamp_start: Union[Unset, datetime.datetime] = UNSET,
    timestamp_end: Union[Unset, datetime.datetime] = UNSET,
    type_: PricesControllerVolumeByMarketType = PricesControllerVolumeByMarketType.PT,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/{chain_id}/prices/{address}/volume-by-market",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        chain_id (float):
        address (str):
        time_frame (Union[Unset, PricesControllerVolumeByMarketTimeFrame]):  Default:
            PricesControllerVolumeByMarketTimeFrame.HOUR.
        timestamp_start (Union[Unset, datetime.datetime]):
        timestamp_end (Union[Unset, datetime.datetime]):
        type_ (PricesControllerVolumeByMarketType):  Default:
            PricesControllerVolumeByMarketType.PT.
