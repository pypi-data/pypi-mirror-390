...
from ...models.market_histories_response import MarketHistoriesResponse
from ...models.markets_controller_market_history_v2_time_frame import MarketsControllerMarketHistoryV2TimeFrame
...
def _get_kwargs(
    ...
    *,
    time_frame: Union[
        Unset, MarketsControllerMarketHistoryV2TimeFrame
    ] = MarketsControllerMarketHistoryV2TimeFrame.HOUR,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v2/{chain_id}/markets/{address}/history",
        "params": params,
    }
...
) -> Optional[MarketHistoriesResponse]:
    if response.status_code == 200:
        response_200 = MarketHistoriesResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Get market historical data by address

    Args:
        chain_id (float):
        address (str):
        time_frame (Union[Unset, MarketsControllerMarketHistoryV2TimeFrame]):  Default:
            MarketsControllerMarketHistoryV2TimeFrame.HOUR.
