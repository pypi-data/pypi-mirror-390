...
from ...models.market_apy_histories_csv_response import MarketApyHistoriesCSVResponse
from ...models.markets_controller_market_apy_history_1d_time_frame import MarketsControllerMarketApyHistory1DTimeFrame
...
def _get_kwargs(
    ...
    *,
    time_frame: Union[
        Unset, MarketsControllerMarketApyHistory1DTimeFrame
    ] = MarketsControllerMarketApyHistory1DTimeFrame.HOUR,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/{chain_id}/markets/{address}/apy-history-1ma",
        "params": params,
    }
...
) -> Optional[MarketApyHistoriesCSVResponse]:
    if response.status_code == 200:
        response_200 = MarketApyHistoriesCSVResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[MarketApyHistoriesCSVResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get market 1D MA historical apy data by address in CSV format

    Args:
        chain_id (float):
        address (str):
        time_frame (Union[Unset, MarketsControllerMarketApyHistory1DTimeFrame]):  Default:
            MarketsControllerMarketApyHistory1DTimeFrame.HOUR.
