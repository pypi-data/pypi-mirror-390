...
class FluidPitzer:
    def __init__(self, x0, species, t=25, database='lassin', neutral=False, solids=None):
        """
    ...
    def get_molalities(self, x):
        ...
        molalities = mt.calculate_molality(x_v, self.species)
    ...
    def total_gibbs_energy(self, x):
        ...
        std_cp_water = mt.get_chemical_potential(species='H2O(l)', t=self.t)
    ...
    def solubility_equilibrium(self, x):
        ...
        if target_species == 'H2O(S)':
            ...
            lnk_potential = mt.get_chemical_potential(species=target_species, t=self.t)
