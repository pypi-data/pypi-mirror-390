...
def zenith_to_altitude(zenith: Union[float, pd.Series, np.ndarray]) -> Union[float, pd.Series, np.ndarray]:
    """
...
def altitude_to_zenith(altitude: Union[float, pd.Series, np.ndarray]) -> Union[float, pd.Series, np.ndarray]:
    """
