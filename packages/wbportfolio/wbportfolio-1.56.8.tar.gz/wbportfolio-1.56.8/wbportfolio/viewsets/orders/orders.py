...
class OrderOrderProposalModelViewSet(
    ...
    def changeexecutioninstruction(self, request, pk=None, order_proposal_id=None, **kwargs):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            execution_instruction_type = parameters.pop("execution_instruction_type")
            ...
            orders_to_update.update(
                execution_instruction=execution_instruction_type, execution_instruction_parameters=execution_parameters
            )
