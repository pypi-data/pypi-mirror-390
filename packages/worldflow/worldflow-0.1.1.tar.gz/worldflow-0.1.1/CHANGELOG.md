...
### Fixed
- Fixed `LocalWorld` to properly support `:memory:` databases by maintaining a persistent connection.
- Resolved "no such table" errors when using in-memory SQLite databases for testing.
