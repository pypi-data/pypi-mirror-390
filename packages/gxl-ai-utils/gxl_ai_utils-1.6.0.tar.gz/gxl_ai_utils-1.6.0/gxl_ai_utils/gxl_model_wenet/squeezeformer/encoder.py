...
from ..squeezeformer.subsampling \
    import DepthwiseConv2dSubsampling4, TimeReductionLayer1D, \
    TimeReductionLayer2D, TimeReductionLayerStream
from ..squeezeformer.encoder_layer import SqueezeformerEncoderLayer
from ..transformer.embedding import RelPositionalEncoding
from ..transformer.attention import MultiHeadedAttention
from ..squeezeformer.attention import RelPositionMultiHeadedAttention
from ..squeezeformer.positionwise_feed_forward \
    import PositionwiseFeedForward
from ..squeezeformer.convolution import ConvolutionModule
...
class SqueezeformerEncoder(nn.Module):
    ...
    def check_ascending_list(self):
        """
        检查一下reduce_idx和recover_idx列表是否是上升排序的
        :return:
        """
        if self.reduce_idx is not None:
