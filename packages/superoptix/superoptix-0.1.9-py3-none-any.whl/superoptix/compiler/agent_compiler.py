...
class AgentCompiler:
    ...
    def compile(
        self, args, tier_level: str = None, use_abstracted: bool = False, use_explicit: bool = True
    ) -> None:
        ...
        try:
            ...
            if target == "dspy":
                if use_protocol_first:
                    ...
                    template_name = self._get_template_for_tier(effective_tier, use_abstracted, use_explicit)
            else:
    ...
    def _compile_with_framework_registry(
        ...
        try:
            ...
            if not framework_info["implemented"]:
                ...
                console.print(
                    f"[dim]📅 Multi-framework support roadmap:[/]"
                )
