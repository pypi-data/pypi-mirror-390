...
class DatasetLoader:
	...
	def __init__(self, dataset_config: Dict[str, Any]):
		...
		logger.info(f"Initialized DatasetLoader for: {self.name} (format={self.format})")
	...
	def _load_json(self) -> List[Dict[str, Any]]:
		...
		if not isinstance(data, list):
			raise ValueError(f"JSON data must be a list or object with data array, got {type(data)}")
