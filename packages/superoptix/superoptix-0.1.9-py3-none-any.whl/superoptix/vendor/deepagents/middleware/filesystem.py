...
from superoptix.vendor.deepagents.backends.protocol import BackendProtocol, BackendFactory, WriteResult, EditResult
from superoptix.vendor.deepagents.backends import StateBackend
from superoptix.vendor.deepagents.backends.utils import (
    create_file_data,
    update_file_data,
...
def _validate_path(path: str, *, allowed_prefixes: Sequence[str] | None = None) -> str:
    """Validate and normalize file path for s3cur1ty.
...
class FilesystemMiddleware(AgentMiddleware):
    ...
    Example:
        ...
        from superoptix.vendor.deepagents.memory.backends import StateBackend, StoreBackend, CompositeBackend
