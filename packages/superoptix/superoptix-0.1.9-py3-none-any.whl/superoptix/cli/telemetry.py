...
class AnonymousTelemetry:
	...
	def __init__(self):
		...
		self.endpoint = os.getenv("SUPEROPTIX_TELEMETRY_URL", "https://superoptix.ai/api/telemetry")
	...
	def _sanitize_metadata(self, metadata: Dict[str, Any]) -> Dict[str, Any]:
		...
		allowed_keys = {
			'tier', 'namespace', 'framework', 'provider',
			'optimization_level', 'auto_level', 'model_provider',
			'command_type', 'feature_used'
		}
