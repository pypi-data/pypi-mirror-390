...
class MCPClient:
    ...
    def add_server(self, name: str, command: str, args: List[str], 
                   description: str = "", env: Optional[Dict] = None):
    ...
    def read_file(self, file_path: str, server_name: str = 'filesystem') -> Optional[str]:
    ...
    def list_directory(self, dir_path: str, server_name: str = 'filesystem') -> Optional[List]:
