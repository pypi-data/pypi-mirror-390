...
See also: docs/guides/orchestra.md""",
                ...
                if content:
                    ...
                    if score > 0:
                        results.append({
                            ...
                            "answer": self._extract_relevant_section(content, query),
                            "docs_link": str(file_path.relative_to(self.project_root)),
                            "score": score,
                            "source": "docs"
                        })
            except Exception as e:
    ...
    def _extract_relevant_section(self, content: str, query: str, max_length: int = 500) -> str:
