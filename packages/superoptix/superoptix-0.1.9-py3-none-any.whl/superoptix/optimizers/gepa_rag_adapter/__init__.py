...
#
# Vendored from GEPA generic_rag_adapter
# This adapter is vendored in SuperOptiX to avoid dependency on GEPA version

"""RAG Adapter for GEPA - Optimize RAG pipelines with any vector store.

This module is vendored from GEPA to provide RAG optimization capabilities.
It enables optimization of query reformulation, context synthesis, answer generation,
and reranking through evolutionary prompt optimization.
"""
