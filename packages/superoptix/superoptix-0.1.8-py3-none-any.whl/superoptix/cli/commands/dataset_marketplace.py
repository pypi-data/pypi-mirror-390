...
def pull_example_dataset(args):
	...
	try:
		...
		if not super_file.exists():
			...
			# In a project, use proper structure
...
"""
		...
		console.print(Panel(usage.strip(), title="📝 Usage Example", border_style="cyan"))
