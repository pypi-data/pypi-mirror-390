...
class ResponseFormatter:
	...
	def format(self, intent, commands: List[str], results: List[Dict[str, Any]]) -> None:
	...
	def _rule_based_format(self, intent, commands: List[str], results: List[Dict[str, Any]]):
	...
	def _format_error(self, intent, command: str, error: str):
		...
		elif 'Model configuration missing' in error or 'Specification execution failed' in error:
