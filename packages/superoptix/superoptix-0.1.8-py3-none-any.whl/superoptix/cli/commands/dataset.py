...
def preview_dataset(args):
	...
	try:
		...
		# Load playbook
		playbook_path = project_root / project_name / "agents" / agent_name / "playbook" / f"{agent_name}_playbook.yaml"
...
[bold]Shuffled:[/bold] {stats['shuffled']}"""
				...
				console.print(Panel(info, title=f"📊 {dataset_name}", border_style="cyan"))
