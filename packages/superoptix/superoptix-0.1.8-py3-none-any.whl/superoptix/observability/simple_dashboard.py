...
if FASTAPI_AVAILABLE:
	...
	async def get_runs(
		...
		try:
			storage = get_storage()
			runs = storage.get_agent_runs(agent_name=agent_name, limit=limit, offset=offset)
	...
	async def get_optimizations(
		...
		try:
			storage = get_storage()
			opts = storage.get_optimizations(agent_name=agent_name, optimizer=optimizer, limit=limit)
	...
	async def get_protocols(
		...
		try:
			storage = get_storage()
			protocols = storage.get_protocol_usage(agent_name=agent_name, protocol_type=protocol_type, limit=limit)
