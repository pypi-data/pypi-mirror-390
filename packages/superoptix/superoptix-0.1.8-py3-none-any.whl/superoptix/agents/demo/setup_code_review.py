...
def setup_code_review_assistant():
	...
	playbook_path = project_root / "agents" / "code_review_assistant" / "playbook" / "code_review_assistant_playbook.yaml"
	...
	print(f"   • Knowledge base: knowledge/code_review/ (9 files)")
	print(f"   • Dataset: data/code_review_examples.csv (50+ examples)")
