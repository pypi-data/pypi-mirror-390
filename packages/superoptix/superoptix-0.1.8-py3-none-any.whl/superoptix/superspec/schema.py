...
class SuperSpecXSchema:
    ...
    OPTIMIZER_TIER_COMPATIBILITY = {
        "oracles": ["GEPA", "SIMBA", "MIPROv2", "BootstrapFewShot", "BetterTogether", "COPRO", "KNNFewShot", "LabeledFewShot"],
        "genies": ["GEPA", "SIMBA", "MIPROv2", "BootstrapFewShot", "BetterTogether", "COPRO", "KNNFewShot", "LabeledFewShot"],
        "protocols": ["GEPA", "SIMBA", "MIPROv2", "BootstrapFewShot", "BetterTogether", "COPRO", "KNNFewShot", "LabeledFewShot"],
        "superagents": ["GEPA", "SIMBA", "MIPROv2", "BootstrapFewShot", "BetterTogether", "COPRO", "KNNFewShot", "LabeledFewShot"],
        "sovereigns": ["GEPA", "SIMBA", "MIPROv2", "BootstrapFewShot", "BetterTogether", "COPRO", "KNNFewShot", "LabeledFewShot"]
    }
                    ...
                    "properties": {
                        ...
                        "params": {
                            ...
                            "properties": {
                                ...
                                "metric": {
                                    "oneOf": [
                                        {"enum": cls.VALID_BUILTIN_METRICS + cls.VALID_GEPA_METRICS},
                ...
                "evaluation": {
                    ...
                    "properties": {
                        ...
                        "cross_v4l1d4t10n": {
                            ...
                            "properties": {
                                "enabled": {"type": "boolean", "default": False},
                                "folds": {"type": "integer", "minimum": 2, "maximum": 10, "default": 5}
                            }
                        }
                    }
                },
