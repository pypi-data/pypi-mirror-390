...
class BaseIndices:
    def __init__(self):
        ...
        # Above technically also field_510, but processing is same
...
class PrimaryIndices(BaseIndices):
    def __init__(self):
        ...
        self.vert_angle = (102, 106, field_570)
        self.center_fix = (106, 111, field_5144)
        # Above technically also field_5271, but processing is same
        self.mult_code = (111, 112, field_5130)
        # Above technically also field_5272, but processing is same
...
class PlanningIndices(BaseIndices):
    def __init__(self):
        ...
        # PAD 22
        self.leg_dist = (74, 78, field_5260)
        # RESERVED 45
