...
class TasksResource(BaseResource):
    ...
    def create_with_instance(
        ...
        Args:
            ...
            additional_branches: Comma-separated list of additional branches to fetch (optional)
        ...
        Example:
            ...
            ...     prompt="Compare changes across branches",
            ...     environment_id=65,
            ...     additional_branches="develop,staging,feature/new-ui"
            ... )
            >>> print(f"Instance has branches: main, develop, staging, feature/new-ui")
