...
MASSCT = Lorentz(name = 'MASSCT',
               spins = [ 2, 2 ],
               structure = 'Identity(2,1)')

# finite renormalisation for axial-vector current

FFVaxialCT = Lorentz(name = 'FFVaxialCT',
               spins = [ 2, 2, 3 ],
               structure = 'Gamma(3,2,-1)*ProjP(-1,1) - Gamma(3,2,-1)*ProjM(-1,1) - ProjP(2,-1)*Gamma(3,-1,1) + ProjM(2,-1)*Gamma(3,-1,1)')
