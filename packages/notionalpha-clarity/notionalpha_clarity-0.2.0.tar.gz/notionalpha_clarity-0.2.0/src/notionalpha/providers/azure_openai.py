...
class AzureOpenAIProvider:
    ...
    def __init__(
        ...
        self.client = AzureOpenAI(
            ...
            api_version='2024-10-21',  # Updated to match backend AI Foundry support
    ...
    async def _capture_signal(
        ...
        try:
            ...
            analysis = await self.signal_analyzer.analyze({
                ...
                'processing_time_ms': None,  # Not available from Azure OpenAI response
            })
            ...
            print(f'[Azure OpenAI Provider] Signal capture failed: {e}')
...
class ChatCompletions:
    ...
    def __init__(self, client: AzureOpenAI, provider: 'AzureOpenAIProvider'):
        self.client = client
