...
```bash
# With pip
pip install essential-utils

# With uv
uv pip install essential-utils
```
...
```python
import asyncio
from essential-utils import run_parallel
...
from essential-utils import AsyncDB, BaseModel
...
```python
import asyncio
from essential-utils import AsyncRequest, make_request
...
```python
import asyncio
from essential-utils import make_request_cffi
...
```python
from dataclasses import dataclass, field
from essential-utils import BaseModel
