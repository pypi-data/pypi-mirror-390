...
enum BufferDebugLogEntryProto_CheckType : int {
  ...
  BufferDebugLogEntryProto_CheckType_CHECK_TYPE_NAN_COUNT = 2,
...
/* @@protoc_insertion_point(class_definition:xla.gpu.BufferDebugLogEntryProto) */ {
 ...
 public:
  ...
  static constexpr CheckType CHECK_TYPE_NAN_COUNT = BufferDebugLogEntryProto_CheckType_CHECK_TYPE_NAN_COUNT;
