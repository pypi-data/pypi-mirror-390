...
VERSION = "2.0.5.1"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
# Dépendances
INSTALL_REQUIRES = ["uvicorn==0.34.2", "fastapi==0.115.12", "CATEGORIT"]
