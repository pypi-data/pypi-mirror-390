...
class SurveyRunner:
    ...
    def __init__(self, survey: Survey):
        ...
        self.last_render_line_count = 0  # Track lines from last render for in-place updates
    ...
    def run(self) -> Optional[Results]:
        ...
        try:
            ...
            # Output newline to move past the survey display area
            print()
    ...
    def _render_survey(self):
        ...
        First render: Output content normally at current position with spacing
        Subsequent renders: Move cursor up to overwrite previous content in-place
        """
        # Output a blank line before first render to separate from previous content
        ...
        # Render the tab header and content
        ...
        if self.last_render_line_count > 0:
            self.renderer.move_up_lines(self.last_render_line_count)
        ...
        self.last_render_line_count = output.count("\n")
