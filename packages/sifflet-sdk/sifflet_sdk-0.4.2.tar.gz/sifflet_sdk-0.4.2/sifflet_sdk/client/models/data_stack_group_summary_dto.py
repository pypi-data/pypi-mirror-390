...
class DataStackGroupSummaryDto(BaseModel):
    """
    DataStackGroupSummaryDto
    """  # noqa: E501

    lineage_platform: Optional[StrictStr] = Field(default=None, alias="lineagePlatform")
    quantity_by_type: Optional[Dict[str, StrictInt]] = Field(default=None, alias="quantityByType")
    __properties: ClassVar[List[str]] = ["lineagePlatform", "quantityByType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataStackGroupSummaryDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataStackGroupSummaryDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"lineagePlatform": obj.get("lineagePlatform"), "quantityByType": obj.get("quantityByType")}
        )
        return _obj
