...
class TransformationAssetDto(BaseModel):
    """
    TransformationAssetDto
    """  # noqa: E501

    connector_status: Optional[StrictStr] = Field(default=None, alias="connectorStatus")
    created_by: Optional[StrictStr] = Field(default=None, alias="createdBy")
    created_date: Optional[StrictInt] = Field(default=None, alias="createdDate")
    destination_platform: Optional[StrictStr] = Field(default=None, alias="destinationPlatform")
    destination_platform_label: Optional[StrictStr] = Field(default=None, alias="destinationPlatformLabel")
    last_successful_run_date: Optional[StrictInt] = Field(default=None, alias="lastSuccessfulRunDate")
    run_frequency_seconds: Optional[StrictInt] = Field(default=None, alias="runFrequencySeconds")
    source_platform: Optional[StrictStr] = Field(default=None, alias="sourcePlatform")
    source_platform_label: Optional[StrictStr] = Field(default=None, alias="sourcePlatformLabel")
    ...
    @field_validator("destination_platform")
    def destination_platform_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransformationAssetDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransformationAssetDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "destinationPlatform": obj.get("destinationPlatform"),
                "destinationPlatformLabel": obj.get("destinationPlatformLabel"),
                "lastSuccessfulRunDate": obj.get("lastSuccessfulRunDate"),
                "runFrequencySeconds": obj.get("runFrequencySeconds"),
                "sourcePlatform": obj.get("sourcePlatform"),
                "sourcePlatformLabel": obj.get("sourcePlatformLabel"),
            }
        )
        return _obj
