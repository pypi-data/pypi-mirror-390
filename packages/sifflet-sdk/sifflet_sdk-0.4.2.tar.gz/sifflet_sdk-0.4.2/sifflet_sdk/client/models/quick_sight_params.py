...
class QuickSightParams(DatasourceParams):
    """
    QuickSightParams
    """  # noqa: E501

    account_id: StrictStr = Field(alias="accountId")
    aws_region: StrictStr = Field(alias="awsRegion")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuickSightParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuickSightParams from a dict"""
        if obj is None:
            return None
