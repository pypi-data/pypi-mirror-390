...
class PublicDescriptionDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "origin"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicDescriptionDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicDescriptionDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"description": obj.get("description"), "origin": obj.get("origin")})
        return _obj
