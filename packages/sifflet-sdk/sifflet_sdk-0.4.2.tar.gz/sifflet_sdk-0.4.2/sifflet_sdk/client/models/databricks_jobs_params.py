...
class DatabricksJobsParams(DatasourceParams):
    """
    ...
    host: StrictStr
    http_path: StrictStr = Field(alias="httpPath")
    port: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatabricksJobsParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatabricksJobsParams from a dict"""
        if obj is None:
            return None
