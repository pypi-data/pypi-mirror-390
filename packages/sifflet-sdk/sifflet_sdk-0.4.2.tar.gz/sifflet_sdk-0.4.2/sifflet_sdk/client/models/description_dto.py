...
class DescriptionDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "sourceType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DescriptionDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DescriptionDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"description": obj.get("description"), "sourceType": obj.get("sourceType")})
        return _obj
