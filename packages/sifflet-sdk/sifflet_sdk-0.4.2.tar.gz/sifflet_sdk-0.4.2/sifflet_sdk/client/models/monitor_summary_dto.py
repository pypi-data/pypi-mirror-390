...
class MonitorSummaryDto(BaseModel):
    ...
    name: StrictStr
    urn: StrictStr
    dataset_name_and_source_type_dtos: List[DatasetNameAndSourceTypeDto] = Field(alias="datasetNameAndSourceTypeDtos")
    label: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MonitorSummaryDto from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in dataset_name_and_source_type_dtos (list)
        _items = []
        if self.dataset_name_and_source_type_dtos:
            for _item_dataset_name_and_source_type_dtos in self.dataset_name_and_source_type_dtos:
                if _item_dataset_name_and_source_type_dtos:
                    _items.append(_item_dataset_name_and_source_type_dtos.to_dict())
            _dict["datasetNameAndSourceTypeDtos"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MonitorSummaryDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "urn": obj.get("urn"),
                "datasetNameAndSourceTypeDtos": (
                    [DatasetNameAndSourceTypeDto.from_dict(_item) for _item in obj["datasetNameAndSourceTypeDtos"]]
                    if obj.get("datasetNameAndSourceTypeDtos") is not None
                    else None
                ),
                "label": obj.get("label"),
            }
