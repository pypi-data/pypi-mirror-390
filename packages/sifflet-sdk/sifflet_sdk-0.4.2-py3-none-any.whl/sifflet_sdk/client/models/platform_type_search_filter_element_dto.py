...
class PlatformTypeSearchFilterElementDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["results", "icon", "id", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlatformTypeSearchFilterElementDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlatformTypeSearchFilterElementDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"results": obj.get("results"), "icon": obj.get("icon"), "id": obj.get("id"), "name": obj.get("name")}
        )
        return _obj
