...
class AthenaParams(DatasourceParams):
    """
    AthenaParams
    """  # noqa: E501
    ...
    s3_output_location: StrictStr = Field(alias="s3OutputLocation")
    vpc_url: Optional[StrictStr] = Field(default=None, alias="vpcUrl")
    workgroup: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AthenaParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AthenaParams from a dict"""
        if obj is None:
            return None
