...
class PublicCreateSourceV2Request(BaseModel):
    ...
    oneof_schema_4_validator: Optional[PublicCreateDatabricksJobsSourceV2Dto] = None
    # data type: PublicCreateDatabricksSourceV2Dto
    oneof_schema_5_validator: Optional[PublicCreateDatabricksSourceV2Dto] = None
    # data type: PublicCreateDbtCloudSourceV2Dto
    oneof_schema_6_validator: Optional[PublicCreateDbtCloudSourceV2Dto] = None
    # data type: PublicCreateDbtSourceV2Dto
    oneof_schema_7_validator: Optional[PublicCreateDbtSourceV2Dto] = None
    # data type: PublicCreateFivetranSourceV2Dto
    oneof_schema_8_validator: Optional[PublicCreateFivetranSourceV2Dto] = None
    # data type: PublicCreateLookerSourceV2Dto
    oneof_schema_9_validator: Optional[PublicCreateLookerSourceV2Dto] = None
    # data type: PublicCreateMicrostrategySourceV2Dto
    oneof_schema_10_validator: Optional[PublicCreateMicrostrategySourceV2Dto] = None
    # data type: PublicCreateMssqlSourceV2Dto
    oneof_schema_11_validator: Optional[PublicCreateMssqlSourceV2Dto] = None
    # data type: PublicCreateMysqlSourceV2Dto
    oneof_schema_12_validator: Optional[PublicCreateMysqlSourceV2Dto] = None
    # data type: PublicCreateOracleSourceV2Dto
    oneof_schema_13_validator: Optional[PublicCreateOracleSourceV2Dto] = None
    # data type: PublicCreatePostgresqlSourceV2Dto
    oneof_schema_14_validator: Optional[PublicCreatePostgresqlSourceV2Dto] = None
    # data type: PublicCreatePowerBiSourceV2Dto
    oneof_schema_15_validator: Optional[PublicCreatePowerBiSourceV2Dto] = None
    # data type: PublicCreateQlikSourceV2Dto
    oneof_schema_16_validator: Optional[PublicCreateQlikSourceV2Dto] = None
    # data type: PublicCreateQuicksightSourceV2Dto
    oneof_schema_17_validator: Optional[PublicCreateQuicksightSourceV2Dto] = None
    # data type: PublicCreateRedshiftSourceV2Dto
    oneof_schema_18_validator: Optional[PublicCreateRedshiftSourceV2Dto] = None
    # data type: PublicCreateSnowflakeSourceV2Dto
    oneof_schema_19_validator: Optional[PublicCreateSnowflakeSourceV2Dto] = None
    # data type: PublicCreateSynapseSourceV2Dto
    oneof_schema_20_validator: Optional[PublicCreateSynapseSourceV2Dto] = None
    # data type: PublicCreateTableauSourceV2Dto
    oneof_schema_21_validator: Optional[PublicCreateTableauSourceV2Dto] = None
