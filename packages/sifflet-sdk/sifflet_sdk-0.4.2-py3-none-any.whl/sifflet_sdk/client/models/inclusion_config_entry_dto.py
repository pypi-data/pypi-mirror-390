...
class InclusionConfigEntryDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["datasourceId", "monitoredTemplates"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InclusionConfigEntryDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InclusionConfigEntryDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"datasourceId": obj.get("datasourceId"), "monitoredTemplates": obj.get("monitoredTemplates")}
        )
        return _obj
