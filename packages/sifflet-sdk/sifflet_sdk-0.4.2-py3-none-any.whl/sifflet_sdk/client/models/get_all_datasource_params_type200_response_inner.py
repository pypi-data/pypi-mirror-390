...
class GetAllDatasourceParamsType200ResponseInner(BaseModel):
    ...
    oneof_schema_18_validator: Optional[PostgresqlParams] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in GetAllDatasourceParamsType200ResponseInner with oneOf schemas: AdfParams, AirflowParams, AthenaParams, BigQueryParams, ComposerParams, DBTCloudParams, DBTParams, DatabricksJobsParams, DatabricksParams, DeclarativeParams, FivetranParams, LookerParams, MicrostrategyParams, MssqlParams, MwaaParams, MysqlParams, OracleParams, PostgresqlParams, PowerBiParams, QlikParams, QuickSightParams, RedshiftParams, SnowflakeParams, SynapseParams, TableauParams, UnknownDatasourceParams. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in GetAllDatasourceParamsType200ResponseInner with oneOf schemas: AdfParams, AirflowParams, AthenaParams, BigQueryParams, ComposerParams, DBTCloudParams, DBTParams, DatabricksJobsParams, DatabricksParams, DeclarativeParams, FivetranParams, LookerParams, MicrostrategyParams, MssqlParams, MwaaParams, MysqlParams, OracleParams, PostgresqlParams, PowerBiParams, QlikParams, QuickSightParams, RedshiftParams, SnowflakeParams, SynapseParams, TableauParams, UnknownDatasourceParams. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into GetAllDatasourceParamsType200ResponseInner with oneOf schemas: AdfParams, AirflowParams, AthenaParams, BigQueryParams, ComposerParams, DBTCloudParams, DBTParams, DatabricksJobsParams, DatabricksParams, DeclarativeParams, FivetranParams, LookerParams, MicrostrategyParams, MssqlParams, MwaaParams, MysqlParams, OracleParams, PostgresqlParams, PowerBiParams, QlikParams, QuickSightParams, RedshiftParams, SnowflakeParams, SynapseParams, TableauParams, UnknownDatasourceParams. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
