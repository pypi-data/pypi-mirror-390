...
class DatasourceHierarchyNodeDto(BaseModel):
    """
    DatasourceHierarchyNodeDto
    """  # noqa: E501

    children: List[DatasourceHierarchyNodeDto]
    count: Optional[StrictInt] = None
    datasource_id: Optional[StrictStr] = Field(default=None, alias="datasourceId")
    monitored_templates: Optional[List[StrictStr]] = Field(default=None, alias="monitoredTemplates")
    name: StrictStr
    type: StrictStr
    __properties: ClassVar[List[str]] = ["children", "count", "datasourceId", "monitoredTemplates", "name", "type"]

    @field_validator("monitored_templates")
    def monitored_templates_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["SOURCE", "AUTHORITY", "DATABASE", "SCHEMA"]):
            raise ValueError("must be one of enum values ('SOURCE', 'AUTHORITY', 'DATABASE', 'SCHEMA')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatasourceHierarchyNodeDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatasourceHierarchyNodeDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "children": (
                    [DatasourceHierarchyNodeDto.from_dict(_item) for _item in obj["children"]]
                    if obj.get("children") is not None
                    else None
                ),
                "count": obj.get("count"),
                "datasourceId": obj.get("datasourceId"),
                "monitoredTemplates": obj.get("monitoredTemplates"),
                "name": obj.get("name"),
                "type": obj.get("type"),
            }
        )
...
DatasourceHierarchyNodeDto.model_rebuild(raise_errors=False)
