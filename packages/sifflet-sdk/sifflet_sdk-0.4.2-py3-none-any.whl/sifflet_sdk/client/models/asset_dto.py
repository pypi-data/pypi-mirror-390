...
class AssetDto(BaseModel):
    ...
    displayed_type: Optional[StrictStr] = Field(default=None, alias="displayedType")
    displayed_type_enum: Optional[StrictStr] = Field(default=None, alias="displayedTypeEnum")
    id: StrictStr
    ...
    @field_validator("displayed_type_enum")
    def displayed_type_enum_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "displayedTypeEnum": obj.get("displayedTypeEnum"),
                "id": obj.get("id"),
