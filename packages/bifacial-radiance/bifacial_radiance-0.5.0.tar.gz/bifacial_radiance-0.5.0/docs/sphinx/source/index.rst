...
<https://github.com/NREL/bifacial_radiance/tree/master/docs/tutorials>`_. The documentation assumes general familiarity with Python, NumPy, and Pandas. Google searches will yield many excellent tutorials for these packages.
