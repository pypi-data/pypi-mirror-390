...
class ParameterValidator:
    ...
    def validate_number(
        ...
        if (
            NumberValidator.is_number(value) and
    ...
    def validate_mandatory_number(
        ...
        """
        ParameterValidator.validate_mandatory(name, value)
        ParameterValidator.validate_number(name, value, do_include_zero)
    ...
    def validate_mandatory_number_between(
        ...
        """
        ParameterValidator.validate_mandatory(name, value)
        ParameterValidator.validate_number_between(name, value, lower_limit, upper_limit, do_include_lower_limit, do_include_upper_limit)
