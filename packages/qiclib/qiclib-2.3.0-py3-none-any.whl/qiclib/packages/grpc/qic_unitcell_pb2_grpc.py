...
class UnitCellServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Submit = channel.unary_unary(
                '/qic_unitcell.UnitCellService/Submit',
                request_serializer=qic__unitcell__pb2.Job.SerializeToString,
                response_deserializer=datatypes__pb2.UInt.FromString,
                _registered_method=True)
        self.GetJobStatus = channel.unary_unary(
                '/qic_unitcell.UnitCellService/GetJobStatus',
                request_serializer=datatypes__pb2.UInt.SerializeToString,
                response_deserializer=qic__unitcell__pb2.JobStatus.FromString,
                _registered_method=True)
        self.GetResults = channel.unary_unary(
                '/qic_unitcell.UnitCellService/GetResults',
                request_serializer=datatypes__pb2.UInt.SerializeToString,
                response_deserializer=qic__unitcell__pb2.ExperimentResults.FromString,
                _registered_method=True)
        self.StreamResults = channel.unary_stream(
                '/qic_unitcell.UnitCellService/StreamResults',
                request_serializer=datatypes__pb2.UInt.SerializeToString,
                response_deserializer=qic__unitcell__pb2.ExperimentResults.FromString,
                _registered_method=True)
...
def add_UnitCellServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Submit': grpc.unary_unary_rpc_method_handler(
                    servicer.Submit,
                    request_deserializer=qic__unitcell__pb2.Job.FromString,
                    response_serializer=datatypes__pb2.UInt.SerializeToString,
            ),
            'GetJobStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetJobStatus,
                    request_deserializer=datatypes__pb2.UInt.FromString,
                    response_serializer=qic__unitcell__pb2.JobStatus.SerializeToString,
            ),
...
class UnitCellService(object):
    ...
    def Submit(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/qic_unitcell.UnitCellService/Submit',
            qic__unitcell__pb2.Job.SerializeToString,
            datatypes__pb2.UInt.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GetJobStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/qic_unitcell.UnitCellService/GetJobStatus',
            datatypes__pb2.UInt.SerializeToString,
            qic__unitcell__pb2.JobStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
