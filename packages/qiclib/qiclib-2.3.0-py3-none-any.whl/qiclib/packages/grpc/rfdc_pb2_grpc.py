...
class RFdcServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetMixerFrequency = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetFrequencyResolution = channel.unary_unary(
                '/rfdc.RFdcService/GetFrequencyResolution',
                request_serializer=rfdc__pb2.ConverterIndex.SerializeToString,
        ...
        self.GetMixerMode = channel.unary_unary(
                ...
                _registered_method=True)
        self.SetMixerMode = channel.unary_unary(
                '/rfdc.RFdcService/SetMixerMode',
                request_serializer=rfdc__pb2.IndexedMode.SerializeToString,
                response_deserializer=datatypes__pb2.Empty.FromString,
                _registered_method=True)
...
class RFdcServiceServicer(object):
    ...
    def GetFrequencyResolution(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def SetMixerMode(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RFdcServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetFrequencyResolution': grpc.unary_unary_rpc_method_handler(
                    servicer.GetFrequencyResolution,
                    request_deserializer=rfdc__pb2.ConverterIndex.FromString,
            ...
            'SetMixerMode': grpc.unary_unary_rpc_method_handler(
                    servicer.SetMixerMode,
                    request_deserializer=rfdc__pb2.IndexedMode.FromString,
                    response_serializer=datatypes__pb2.Empty.SerializeToString,
            ),
...
class RFdcService(object):
    ...
    @staticmethod
    def GetFrequencyResolution(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    def SetMixerMode(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/rfdc.RFdcService/SetMixerMode',
            rfdc__pb2.IndexedMode.SerializeToString,
            datatypes__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
