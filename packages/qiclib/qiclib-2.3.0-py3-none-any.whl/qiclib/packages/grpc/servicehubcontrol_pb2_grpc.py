...
class ServicehubControlServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.LoadNewProfile = channel.unary_unary(
                '/servicehubcontrol.ServicehubControlService/LoadNewProfile',
        ...
        self.LoadNewConfig = channel.unary_unary(
                ...
                response_deserializer=datatypes__pb2.Empty.FromString,
                _registered_method=True)
        self.LoadNewConfigAndPLAndDTOs = channel.unary_unary(
                '/servicehubcontrol.ServicehubControlService/LoadNewConfigAndPLAndDTOs',
                request_serializer=servicehubcontrol__pb2.ReloadData.SerializeToString,
                response_deserializer=datatypes__pb2.Empty.FromString,
                _registered_method=True)
...
class ServicehubControlServiceServicer(object):
    ...
    def LoadNewProfile(self, request, context):
        """*
    ...
    def LoadNewConfigAndPLAndDTOs(self, request, context):
        """*
...
def add_ServicehubControlServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'LoadNewProfile': grpc.unary_unary_rpc_method_handler(
                    servicer.LoadNewProfile,
            ...
            'LoadNewConfigAndPLAndDTOs': grpc.unary_unary_rpc_method_handler(
                    servicer.LoadNewConfigAndPLAndDTOs,
                    request_deserializer=servicehubcontrol__pb2.ReloadData.FromString,
                    response_serializer=datatypes__pb2.Empty.SerializeToString,
            ),
...
class ServicehubControlService(object):
    ...
    @staticmethod
    def LoadNewConfigAndPLAndDTOs(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/servicehubcontrol.ServicehubControlService/LoadNewConfigAndPLAndDTOs',
            servicehubcontrol__pb2.ReloadData.SerializeToString,
            datatypes__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
