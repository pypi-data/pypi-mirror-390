...
class Write(_message.Message):
    __slots__ = ("ep_index", "channel", "reg", "volt")
    ...
    reg: int
    volt: float
    def __init__(self, ep_index: _Optional[_Union[_datatypes_pb2.EndpointIndex, _Mapping]] = ..., channel: _Optional[int] = ..., reg: _Optional[int] = ..., volt: _Optional[float] = ...) -> None: ...
