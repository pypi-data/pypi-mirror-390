...
class StorageStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReadData = channel.unary_unary(
                '/qic_storage.Storage/ReadData',
                request_serializer=qic__storage__pb2.ReadDataRequest.SerializeToString,
                response_deserializer=qic__storage__pb2.ReadDataResponse.FromString,
                _registered_method=True)
        self.WriteData = channel.unary_unary(
                '/qic_storage.Storage/WriteData',
                request_serializer=qic__storage__pb2.WriteDataRequest.SerializeToString,
                response_deserializer=datatypes__pb2.Empty.FromString,
                _registered_method=True)
...
def add_StorageServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReadData': grpc.unary_unary_rpc_method_handler(
                    servicer.ReadData,
                    request_deserializer=qic__storage__pb2.ReadDataRequest.FromString,
                    response_serializer=qic__storage__pb2.ReadDataResponse.SerializeToString,
            ),
            'WriteData': grpc.unary_unary_rpc_method_handler(
                    servicer.WriteData,
                    request_deserializer=qic__storage__pb2.WriteDataRequest.FromString,
                    response_serializer=datatypes__pb2.Empty.SerializeToString,
            ),
    }
...
class Storage(object):
    ...
    def ReadData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/qic_storage.Storage/ReadData',
            qic__storage__pb2.ReadDataRequest.SerializeToString,
            qic__storage__pb2.ReadDataResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def WriteData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/qic_storage.Storage/WriteData',
            qic__storage__pb2.WriteDataRequest.SerializeToString,
            datatypes__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
