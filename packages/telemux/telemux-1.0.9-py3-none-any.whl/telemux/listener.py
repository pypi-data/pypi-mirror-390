...
def process_update(update: Dict[str, Any], bot_token: str, chat_id: str, user_id: Optional[str] = None) -> None:
    ...
    try:
        ...
        if bypass_sanitization:
            ...
            # Normal mode - just send confirmation
    ...
    try:
        while True:
            ...
            for update in updates:
                ...
                # Process update
                try:
                    process_update(update, bot_token, chat_id, user_id)
                except Exception as e:
