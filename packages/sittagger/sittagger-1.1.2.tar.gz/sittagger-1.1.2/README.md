...
![sit-tagger window with a directory tree pane and the list of files (with thumbnails) from the selected dir](https://gitlab.com/hydrargyrum/sit-tagger/-/raw/master/docs/shot-dirview.jpg)

![sit-tagger window with a tags list pane (with a checkbox for each tag) and the list of files (with thumbnails) matching the checked tags](https://gitlab.com/hydrargyrum/sit-tagger/-/raw/master/docs/shot-tagview.jpg)
...
![sit-tagger window with the list of files (with thumbnails) and a caption editor pane (showing a user-entered caption with #hashtags in it)](https://gitlab.com/hydrargyrum/sit-tagger/-/raw/master/docs/shot-caption.jpg)
