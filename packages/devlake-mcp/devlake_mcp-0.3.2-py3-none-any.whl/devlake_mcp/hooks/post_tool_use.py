...
from devlake_mcp.utils import get_temp_dir, get_temp_file_path, compress_content
...
# 配置日志（启动时调用一次）
configure_logging(log_dir=HOOK_LOG_DIR, log_file='post_tool_use.log')
...
def main():
    ...
    try:
        ...
        prompt_uuid = get_current_generation_id(session_id)
