...
def open_cloud_music(exe_path: str = None) -> dict:
    ...
    """
    try:
        _open_cloud_music(exe_path)
        return {"code": 200, "msg": "网易云音乐已打开"}
...
def search_and_play_mcp(keyword: str) -> dict:
    ...
    """
    try:
        _search_and_play(keyword)
        return {"code": 200, "msg": "已搜索并播放"}
    except Exception as e:
