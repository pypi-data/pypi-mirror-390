...
class Asset:
    ...
    async def create_asset(self, asset_object_schema: AssetObjectSchema, headers: HeaderTypes | None = None) -> ResponseModel[AssetObjectSchema]:
        ...
        return ResponseModel(
            ...
            content=AssetObjectSchema(**response.json()),
            response=response
        )
    ...
    async def query_asset_tree(self, asset_query_schema: AssetQuerySchema, headers: HeaderTypes | None = None) -> ResponseModel[AssetTreeSchema]:
        ...
        return ResponseModel(
            status_code=response.status_code,
            content=AssetTreeSchema(**response.json()),
            response=response
        )

    async def query_assets(self, asset_query_schema: AssetQuerySchema, headers: HeaderTypes | None = None) -> ResponseModel[list]:
        """
    ...
    async def write_attribute_events(self, attribute_event_schema: AttributeEventSchema, headers: HeaderTypes | None = None) -> ResponseModel[list]:
        """
    ...
    async def write_attribute_values(self, attribute_state_schema: AttributeStateSchema, headers: HeaderTypes | None = None) -> ResponseModel[list]:
        """
