...
class Dashboard:
    ...
    async def update_dashboard(self, dashboard_schema: DashboardSchema, headers: HeaderTypes | None = None) -> ResponseModel[DashboardSchema]:
        ...
        return ResponseModel(
            ...
            content=DashboardSchema(**response.json()),
            response=response
        )
    ...
    async def query_dashboards(self, dashboard_query_schema: DashboardQuerySchema, headers: HeaderTypes | None = None) -> ResponseModel[list]:
        """
