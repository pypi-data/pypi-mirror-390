...
class Alarm:
    ...
    async def get_alarms(self, headers: HeaderTypes | None = None) -> ResponseModel[list]:
        """
    ...
    async def create_alarm(self, headers: HeaderTypes | None = None) -> ResponseModel[SentAlarmSchema]:
        ...
        return ResponseModel(
            status_code=response.status_code,
            content=SentAlarmSchema(**response.json()),
            response=response
        )
    ...
    async def get_asset_links(self, alarm_id: int, headers: HeaderTypes | None = None) -> ResponseModel[list]:
        """
