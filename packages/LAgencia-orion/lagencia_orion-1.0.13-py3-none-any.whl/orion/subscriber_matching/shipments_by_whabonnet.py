...
async def shimpent_whabonet_castillo(message: Dict):
    ...
    if not message.get("adviser_name"):
        ...
        data = {"app": "arrcastillo", "securekey": "sk_e6de090b1f89457698ff81a01b7b9e9e", "template": [{"id": "425811df-40ea-4167-beb6-f084e10ede49", "params": [message.get("name", ""), message.get("token", "")]}], "localid": "suscription", "IntegratorUser": "0", "message": [], "number": message.get("phone_number")}
    else:
