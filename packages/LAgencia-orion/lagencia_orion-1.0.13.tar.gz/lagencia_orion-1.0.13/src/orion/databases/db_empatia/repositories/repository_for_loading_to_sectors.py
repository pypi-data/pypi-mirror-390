...
# ============================ ACTUALIZAR LOS SHOWS DE LA TABLA SECTORES  ============================


# sector_id	name_origin	sector_related_id	name_related


# # Función que construye la geometría a partir de las coordenadas
...
# def load_properties_to_properties2():
#     """Carga los registros de la tabla properties en la tabla properties2."""

#     with get_session_empatia() as session:
#         # Obtener todos los registros de la tabla 'properties'
#         properties = session.query(Property).all()  # where(Property.latitude.isnot(None)).all()

#         # Crear una lista de los registros a insertar
#         rows: List[dict] = []

#         for prop in properties:
#             # Construir la geometría a partir de la latitud y longitud
#             if prop.latitude is None or prop.latitude == "None":
#                 continue
#             if prop.longitude is None or prop.longitude == "None":
#                 continue
#             geometry = create_geometry_from_coordinates(float(prop.latitude), float(prop.longitude))

#             # Preparar el diccionario con los datos que vamos a insertar
#             rows.append(
#                 {
#                     "id": prop.id,  # Generamos un nuevo id para cada propiedad
#                     "code": prop.code,
#                     "latitude": prop.latitude,
#                     "longitude": prop.longitude,
#                     "geometry": geometry.wkt,  # Convertimos el MULTIPOLYGON a WKT (Well-Known Text)
#                     "show_villacruz": prop.show_villacruz,
#                     "show_rent_villacruz": prop.show_rent_villacruz,
#                     "show_sale_villacruz": prop.show_sale_villacruz,
#                     "show_furnished_villacruz": prop.show_furnished_villacruz,
#                     "show_castillo": prop.show_castillo,
#                     "show_rent_castillo": prop.show_rent_castillo,
#                     "show_sale_castillo": prop.show_sale_castillo,
#                     "show_furnished_castillo": prop.show_furnished_castillo,
#                     "show_estrella": prop.show_estrella,
#                     "show_rent_estrella": prop.show_rent_estrella,
#                     "show_sale_estrella": prop.show_sale_estrella,
#                     "show_furnished_estrella": prop.show_furnished_estrella,
#                     "show_livin": prop.show_livin,
#                     "show_rent_livin": prop.show_rent_livin,
#                     "show_sale_livin": prop.show_sale_livin,
#                     "show_furnished_livin": prop.show_furnished_livin,
#                 }
#             )

#         if rows:
#             # Inserta los registros en la tabla 'properties2'
#             session.execute(Property2.__table__.insert(), rows)
#             session.commit()
