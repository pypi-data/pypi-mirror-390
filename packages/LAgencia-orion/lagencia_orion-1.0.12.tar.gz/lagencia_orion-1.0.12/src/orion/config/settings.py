...
# def _optional_env_file() -> Optional[str]:
#     """
#     Devuelve la ruta del .env que se debe utilizar
#     """
#     if os.getenv("PYTHON_ENV_ORION"):
#         env = os.environ["PYTHON_ENV_ORION"]
#         return BASE_DIR / f".env.{env}"

#     root_env = PROJECT_ROOT / ".env"
#     if root_env.exists():
#         load_dotenv(dotenv_path=root_env, override=True)

#         env = os.getenv("PYTHON_ENV_ORION")
#         if env:
#             logger.debug(f"Cargando .env desde {root_env}")
#             return BASE_DIR / f".env.{env}"

#     logger.debug("Cargando .env.dev por default")
