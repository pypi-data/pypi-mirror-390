...
from src.database.repository.querys_searcher import QuerysNewRevenues, QuerysSubscriptions, QuerysProperty, NewRevenues
...
templates= {"livin": {
            ...
            "livin_adviser": {
                        ...
                        "components": [
                            ...
                            "value": "_name_customer",
                            "index": "1"
                            },
                            {
                            "type": "text",
                            "parameter_name": "cel_cliente",
                            "value": "_mobile_customer",
                            "index": "2"
                            },
                            {
                            "type": "button",
...
def build_messages_livin_customer() -> List[Dict]:
    ...
    merged["show_livin"].fillna(False, inplace=True)
    merged["show_villacruz"].fillna(False, inplace=True)
    merged["show_estrella"].fillna(False, inplace=True)
    merged["show_castillo"].fillna(False, inplace=True)
