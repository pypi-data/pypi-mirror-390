...
from morphomath.decomposition import (
    TYPE_TOROID_POINT,
    TYPE_VEC,
    all_steps_decomposition,
    initialisation,
)
from morphomath.kernel import Kernel


def check_all_steps_decomposition(kernel: Kernel) -> None:
    """Verify in the decompositions are corrects."""
    lattice = initialisation(kernel)
    ref_kernels = {
        i: Kernel.from_points(
...
def recompose(
    ...
    for i, fusion in merge_table.items():
        ...
        for ker_idx, mod in fusion:
            points |= {
                tuple(r + s*(q+m) for q, r, m, s in zip(*tp, mod, shape, strict=True))
...
def test_decomposition_1d_1() -> None:
    """Test the decomposition."""
    check_all_steps_decomposition(Kernel([1]))


def test_decomposition_1d_11() -> None:
    """Test the decomposition."""
    check_all_steps_decomposition(Kernel([1, 1]))


def test_decomposition_1d_111() -> None:
    """Test the decomposition."""
    check_all_steps_decomposition(Kernel([1, 1, 1]))


def test_decomposition_1d_1111() -> None:
    """Test the decomposition."""
    check_all_steps_decomposition(Kernel([1, 1, 1, 1]))


def test_decomposition_2d_1() -> None:
    """Test the decomposition."""
    check_all_steps_decomposition(Kernel([[1]]))


def test_decomposition_2d_11_11() -> None:
    """Test the decomposition."""
    check_all_steps_decomposition(Kernel([[1, 1], [1, 1]]))


def test_decomposition_2d_010_010_111() -> None:
    """Test the decomposition."""
