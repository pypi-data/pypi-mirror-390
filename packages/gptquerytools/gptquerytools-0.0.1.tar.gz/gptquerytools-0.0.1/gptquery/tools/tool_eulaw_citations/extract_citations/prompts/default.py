# gptquery\tools\tool_eulaw_citations\extract_citations\prompts\default.py

"""
Exractor  prompt template for choosing directly mentioned citations from provided text (or quetsion).
...
32014R0050,annex I,footer footnote 67
