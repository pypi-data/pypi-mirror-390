...
def run_cli(args: argparse.Namespace) -> int:
    ...
    group = backend.courses_groups_resolve_and_create(course_query, groupset_query, args.name)

    output = lms.model.base.base_list_to_output_format([group], args.output_format,
