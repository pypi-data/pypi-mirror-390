...
def run_cli(args: argparse.Namespace) -> int:
    ...
    queries = backend.parse_groupset_queries(args.groupsets)

    groupsets = backend.courses_groupsets_get(course_query, queries)

    output = lms.model.base.base_list_to_output_format(groupsets, args.output_format,
...
def _get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('groupsets', metavar = 'GROUP_SET_QUERY',
        type = str, nargs = '*',
        help = 'A query for an groupset to get.')
