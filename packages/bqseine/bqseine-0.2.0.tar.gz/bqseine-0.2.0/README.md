...
- *temperature* (set by default to 0.4) is how creative the model is allowed to get with 1 being max
- *mode* (set by default to "AUTO") is the tool mode
- *model* (set by default to "gemini-2.5") is the AI model to be used
