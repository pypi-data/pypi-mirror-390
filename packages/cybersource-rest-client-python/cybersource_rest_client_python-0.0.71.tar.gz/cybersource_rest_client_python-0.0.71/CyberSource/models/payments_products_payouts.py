...
class PaymentsProductsPayouts(object):
    """
    ...
    def __init__(self, subscription_information=None, configuration_information=None):
        """
        PaymentsProductsPayouts - a model defined in Swagger
        """
    ...
    def configuration_information(self):
        """
        Gets the configuration_information of this PaymentsProductsPayouts.

        :return: The configuration_information of this PaymentsProductsPayouts.
        :rtype: PaymentsProductsPayoutsConfigurationInformation
        """
    ...
    def configuration_information(self, configuration_information):
        """
        Sets the configuration_information of this PaymentsProductsPayouts.

        :param configuration_information: The configuration_information of this PaymentsProductsPayouts.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PaymentsProductsPayouts):
            return False
