...
class Invoicingv2invoiceSettingsInvoiceSettingsInformation(object):
    ...
    def custom_labels(self):
        """
        Gets the custom_labels of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        ...
        :return: The custom_labels of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
    ...
    def custom_labels(self, custom_labels):
        """
        Sets the custom_labels of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
        A list of custom labels that allows you to override (rename) default field names and control the visibility of specific fields on invoices and items. If the list is empty, the labels will not be overwritten. 

        :param custom_labels: The custom_labels of this Invoicingv2invoiceSettingsInvoiceSettingsInformation.
