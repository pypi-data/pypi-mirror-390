...
class InlineResponse2012PayoutInformationPullFunds(object):
    """
    ...
    def __init__(self, domestic_participant=None, cross_border_participant=None):
        """
        InlineResponse2012PayoutInformationPullFunds - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse2012PayoutInformationPullFunds):
            return False
