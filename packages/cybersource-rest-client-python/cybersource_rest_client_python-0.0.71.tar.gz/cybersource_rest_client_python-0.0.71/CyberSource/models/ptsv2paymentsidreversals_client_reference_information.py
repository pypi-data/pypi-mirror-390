...
class Ptsv2paymentsidreversalsClientReferenceInformation(object):
    ...
    def __init__(self, code=None, paused_request_id=None, comments=None, partner=None, application_name=None, application_version=None, application_user=None, reconciliation_id=None, transaction_id=None):
        """
    ...
    def reconciliation_id(self):
        """
        Gets the reconciliation_id of this Ptsv2paymentsidreversalsClientReferenceInformation.
        Reference number for the transaction. Depending on how your Cybersource account is configured, this value could either be provided in the API request or generated by CyberSource. The actual value used in the request to the processor is provided back to you by Cybersource in the response. 

        :return: The reconciliation_id of this Ptsv2paymentsidreversalsClientReferenceInformation.
        :rtype: str
        """
    ...
    def reconciliation_id(self, reconciliation_id):
        """
        Sets the reconciliation_id of this Ptsv2paymentsidreversalsClientReferenceInformation.
        Reference number for the transaction. Depending on how your Cybersource account is configured, this value could either be provided in the API request or generated by CyberSource. The actual value used in the request to the processor is provided back to you by Cybersource in the response. 

        :param reconciliation_id: The reconciliation_id of this Ptsv2paymentsidreversalsClientReferenceInformation.
        :type: str
        """
    ...
    def transaction_id(self):
        """
        Gets the transaction_id of this Ptsv2paymentsidreversalsClientReferenceInformation.
        ...
        :return: The transaction_id of this Ptsv2paymentsidreversalsClientReferenceInformation.
        :rtype: str
        """
    ...
    def transaction_id(self, transaction_id):
        """
        Sets the transaction_id of this Ptsv2paymentsidreversalsClientReferenceInformation.
        Identifier that you assign to the transaction. Normally generated by a client server to identify a unique API request.  **Note** Use this field only if you want to support merchant-initiated reversal and void operations.  #### Used by **Authorization, Authorization Reversal, Capture, Credit, and Void** Optional field.  #### PIN Debit For a PIN debit reversal, your request must include a request ID or a merchant transaction identifier. Optional field for PIN debit purchase or credit requests. 
