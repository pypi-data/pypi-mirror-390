...
class TmsPaymentInstrumentProcessingInfo(object):
    """
    ...
    def __init__(self, bill_payment_program_enabled=None, bank_transfer_options=None):
        """
        TmsPaymentInstrumentProcessingInfo - a model defined in Swagger
        """
    ...
    def bank_transfer_options(self):
        """
        Gets the bank_transfer_options of this TmsPaymentInstrumentProcessingInfo.

        :return: The bank_transfer_options of this TmsPaymentInstrumentProcessingInfo.
        :rtype: TmsPaymentInstrumentProcessingInfoBankTransferOptions
        """
    ...
    def bank_transfer_options(self, bank_transfer_options):
        """
        Sets the bank_transfer_options of this TmsPaymentInstrumentProcessingInfo.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, TmsPaymentInstrumentProcessingInfo):
            return False
