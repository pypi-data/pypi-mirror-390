...
class CreateSubscriptionResponse(object):
    ...
    def links(self):
        """
        Gets the links of this CreateSubscriptionResponse.

        :return: The links of this CreateSubscriptionResponse.
        :rtype: CreateSubscriptionResponseLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this CreateSubscriptionResponse.

        :param links: The links of this CreateSubscriptionResponse.
    ...
    def submit_time_utc(self):
        """
        Gets the submit_time_utc of this CreateSubscriptionResponse.
        Time of request in UTC. Format: `YYYY-MM-DDThh:mm:ssZ` **Example** `2016-08-11T22:47:57Z` equals August 11, 2016, at 22:47:57 (10:47:57 p.m.). The `T` separates the date and the time. The `Z` indicates UTC.  Returned by Cybersource for all services. 

        :return: The submit_time_utc of this CreateSubscriptionResponse.
        :rtype: str
        """
    ...
    def submit_time_utc(self, submit_time_utc):
        """
        Sets the submit_time_utc of this CreateSubscriptionResponse.
        Time of request in UTC. Format: `YYYY-MM-DDThh:mm:ssZ` **Example** `2016-08-11T22:47:57Z` equals August 11, 2016, at 22:47:57 (10:47:57 p.m.). The `T` separates the date and the time. The `Z` indicates UTC.  Returned by Cybersource for all services. 

        :param submit_time_utc: The submit_time_utc of this CreateSubscriptionResponse.
        :type: str
        """
    ...
    def subscription_information(self):
        """
        Gets the subscription_information of this CreateSubscriptionResponse.

        :return: The subscription_information of this CreateSubscriptionResponse.
    ...
    def subscription_information(self, subscription_information):
        """
        Sets the subscription_information of this CreateSubscriptionResponse.
