...
class RiskProductsPortfolioRiskControls(object):
    """
    ...
    def __init__(self, subscription_information=None, configuration_information=None):
        """
        RiskProductsPortfolioRiskControls - a model defined in Swagger
        """
    ...
    def configuration_information(self):
        """
        Gets the configuration_information of this RiskProductsPortfolioRiskControls.

        :return: The configuration_information of this RiskProductsPortfolioRiskControls.
        :rtype: RiskProductsPortfolioRiskControlsConfigurationInformation
        """
    ...
    def configuration_information(self, configuration_information):
        """
        Sets the configuration_information of this RiskProductsPortfolioRiskControls.

        :param configuration_information: The configuration_information of this RiskProductsPortfolioRiskControls.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RiskProductsPortfolioRiskControls):
            return False
