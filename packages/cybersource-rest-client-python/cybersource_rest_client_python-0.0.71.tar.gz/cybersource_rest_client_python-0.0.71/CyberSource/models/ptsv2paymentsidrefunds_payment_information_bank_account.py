...
class Ptsv2paymentsidrefundsPaymentInformationBankAccount(object):
    """
    ...
    def __init__(self, type=None, number=None, encoder_id=None, check_number=None, check_image_reference_number=None):
        """
        Ptsv2paymentsidrefundsPaymentInformationBankAccount - a model defined in Swagger
        """
    ...
    def type(self):
        """
        Gets the type of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        ...
        :return: The type of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        Account type.  Possible values:  - **C**: Checking.  - **G**: General ledger. This value is supported only on Wells Fargo ACH.  - **S**: Savings (U.S. dollars only).  - **X**: Corporate checking (U.S. dollars only). 

        :param type: The type of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        :type: str
        """
    ...
    def number(self):
        """
        Gets the number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        Account number.  When processing encoded account numbers, use this field for the encoded account number. 

        :return: The number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """
        Sets the number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        Account number.  When processing encoded account numbers, use this field for the encoded account number. 
    ...
    def encoder_id(self):
        """
        Gets the encoder_id of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        ...
        :return: The encoder_id of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        :rtype: str
        """
    ...
    def encoder_id(self, encoder_id):
        """
        Sets the encoder_id of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        Identifier for the bank that provided the customer's encoded account number.  To obtain the bank identifier, contact your processor. 

        :param encoder_id: The encoder_id of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        :type: str
        """
    ...
    def check_number(self):
        """
        Gets the check_number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        ...
        :return: The check_number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        :rtype: str
        """
    ...
    def check_number(self, check_number):
        """
        Sets the check_number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        Check number.  Chase Paymentech Solutions - Optional. CyberSource ACH Service - Not used. RBS WorldPay Atlanta - Optional on debits. Required on credits. TeleCheck - Strongly recommended on debit requests. Optional on credits. 

        :param check_number: The check_number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        :type: str
        """
    ...
    def check_image_reference_number(self):
        """
        Gets the check_image_reference_number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        Image reference number associated with the check. You cannot include any special characters. 

        :return: The check_image_reference_number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        :rtype: str
        """
    ...
    def check_image_reference_number(self, check_image_reference_number):
        """
        Sets the check_image_reference_number of this Ptsv2paymentsidrefundsPaymentInformationBankAccount.
        Image reference number associated with the check. You cannot include any special characters. 
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ptsv2paymentsidrefundsPaymentInformationBankAccount):
            return False
