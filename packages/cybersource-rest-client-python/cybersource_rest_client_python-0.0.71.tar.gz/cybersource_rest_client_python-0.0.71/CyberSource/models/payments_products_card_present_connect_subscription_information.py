...
class PaymentsProductsCardPresentConnectSubscriptionInformation(object):
    """
    ...
    def __init__(self, enabled=None, self_serviceability='NOT_SELF_SERVICEABLE'):
        """
        PaymentsProductsCardPresentConnectSubscriptionInformation - a model defined in Swagger
        """
    ...
    def enabled(self):
        """
        Gets the enabled of this PaymentsProductsCardPresentConnectSubscriptionInformation.

        :return: The enabled of this PaymentsProductsCardPresentConnectSubscriptionInformation.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """
        Sets the enabled of this PaymentsProductsCardPresentConnectSubscriptionInformation.

        :param enabled: The enabled of this PaymentsProductsCardPresentConnectSubscriptionInformation.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PaymentsProductsCardPresentConnectSubscriptionInformation):
            return False
