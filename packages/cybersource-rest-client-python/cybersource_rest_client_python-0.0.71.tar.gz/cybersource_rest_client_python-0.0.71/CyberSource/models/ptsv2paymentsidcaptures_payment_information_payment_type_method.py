...
class Ptsv2paymentsidcapturesPaymentInformationPaymentTypeMethod(object):
    """
    ...
    def __init__(self, name=None):
        """
        Ptsv2paymentsidcapturesPaymentInformationPaymentTypeMethod - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ptsv2paymentsidcapturesPaymentInformationPaymentTypeMethod):
            return False
