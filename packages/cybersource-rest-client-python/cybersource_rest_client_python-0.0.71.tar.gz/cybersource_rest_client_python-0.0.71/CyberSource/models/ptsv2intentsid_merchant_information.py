...
class Ptsv2intentsidMerchantInformation(object):
    """
    ...
    def __init__(self, merchant_descriptor=None):
        """
        Ptsv2intentsidMerchantInformation - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ptsv2intentsidMerchantInformation):
            return False
