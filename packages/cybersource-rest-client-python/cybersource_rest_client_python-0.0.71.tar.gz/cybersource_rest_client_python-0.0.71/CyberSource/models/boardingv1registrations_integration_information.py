...
class Boardingv1registrationsIntegrationInformation(object):
    """
    ...
    def oauth2(self):
        """
        Gets the oauth2 of this Boardingv1registrationsIntegrationInformation.

        :return: The oauth2 of this Boardingv1registrationsIntegrationInformation.
    ...
    def oauth2(self, oauth2):
        """
        Sets the oauth2 of this Boardingv1registrationsIntegrationInformation.

        :param oauth2: The oauth2 of this Boardingv1registrationsIntegrationInformation.
    ...
    def tenant_configurations(self):
        """
        Gets the tenant_configurations of this Boardingv1registrationsIntegrationInformation.
        tenantConfigurations is an array of objects that includes the tenant information this merchant is associated with.

        :return: The tenant_configurations of this Boardingv1registrationsIntegrationInformation.
        :rtype: list[Boardingv1registrationsIntegrationInformationTenantConfigurations]
        """
    ...
    def tenant_configurations(self, tenant_configurations):
        """
        Sets the tenant_configurations of this Boardingv1registrationsIntegrationInformation.
        tenantConfigurations is an array of objects that includes the tenant information this merchant is associated with.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Boardingv1registrationsIntegrationInformation):
            return False
