...
class UnifiedCheckoutCaptureContextApi(object):
    ...
    def generate_unified_checkout_capture_context_with_http_info(self, generate_unified_checkout_capture_context_request, **kwargs):
        ...
        if MLEUtility.check_is_mle_for_api(self.api_client.mconfig, inbound_mle_status, "generate_unified_checkout_capture_context,generate_unified_checkout_capture_context_with_http_info"):
