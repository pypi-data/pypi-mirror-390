...
class SecureFileShareApi(object):
    ...
    def get_file_with_http_info(self, file_id, **kwargs):
        ...
        if MLEUtility.check_is_mle_for_api(self.api_client.mconfig, inbound_mle_status, "get_file,get_file_with_http_info"):
    ...
    def get_file_detail_with_http_info(self, start_date, end_date, **kwargs):
        ...
        inbound_mle_status = "false"
        if MLEUtility.check_is_mle_for_api(self.api_client.mconfig, inbound_mle_status, "get_file_detail,get_file_detail_with_http_info"):
                body_params = MLEUtility.encrypt_request_payload(self.api_client.mconfig, body_params)
