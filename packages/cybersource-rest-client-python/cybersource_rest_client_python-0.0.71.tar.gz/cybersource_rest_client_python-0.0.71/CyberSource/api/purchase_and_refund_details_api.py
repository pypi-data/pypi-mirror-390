...
class PurchaseAndRefundDetailsApi(object):
    ...
    def get_purchase_and_refund_details_with_http_info(self, start_time, end_time, **kwargs):
        ...
        if MLEUtility.check_is_mle_for_api(self.api_client.mconfig, inbound_mle_status, "get_purchase_and_refund_details,get_purchase_and_refund_details_with_http_info"):
