...
class SearchTransactionsApi(object):
    ...
    def create_search_with_http_info(self, create_search_request, **kwargs):
        ...
        if MLEUtility.check_is_mle_for_api(self.api_client.mconfig, inbound_mle_status, "create_search,create_search_with_http_info"):
    ...
    def get_search_with_http_info(self, search_id, **kwargs):
        ...
        inbound_mle_status = "false"
        if MLEUtility.check_is_mle_for_api(self.api_client.mconfig, inbound_mle_status, "get_search,get_search_with_http_info"):
                body_params = MLEUtility.encrypt_request_payload(self.api_client.mconfig, body_params)
