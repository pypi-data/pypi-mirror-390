...
class NotificationOfChangesApi(object):
    ...
    def get_notification_of_change_report_with_http_info(self, start_time, end_time, **kwargs):
        ...
        if MLEUtility.check_is_mle_for_api(self.api_client.mconfig, inbound_mle_status, "get_notification_of_change_report,get_notification_of_change_report_with_http_info"):
