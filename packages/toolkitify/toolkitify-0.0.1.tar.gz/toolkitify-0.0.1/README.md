...
| ------------------------------------- | -------------------------------------------------------------------------- | -------------- |
| Cache (`cache`)                       | Advanced caching system for functions                                      | 🔴 Not started |
| Client Only (`client-only`)           | Client-side only code directive                                            | 🔴 Not started |
| Rate Limit (`rate-limit`)             | Advanced Rate Limit System                                                 | 🔴 Not started |
| Server Only (`server-only`)           | Server-side only code directive                                            | 🔴 Not started |