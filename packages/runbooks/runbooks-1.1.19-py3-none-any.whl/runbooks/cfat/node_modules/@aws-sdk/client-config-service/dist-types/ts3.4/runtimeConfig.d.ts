...
export declare const getRuntimeConfig: (config: ConfigServiceClientConfig) => {
  runtime: string;
  ...
  httpAuthSchemeProvider: import("./auth/httpAuthSchemeProvider").ConfigServiceHttpAuthSchemeProvider;
  credentials?:
