...
export interface SSOAdmin {
     ...
     */
    createApplicationAssignment(args: CreateApplicationAssignmentCommandInput, options?: __HttpHandlerOptions): Promise<CreateApplicationAssignmentCommandOutput>;
    createApplicationAssignment(args: CreateApplicationAssignmentCommandInput, cb: (err: any, data?: CreateApplicationAssignmentCommandOutput) => void): void;
    createApplicationAssignment(args: CreateApplicationAssignmentCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateApplicationAssignmentCommandOutput) => void): void;
    /**
     ...
     */
    createTrustedTokenIssuer(args: CreateTrustedTokenIssuerCommandInput, options?: __HttpHandlerOptions): Promise<CreateTrustedTokenIssuerCommandOutput>;
    createTrustedTokenIssuer(args: CreateTrustedTokenIssuerCommandInput, cb: (err: any, data?: CreateTrustedTokenIssuerCommandOutput) => void): void;
    createTrustedTokenIssuer(args: CreateTrustedTokenIssuerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateTrustedTokenIssuerCommandOutput) => void): void;
    /**
     ...
     */
    deleteApplicationAccessScope(args: DeleteApplicationAccessScopeCommandInput, options?: __HttpHandlerOptions): Promise<DeleteApplicationAccessScopeCommandOutput>;
    deleteApplicationAccessScope(args: DeleteApplicationAccessScopeCommandInput, cb: (err: any, data?: DeleteApplicationAccessScopeCommandOutput) => void): void;
    deleteApplicationAccessScope(args: DeleteApplicationAccessScopeCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteApplicationAccessScopeCommandOutput) => void): void;
    /**
     * @see {@link DeleteApplicationAssignmentCommand}
     */
    deleteApplicationAssignment(args: DeleteApplicationAssignmentCommandInput, options?: __HttpHandlerOptions): Promise<DeleteApplicationAssignmentCommandOutput>;
    deleteApplicationAssignment(args: DeleteApplicationAssignmentCommandInput, cb: (err: any, data?: DeleteApplicationAssignmentCommandOutput) => void): void;
    deleteApplicationAssignment(args: DeleteApplicationAssignmentCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteApplicationAssignmentCommandOutput) => void): void;
    /**
     * @see {@link DeleteApplicationAuthenticationMethodCommand}
     */
    deleteApplicationAuthenticationMethod(args: DeleteApplicationAuthenticationMethodCommandInput, options?: __HttpHandlerOptions): Promise<DeleteApplicationAuthenticationMethodCommandOutput>;
    deleteApplicationAuthenticationMethod(args: DeleteApplicationAuthenticationMethodCommandInput, cb: (err: any, data?: DeleteApplicationAuthenticationMethodCommandOutput) => void): void;
    deleteApplicationAuthenticationMethod(args: DeleteApplicationAuthenticationMethodCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteApplicationAuthenticationMethodCommandOutput) => void): void;
    /**
     * @see {@link DeleteApplicationGrantCommand}
     */
    deleteApplicationGrant(args: DeleteApplicationGrantCommandInput, options?: __HttpHandlerOptions): Promise<DeleteApplicationGrantCommandOutput>;
    deleteApplicationGrant(args: DeleteApplicationGrantCommandInput, cb: (err: any, data?: DeleteApplicationGrantCommandOutput) => void): void;
    deleteApplicationGrant(args: DeleteApplicationGrantCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteApplicationGrantCommandOutput) => void): void;
    /**
     ...
     */
    deleteTrustedTokenIssuer(args: DeleteTrustedTokenIssuerCommandInput, options?: __HttpHandlerOptions): Promise<DeleteTrustedTokenIssuerCommandOutput>;
    deleteTrustedTokenIssuer(args: DeleteTrustedTokenIssuerCommandInput, cb: (err: any, data?: DeleteTrustedTokenIssuerCommandOutput) => void): void;
    deleteTrustedTokenIssuer(args: DeleteTrustedTokenIssuerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteTrustedTokenIssuerCommandOutput) => void): void;
    /**
     ...
     */
    describeApplicationAssignment(args: DescribeApplicationAssignmentCommandInput, options?: __HttpHandlerOptions): Promise<DescribeApplicationAssignmentCommandOutput>;
    describeApplicationAssignment(args: DescribeApplicationAssignmentCommandInput, cb: (err: any, data?: DescribeApplicationAssignmentCommandOutput) => void): void;
    describeApplicationAssignment(args: DescribeApplicationAssignmentCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeApplicationAssignmentCommandOutput) => void): void;
    /**
     * @see {@link DescribeApplicationProviderCommand}
     */
    describeApplicationProvider(args: DescribeApplicationProviderCommandInput, options?: __HttpHandlerOptions): Promise<DescribeApplicationProviderCommandOutput>;
    describeApplicationProvider(args: DescribeApplicationProviderCommandInput, cb: (err: any, data?: DescribeApplicationProviderCommandOutput) => void): void;
    describeApplicationProvider(args: DescribeApplicationProviderCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeApplicationProviderCommandOutput) => void): void;
    /**
     ...
     */
    describeTrustedTokenIssuer(args: DescribeTrustedTokenIssuerCommandInput, options?: __HttpHandlerOptions): Promise<DescribeTrustedTokenIssuerCommandOutput>;
    describeTrustedTokenIssuer(args: DescribeTrustedTokenIssuerCommandInput, cb: (err: any, data?: DescribeTrustedTokenIssuerCommandOutput) => void): void;
    describeTrustedTokenIssuer(args: DescribeTrustedTokenIssuerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeTrustedTokenIssuerCommandOutput) => void): void;
    /**
     ...
     */
    getApplicationAccessScope(args: GetApplicationAccessScopeCommandInput, options?: __HttpHandlerOptions): Promise<GetApplicationAccessScopeCommandOutput>;
    getApplicationAccessScope(args: GetApplicationAccessScopeCommandInput, cb: (err: any, data?: GetApplicationAccessScopeCommandOutput) => void): void;
    getApplicationAccessScope(args: GetApplicationAccessScopeCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetApplicationAccessScopeCommandOutput) => void): void;
    /**
     * @see {@link GetApplicationAssignmentConfigurationCommand}
     */
    getApplicationAssignmentConfiguration(args: GetApplicationAssignmentConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<GetApplicationAssignmentConfigurationCommandOutput>;
    getApplicationAssignmentConfiguration(args: GetApplicationAssignmentConfigurationCommandInput, cb: (err: any, data?: GetApplicationAssignmentConfigurationCommandOutput) => void): void;
    getApplicationAssignmentConfiguration(args: GetApplicationAssignmentConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetApplicationAssignmentConfigurationCommandOutput) => void): void;
    /**
     * @see {@link GetApplicationAuthenticationMethodCommand}
     */
    getApplicationAuthenticationMethod(args: GetApplicationAuthenticationMethodCommandInput, options?: __HttpHandlerOptions): Promise<GetApplicationAuthenticationMethodCommandOutput>;
    getApplicationAuthenticationMethod(args: GetApplicationAuthenticationMethodCommandInput, cb: (err: any, data?: GetApplicationAuthenticationMethodCommandOutput) => void): void;
    getApplicationAuthenticationMethod(args: GetApplicationAuthenticationMethodCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetApplicationAuthenticationMethodCommandOutput) => void): void;
    /**
     * @see {@link GetApplicationGrantCommand}
     */
    getApplicationGrant(args: GetApplicationGrantCommandInput, options?: __HttpHandlerOptions): Promise<GetApplicationGrantCommandOutput>;
    getApplicationGrant(args: GetApplicationGrantCommandInput, cb: (err: any, data?: GetApplicationGrantCommandOutput) => void): void;
    getApplicationGrant(args: GetApplicationGrantCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetApplicationGrantCommandOutput) => void): void;
    /**
     * @see {@link GetApplicationSessionConfigurationCommand}
     */
    getApplicationSessionConfiguration(args: GetApplicationSessionConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<GetApplicationSessionConfigurationCommandOutput>;
    getApplicationSessionConfiguration(args: GetApplicationSessionConfigurationCommandInput, cb: (err: any, data?: GetApplicationSessionConfigurationCommandOutput) => void): void;
    getApplicationSessionConfiguration(args: GetApplicationSessionConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetApplicationSessionConfigurationCommandOutput) => void): void;
    /**
     ...
     */
    listAccountAssignmentsForPrincipal(args: ListAccountAssignmentsForPrincipalCommandInput, options?: __HttpHandlerOptions): Promise<ListAccountAssignmentsForPrincipalCommandOutput>;
    listAccountAssignmentsForPrincipal(args: ListAccountAssignmentsForPrincipalCommandInput, cb: (err: any, data?: ListAccountAssignmentsForPrincipalCommandOutput) => void): void;
    listAccountAssignmentsForPrincipal(args: ListAccountAssignmentsForPrincipalCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListAccountAssignmentsForPrincipalCommandOutput) => void): void;
    /**
     ...
     */
    listApplicationAccessScopes(args: ListApplicationAccessScopesCommandInput, options?: __HttpHandlerOptions): Promise<ListApplicationAccessScopesCommandOutput>;
    listApplicationAccessScopes(args: ListApplicationAccessScopesCommandInput, cb: (err: any, data?: ListApplicationAccessScopesCommandOutput) => void): void;
    listApplicationAccessScopes(args: ListApplicationAccessScopesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListApplicationAccessScopesCommandOutput) => void): void;
    /**
     * @see {@link ListApplicationAssignmentsCommand}
     */
    listApplicationAssignments(args: ListApplicationAssignmentsCommandInput, options?: __HttpHandlerOptions): Promise<ListApplicationAssignmentsCommandOutput>;
    listApplicationAssignments(args: ListApplicationAssignmentsCommandInput, cb: (err: any, data?: ListApplicationAssignmentsCommandOutput) => void): void;
    listApplicationAssignments(args: ListApplicationAssignmentsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListApplicationAssignmentsCommandOutput) => void): void;
    /**
     * @see {@link ListApplicationAssignmentsForPrincipalCommand}
     */
    listApplicationAssignmentsForPrincipal(args: ListApplicationAssignmentsForPrincipalCommandInput, options?: __HttpHandlerOptions): Promise<ListApplicationAssignmentsForPrincipalCommandOutput>;
    listApplicationAssignmentsForPrincipal(args: ListApplicationAssignmentsForPrincipalCommandInput, cb: (err: any, data?: ListApplicationAssignmentsForPrincipalCommandOutput) => void): void;
    listApplicationAssignmentsForPrincipal(args: ListApplicationAssignmentsForPrincipalCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListApplicationAssignmentsForPrincipalCommandOutput) => void): void;
    /**
     * @see {@link ListApplicationAuthenticationMethodsCommand}
     */
    listApplicationAuthenticationMethods(args: ListApplicationAuthenticationMethodsCommandInput, options?: __HttpHandlerOptions): Promise<ListApplicationAuthenticationMethodsCommandOutput>;
    listApplicationAuthenticationMethods(args: ListApplicationAuthenticationMethodsCommandInput, cb: (err: any, data?: ListApplicationAuthenticationMethodsCommandOutput) => void): void;
    listApplicationAuthenticationMethods(args: ListApplicationAuthenticationMethodsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListApplicationAuthenticationMethodsCommandOutput) => void): void;
    /**
     * @see {@link ListApplicationGrantsCommand}
     */
    listApplicationGrants(args: ListApplicationGrantsCommandInput, options?: __HttpHandlerOptions): Promise<ListApplicationGrantsCommandOutput>;
    listApplicationGrants(args: ListApplicationGrantsCommandInput, cb: (err: any, data?: ListApplicationGrantsCommandOutput) => void): void;
    listApplicationGrants(args: ListApplicationGrantsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListApplicationGrantsCommandOutput) => void): void;
    /**
     ...
     */
    listTrustedTokenIssuers(args: ListTrustedTokenIssuersCommandInput, options?: __HttpHandlerOptions): Promise<ListTrustedTokenIssuersCommandOutput>;
    listTrustedTokenIssuers(args: ListTrustedTokenIssuersCommandInput, cb: (err: any, data?: ListTrustedTokenIssuersCommandOutput) => void): void;
    listTrustedTokenIssuers(args: ListTrustedTokenIssuersCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListTrustedTokenIssuersCommandOutput) => void): void;
    /**
     ...
     */
    putApplicationAccessScope(args: PutApplicationAccessScopeCommandInput, options?: __HttpHandlerOptions): Promise<PutApplicationAccessScopeCommandOutput>;
    putApplicationAccessScope(args: PutApplicationAccessScopeCommandInput, cb: (err: any, data?: PutApplicationAccessScopeCommandOutput) => void): void;
    putApplicationAccessScope(args: PutApplicationAccessScopeCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutApplicationAccessScopeCommandOutput) => void): void;
    /**
     * @see {@link PutApplicationAssignmentConfigurationCommand}
     */
    putApplicationAssignmentConfiguration(args: PutApplicationAssignmentConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<PutApplicationAssignmentConfigurationCommandOutput>;
    putApplicationAssignmentConfiguration(args: PutApplicationAssignmentConfigurationCommandInput, cb: (err: any, data?: PutApplicationAssignmentConfigurationCommandOutput) => void): void;
    putApplicationAssignmentConfiguration(args: PutApplicationAssignmentConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutApplicationAssignmentConfigurationCommandOutput) => void): void;
    /**
     * @see {@link PutApplicationAuthenticationMethodCommand}
     */
    putApplicationAuthenticationMethod(args: PutApplicationAuthenticationMethodCommandInput, options?: __HttpHandlerOptions): Promise<PutApplicationAuthenticationMethodCommandOutput>;
    putApplicationAuthenticationMethod(args: PutApplicationAuthenticationMethodCommandInput, cb: (err: any, data?: PutApplicationAuthenticationMethodCommandOutput) => void): void;
    putApplicationAuthenticationMethod(args: PutApplicationAuthenticationMethodCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutApplicationAuthenticationMethodCommandOutput) => void): void;
    /**
     * @see {@link PutApplicationGrantCommand}
     */
    putApplicationGrant(args: PutApplicationGrantCommandInput, options?: __HttpHandlerOptions): Promise<PutApplicationGrantCommandOutput>;
    putApplicationGrant(args: PutApplicationGrantCommandInput, cb: (err: any, data?: PutApplicationGrantCommandOutput) => void): void;
    putApplicationGrant(args: PutApplicationGrantCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutApplicationGrantCommandOutput) => void): void;
    /**
     * @see {@link PutApplicationSessionConfigurationCommand}
     */
    putApplicationSessionConfiguration(args: PutApplicationSessionConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<PutApplicationSessionConfigurationCommandOutput>;
    putApplicationSessionConfiguration(args: PutApplicationSessionConfigurationCommandInput, cb: (err: any, data?: PutApplicationSessionConfigurationCommandOutput) => void): void;
    putApplicationSessionConfiguration(args: PutApplicationSessionConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutApplicationSessionConfigurationCommandOutput) => void): void;
    /**
     ...
     */
    updateTrustedTokenIssuer(args: UpdateTrustedTokenIssuerCommandInput, options?: __HttpHandlerOptions): Promise<UpdateTrustedTokenIssuerCommandOutput>;
    updateTrustedTokenIssuer(args: UpdateTrustedTokenIssuerCommandInput, cb: (err: any, data?: UpdateTrustedTokenIssuerCommandOutput) => void): void;
