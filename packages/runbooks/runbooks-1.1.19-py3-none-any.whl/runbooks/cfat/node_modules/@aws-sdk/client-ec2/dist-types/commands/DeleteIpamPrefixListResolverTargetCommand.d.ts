...
import { DeleteIpamPrefixListResolverTargetRequest, DeleteIpamPrefixListResolverTargetResult } from "../models/models_3";
/**
 * @public
 */
...
declare const DeleteIpamPrefixListResolverTargetCommand_base: {
    new (input: DeleteIpamPrefixListResolverTargetCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamPrefixListResolverTargetCommandInput, DeleteIpamPrefixListResolverTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteIpamPrefixListResolverTargetCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamPrefixListResolverTargetCommandInput, DeleteIpamPrefixListResolverTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
