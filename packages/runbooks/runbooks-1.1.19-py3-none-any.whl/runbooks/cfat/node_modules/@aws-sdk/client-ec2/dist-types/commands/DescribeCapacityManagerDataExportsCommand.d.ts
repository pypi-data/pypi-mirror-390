...
import { DescribeCapacityManagerDataExportsRequest, DescribeCapacityManagerDataExportsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeCapacityManagerDataExportsCommand_base: {
    new (input: DescribeCapacityManagerDataExportsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeCapacityManagerDataExportsCommandInput, DescribeCapacityManagerDataExportsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityManagerDataExportsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeCapacityManagerDataExportsCommandInput, DescribeCapacityManagerDataExportsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
