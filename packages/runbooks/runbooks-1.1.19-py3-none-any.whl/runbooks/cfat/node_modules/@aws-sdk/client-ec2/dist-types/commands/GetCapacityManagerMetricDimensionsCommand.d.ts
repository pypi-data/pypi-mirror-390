...
import { GetCapacityManagerMetricDimensionsRequest, GetCapacityManagerMetricDimensionsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetCapacityManagerMetricDimensionsCommand_base: {
    new (input: GetCapacityManagerMetricDimensionsCommandInput): import("@smithy/smithy-client").CommandImpl<GetCapacityManagerMetricDimensionsCommandInput, GetCapacityManagerMetricDimensionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetCapacityManagerMetricDimensionsCommandInput): import("@smithy/smithy-client").CommandImpl<GetCapacityManagerMetricDimensionsCommandInput, GetCapacityManagerMetricDimensionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
