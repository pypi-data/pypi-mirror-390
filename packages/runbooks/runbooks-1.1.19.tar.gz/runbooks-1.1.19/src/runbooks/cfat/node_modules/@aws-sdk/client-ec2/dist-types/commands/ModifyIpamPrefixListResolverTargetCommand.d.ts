...
import { ModifyIpamPrefixListResolverTargetRequest, ModifyIpamPrefixListResolverTargetResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyIpamPrefixListResolverTargetCommand_base: {
    new (input: ModifyIpamPrefixListResolverTargetCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIpamPrefixListResolverTargetCommandInput, ModifyIpamPrefixListResolverTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyIpamPrefixListResolverTargetCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIpamPrefixListResolverTargetCommandInput, ModifyIpamPrefixListResolverTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
