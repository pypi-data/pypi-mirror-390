...
import { CreateIpamPrefixListResolverTargetRequest, CreateIpamPrefixListResolverTargetResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIpamPrefixListResolverTargetCommand_base: {
    new (input: CreateIpamPrefixListResolverTargetCommandInput): import("@smithy/smithy-client").CommandImpl<CreateIpamPrefixListResolverTargetCommandInput, CreateIpamPrefixListResolverTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateIpamPrefixListResolverTargetCommandInput): import("@smithy/smithy-client").CommandImpl<CreateIpamPrefixListResolverTargetCommandInput, CreateIpamPrefixListResolverTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
