...
declare const DisableCapacityManagerCommand_base: {
    new (input: DisableCapacityManagerCommandInput): import("@smithy/smithy-client").CommandImpl<DisableCapacityManagerCommandInput, DisableCapacityManagerCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DisableCapacityManagerCommandInput]): import("@smithy/smithy-client").CommandImpl<DisableCapacityManagerCommandInput, DisableCapacityManagerCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
