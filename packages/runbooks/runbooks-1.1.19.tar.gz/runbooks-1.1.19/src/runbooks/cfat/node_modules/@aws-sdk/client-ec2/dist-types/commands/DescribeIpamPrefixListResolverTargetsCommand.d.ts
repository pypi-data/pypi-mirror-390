...
import { DescribeIpamPrefixListResolverTargetsRequest, DescribeIpamPrefixListResolverTargetsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const DescribeIpamPrefixListResolverTargetsCommand_base: {
    new (input: DescribeIpamPrefixListResolverTargetsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeIpamPrefixListResolverTargetsCommandInput, DescribeIpamPrefixListResolverTargetsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamPrefixListResolverTargetsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeIpamPrefixListResolverTargetsCommandInput, DescribeIpamPrefixListResolverTargetsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
