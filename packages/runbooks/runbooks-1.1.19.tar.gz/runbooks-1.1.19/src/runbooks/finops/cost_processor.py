...
def categorize_aws_services(enriched_services: List[Dict[str, Any]]) -> Dict[str, List[Dict[str, Any]]]:
    ...
    compute_keywords = ["EC2", "Lambda", "Fargate", "Batch", "Elastic Container", "ECS", "EKS", "Compute"]
    network_keywords = ["VPC", "Virtual Private Cloud", "CloudFront", "Route 53", "Direct Connect", "Global Accelerator", "API Gateway", "Elastic Load Balancing"]
    storage_keywords = ["S3", "EBS", "Glacier", "EFS", "FSx", "Storage Gateway", "Backup", "Snapshot"]
    database_keywords = ["RDS", "DynamoDB", "Aurora", "ElastiCache", "Redshift", "DocumentDB", "Neptune", "Database Migration"]
