    ...
    try:
        ...
        for tg in target_groups:
            ...
            try:
                ...
                logger.warning(f"Failed to check target group {tg_arn}: {e}")
                continue
    ...
    try:
        ...
        for cluster_arn in cluster_arns:
            try:
                ...
                logger.warning(f"Failed to check ECS cluster {cluster_arn}: {e}")
                continue
