...
def create_compliance_dashboard(compliance_scores: dict) -> Panel:
    ...
    return Panel(
        content,
        title="[bright_cyan]Compliance Dashboard[/bright_cyan]",
...
def assess_enhanced(
    ...
    try:
        ...
        # Print header
        print_header("Well-Architected Framework Assessment", "1.1.19")
