...
class Image(Element):
    ...
    **EXAMPLE:**
    ...
    '''
    @validate_types
    def __init__(self, content: PILImage | BytesIO, size: ImageSize = ..., title: str = '', description: str = '', show_title: bool = True, show_description: bool = True, extension: str = 'jpeg', raw_image_bytes: bool = False, overflow_behavior: ElementOverflowBehavior = ...) -> None: ...
