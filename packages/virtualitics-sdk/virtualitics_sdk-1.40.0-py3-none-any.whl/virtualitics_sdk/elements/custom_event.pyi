...
class CustomEvent(InputElement):
    ...
    **EXAMPLE:**
    ...
    '''
    @validate_types
    def __init__(self, title: str, confirmation_text: str = None, label: str = None, show_confirmation: bool = True, icon: str = '', open_new_tab: bool = False, vertical_position: ElementVerticalPosition = ..., horizontal_position: ElementHorizontalPosition = ..., **kwargs) -> None: ...
    @validate_types
...
class TriggerFlowCustomEvent(CustomEvent):
    ...
    **EXAMPLE:**
    ...
    timeout: Incomplete
    @validate_types
    def __init__(self, title: str, app_name: str, confirmation_text: str = None, label: str = None, input_parameters: dict | None = None, timeout: int = 30, horizontal_position: ElementHorizontalPosition = ..., vertical_position: ElementVerticalPosition = ..., **kwargs) -> None: ...
    @validate_types
