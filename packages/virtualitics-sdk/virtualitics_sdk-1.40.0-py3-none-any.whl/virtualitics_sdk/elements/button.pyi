...
from virtualitics_sdk.types import PageUpdateCallback as PageUpdateCallback, StandardOnClickCallback as StandardOnClickCallback
...
class Button(Element):
    ...
    :param on_click: **Drilldown callback** executed when the button is clicked, only used when
                     ``button_type`` is ``ButtonType.DRILLDOWN``. The callback is persisted and invoked
                     by the platform at runtime. It should be a callable with the following signature:
