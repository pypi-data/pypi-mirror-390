...
class NumericSlider(NumericRange):
    ...
    **EXAMPLE with page_update:**
    ...
    '''
    def __init__(self, min_range: int | float, max_range: int | float, selected: int | float = None, title: str = '', description: str = '', show_title: bool = True, show_description: bool = True, step_size: float | int | None = None, page_update: Callable | None = None) -> None: ...
...
class NumericRangeSlider(NumericRange):
    ...
    **EXAMPLE with page_update:**
    ...
    '''
    def __init__(self, min_range: int | float, max_range: int | float, min_selection: int | float | None = None, max_selection: int | float | None = None, title: str = '', description: str = '', show_title: bool = True, show_description: bool = True, step_size: float | int | None = None, page_update: Callable | None = None) -> None: ...
