...
class TextInput(InputElement):
    ...
    **EXAMPLE:**
    ...
    How to use page_update
        ...
        .. code-block:: python
            ...
            def textinput_updater(store_interface: StoreInterface):
                ...
                text_element = page.get_element_by_title(\'My Updatable Text Input\')
    ...
    required: Incomplete
    @validate_types
    def __init__(self, value: str = '', description: str = '', title: str = '', show_title: bool = True, show_description: bool = True, required: bool = False, label: str = '', placeholder: str = '', page_update: Callable | None = None) -> None: ...
