...
def _load_library():
    ...
    try: 
        ...
        if hasattr(module, 'MOE') and hasattr(module, 'MOEConfig'):
            print("Successfully loaded MOE and MOEConfig")
            return module.MOE, module.MOEConfig
        else:
            raise AttributeError("MOE or MOEConfig not found in the module")
    except Exception as e:
