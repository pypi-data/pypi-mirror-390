...
See [agent/research/research_agent.py](agent/research/research_agent.py) for a more complex research agent example, or explore other agent types in the [agent/](agent/) directory.
