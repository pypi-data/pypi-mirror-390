    ...
    operations = [
        ...
        migrations.RunSQL(
            ...
            from "core_User" cu inner join
                (select "Code", max("OfficerID") as maxid from "tblOfficer"
                   where "ValidityTo" is null group by "Code") maxofficer
                    on "Code"=cu.username
        ...
        migrations.RunSQL(
            sql=f"""
            insert into "core_User" (id, username, i_user_id, t_user_id, officer_id, claim_admin_id)
            select {NEWID_FUNC} as uuid, ca."ClaimAdminCode", u."UserID",
              null as t, null as o, max(ca."ClaimAdminId") as max_id
        ...
        migrations.RunSQL(
            ...
            from "core_User" cu inner join
                (select "ClaimAdminCode", max("ClaimAdminId") as maxid
                    from "tblClaimAdmin" where "ValidityTo" is null
                    group by "ClaimAdminCode") maxca
