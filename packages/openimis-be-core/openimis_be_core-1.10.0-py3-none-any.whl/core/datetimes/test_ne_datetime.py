...
class NeDateTestCase(TestCase):
    def setUp(self):
        ...
        core.calendar = importlib.import_module(".calendars.ne_calendar", "core")
        core.datetime = importlib.import_module(".datetimes.ne_datetime", "core")
    ...
    def test_repr(self):
        self.assertEqual(
            repr(core.datetime.date(2076, 2, 32)),
    ...
    def test_str(self):
        ...
        self.assertEqual(
            core.datetime.date(2076, 2, 32).displaylongformat(), "शनिवार ३२ जेठ २०७६"
        )
        self.assertEqual(
            core.datetime.date(2076, 2, 32).displayshortformat(), "३२/२/२०७६"
        )

    def test_iso_format(self):
        self.assertEquals("2076-02-32", core.datetime.date(2076, 2, 32).raw_isoformat())
        self.assertEquals("2076-04-01", core.datetime.date(2076, 4, 1).raw_isoformat())
        self.assertEquals("2019-06-15", core.datetime.date(2076, 2, 32).ad_isoformat())
        self.assertEquals("2019-06-15", core.datetime.date(2076, 2, 32).isoformat())

    def test_add_sub_years(self):
        dt = core.datetime.date(2075, 10, 22)
        self.assertEquals(
            core.datetime.date(2077, 10, 22), (dt + datetimedelta(years=2))
        )
        self.assertEquals(
            core.datetime.date(2073, 10, 22), (dt + datetimedelta(years=-2))
        )
        self.assertEquals(
            core.datetime.date(2077, 10, 22), (dt - datetimedelta(years=-2))
        )
    ...
    def test_add_sub_months(self):
        dt = core.datetime.date(2075, 10, 22)
        self.assertEquals(
            core.datetime.date(2075, 12, 22), (dt + datetimedelta(months=2))
        )
        self.assertEquals(
            core.datetime.date(2075, 8, 22), (dt + datetimedelta(months=-2))
        )
        self.assertEquals(
            core.datetime.date(2075, 8, 22), (dt - datetimedelta(months=2))
        )
    ...
    def test_add_sub_days(self):
        dt = core.datetime.date(2075, 10, 22)
        self.assertEquals(
            core.datetime.date(2075, 11, 7), (dt + datetimedelta(days=14))
        )
        self.assertEquals(
            core.datetime.date(2075, 11, 7), (dt - datetimedelta(days=-14))
        )
        ...
        self.assertEquals(
            core.datetime.date(2075, 9, 27), (dt + datetimedelta(days=-14))
        )
        self.assertEquals(
            core.datetime.date(2075, 9, 27), (dt - datetimedelta(days=14))
        )
    ...
    def test_add_sub_mixed(self):
        dt = core.datetime.date(2075, 10, 22)
        self.assertEquals(
            core.datetime.date(2075, 12, 6), (dt + datetimedelta(months=1, days=14))
        )
        self.assertEquals(
    ...
    def test_min_max_date(self):
        self.assertEqual(
            core.datetime.date.min, core.datetime.date.from_ad_date(py_date(1, 1, 1))
        )
        self.assertEqual(
            core.datetime.date.max,
...
class NeDatetimeTestCase(TestCase):
    ...
    def test_from_ad_datetime(self):
        ...
        looped_dt = ne_dt.to_ad_datetime()
        self.assertEqual(looped_dt, py_datetime(2020, 1, 13, 11, 23, 42, 123987))
    ...
    def test_iso_format(self):
        self.assertEquals(
            "2019-06-15 11:22:33.444444",
            core.datetime.datetime(2076, 2, 32, 11, 22, 33, 444444).isoformat(),
        )
    ...
    def test_min_max_date(self):
        self.assertEqual(
            core.datetime.datetime.min,
            core.datetime.datetime.from_ad_datetime(py_datetime(1, 1, 1)),
        )
        self.assertEqual(
            core.datetime.datetime.max,
            core.datetime.datetime.from_ad_datetime(
    ...
    def test_diff(self):
        ...
        self.assertEqual(ne_dt_2 - ne_dt_1, datetimedelta(days=30, minutes=2))
