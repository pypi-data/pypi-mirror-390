...
class PipelineEntry(_message.Message):
    __slots__ = ("pipeline_id", "pipeline_name", "room_id", "pipeline_type", "input_resource_ids", "output_source_ids", "created_at", "recent_events", "pipeline_description", "data_connections")
