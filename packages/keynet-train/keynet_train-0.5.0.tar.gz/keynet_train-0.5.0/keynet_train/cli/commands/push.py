...
def handle_push(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        if args.dockerfile:
            ...
            print_step(7, 10, "Using custom Dockerfile")
            ...
            print_step(7, 10, "Resolving dependencies")
        ...
        print_step(8, 10, "Building container image")
        client = DockerClient(harbor_creds)
        with console.status("[bold cyan]Building image...", spinner="dots") as status:
        ...
        # Step 10: Push image
        print_step(10, 10, "Pushing to Harbor")
