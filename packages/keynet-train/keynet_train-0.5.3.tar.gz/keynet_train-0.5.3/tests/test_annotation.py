...
class TestTracePytorch:
    ...
    def test_multi_input_model(self, setup_mlflow, mock_pytorch_onnx_client):
        ...
        @trace_pytorch(
            ...
            sample_inputs,
            model_name="multi-input-test-model",
            auto_convert_onnx=True,
            enable_autolog=False,
        )
    ...
    def test_dynamic_axes(self, setup_mlflow, mock_pytorch_onnx_client):
        ...
        @trace_pytorch(
            ...
            model_name="dynamic-axes-test-model",
    ...
    def test_invalid_return_type(self, setup_mlflow):
        ...
        @trace_pytorch(
            "invalid_experiment",
            torch.randn(1, 784),
            model_name="invalid-return-test-model",
            enable_autolog=False,
        )
        def train_invalid():
            model = SimpleModel()
    ...
    def test_device_handling(self, setup_mlflow, mock_pytorch_onnx_client):
        ...
        @trace_pytorch(
            "device_experiment",
            torch.randn(1, 784),
            model_name="device-handling-test-model",
    ...
    def test_trace_pytorch_with_base_image(
        ...
        @trace_pytorch(
            ...
            torch.randn(1, 784),
            model_name="base-image-test-model",
        ...
        experiment = mlflow.get_experiment_by_name("base_image_experiment")
        assert experiment is not None
    ...
    def test_trace_pytorch_without_base_image(
        ...
        @trace_pytorch(
            ...
            torch.randn(1, 784),
            model_name="no-base-image-test-model",
            enable_autolog=False,
            auto_convert_onnx=False,
        )
        def train():
        ...
        experiment = mlflow.get_experiment_by_name("no_base_image_experiment")
        assert experiment is not None
