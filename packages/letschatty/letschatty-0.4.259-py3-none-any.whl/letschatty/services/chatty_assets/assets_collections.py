...
class AssetsCollections(metaclass=SingletonMeta):
    ...
    def get_product_by_id(self, id: str) -> Product:
        """Get a product by ID."""
        return self.products.get_by_id(id)

    def get_tag_by_id(self, id: str) -> Tag:
        """Get a tag by ID."""
        return self.tags.get_by_id(id)

    def get_user_by_id(self, id: str) -> User:
        """Get a user by ID."""
        return self.users.get_by_id(id)

    def get_chat_by_id(self, id: str) -> Chat:
        """Get a chat by ID."""
        return self.chats.get_by_id(id)

    def get_source_by_id(self, id: str) -> SourceBase:
        """Get a source by ID."""
        return self.sources.get_by_id(id)

    def get_flow_by_id(self, id: str) -> FlowPreview:
        """Get a flow by ID."""
        return self.flows.get_by_id(id)

    def get_sale_by_id(self, id: str) -> Sale:
        """Get a sale by ID."""
        return self.sales.get_by_id(id)

    def get_contact_point_by_id(self, id: str) -> ContactPoint:
        """Get a contact point by ID."""
        return self.contact_points.get_by_id(id)

    def get_ai_agent_by_id(self, id: str) -> ChattyAIAgent:
        """Get an AI agent by ID."""
        return self.ai_agents.get_by_id(id)

    def get_filter_criteria_by_id(self, id: str) -> FilterCriteria:
        """Get a filter criteria by ID."""
        return self.filter_criterias.get_by_id(id)

    def get_filter_criterias_by_ids(self, ids: list[str]) -> list[FilterCriteria]:
        """Get multiple filter criterias by their IDs."""
        return self.filter_criterias.get_by_ids(ids)
