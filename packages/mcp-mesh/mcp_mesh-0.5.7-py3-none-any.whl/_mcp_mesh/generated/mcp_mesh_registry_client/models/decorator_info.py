...
class DecoratorInfo(BaseModel):
    ...
    dependencies: List[StandardizedDependency] = Field(description="Dependencies required by this function")
    description: Optional[StrictStr] = Field(default=None, description="Function description")
    version: Optional[StrictStr] = Field(default=None, description="Function/capability version")
    tags: Optional[List[StrictStr]] = Field(default=None, description="Tags for this capability")
    __properties: ClassVar[List[str]] = ["function_name", "capability", "dependencies", "description", "version", "tags"]
