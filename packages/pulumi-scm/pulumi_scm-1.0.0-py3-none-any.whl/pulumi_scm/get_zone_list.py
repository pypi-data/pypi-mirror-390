...
class GetZoneListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetZoneListDataResult']:
        """
        The data.
        """
...
def get_zone_list(device: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getZoneList:getZoneList', __args__, opts=opts, typ=GetZoneListResult).value
...
def get_zone_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getZoneList:getZoneList', __args__, opts=opts, typ=GetZoneListResult)
    return __ret__.apply(lambda __response__: GetZoneListResult(
