...
__all__ = [
    'GetPbfRuleListResult',
    'AwaitableGetPbfRuleListResult',
    'get_pbf_rule_list',
    'get_pbf_rule_list_output',
]

@pulumi.output_type
class GetPbfRuleListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetPbfRuleListDataResult']:
        """
        The data.
        """
...
class AwaitableGetPbfRuleListResult(GetPbfRuleListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPbfRuleListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_pbf_rule_list(device: Optional[_builtins.str] = None,
                      folder: Optional[_builtins.str] = None,
                      limit: Optional[_builtins.int] = None,
                      name: Optional[_builtins.str] = None,
                      offset: Optional[_builtins.int] = None,
                      snippet: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPbfRuleListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getPbfRuleList:getPbfRuleList', __args__, opts=opts, typ=GetPbfRuleListResult).value

    return AwaitableGetPbfRuleListResult(
...
def get_pbf_rule_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getPbfRuleList:getPbfRuleList', __args__, opts=opts, typ=GetPbfRuleListResult)
    return __ret__.apply(lambda __response__: GetPbfRuleListResult(
