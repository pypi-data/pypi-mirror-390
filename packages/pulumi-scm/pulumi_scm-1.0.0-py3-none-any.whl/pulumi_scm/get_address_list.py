...
class GetAddressListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetAddressListDataResult']:
        """
        The data.
        """
...
def get_address_list(device: Optional[_builtins.str] = None,
    ...
    all_shared = scm.get_address_list(folder="Shared")
    pulumi.export("addressDataSourceResultsFromList", {addr.id: addr for addr in all_shared.datas})
    paginated_addresses_example = scm.get_address_list(folder="Shared",
        limit=5,
        offset=0)
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getAddressList:getAddressList', __args__, opts=opts, typ=GetAddressListResult).value
...
def get_address_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getAddressList:getAddressList', __args__, opts=opts, typ=GetAddressListResult)
