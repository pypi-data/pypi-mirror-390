...
from osc4py3.as_eventloop import *   # OSC event loop system for asynchronous OSC message handling
...
class OscIn(_QtCore.QObject):
   ...
   def __init__(self, port=57110):
      ...
      if alternativeIPs:
         ...
         print(f'(Alternative IP addresses: 127.0.0.1)')

      print(f'Use this info to configure OSC clients.\n')
