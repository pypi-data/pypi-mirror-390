...
``tendril-connector-keycloak`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-connector-keycloak
...
`github releases <https://github.com/tendril-framework/tendril-connector-keycloak/releases>`_.
...
``tendril-connector-keycloak``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-connector-keycloak.git
    $ cd tendril-connector-keycloak
    $ pip install -e .
