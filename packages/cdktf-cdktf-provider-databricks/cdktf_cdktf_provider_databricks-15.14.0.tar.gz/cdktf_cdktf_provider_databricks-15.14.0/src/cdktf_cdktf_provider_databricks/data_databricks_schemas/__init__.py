...
Refer to the Terraform Registry for docs: [`data_databricks_schemas`](https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/schemas).
'''
...
class DataDatabricksSchemas(
    ...
    def __init__(
        ...
        *,
        ...
        provider_config: typing.Optional[typing.Union["DataDatabricksSchemasProviderConfig", typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        :param catalog_name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/schemas#catalog_name DataDatabricksSchemas#catalog_name}.
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/schemas#id DataDatabricksSchemas#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param ids: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/schemas#ids DataDatabricksSchemas#ids}.
        :param provider_config: provider_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/schemas#provider_config DataDatabricksSchemas#provider_config}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataDatabricksSchemas that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/schemas#import import section} in the documentation of this resource for the id to use
    ...
    def put_provider_config(self, *, workspace_id: builtins.str) -> None:
        '''
        :param workspace_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/schemas#workspace_id DataDatabricksSchemas#workspace_id}.
        '''
        value = DataDatabricksSchemasProviderConfig(workspace_id=workspace_id)
    ...
    def provider_config(self) -> "DataDatabricksSchemasProviderConfigOutputReference":
        return typing.cast("DataDatabricksSchemasProviderConfigOutputReference", jsii.get(self, "providerConfig"))
    ...
    def provider_config_input(
        self,
    ) -> typing.Optional["DataDatabricksSchemasProviderConfig"]:
        return typing.cast(typing.Optional["DataDatabricksSchemasProviderConfig"], jsii.get(self, "providerConfigInput"))
...
class DataDatabricksSchemasConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if isinstance(provider_config, dict):
            provider_config = DataDatabricksSchemasProviderConfig(**provider_config)
        if __debug__:
    ...
    @builtins.property
    def provider_config(self) -> typing.Optional["DataDatabricksSchemasProviderConfig"]:
        ...
        return typing.cast(typing.Optional["DataDatabricksSchemasProviderConfig"], result)
...
@jsii.data_type(
    jsii_type="@cdktf/provider-databricks.dataDatabricksSchemas.DataDatabricksSchemasProviderConfig",
    jsii_struct_bases=[],
    name_mapping={"workspace_id": "workspaceId"},
)
class DataDatabricksSchemasProviderConfig:
    def __init__(self, *, workspace_id: builtins.str) -> None:
        '''
        :param workspace_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.97.0/docs/data-sources/schemas#workspace_id DataDatabricksSchemas#workspace_id}.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__024f2c48976f4693c514932616ae1b16f4a420e11d4cf947e42efdd386660ce1)
    ...
    def __repr__(self) -> str:
        return "DataDatabricksSchemasProviderConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataDatabricksSchemasProviderConfigOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-databricks.dataDatabricksSchemas.DataDatabricksSchemasProviderConfigOutputReference",
):
    def __init__(
        self,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c3e836a9a1170d9caf5c8212f0d547ad2e4b5e5f5303b5ecc4b8caf7b14cf7fa)
    ...
    def workspace_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5398280d02da42e10db13238971a528ece0db4a225dee3b3fc6a4300a9d0f481)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "workspaceId", value) # pyright: ignore[reportArgumentType]

    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[DataDatabricksSchemasProviderConfig]:
        return typing.cast(typing.Optional[DataDatabricksSchemasProviderConfig], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[DataDatabricksSchemasProviderConfig],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3105665742aec43ffef59ff81236e120d77a8ed5fb4604c23a253f555576744a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
__all__ = [
    ...
    "DataDatabricksSchemasProviderConfig",
    "DataDatabricksSchemasProviderConfigOutputReference",
]
...
def _typecheckingstub__024f2c48976f4693c514932616ae1b16f4a420e11d4cf947e42efdd386660ce1(
    *,
...
def _typecheckingstub__c3e836a9a1170d9caf5c8212f0d547ad2e4b5e5f5303b5ecc4b8caf7b14cf7fa(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__5398280d02da42e10db13238971a528ece0db4a225dee3b3fc6a4300a9d0f481(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3105665742aec43ffef59ff81236e120d77a8ed5fb4604c23a253f555576744a(
    value: typing.Optional[DataDatabricksSchemasProviderConfig],
) -> None:
    """Type checking stubs"""
    pass
