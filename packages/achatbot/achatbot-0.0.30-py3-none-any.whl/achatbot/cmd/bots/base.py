...
from achatbot.processors.context.memory import MemoryProcessor
...
from achatbot.processors.ai_processor import AIProcessor, FrameProcessor
...
from achatbot.common.pool_engine import EngineProviderPool, PoolInstanceInfo
...
class AIBot(IBot):
    ...
    def get_gemma3n_vision_speech_processor(
        ...
        from achatbot.processors.omni.gemma_vision_speech import Gemma3nVisionSpeechProcessor
        from achatbot.processors.omni.base import MockVisionVoiceProcessor
    ...
    def get_memory_processor(
        ...
        if processor_type == "Mem0MemoryProcessor":
            from achatbot.processors.context.memory.mem0 import Mem0MemoryProcessor
