...
class SetupDT(f90wrap.runtime.FortranDerivedType):
    ...
    def __del__(self):
        ...
        try:
            if self._alloc:
                _libfcore.f90wrap_mwd_setup__setupdt_finalise(this=self._handle)
        except:
            pass
    ...
    def n_internal_fluxes(self):
        """
        Element n_internal_fluxes ftype=integer  pytype=int
    ...
    def n_snow_fluxes(self):
        """
        Element n_snow_fluxes ftype=integer  pytype=int
    ...
    def n_hydro_fluxes(self):
        """
        Element n_hydro_fluxes ftype=integer  pytype=int
    ...
    def n_routing_fluxes(self):
        """
        Element n_routing_fluxes ftype=integer  pytype=int
    ...
    def n_layers(self):
        """
        Element n_layers ftype=integer  pytype=int
    ...
    def hidden_neuron(self):
        """
        Element hidden_neuron ftype=integer pytype=int
    ...
    def neurons(self):
        """
        Element neurons ftype=integer pytype=int
