...
class RR_ParametersDT(f90wrap.runtime.FortranDerivedType):
    def copy(self):
        return rr_parametersdt_copy(self)
    """
    ...
    def __del__(self):
        """
        Destructor for class Rr_Parametersdt
        ...
        Automatically generated destructor for rr_parametersdt
        """
        try:
            if self._alloc:
                _libfcore.f90wrap_mwd_rr_parameters__rr_parametersdt_finalise(this=self._handle)
        except:
            pass
