...
class _UserDBConfig(UserConfig):
    """
    Internal class modelling the representation of a delta user config stored in the database.

    This is used to validate and parse configuration deltas from the database,
    ...
    # Everything is optional since DB stores only deltas from defaults
