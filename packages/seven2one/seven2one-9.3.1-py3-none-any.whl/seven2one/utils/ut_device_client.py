# Patched copy of oauthlib.oauth2.rfc8628.clients.device to use in OAuth2Session (package requests_oauthlib)
"""
...
class DeviceClient(Client):
    ...
    # the single code change: renamed device_code to code
    def prepare_request_body(self, code, body='', scope=None,
        ...
        scope = self.scope if scope is None else scope
        return prepare_token_request(self.grant_type, body=body, device_code=code,
                                     scope=scope, **kwargs)
