...
class SLM200(DisplayDeviceTemplate):
    ...
    def __init__(
        ...
        DisplayDeviceTemplate(config_dict, default_config, keep_device_open)
    ...
    def video_mode(self, mode: int | str = "USB") -> bool:
        ...
        if isinstance(mode, str):
            mode_int = VIDEO_MODE[mode.upper()]
        return self._handle_return_status(self._controlcommand(b"VI", [mode_int]))
