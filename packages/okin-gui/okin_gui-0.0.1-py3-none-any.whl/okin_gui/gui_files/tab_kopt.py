...
class KOptTab(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setup_ui()
        # self.load_mechanism("my_mechanism2.mech")

        self.sb_string = """J1: Os -> OsO3;		k1*Os-kN1*OsO3
J2: OsO3 + NMO -> OsO4 + NMM;		k2*OsO3*NMO-kN2*OsO4*NMM
J3: OsO4 + alkene -> cat1;		k3*OsO4*alkene-kN3*cat1
J4: cat1 -> diol + OsO3;		k4*cat1-kN4*diol*OsO3
J5: NMM + OsO3 -> catI;		k5*NMM*OsO3-kN5*catI
...
rct_vol1 = 40.0
add_vol1 = 1.5
new_vol1 = rct_vol1 + add_vol1
ratio1 = rct_vol1/new_vol1
alkene_added_mmol = 1.387
at(time>=70.1) && (event_1==1): NMO=NMO*ratio1,
diol=diol*ratio1,
alkene=(alkene*rct_vol1 + alkene_added_mmol)/new_vol1
...
ratio1 = rct_vol1/new_vol1
alkene_added_mmol = 1.387
at(time>=115.1) && (event_1==1): NMO=NMO*ratio1,
diol=diol*ratio1,
alkene=(alkene*rct_vol1 + alkene_added_mmol)/new_vol1
...
ratio1 = rct_vol1/new_vol1
NMO_added_mmol = 3.5
at(time>=115.2) && (event_1==1): NMO=(NMO*rct_vol1 + NMO_added_mmol)/new_vol1,
diol=diol*ratio1,
alkene=alkene*ratio1
...
ratio1 = rct_vol1/new_vol1
alkene_added_mmol = 1.387
at(time>=170.1) && (event_1==1): NMO=NMO*ratio1,
diol=diol*ratio1,
alkene=(alkene*rct_vol1 + alkene_added_mmol)/new_vol1
...
ratio1 = rct_vol1/new_vol1
NMO_added_mmol = 3.5
at(time>=170.2) && (event_1==1): NMO=(NMO*rct_vol1 + NMO_added_mmol)/new_vol1,
diol=diol*ratio1,
alkene=alkene*ratio1
            """
    ...
    def update_copasi_settings(self):
        ...
        settings_str = self.copasi_settings_wgt.get_settings_string()
    ...
    def get_opt_wgt(self):
        ...
        settings = eval(self.copasi_settings_wgt.get_settings_string())
        ...
        self.settings["nr_gen"]["QElem"].valueChanged.connect(self.update_copasi_settings)
        self.settings["nr_pop"]["QElem"].valueChanged.connect(self.update_copasi_settings)
