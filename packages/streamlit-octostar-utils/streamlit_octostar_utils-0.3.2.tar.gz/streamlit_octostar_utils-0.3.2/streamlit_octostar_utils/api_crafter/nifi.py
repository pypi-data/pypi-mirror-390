...
class NifiEntity(object):
    ...
    def add_annotations(
        ...
        if not self.annotations:
            self.annotations = {}
        self.annotations = recursive_update_dict(
            self.annotations, json, merge_method, recurse
        )
    ...
    def propagate_annotations(self, to_entity, fields=None, merge_method=lambda _, v2: v2):
        ...
        to_entity.annotations = recursive_update_dict(
            to_entity.annotations, annotations_to_propagate, merge_method
        )
