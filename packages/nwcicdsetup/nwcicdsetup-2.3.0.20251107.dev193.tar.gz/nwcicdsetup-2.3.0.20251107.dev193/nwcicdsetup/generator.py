...
from .circleci import initCircleCi_async

from .NWServiceContext import NWServiceContext
from .nwservice import NWService
from .validationschema import general_config_validate, is_nw_runner_resource, checkout_method_validate
...
async def generate(
    ...
    logger.info(f"Global working directory: {global_working_direcotry}")
    ...
    try:
        ...
        circleci_context = await initCircleCi_async(pipeline, dummy_env, force)
        cwd = Path(".")
        configs = (
