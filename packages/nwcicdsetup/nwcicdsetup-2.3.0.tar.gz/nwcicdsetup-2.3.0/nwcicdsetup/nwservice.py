...
from .NWServiceContext import NWServiceContext
from .circleci import check_change_async, check_dotnet_change_async
from .validationschema import approval_task_name, service_validate, is_nw_runner_resource
...
class NWTask:
    ...
    def __init__(self, name: str, service: "NWService", members: Dict[str, Any]):
        ...
        """the resource class used for job generation"""
         # Prefer task-level working_directory; fall back to service.context.global_working_directory
        self.working_directory: str = members.get("working_directory") or service.context.global_working_directory
        """working directory used to speed up builds; falls back to service.context.global_working_directory"""
        self.requires: List[str] = list(members["requires"])
