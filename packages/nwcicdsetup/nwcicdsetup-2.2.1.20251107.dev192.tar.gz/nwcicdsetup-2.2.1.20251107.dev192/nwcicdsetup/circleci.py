...
from .dotnetdependencyresolver import fetch_dependencies
from .githubapiclient import GitHubAPIClient

# ---- add this line ----
TupleK = Tuple  # compatibility alias
logger = logging.getLogger(__name__)

async def initCircleCi_async(pipeline: int, dummy_env: bool, forced: bool) -> CircleCIContext:
...
async def check_change_async(circleci_context: CircleCIContext, project_name: str, dependencies: List[str], name: str) -> TupleK[bool, Dict[str, Any]]:
    if not circleci_context.last_successful_vcs_revision:
