...
Original source:
https://github.com/langchain-ai/langchain-experimental/blob/main/libs/experimental/langchain_experimental/tools/python/tool.py
"""
...
from .repl_util import PythonREPL
...
class PythonAstREPLTool(BaseTool):
    ...
    sanitize_input: bool = True
    args_schema: ArgsSchema | None = PythonInputs
