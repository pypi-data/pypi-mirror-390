    ...
    def cb_devicevalues(self, handler, params):
        ...
        <script>
            $(function () {
                ...
                columns: [
                    { data: "key" },
                    { data: "manual", render: v=>v ? 'MAN' : 'AUTO' },
                    { data: "toreachvalue" },
                    { data: "valuestr" },
                    { data: "flags" },
        ...
        <script>
            $(function () {
                    ...
                    columns: [
                        ...
                        { data: "toreachvalue", className: "editable text-start",
                          render: function(value, type, row)
                          {
                                if (type === "display")
                                {
                                    if (row.manual && row.writable)
                                    {
                                        if (row.digital)
                                        {
                                            ...
                                            return `<label class="form-switch">
                                                <input type="checkbox" class="toggle-enabled" data-id="${row.key}" ${checked}>
                                                <span class="slider"></span>
                                                </label>`;
                                        }
                                        else
                                        {
                                            return `<input class="form-control form-control-sm cell-input"
                                                        data-id="${row.key}" data-field="sp"
                                                        value="${value ?? ''}">`;
                                        }
                                    }
                                 }
