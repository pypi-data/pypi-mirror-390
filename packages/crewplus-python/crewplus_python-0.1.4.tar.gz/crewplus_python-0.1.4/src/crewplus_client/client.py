...
class CrewPlusClient:
    ...
    def _request(self, method: str, path: str, **kwargs: Any) -> Any:
        ...
        try:
            ...
            # [修正] 针对 DELETE 请求进行特殊处理
            # 只要状态码是 2xx，就认为删除成功，即使响应体不含 'data' 字段
            if method.upper() == "DELETE" and response.ok:
                return {"success": True, "message": "Delete operation reported success."}
