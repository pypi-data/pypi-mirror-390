...
class ApiClient(object):
    ...
    def set_sdk_version(self, value):
    ...
    def __call_api(
        ...
        post_params: typing.Optional[
            typing.List[typing.Tuple[str, typing.Any]]
        ] = None,
        files: typing.Optional[
            typing.Dict[str, typing.List[io.IOBase]]
        ] = None,
        ...
        self.client_id = '{}; {}; Python SDK; {}; {};'.format(
            self.configuration.app_name,
            self.configuration.app_version,
            self.sdk_version,
            self.configuration.machine_name,
        )
    ...
    def select_header_content_type(
        self, content_types, method=None, body=None
    ):
...
class Endpoint(object):
    ...
    def __validate_inputs(self, kwargs):
        for param in self.params_map['enum']:
            if param in kwargs:
                check_allowed_values(
                    self.allowed_values, (param,), kwargs[param]
                )
    ...
    def __gather_params(self, kwargs):
        ...
        for param_name, param_value in kwargs.items():
            ...
            if param_location:
                ...
                if param_location == 'form' and self.openapi_types[
                    param_name
                ] == (file_type,):
                    params['file'][param_name] = [param_value]
                elif param_location == 'form' and self.openapi_types[
                    param_name
                ] == ([file_type],):
    ...
    def call_with_http_info(self, **kwargs):
        ...
        params['header']['avalara-version'] = self.headers_map['avalara-version']
