...
def read_natural_gas_delivery_points(simplified=False, verbose=False):
    """Download data of natural gas delivery points in Brazil.

    This function downloads and returns data of natural gas delivery points
    ...
    -------
    gpd.GeoDataFrame
        A GeoDataFrame containing data on natural gas delivery points in Brazil.
    ...
    try:
        ...
        raise Exception(f"Failed to download or process natural gas delivery points data: {str(e)}")
