...
def read_natural_gas_processing_hub(simplified=False, verbose=False):
    """Download data of natural gas processing hubs in Brazil.

    This function downloads and returns data of natural gas processing hubs
    ...
    -------
    gpd.GeoDataFrame
        A GeoDataFrame containing data on natural gas processing hubs in Brazil.
    ...
    Example
    -------
    >>> from tunned_geobr import read_natural_gas_processing_hub
    >>> 
    >>> # Read the data
    >>> gas_hubs = read_natural_gas_processing_hub()
    >>> 
    >>> # Plot the data
    >>> gas_hubs.plot()
    """
    ...
    try:
        ...
        raise Exception(f"Failed to download or process natural gas processing hubs data: {str(e)}")
