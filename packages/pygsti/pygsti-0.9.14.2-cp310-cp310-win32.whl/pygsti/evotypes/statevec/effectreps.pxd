...
cdef extern from "effectcreps.h" namespace "CReps_statevec":
    ...
    cdef cppclass EffectCRep_Dense(EffectCRep):
        ...
        EffectCRep_Dense(double complex*,INT) except +
        double probability(StateCRep* state)
        double complex amplitude(StateCRep* state)
        INT _dim
    ...
    cdef cppclass EffectCRep_TensorProd(EffectCRep):
        ...
        EffectCRep_TensorProd(double complex*, INT*, INT, INT, INT) except +
        double probability(StateCRep* state)
        double complex amplitude(StateCRep* state)
        INT _dim
        INT _nfactors
    ...
    cdef cppclass EffectCRep_Computational(EffectCRep):
        ...
        EffectCRep_Computational(INT, INT, INT) except +
        double probability(StateCRep* state)
        double complex amplitude(StateCRep* state)
        INT _dim
        INT _nonzero_index;
