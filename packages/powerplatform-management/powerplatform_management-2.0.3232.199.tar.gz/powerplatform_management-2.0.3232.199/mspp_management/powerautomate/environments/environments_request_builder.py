...
class EnvironmentsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /powerautomate/environments
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/powerautomate/environments", path_parameters)
    
    def by_environment_id(self,environment_id: str) -> WithEnvironmentItemRequestBuilder:
        """
        Gets an item from the ApiSdk.powerautomate.environments.item collection
