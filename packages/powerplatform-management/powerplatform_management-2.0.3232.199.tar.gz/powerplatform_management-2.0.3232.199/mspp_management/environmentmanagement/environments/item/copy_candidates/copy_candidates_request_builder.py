...
class CopyCandidatesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /environmentmanagement/environments/{environment-id}/copyCandidates
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new CopyCandidatesRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/environmentmanagement/environments/{environment%2Did}/copyCandidates?api-version={api%2Dversion}{&ValidateOnly*,ValidateProperties*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[CopyCandidatesRequestBuilderGetQueryParameters]] = None) -> Optional[EnvironmentPagedCollection]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CopyCandidatesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Gets the list of environments that can be copied as the target environment.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> CopyCandidatesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: CopyCandidatesRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return CopyCandidatesRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class CopyCandidatesRequestBuilderGetQueryParameters():
        """
        Gets the list of environments that can be copied as the target environment.
        """
    ...
    @dataclass
    class CopyCandidatesRequestBuilderGetRequestConfiguration(RequestConfiguration[CopyCandidatesRequestBuilderGetQueryParameters]):
        """
