...
if TYPE_CHECKING:
    from .....models.operation_execution_result_paged_collection import OperationExecutionResultPagedCollection
    from .....models.validation_response import ValidationResponse

class OperationsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /environmentmanagement/environments/{environment-id}/operations
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/environmentmanagement/environments/{environment%2Did}/operations?api-version={api%2Dversion}{&continuationToken*,limit*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[OperationsRequestBuilderGetQueryParameters]] = None) -> Optional[OperationExecutionResultPagedCollection]:
        """
        Lists the environment lifecycle operations for a specific environment.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[OperationExecutionResultPagedCollection]
        """
        ...
        return await self.request_adapter.send_async(request_info, OperationExecutionResultPagedCollection, error_mapping)
