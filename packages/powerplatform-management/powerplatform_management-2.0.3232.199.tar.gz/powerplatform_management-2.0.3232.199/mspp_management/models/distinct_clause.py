...
@dataclass
class DistinctClause(ClauseBaseClass, Parsable):
    """
    KQL distinct operator: https://learn.microsoft.com/azure/data-explorer/kusto/query/distinctoperator
    """
    # The FieldList property
    field_list: Optional[list[str]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DistinctClause:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DistinctClause
        """
