...
@dataclass
class BillingPolicyEnvironmentResponseModelV1(Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BillingPolicyEnvironmentResponseModelV1:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: BillingPolicyEnvironmentResponseModelV1
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return BillingPolicyEnvironmentResponseModelV1()
