...
if TYPE_CHECKING:
    from .....models.environment_restore_request import EnvironmentRestoreRequest
    from .....models.validation_response import ValidationResponse

class RestoreRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /environmentmanagement/environments/{environment-id}/Restore
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/environmentmanagement/environments/{environment%2Did}/Restore?api-version={api%2Dversion}{&ValidateOnly*,ValidateProperties*}", path_parameters)
    
    async def post(self,body: EnvironmentRestoreRequest, request_configuration: Optional[RequestConfiguration[RestoreRequestBuilderPostQueryParameters]] = None) -> None:
        """
        Restores the specified environment to a previous backup.
        param body: Request model for restoring an environment to a previous backup.
    ...
    def to_post_request_information(self,body: EnvironmentRestoreRequest, request_configuration: Optional[RequestConfiguration[RestoreRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Restores the specified environment to a previous backup.
        param body: Request model for restoring an environment to a previous backup.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class RestoreRequestBuilderPostQueryParameters():
        """
        Restores the specified environment to a previous backup.
        """
    ...
    @dataclass
    class RestoreRequestBuilderPostRequestConfiguration(RequestConfiguration[RestoreRequestBuilderPostQueryParameters]):
        """
