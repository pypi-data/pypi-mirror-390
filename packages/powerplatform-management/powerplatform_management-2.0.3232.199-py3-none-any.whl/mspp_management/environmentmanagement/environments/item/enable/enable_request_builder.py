...
class EnableRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /environmentmanagement/environments/{environment-id}/Enable
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/environmentmanagement/environments/{environment%2Did}/Enable?api-version={api%2Dversion}{&ValidateOnly*,ValidateProperties*}", path_parameters)
    
    async def post(self,body: StateChangeRequest, request_configuration: Optional[RequestConfiguration[EnableRequestBuilderPostQueryParameters]] = None) -> None:
        """
    ...
    def to_post_request_information(self,body: StateChangeRequest, request_configuration: Optional[RequestConfiguration[EnableRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Enables the specified environment.
        param body: Represents a request to change the state of an environment.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class EnableRequestBuilderPostQueryParameters():
        """
        Enables the specified environment.
        """
    ...
    @dataclass
    class EnableRequestBuilderPostRequestConfiguration(RequestConfiguration[EnableRequestBuilderPostQueryParameters]):
        """
