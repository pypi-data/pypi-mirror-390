...
if TYPE_CHECKING:
    from .....models.advisor_action import AdvisorAction

class ActionsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /analytics/advisorRecommendations/{scenario}/actions
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/analytics/advisorRecommendations/{scenario}/actions?api-version={api%2Dversion}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ActionsRequestBuilderGetQueryParameters]] = None) -> Optional[list[AdvisorAction]]:
        """
        Gets allowed actions for a recommendation.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[list[AdvisorAction]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, AdvisorAction, None)
