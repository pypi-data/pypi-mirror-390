...
class AssignmentsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /governance/ruleBasedPolicies/environmentGroups/{environmentGroupId}/assignments
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/governance/ruleBasedPolicies/environmentGroups/{environmentGroupId}/assignments?api-version={api%2Dversion}&includeRuleSetCounts={includeRuleSetCounts}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AssignmentsRequestBuilderGetQueryParameters]] = None) -> Optional[RuleAssignmentsResponse]:
        """
        Retrieves a list of rule assignments for a specific environment group. This operation provides details about the policy assignments, including rule sets and associated resource types.
