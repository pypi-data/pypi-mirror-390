...
[boto3 VPCLattice 1.40.69](https://pypi.org/project/boto3/) compatible with
...
1. Run mypy-boto3-builder in your package root directory:
   `uvx --with 'boto3==1.40.69' mypy-boto3-builder`
...
list_domain_verifications_paginator: ListDomainVerificationsPaginator = client.get_paginator(
