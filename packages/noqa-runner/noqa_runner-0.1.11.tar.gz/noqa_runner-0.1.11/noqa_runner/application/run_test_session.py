        ...
        for test_info in tests:
            ...
            try:
                async with AppiumClient(
                    ...
                    # clean up alerts
                    try:
                        await mobile_service.client.dismiss_system_alert()
                    except AppiumError:
                        pass
                    ...
                    if app_store_id:
                        ...
                        await appium_client.install_app_testflight(
        ...
        async with AgentApiAdapter(
            ...
            while step_count < MAX_STEPS:
                ...
                if (
                    ...
                    app_state = await mobile_service.get_app_state(state.bundle_id)
                    if app_state != 4:
                        state.result_summary = "App was crashed"
