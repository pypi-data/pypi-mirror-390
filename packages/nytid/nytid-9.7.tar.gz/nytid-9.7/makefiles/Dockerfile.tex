...
This image is built using a {\Tt{}\LA{}Dockerfile~{\nwtagstyle{}\subpageref{NWMSZ2s-4YMQMm-1}}\RA{}\nwendquote}.

The {\Tt{}\LA{}Dockerfile~{\nwtagstyle{}\subpageref{NWMSZ2s-4YMQMm-1}}\RA{}\nwendquote} will have the following structure:
\nwfilename{Dockerfile.nw}\nwbegincode{1}\sublabel{NWMSZ2s-4YMQMm-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWMSZ2s-4YMQMm-1}}}\moddef{Dockerfile~{\nwtagstyle{}\subpageref{NWMSZ2s-4YMQMm-1}}}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
