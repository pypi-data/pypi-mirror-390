...
### Core Components
*MILESCoder Class*
The main encoder/decoder class that handles conversion between MILES strings and structured data:
...
The miles_field() function creates Pydantic fields with MILES-specific metadata:
```python
