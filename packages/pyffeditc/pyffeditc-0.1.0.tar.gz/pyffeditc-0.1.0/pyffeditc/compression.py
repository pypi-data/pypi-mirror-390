...
def compress(
    ...
    if output_filepath is None:
        ...
        return wrapper.compress(input_filepath, output_filepath, ffeditc_exe_filepath)
...
def decompress(
    ...
    if output_filepath is None:
        ...
        return wrapper.decompress(input_filepath, output_filepath, ffeditc_exe_filepath)
