...
@define()
class LocalRoleMembership(RoleMembership):
    """Class for a RoleMembership that does not yet exist in SSAS.
    ...
    def load(self, ssas: "BaseTabularModel") -> "RoleMembership":
        return self._create_helper(ssas, ssas.role_memberships)
