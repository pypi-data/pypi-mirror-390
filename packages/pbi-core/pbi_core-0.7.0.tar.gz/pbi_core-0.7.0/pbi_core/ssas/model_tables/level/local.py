...
@define()
class LocalLevel(Level):
    """Class for a Level that does not yet exist in SSAS.
    ...
    def load(self, ssas: "BaseTabularModel") -> "Level":
        return self._create_helper(ssas, ssas.levels)
