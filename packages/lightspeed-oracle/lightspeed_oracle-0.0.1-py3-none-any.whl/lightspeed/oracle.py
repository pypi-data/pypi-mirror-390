"""
Binance Oracle Module - Real-Time Market Data Retrieval Module
===================================================
...
from .exceptions import LightspeedError, validate
...
class Oracle:
    ...
    def __init__(self, endpoint: str = "") -> None:
        ...
        Raises:
            LightspeedError: If the endpoint is not responding or invalid.
    ...
    def configure_timeout(self, timeout: int) -> None:
        ...
        Raises:
            LightspeedError: If timeout is not positive
    ...
    def request(self, path: str, payload: dict | None = None) -> typing.Any:
        ...
        Raises:
            LightspeedError: If API returns error or request fails
    ...
    def exchange_info(self, symbol: str | list[str]) -> dict:
        ...
        Raises:
            LightspeedError: If symbol is invalid or empty list provided
    ...
    def orderbook(self, symbol: str, depth: int = 100) -> pandas.DataFrame:
        ...
        Raises:
            LightspeedError: If symbol is invalid or depth exceeds 5000
    ...
    def trades(self, symbol: str, limit: int = 500) -> pandas.DataFrame:
        ...
        Raises:
            LightspeedError: If symbol is invalid or limit exceeds 1000
    ...
    def klines(
        ...
        Raises:
            LightspeedError: If symbol/interval/timezone invalid or limit exceeds 1000
    ...
    def average_price(self, symbol: str) -> dict:
        ...
        Raises:
            LightspeedError: If symbol is invalid
    ...
    def twenty_four_stats(
        ...
        Raises:
            LightspeedError: If symbol invalid, empty list, or type not FULL/MINI
