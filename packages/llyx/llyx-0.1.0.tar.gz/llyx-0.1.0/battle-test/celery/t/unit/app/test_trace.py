    ...
    def test_uses_exc_argument(self):
        ...
        def create_exception_with_traceback():
            ...
            try:
                ...
                def inner_function():
                    x = (
                        "some_local_variable" * 1000
                    )  # Create local variable  # noqa: F841
                    y = list(range(1000))  # Another local variable  # noqa: F841
                    raise ValueError("Test exception with traceback")

                def outer_function():
                    z = (
                        "outer_local_variable" * 1000
                    )  # Local variable in outer frame  # noqa: F841
                    inner_function()
        ...
        assert any(count > 0 for count in frame_locals_before), (
            "Frames should have local variables"
        )
