...
class test_task_retries(TasksCase):
    ...
    def test_autoretry_backoff_jitter(
        self, randrange, retry_backoff, expected_countdowns
    ):
        @self.app.task(
            bind=True,
            shared=False,
...
class test_tasks(TasksCase):
    ...
    def test_replace(self):
        ...
        sig1.set.assert_called_once_with(
...
class test_apply_task(TasksCase):
    ...
    def test_apply_with_parent_task_no_root_id(self):
        ...
        mock_parent = Mock()
        mock_parent.request = Mock(id="parent-id-123", root_id=None, callbacks=[])
