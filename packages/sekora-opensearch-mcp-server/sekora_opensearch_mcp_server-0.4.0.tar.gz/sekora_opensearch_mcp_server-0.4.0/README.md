...
- [OpenSearch MCP Server](https://github.com/opensearch-project/sekora-opensearch-mcp-server#opensearch-mcp-server)
- [Installing sekora-opensearch-mcp-server](https://github.com/opensearch-project/sekora-opensearch-mcp-server#installing-sekora-opensearch-mcp-server)
- [Available tools](https://github.com/opensearch-project/sekora-opensearch-mcp-server#available-tools)
- [User Guide](https://github.com/opensearch-project/sekora-opensearch-mcp-server#user-guide)
- [Contributing](https://github.com/opensearch-project/sekora-opensearch-mcp-server#contributing)
- [Code of Conduct](https://github.com/opensearch-project/sekora-opensearch-mcp-server#code-of-conduct)
- [License](https://github.com/opensearch-project/sekora-opensearch-mcp-server#license)
- [Copyright](https://github.com/opensearch-project/sekora-opensearch-mcp-server#copyright)
...
sekora-opensearch-mcp-server can be installed from [PyPI](https://pypi.org/project/sekora-opensearch-mcp-server/) via pip:
...
- [Development Guide](DEVELOPER_GUIDE.md#sekora-opensearch-mcp-server-developer-guide) - Setup your development environment
