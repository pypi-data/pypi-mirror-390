...
from qpytorch.kernels import GridInterpolationKernel, MultitaskKernel, RBFKernel
...
class TestKroneckerMultiTaskKISSQEPRegression(unittest.TestCase):
    def setUp(self):
    ...
    def test_multitask_qep_mean_abs_error(self, cuda=False):
    ...
    def test_multitask_qep_mean_abs_error_cuda(self):
        if torch.cuda.is_available():
            with least_used_cuda_device():
                self.test_multitask_qep_mean_abs_error(cuda=True)
