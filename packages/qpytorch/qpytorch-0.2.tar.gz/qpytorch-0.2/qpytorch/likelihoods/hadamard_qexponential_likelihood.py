...
class HadamardQExponentialLikelihood(_QExponentialLikelihoodBase):
    r"""
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        return QExponential(function_samples, noise.sqrt(), power=self.power)
    ...
    def marginal(self, function_dist: MultivariateQExponential, *params: Any, **kwargs: Any) -> MultivariateQExponential:
        ...
        return function_dist.__class__(mean, full_covar, power=function_dist.power)
