...
setup(
    name="qpytorch",
    version=find_version("qpytorch", "version.py"),
    description="An implementation of Q-Exponential Processes in Pytorch based on GPyTorch",
    long_description=readme,
    long_description_content_type="text/markdown",
    author="Shiwei Lan",
    url="https://lanzithinking.github.io/qepytorch/",
    author_email="lanzithinking@gmail.com",
    project_urls={
        "Documentation": "https://qepytorch.readthedocs.io",
