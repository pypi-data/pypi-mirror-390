...
setup(
    ...
    keywords="sri subresource-integrity security html css javascript",
    project_urls={
        "Bug Reports": "https://github.com/adasThePro/sri-tool/issues",
        "Source": "https://github.com/adasThePro/sri-tool",
    },
)
