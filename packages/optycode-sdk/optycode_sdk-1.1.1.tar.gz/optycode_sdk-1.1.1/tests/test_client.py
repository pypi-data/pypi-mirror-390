...
class OptycodeAPI:
    ...
    def log_data(self, user_question: str, model_answer: str, model_id: str, session_id= None, model_input= None, question_id= None, rag_elements= None, attachment=None) -> dict:
        """
...
signed_url = client.upload_attachement(attachment=image, model_id="", question_id=19, session_id="check_this_out")

client.log_data_async(user_question="test new endpoint", model_answer="appropriate response", model_id="", session_id=2, model_input="last test no returns", question_id=19, signed_url=signed_url)