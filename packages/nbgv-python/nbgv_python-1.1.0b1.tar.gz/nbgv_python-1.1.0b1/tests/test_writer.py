...
def test_write_version_file_default_template_python_prefers_normalized(tmp_path: Path) -> None:
...
def test_write_version_file_default_template_python_fallback(tmp_path: Path) -> None:
