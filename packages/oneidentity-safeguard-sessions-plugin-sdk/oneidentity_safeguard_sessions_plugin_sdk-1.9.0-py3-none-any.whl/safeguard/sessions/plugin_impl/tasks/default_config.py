...
[ignore_upn_suffix_for_rdp]
# To ignore the suffix part of UPN usernames set 'ignore' to 'true', otherwise
# set it to 'false'. The default behaviour of the AA plugin is to ignore the suffix.
