...
class RequestsTLS:
    ...
    def from_config(cls, plugin_configuration, section="tls", enabled=None, ca_cert=None, client_cert=None):
        ...
        ca_cert = ca_cert or plugin_configuration.get_ca_certificate(section, "ca_cert", default=None)
        client_cert = client_cert or plugin_configuration.get_certificate(section, "client_cert", default=None)
