            ...
            if insert_tool_citations:
                ...
                if citations_provider is not None:
                    if isinstance(citations_provider, str):
                        citations_provider_enum = LLMProvider(citations_provider.lower())
                    else:
                ...
                citations_model_to_use = citations_model if citations_model else current_model
                ...
                if citations_provider_enum not in [LLMProvider.OPENAI, LLMProvider.ANTHROPIC]:
                    raise ValueError(
            ...
            if insert_tool_citations and response.tool_outputs:
                ...
                if citations_excluded_tools:
                    ...
                    tool_outputs_for_citation = [
                        o for o in response.tool_outputs if o.get("name") not in excluded_set
                    ]
