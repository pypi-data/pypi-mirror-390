...
try:
    ...
    from agent_queues.queues.agent_queue import (
    ...
    from agent_queues.queues.agent_queue_manager import (
        AgentQueueManager as _AgentQueueManager,
        create_manager as _create_manager,
    )
    from agent_queues.queues.agent_queue_report import (
...
# 导出配置模块
try:
    from agent_queues.config import settings, ClientSettings
