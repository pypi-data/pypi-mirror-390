...
User request: ${promptText}`;
      ...
      if (hasSelection) {
        ...
        const applyOperationsToCell = (operations: EditOperation[]) => {
  ...
  public refreshHighlighting(notebook: NotebookPanel): void {
    ...
    const notebookPath =
      AppStateService.getCurrentNotebookId() || notebook.context.path;
