...
class QueueRegistry:
    ...
    def __init__(self, redis_client, async_redis_client=None, redis_prefix: str = 'jettask', redis_url: str = None):
    ...
    def async_redis(self):
        if self._async_redis is None:
            ...
            if not self._redis_url:
                raise RuntimeError("Cannot create async_redis_client: no redis_url provided")

            self._async_redis = get_async_redis_client(self._redis_url, decode_responses=True)
