<div align="center">
  ...
  [![Version](https://img.shields.io/badge/Version-0.3.0-brightgreen.svg)](https://github.com/helios123/imgenx-mcp/releases)
  [![Python](https://img.shields.io/badge/Python-3.10+-blue.svg)](https://www.python.org/downloads/)
  [![MCP](https://img.shields.io/badge/MCP-Compatible-green.svg)](https://modelcontextprotocol.io/)
  [![License](https://img.shields.io/badge/License-MIT-yellow.svg)](#许可证)

**一站式 AI 图片/视频生成与处理套件，支持文本/图生图、文本/图生视频、图片分析与常用编辑（裁剪、缩放、转换、调参），并集成阿里云 OSS 上传。可作为命令行工具或 MCP Server 使用**
</div>
...
- **☁️ 阿里云 OSS 上传**: 直接上传文件到阿里云 OSS，支持 CDN 加速（新增）
  - **upload_to_oss**: 上传本地文件到 OSS
  - **download_and_upload_to_oss**: 下载 URL 并直接上传到 OSS
