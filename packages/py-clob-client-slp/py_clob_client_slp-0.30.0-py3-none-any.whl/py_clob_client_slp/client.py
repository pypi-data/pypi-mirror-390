...
class ClobClient:
    ...
    def create_order(
        self, order_args: OrderArgs, options: Optional[PartialCreateOrderOptions] = None, my_tick_size: TickSize = None
    ):
        """
        ...
        return self.builder.create_order(
            order_args,
            CreateOrderOptions(
                tick_size=my_tick_size if my_tick_size else tick_size,
                neg_risk=neg_risk,
            ),
        )
