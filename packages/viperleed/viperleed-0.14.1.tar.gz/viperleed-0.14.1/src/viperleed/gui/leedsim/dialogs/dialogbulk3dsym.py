"""Module dialogbulk3dsym of viperleed.gui.leedsim.dialogs.

Defines the Bulk3DSymDialog QDialog that allows users to input
additional 3D symmetry operations for the bulk of their sample.
"""
