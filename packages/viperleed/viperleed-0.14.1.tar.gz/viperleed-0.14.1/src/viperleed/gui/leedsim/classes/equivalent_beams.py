"""Module equivalent_beams of viperleed.gui.leedsim.classes.

Defines the LEEDEquivalentBeams, a helper class for "splitting" LEED
spots into equivalence classes.
"""
...
from viperleed.gui.helpers import equal_dicts
