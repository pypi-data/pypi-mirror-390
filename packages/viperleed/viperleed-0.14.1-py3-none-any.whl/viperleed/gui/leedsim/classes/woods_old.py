"""Module woods_old of viperleed.gui.leedsim.classes.

Defines the Woods class, used for conversion of a Woods' notation
string into a matrix and vice versa, as well as for formatting.
This is the older version of the Woods class. This module is
kept for compatibility with the older main window.
"""
