"""
Test Suite for Multi-Backend LLM Support (v1.3.0)
==================================================

Tests for Ollama, LM Studio, and Gemini backends.
...
class TestLLMClientFactory(unittest.TestCase):
    ...
    def test_get_available_backends(self):
        ...
        self.assertIn('gemini', backend_names)
    ...
    def test_create_gemini_client_without_key(self):
        """Test that Gemini client requires API key"""
        print("\n🧪 TEST 6: Gemini requires API key")
        
        # Should raise error if no API key
        with self.assertRaises(ValueError) as context:
            client = LLMClientFactory.create('gemini', model='gemini-1.5-flash')
    ...
    def test_create_invalid_backend(self):
        ...
        print("\n🧪 TEST 7: Invalid backend handling")
