...
class BoundLabel(QLabel):
    ...
    Optional transforms:
      multiplier: 0.001   # e.g. ms → s
      offset: 273.15      # e.g. °C → K
      field_type: float   # force cast
      precision: 3        # number of decimal digits for floats (default=3)
      unit: "V"           # optional unit suffix
    """
    ...
    def _on_msg(self, msg, field):
        ...
        try:
            ...
            logger.warning(f"BoundLabel transform failed for field {field}: {e}")
