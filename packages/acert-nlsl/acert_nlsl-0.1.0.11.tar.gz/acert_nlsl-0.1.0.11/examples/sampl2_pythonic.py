"""Recreate the ``sampl2`` two-spectrum series using Python."""
...
def main():
    """Run the ``sampl2`` optimisation with the modern API."""
    ...
    for idx, experimental in enumerate(experimental_series):
        ...
        if denominator > 0.0:
            print(
                f"sampl2 spectrum {idx + 1}: relative rms ="
