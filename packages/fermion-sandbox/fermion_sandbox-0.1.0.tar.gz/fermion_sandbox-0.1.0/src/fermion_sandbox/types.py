...
class ProgramRunData(BaseModel):
    ...
    exit_signal: Optional[int] = Field(alias="exitSignal")
    exit_code: int = Field(alias="exitCode")
    stdout_base64_url_encoded: str = Field(alias="stdoutBase64UrlEncoded")
    stderr_base64_url_encoded: str = Field(alias="stderrBase64UrlEncoded")
...
class RunResult(BaseModel):
    ...
    finished_at: Optional[str] = Field(alias="finishedAt")
    run_status: Optional[RunStatus] = Field(alias="runStatus")
