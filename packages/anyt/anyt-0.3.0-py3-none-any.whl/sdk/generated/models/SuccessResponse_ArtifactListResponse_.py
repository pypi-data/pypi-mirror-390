...
from .ArtifactListResponse import ArtifactListResponse

class SuccessResponse_ArtifactListResponse_(BaseModel):
    """
    SuccessResponse[ArtifactListResponse] model
            """
    model_config = {
    ...
    data : ArtifactListResponse = Field(validation_alias="data" )
