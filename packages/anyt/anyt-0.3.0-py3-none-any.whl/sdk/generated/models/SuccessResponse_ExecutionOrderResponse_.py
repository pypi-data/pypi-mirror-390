...
from .ExecutionOrderResponse import ExecutionOrderResponse

class SuccessResponse_ExecutionOrderResponse_(BaseModel):
    """
    SuccessResponse[ExecutionOrderResponse] model
            """
    model_config = {
    ...
    data : ExecutionOrderResponse = Field(validation_alias="data" )
