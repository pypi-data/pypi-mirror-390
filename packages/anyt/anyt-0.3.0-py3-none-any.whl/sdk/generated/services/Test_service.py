...
def test_success_v1_test_success_get(api_config_override : Optional[APIConfig] = None) -> SuccessResponse_dict_str__Any__:
...
def test_paginated_v1_test_paginated_get(api_config_override : Optional[APIConfig] = None, *, page : Optional[int] = None, per_page : Optional[int] = None) -> PaginatedResponse_TestItem_:
    api_config = api_config_override if api_config_override else APIConfig()
...
def test_not_found_v1_test_not_found_get(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def test_validation_v1_test_validation_get(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def test_bad_request_v1_test_bad_request_get(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def test_conflict_v1_test_conflict_get(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def test_version_check_v1_test_version_check__item_id__put(api_config_override : Optional[APIConfig] = None, *, item_id : int, If_Match : Optional[Union[str,None]] = None) -> SuccessResponse_dict_str__Any__:
    api_config = api_config_override if api_config_override else APIConfig()
    ...
    return SuccessResponse_dict_str__Any__(**body) if body is not None else SuccessResponse_dict_str__Any__()
def test_server_error_v1_test_server_error_get(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def test_automatic_validation_v1_test_validation_automatic_post(api_config_override : Optional[APIConfig] = None, *, data : CreateTestInput) -> SuccessResponse_dict_str__Any__:
    api_config = api_config_override if api_config_override else APIConfig()
