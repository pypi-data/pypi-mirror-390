...
async def health_check_health_get(api_config_override : Optional[APIConfig] = None) -> HealthResponse:
    ...
    return HealthResponse(**body) if body is not None else HealthResponse()
async def health_check_v1_health__get(api_config_override : Optional[APIConfig] = None) -> SuccessResponse_dict_str__Any__:
    api_config = api_config_override if api_config_override else APIConfig()
