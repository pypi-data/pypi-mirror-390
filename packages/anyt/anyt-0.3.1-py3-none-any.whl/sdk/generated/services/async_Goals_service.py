...
async def list_goals_v1_workspaces__workspace_id__goals__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], status_filter : Optional[Union[str,None]] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> SuccessResponse_List_GoalResponse__:
...
async def create_goal_v1_workspaces__workspace_id__goals__post(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], data : CreateGoalRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> SuccessResponse_GoalResponse_:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def get_goal_v1_workspaces__workspace_id__goals__goal_id__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], goal_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> SuccessResponse_GoalResponse_:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return SuccessResponse_GoalResponse_(**body) if body is not None else SuccessResponse_GoalResponse_()
async def delete_goal_v1_workspaces__workspace_id__goals__goal_id__delete(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], goal_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> SuccessResponse_dict_str__Any__:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def update_goal_v1_workspaces__workspace_id__goals__goal_id__patch(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], goal_id : int, data : UpdateGoalRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> SuccessResponse_GoalResponse_:
    api_config = api_config_override if api_config_override else APIConfig()
