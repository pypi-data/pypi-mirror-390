...
class SuccessResponse_WorkspaceMemberResponse_(BaseModel):
    """
    SuccessResponse[WorkspaceMemberResponse] model
            """
    model_config = {
    ...
    data : WorkspaceMemberResponse = Field(validation_alias="data" )
