...
from .EventListResponse import EventListResponse

class SuccessResponse_EventListResponse_(BaseModel):
    """
    SuccessResponse[EventListResponse] model
            """
    model_config = {
    ...
    data : EventListResponse = Field(validation_alias="data" )
