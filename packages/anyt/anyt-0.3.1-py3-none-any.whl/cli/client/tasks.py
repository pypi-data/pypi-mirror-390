...
from sdk.generated.models.TaskListResponse_Output import TaskListResponse_Output
...
from sdk.generated.services.async_Public_Tasks_service import (  # pyright: ignore[reportMissingImports]  # noqa: F401
    get_public_task_v1_t__uid__get,
)
from sdk.generated.services.async_Task_Dependencies_service import (  # pyright: ignore[reportMissingImports]  # noqa: F401
    add_dependency_v1_workspaces__workspace_id__tasks__task_identifier__dependencies__post,
    get_dependencies_v1_workspaces__workspace_id__tasks__task_identifier__dependencies__get,
    get_dependents_v1_workspaces__workspace_id__tasks__task_identifier__dependents_get,
    remove_dependency_v1_workspaces__workspace_id__tasks__task_identifier__dependencies__depends_on_identifier__delete,
)
from sdk.generated.services.async_Tasks_service import (  # pyright: ignore[reportMissingImports]  # noqa: F401
    bulk_update_tasks_v1_workspaces__workspace_id__bulk_tasks_patch,
    create_task_v1_projects__project_id__tasks__post,
    delete_task_v1_workspaces__workspace_id__tasks__task_identifier__delete,
    get_task_v1_workspaces__workspace_id__tasks__task_identifier__get,
    list_tasks_v1_workspaces__workspace_id__tasks__get,
    update_task_v1_workspaces__workspace_id__tasks__task_identifier__patch,
)
...
class TasksAPIClient:
    ...
    async def list_tasks(self, filters: TaskFilters) -> list[Task]:
        ...
        response = await list_tasks_v1_workspaces__workspace_id__tasks__get(
            ...
            has_subtasks=params.get("has_subtasks"),
        ...
        response_data: TaskListResponse_Output = cast(Any, response).data
    ...
    async def get_task(self, identifier: str) -> Task:
        ...
        response = (
            await get_task_v1_workspaces__workspace_id__tasks__task_identifier__get(
                api_config_override=self._get_api_config(),
        ...
        task_data: GeneratedTask = cast(Any, response).data
    ...
    async def get_task_by_uid(self, uid: str) -> Task:
        ...
        Raises:
            ...
            APIError: On other HTTP errors
        """
        response = await get_public_task_v1_t__uid__get(
            api_config_override=self._get_api_config(),
            uid=uid,
            workspace_id=self.workspace_id,
            X_API_Key=self.api_key,
    ...
    async def create_task(self, project_id: int, task: TaskCreate) -> Task:
        ...
        response = await create_task_v1_projects__project_id__tasks__post(
            api_config_override=self._get_api_config(),
    ...
    async def update_task(self, identifier: str, updates: TaskUpdate) -> Task:
        ...
        # Call generated service function
        response = await update_task_v1_workspaces__workspace_id__tasks__task_identifier__patch(
            api_config_override=self._get_api_config(),
            workspace_id=self.workspace_id,
            task_identifier=identifier,
            data=request,
    ...
    async def delete_task(self, identifier: str) -> None:
        ...
        Raises:
            ...
            APIError: On other HTTP errors
        """
        await delete_task_v1_workspaces__workspace_id__tasks__task_identifier__delete(
            api_config_override=self._get_api_config(),
            workspace_id=self.workspace_id,
            task_identifier=identifier,
            X_API_Key=self.api_key,
    ...
    async def add_task_dependency(
        ...
        response = await add_dependency_v1_workspaces__workspace_id__tasks__task_identifier__dependencies__post(
            api_config_override=self._get_api_config(),
            workspace_id=self.workspace_id,
            task_identifier=identifier,
            data=request,
        ...
        dep_response: DependencyResponse = cast(Any, response).data
    ...
    async def remove_task_dependency(self, identifier: str, depends_on: str) -> None:
        ...
        Raises:
            ...
            APIError: On other HTTP errors
        """
        await remove_dependency_v1_workspaces__workspace_id__tasks__task_identifier__dependencies__depends_on_identifier__delete(
            api_config_override=self._get_api_config(),
            workspace_id=self.workspace_id,
            task_identifier=identifier,
    ...
    async def get_task_dependencies(self, identifier: str) -> list[TaskDependencyInfo]:
        ...
        Raises:
            ...
            APIError: On other HTTP errors
        """
        response = await get_dependencies_v1_workspaces__workspace_id__tasks__task_identifier__dependencies__get(
            api_config_override=self._get_api_config(),
            workspace_id=self.workspace_id,
            task_identifier=identifier,
            X_API_Key=self.api_key,
        ...
        deps_data: list[GeneratedDependencyTaskInfo] = cast(Any, response).data
    ...
    async def get_task_dependents(self, identifier: str) -> list[TaskDependencyInfo]:
        ...
        Raises:
            ...
            APIError: On other HTTP errors
        """
        response = await get_dependents_v1_workspaces__workspace_id__tasks__task_identifier__dependents_get(
            api_config_override=self._get_api_config(),
            workspace_id=self.workspace_id,
            task_identifier=identifier,
            X_API_Key=self.api_key,
    ...
    async def get_task_events(
        ...
        Raises:
            ...
            APIError: On other HTTP errors
        """
        # Note: The generated client doesn't have a dedicated events endpoint yet
        # This is a placeholder that should be updated when the endpoint is available
        # For now, return empty list to maintain backward compatibility
        return []
    ...
    async def suggest_tasks(
        ...
        Raises:
            APIError: On HTTP errors
        """
        from sdk.generated.models.TaskSuggestionsResponse_Output import (
            TaskSuggestionsResponse_Output,
        )

        response = await suggest_workspace_tasks_v1_workspaces__workspace_id__tasks_suggest_get(
            api_config_override=self._get_api_config(),
            workspace_id=workspace_id,
        ...
        response_data: TaskSuggestionsResponse_Output = cast(Any, response).data
        return TaskSuggestionsResponse(response_data)
    ...
    async def suggest_project_tasks(
        ...
        Args:
            ...
            include_assigned: Include already-assigned tasks (default False)
            agent_id: Optional agent ID to filter tasks assigned to that agent
        ...
        response = await suggest_project_tasks_v1_workspaces__workspace_id__projects__project_id__tasks_suggest_get(
            api_config_override=self._get_api_config(),
            workspace_id=workspace_id,
            project_id=project_id,
            max_suggestions=max_suggestions,
    ...
    async def bulk_update(
        ...
        if updates.estimate is not None:
            generated_update.estimate = updates.estimate
        if updates.goal_id is not None:
            generated_update.goal_id = updates.goal_id
        if updates.labels is not None:
            generated_update.labels = updates.labels
        ...
        # Call generated service function
        response = (
            await bulk_update_tasks_v1_workspaces__workspace_id__bulk_tasks_patch(
                api_config_override=self._get_api_config(),
                workspace_id=ws_id,
                data=request,
                X_API_Key=self.api_key,
        ...
        # Extract data from success response
        response_data: GeneratedBulkUpdateTasksResponse = cast(Any, response).data
