...
class AssertionOperations:
    ...
    def assert_has_columns(self: SupportsDataFrameOps, expected_columns: List[str]) -> None:
    ...
    def assert_schema_matches(self: SupportsDataFrameOps, expected_schema: StructType) -> None:
