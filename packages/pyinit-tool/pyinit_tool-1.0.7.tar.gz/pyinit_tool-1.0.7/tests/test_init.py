...
def test_initialize_project_success_with_migration(mocker, tmp_path):
    ...
    (project_root / "main.py").write_text("print('main')") # Include a main.py to test it's preserved
    ...
    mocker.patch("importlib.resources.abc.Traversable.read_text", return_value=mock_template_content)
...
def test_initialize_project_fails_if_already_structured(mocker, tmp_path, existing_item):
