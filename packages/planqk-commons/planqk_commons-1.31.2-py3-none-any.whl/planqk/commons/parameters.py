...
def create_datapool_instance(parameter_name: str) -> DataPool:
    ...
    Creates a DataPool instance pointing to '/var/runtime/datapool/{parameter_name}' by default.
    ...
    from planqk.commons.constants import DATAPOOL_DIRECTORY_ENV, DEFAULT_DATAPOOL_DIRECTORY

    datapool_directory = os.environ.get(DATAPOOL_DIRECTORY_ENV, DEFAULT_DATAPOOL_DIRECTORY)
    datapool_path = os.path.join(datapool_directory, parameter_name)
