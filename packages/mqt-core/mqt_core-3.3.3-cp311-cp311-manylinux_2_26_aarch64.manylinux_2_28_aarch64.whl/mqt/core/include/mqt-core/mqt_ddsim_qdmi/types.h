 ...
 * ```
 * struct MQT_DDSIM_QDMI_Site_impl_d {
 *   size_t id;
 * };
 * ```
 */
typedef struct MQT_DDSIM_QDMI_Site_impl_d *MQT_DDSIM_QDMI_Site;
 ...
 * ```
 * struct MQT_DDSIM_QDMI_Operation_impl_d {
 *   std::string name;
 * };
 * ```
 */
typedef struct MQT_DDSIM_QDMI_Operation_impl_d *MQT_DDSIM_QDMI_Operation;
