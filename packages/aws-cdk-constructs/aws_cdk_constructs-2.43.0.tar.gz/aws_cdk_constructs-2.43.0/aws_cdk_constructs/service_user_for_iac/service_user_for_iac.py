...
class ServiceUserForIAC(Construct):
    ...
    Args:
        ...
        will_create_user (str): Whether or not should create the service user, accepted values: true, false. Default: false
    ...
    def __init__(
        ...
        **kwargs,
        ...
        create_user = (
            will_create_user
            and isinstance(will_create_user, str)
            and will_create_user.lower() == 'true'
        )
