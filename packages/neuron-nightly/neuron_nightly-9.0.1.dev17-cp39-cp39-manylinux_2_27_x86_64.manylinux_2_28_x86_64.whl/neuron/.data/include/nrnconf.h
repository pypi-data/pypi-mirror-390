...
#define NEURON_DATA_DIR "/tmp/tmp5jeu2lt1/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp5jeu2lt1/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-yw_98ctb/bin/python)"};
