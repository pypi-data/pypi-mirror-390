...
#define NEURON_DATA_DIR "/tmp/tmps53qaff2/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmps53qaff2/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-nt2ecy3m/bin/python)"};
