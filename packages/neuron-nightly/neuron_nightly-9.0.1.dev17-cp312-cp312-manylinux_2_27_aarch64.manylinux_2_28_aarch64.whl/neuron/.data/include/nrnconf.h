...
#define NEURON_DATA_DIR "/tmp/tmpitej0oba/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpitej0oba/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-3swlpsme/bin/python)"};
