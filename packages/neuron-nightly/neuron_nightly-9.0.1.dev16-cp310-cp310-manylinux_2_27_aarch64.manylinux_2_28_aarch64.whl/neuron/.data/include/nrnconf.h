...
#define NEURON_DATA_DIR "/tmp/tmp9jwp348w/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp9jwp348w/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-4lxrpzk6/bin/python)"};
