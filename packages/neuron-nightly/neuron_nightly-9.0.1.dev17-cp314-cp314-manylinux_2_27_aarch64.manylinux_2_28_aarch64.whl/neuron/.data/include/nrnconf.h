...
#define NEURON_DATA_DIR "/tmp/tmpcnn2uy1i/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpcnn2uy1i/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-dmgds3mx/bin/python)"};
