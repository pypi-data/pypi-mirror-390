...
#define NEURON_DATA_DIR "/tmp/tmpwqow7zft/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpwqow7zft/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-n4j2tkbi/bin/python)"};
