...
#define NEURON_DATA_DIR "/tmp/tmp3bn0d37d/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp3bn0d37d/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-tl9wl6sf/bin/python)"};
