...
#define NEURON_DATA_DIR "/tmp/tmp41gaoy1z/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp41gaoy1z/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-8fvgofbk/bin/python)"};
