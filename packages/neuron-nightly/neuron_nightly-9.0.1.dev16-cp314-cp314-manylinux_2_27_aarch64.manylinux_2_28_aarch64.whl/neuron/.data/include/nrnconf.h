...
#define NEURON_DATA_DIR "/tmp/tmp5v2_er45/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp5v2_er45/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-wiq0hp_0/bin/python)"};
