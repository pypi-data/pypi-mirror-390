...
#define NEURON_DATA_DIR "/tmp/tmp_d0ea4j3/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp_d0ea4j3/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-wkqy7j_y/bin/python)"};
