...
#define NEURON_DATA_DIR "/tmp/tmpg4f_hast/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpg4f_hast/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-zth_jc_5/bin/python)"};
