...
#define NEURON_DATA_DIR "/tmp/tmps6kex03h/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmps6kex03h/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-0eav90rm/bin/python)"};
