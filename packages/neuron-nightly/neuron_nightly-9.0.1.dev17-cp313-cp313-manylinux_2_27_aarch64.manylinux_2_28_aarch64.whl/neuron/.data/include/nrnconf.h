...
#define NEURON_DATA_DIR "/tmp/tmp0614z3vh/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp0614z3vh/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-ql515q1g/bin/python)"};
