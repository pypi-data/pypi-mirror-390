...
#define NEURON_DATA_DIR "/tmp/tmpa1m0wuxa/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpa1m0wuxa/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-y_q0357w/bin/python)"};
