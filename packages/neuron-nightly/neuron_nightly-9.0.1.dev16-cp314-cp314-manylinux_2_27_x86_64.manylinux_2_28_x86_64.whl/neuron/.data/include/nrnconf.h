...
#define NEURON_DATA_DIR "/tmp/tmp08q_9iqx/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp08q_9iqx/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-5qr81wu2/bin/python)"};
