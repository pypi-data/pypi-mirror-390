...
#define NEURON_DATA_DIR "/tmp/tmphrieqqy2/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmphrieqqy2/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-d84jkngi/bin/python)"};
