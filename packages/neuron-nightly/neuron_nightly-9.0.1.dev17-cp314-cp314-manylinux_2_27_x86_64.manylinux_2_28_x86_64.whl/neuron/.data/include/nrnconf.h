...
#define NEURON_DATA_DIR "/tmp/tmpziilce2o/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpziilce2o/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-ynqt36wx/bin/python)"};
