...
#define NEURON_DATA_DIR "/tmp/tmplpcg1v51/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmplpcg1v51/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-33rud5mv/bin/python)"};
