...
#define NEURON_DATA_DIR "/tmp/tmpp7wadn22/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpp7wadn22/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-cgogdify/bin/python)"};
