...
#define NEURON_DATA_DIR "/tmp/tmp8nh546c1/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp8nh546c1/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-ph5f2uub/bin/python)"};
