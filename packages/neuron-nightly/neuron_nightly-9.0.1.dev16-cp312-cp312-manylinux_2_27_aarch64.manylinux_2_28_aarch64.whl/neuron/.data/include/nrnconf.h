...
#define NEURON_DATA_DIR "/tmp/tmps0ofwfjw/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmps0ofwfjw/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-d_xm6e8j/bin/python)"};
