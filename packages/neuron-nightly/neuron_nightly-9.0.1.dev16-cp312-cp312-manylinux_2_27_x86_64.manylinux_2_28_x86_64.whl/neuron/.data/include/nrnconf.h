...
#define NEURON_DATA_DIR "/tmp/tmpvvpcw2ai/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpvvpcw2ai/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-rmpcmx39/bin/python)"};
