...
#define NEURON_DATA_DIR "/tmp/tmpcsjds1zh/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpcsjds1zh/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-mfx_xtzw/bin/python)"};
