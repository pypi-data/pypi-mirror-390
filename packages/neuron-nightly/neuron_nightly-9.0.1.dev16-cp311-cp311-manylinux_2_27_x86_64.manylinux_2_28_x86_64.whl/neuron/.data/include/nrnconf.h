...
#define NEURON_DATA_DIR "/tmp/tmp5s1o2lqn/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp5s1o2lqn/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-ce6x2pus/bin/python)"};
