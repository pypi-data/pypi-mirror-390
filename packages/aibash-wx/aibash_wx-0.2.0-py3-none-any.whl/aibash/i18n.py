...
class I18n:
    ...
    STRINGS: Dict[str, Dict[str, str]] = {
        "en": {
            ...
            # 参数解析
            "parser_usage": "{prog} [-h] [-l QUERY | -a QUERY] [--config PATH] [-new] [--auto-approve-all] [--auto-approve-commands] [--auto-approve-files] [--auto-approve-web] [--auto-max-steps AUTO_MAX_STEPS] [--ui-language {{en,zh}}] [-v] [--init] [--history] [--clear-history] [--test]",
            ...
            "help_auto_max_steps": "Automation: limit the maximum number of actions (default: 20)",
        ...
        "zh": {
            ...
            "help_auto_max_steps": "自动模式：限制最多执行的步骤数量（默认 20）",
