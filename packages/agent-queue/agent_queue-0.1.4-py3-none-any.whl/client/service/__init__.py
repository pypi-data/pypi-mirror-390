...
# 导出客户端工厂（从 queues 包导入）
try:
    from client.queues import PrivateAgentTasksQueue, AgentClient, create_client
    __all__.extend(["PrivateAgentTasksQueue", "AgentClient", "create_client"])
except ImportError:
    pass
