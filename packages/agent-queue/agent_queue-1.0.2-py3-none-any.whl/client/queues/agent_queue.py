...
from client.queue_service_pb2_grpc import QueueServiceStub
...
class PrivateAgentTasksQueue:
    ...
    def health_check(self):
        """健康检查"""
        from client import HealthCheckRequest
    ...
    def delete_queue(self, agent_id: str, confirm: bool = True):
        ...
        """
        from client import DeleteQueueRequest
    ...
    def get_tasks_by_status(self, agent_id: str, status: int, limit: int = 100, offset: int = 0):
        ...
        """
        from client import GetTasksByStatusRequest
