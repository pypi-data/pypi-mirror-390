...
try:
    from client.queues.agent_queue import (
        PrivateAgentTasksQueue,
        AgentClient,  # 向后兼容别名
        create_client,
        AgentQueue,
    )
    from client.queues.agent_queue_manager import (
        AgentQueueManager,
        create_manager,
    )
    from client.queues.agent_queue_report import (
...
def get_proto_file_path() -> str:
    ...
    示例:
        from client import get_proto_file_path
...
def get_proto_content() -> str:
    ...
    示例:
        from client import get_proto_content
