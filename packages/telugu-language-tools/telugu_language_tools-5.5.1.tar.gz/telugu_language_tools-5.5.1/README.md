# Telugu Library v5.5.1 - Modern Telugu Engine

[![Python Version](https://img.shields.io/badge/python-3.7%2B-blue.svg)](https://www.python.org/downloads/)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![Version](https://img.shields.io/badge/version-5.5.1-brightgreen.svg)](https://github.com/yourusername/telugu_lib)
...
# Install
pip install dist/telugu_engine-5.5.1-py3-none-any.whl
```
...
```
telugu_engine/
├── transliterator.py     # v4.3.0 enhanced transliteration engine
