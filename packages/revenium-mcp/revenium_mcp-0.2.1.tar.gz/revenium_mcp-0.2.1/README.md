...
[![Version](https://img.shields.io/badge/version-0.2.1-blue)](https://github.com/revenium/revenium-mcp)
...
Comprehensive system diagnostics combining configuration analysis, auto-discovery debugging, and log analysis for troubleshooting and monitoring.

**Configuration & Health Monitoring:**
- Analyze environment variables and configuration sources
- Check auto-discovery system status and validation
- Verify onboarding and setup status
- Get overall system health summary

**Log Analysis & Investigation:**
- Review internal system logs for AI metering failures and issues
- Analyze integration and connectivity logs
- Search historical log data for specific patterns
- Analyze operation trends and identify recurring problems

**Common Use Cases:**
- *Example: "Check my system configuration and show which environment variables are being used"*
- *Example: "Show me recent internal logs to investigate why transactions are failing"*
- *Example: "Search logs for errors related to API key authentication"*
- *Example: "Analyze operation patterns in the last 24 hours"*
- *Example: "Debug auto-discovery issues and verify my API connection"*
...
#### **Tool Reference by Profile**

The following table shows all available tools organized by category, with their profile availability:

| Tool Name | Starter | Business | Description |
|-----------|---------|----------|-------------|
| **Setup & Configuration Tools** | | | |
| `system_setup` | ✓ | ✓ | Unified system setup and onboarding combining welcome guidance, setup checklist, and email verification |
| **Cost Alerts** | | | |
| `manage_alerts` | ✓ | ✓ | AI spending alerts and anomaly monitoring with threshold and cumulative usage alert creation |
| **Core Business Management Tools** | | | |
| `manage_products` | | ✓ | Product management for usage-based billing with unified progressive complexity |
| `manage_subscriptions` | | ✓ | Subscription management connecting customers to products |
| `manage_customers` | | ✓ | Customer lifecycle management for organizations, subscribers, users, and teams |
| `manage_sources` | | ✓ | Data source management for usage-based billing |
| `manage_metering_elements` | | ✓ | Metering elements ('meters') for usage-based billing configuration |
| `manage_subscriber_credentials` | | ✓ | Subscriber credential management for billing identity |
| **Metering & Analytics Tools** | | | |
| `manage_metering` | ✓ | ✓ | Submit AI transaction metering metadata and lookup existing AI transactions |
| `business_analytics_management` | ✓ | ✓ | Business analytics and cost analysis with enhanced statistical anomaly detection |
| **System & Monitoring Tools** | | | |
| `manage_capabilities` | | ✓ | Manage unified capabilities across all MCP tools with verification and health status |
| `tool_introspection` | ✓ | ✓ | Tool introspection providing detailed description of each tool's function |
| `system_diagnostics` | ✓ | ✓ | Unified system diagnostics combining configuration analysis, auto-discovery debugging, and log analysis |
| **Advanced Features** | | | |
| `manage_workflows` | | ✓ | Cross-tool workflow management for complex multi-step operations |
| **Slack Integration Tools** | | | |
| `slack_management` | ✓ | ✓ | Unified Slack integration management combining configuration, OAuth workflow, and setup assistance |

**Profile Summary:**
- **Starter Profile (7 tools):** Essential cost monitoring, alerting, and AI metering integration
- **Business Profile (15 tools):** Complete usage-based billing, product management, and comprehensive analytics
...
| Variable | Required | Description | Example |
|----------|----------|-------------|---------|
| `REVENIUM_BASE_URL` | ⚪ | API endpoint URL (defaults to main Revenium instance) | `https://api.revenium.ai/meter` |
| `REVENIUM_APP_BASE_URL` | ⚪ | Defines which Revenium web application instance to use for Slack channel configurations (defaults to main Revenium instance) | `https://app.revenium.ai` |
