...
def broker_list_tool(mcp:FastMCP):
    ...
    async def get_trading_account_summary(broker_name: Optional[str] = Field(None,
                                                                             description="The broker name,Unless otherwise requested by the user, the default value shall be retained.")):
