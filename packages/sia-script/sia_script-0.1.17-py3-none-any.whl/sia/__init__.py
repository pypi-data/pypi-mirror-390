...
from .vqram import VirtualQRAM, get_vqram, save_state, load_state, load_circuit, list_saved_states, get_state_info

# Initialize chi and qbt
chi = ChiClass(verbose=False)
qbt = qbtclass(num_qubits=2)  # REMOVED: verbose=False
