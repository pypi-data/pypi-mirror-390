...
class StringToDoubleVectorUnorderedMap(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap___nonzero__(self)

    def __bool__(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap___bool__(self)

    def __len__(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap___len__(self)
    def __iter__(self):
        return self.key_iterator()
    def iterkeys(self):
        return self.key_iterator()
    ...
    def __getitem__(self, key):
        return _iDynTree.StringToDoubleVectorUnorderedMap___getitem__(self, key)

    def __delitem__(self, key):
        return _iDynTree.StringToDoubleVectorUnorderedMap___delitem__(self, key)

    def has_key(self, key):
        return _iDynTree.StringToDoubleVectorUnorderedMap_has_key(self, key)

    def keys(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_keys(self)

    def values(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_values(self)

    def items(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_items(self)

    def __contains__(self, key):
        return _iDynTree.StringToDoubleVectorUnorderedMap___contains__(self, key)

    def key_iterator(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_key_iterator(self)

    def value_iterator(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_value_iterator(self)

    def __setitem__(self, *args):
        return _iDynTree.StringToDoubleVectorUnorderedMap___setitem__(self, *args)

    def asdict(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_asdict(self)

    def __init__(self, *args):
        _iDynTree.StringToDoubleVectorUnorderedMap_swiginit(self, _iDynTree.new_StringToDoubleVectorUnorderedMap(*args))

    def empty(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_empty(self)

    def size(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_size(self)

    def swap(self, v):
        return _iDynTree.StringToDoubleVectorUnorderedMap_swap(self, v)

    def begin(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_begin(self)

    def end(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_end(self)

    def clear(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_clear(self)

    def get_allocator(self):
        return _iDynTree.StringToDoubleVectorUnorderedMap_get_allocator(self)

    def count(self, x):
        return _iDynTree.StringToDoubleVectorUnorderedMap_count(self, x)

    def erase(self, *args):
        return _iDynTree.StringToDoubleVectorUnorderedMap_erase(self, *args)

    def find(self, x):
        return _iDynTree.StringToDoubleVectorUnorderedMap_find(self, x)
    __swig_destroy__ = _iDynTree.delete_StringToDoubleVectorUnorderedMap

# Register StringToDoubleVectorUnorderedMap in _iDynTree:
_iDynTree.StringToDoubleVectorUnorderedMap_swigregister(StringToDoubleVectorUnorderedMap)
...
class TransformDerivative(object):
    ...
    def fromHomogeneousTransformDerivative(self, transformDerivative):
        return _iDynTree.TransformDerivative_fromHomogeneousTransformDerivative(self, transformDerivative)
...
class IJoint(object):
    ...
    def getPositionDerivativeVelocityJacobian(self, jntPos, positionDerivative_J_velocity):
        return _iDynTree.IJoint_getPositionDerivativeVelocityJacobian(self, jntPos, positionDerivative_J_velocity)
    ...
    def setJointPosCoordsToRest(self, jntPos):
        return _iDynTree.IJoint_setJointPosCoordsToRest(self, jntPos)

    def normalizeJointPosCoords(self, jntPos):
        return _iDynTree.IJoint_normalizeJointPosCoords(self, jntPos)
...
class FixedJoint(IJoint):
    ...
    def getPositionDerivativeVelocityJacobian(self, jntPos, positionDerivative_J_velocity):
        return _iDynTree.FixedJoint_getPositionDerivativeVelocityJacobian(self, jntPos, positionDerivative_J_velocity)

    def setJointPosCoordsToRest(self, jntPos):
        return _iDynTree.FixedJoint_setJointPosCoordsToRest(self, jntPos)

    def normalizeJointPosCoords(self, jntPos):
        return _iDynTree.FixedJoint_normalizeJointPosCoords(self, jntPos)
...
class RevoluteJoint(MovableJointImpl1):
    ...
    def getPositionDerivativeVelocityJacobian(self, jntPos, positionDerivative_J_velocity):
        return _iDynTree.RevoluteJoint_getPositionDerivativeVelocityJacobian(self, jntPos, positionDerivative_J_velocity)

    def setJointPosCoordsToRest(self, jntPos):
        return _iDynTree.RevoluteJoint_setJointPosCoordsToRest(self, jntPos)

    def normalizeJointPosCoords(self, jntPos):
        return _iDynTree.RevoluteJoint_normalizeJointPosCoords(self, jntPos)
...
class PrismaticJoint(MovableJointImpl1):
    ...
    def getPositionDerivativeVelocityJacobian(self, jntPos, positionDerivative_J_velocity):
        return _iDynTree.PrismaticJoint_getPositionDerivativeVelocityJacobian(self, jntPos, positionDerivative_J_velocity)

    def setJointPosCoordsToRest(self, jntPos):
        return _iDynTree.PrismaticJoint_setJointPosCoordsToRest(self, jntPos)

    def normalizeJointPosCoords(self, jntPos):
        return _iDynTree.PrismaticJoint_normalizeJointPosCoords(self, jntPos)
...
JOINT_FIXED = _iDynTree.JOINT_FIXED
JOINT_REVOLUTE = _iDynTree.JOINT_REVOLUTE
JOINT_PRISMATIC = _iDynTree.JOINT_PRISMATIC
JOINT_REVOLUTE_SO2 = _iDynTree.JOINT_REVOLUTE_SO2
JOINT_SPHERICAL = _iDynTree.JOINT_SPHERICAL

def getRandomLink():
    return _iDynTree.getRandomLink()

def addRandomLinkToModel(*args):
    return _iDynTree.addRandomLinkToModel(*args)
...
def getRandomModel(*args):
    return _iDynTree.getRandomModel(*args)

def getRandomChain(*args):
    return _iDynTree.getRandomChain(*args)

def getRandomJointPositions(vec, model):
    return _iDynTree.getRandomJointPositions(vec, model)

def getRandomInverseDynamicsInputs(*args):
    return _iDynTree.getRandomInverseDynamicsInputs(*args)
...
def convertSphericalJointsToThreeRevoluteJoints(*args):
    return _iDynTree.convertSphericalJointsToThreeRevoluteJoints(*args)

def convertThreeRevoluteJointsToSphericalJoint(inputModel, outputModel, sphericalJointZeroMassTolerance=1e-6, sphericalJointOrthogonalityTolerance=1e-6, sphericalJointIntersectionTolerance=1e-6):
    return _iDynTree.convertThreeRevoluteJointsToSphericalJoint(inputModel, outputModel, sphericalJointZeroMassTolerance, sphericalJointOrthogonalityTolerance, sphericalJointIntersectionTolerance)
...
SIMPLE_JOINT_TYPES = cvar.SIMPLE_JOINT_TYPES
ALL_JOINT_TYPES = cvar.ALL_JOINT_TYPES
...
class ModelParserOptions(object):
    ...
    convertThreeRevoluteJointsToSphericalJoint = property(_iDynTree.ModelParserOptions_convertThreeRevoluteJointsToSphericalJoint_get, _iDynTree.ModelParserOptions_convertThreeRevoluteJointsToSphericalJoint_set)
    sphericalJointZeroMassTolerance = property(_iDynTree.ModelParserOptions_sphericalJointZeroMassTolerance_get, _iDynTree.ModelParserOptions_sphericalJointZeroMassTolerance_set)
    sphericalJointOrthogonalityTolerance = property(_iDynTree.ModelParserOptions_sphericalJointOrthogonalityTolerance_get, _iDynTree.ModelParserOptions_sphericalJointOrthogonalityTolerance_set)
    sphericalJointIntersectionTolerance = property(_iDynTree.ModelParserOptions_sphericalJointIntersectionTolerance_get, _iDynTree.ModelParserOptions_sphericalJointIntersectionTolerance_set)
...
class ModelExporterOptions(object):
    ...
    exportSphericalJointsAsThreeRevoluteJoints = property(_iDynTree.ModelExporterOptions_exportSphericalJointsAsThreeRevoluteJoints_get, _iDynTree.ModelExporterOptions_exportSphericalJointsAsThreeRevoluteJoints_set)
    sphericalJointFakeLinkPrefix = property(_iDynTree.ModelExporterOptions_sphericalJointFakeLinkPrefix_get, _iDynTree.ModelExporterOptions_sphericalJointFakeLinkPrefix_set)
    sphericalJointRevoluteJointPrefix = property(_iDynTree.ModelExporterOptions_sphericalJointRevoluteJointPrefix_get, _iDynTree.ModelExporterOptions_sphericalJointRevoluteJointPrefix_set)
