...
from labels.core.dependency_chains import calculate_dependency_paths_for_packages
...
def gather_packages_and_relationships(
    ...
    *,
    ...
    packages = calculate_dependency_paths_for_packages(packages, all_relationships)
