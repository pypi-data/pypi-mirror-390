...
class TherapeuticHealthAnalyzer:
    ...
    def analyze_therapeutic_health(
        ...
        **kwargs : Any
        ...
        metrics["healing_potential"] = self._calculate_healing_potential(
            G, sequence
        )
        metrics["trauma_safety"] = self._calculate_trauma_safety(G, sequence)
        metrics["therapeutic_alliance"] = self._calculate_alliance_strength(
            G, sequence
        )
        
        return metrics
    
    def _calculate_healing_potential(
    ...
    def _calculate_alliance_strength(
        self, G: nx.Graph, sequence: List[str]
    ) -> float:
