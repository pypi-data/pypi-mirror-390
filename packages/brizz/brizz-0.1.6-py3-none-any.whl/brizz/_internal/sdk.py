...
class _Brizz:
    ...
    def initialize(
        ...
        custom_log_exporter: LogExporter | None = None,
        ...
        Args:
            ...
            blocked_instrumentations: List of instrumentation names to block (defaults to all HTTP clients)
    ...
    def _initialize_modules(self) -> None:
        ...
        try:
            # Log blocked instrumentations
            if self._config.blocked_instrumentations:
                logger.debug(
                    f"Blocked instrumentations: {', '.join(self._config.blocked_instrumentations)}"
                )

            auto_instrument(blocked_instrumentations=self._config.blocked_instrumentations)
        except Exception as e:
