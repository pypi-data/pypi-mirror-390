...
class InstrumentationRegistry:
    ...
    def auto_instrument_all(self, blocked_instrumentations: list[str] | None = None) -> None:
        """Auto-instrument all available AI libraries.

        Args:
            blocked_instrumentations: List of instrumentation names to block
        """
        blocked_instrumentations = blocked_instrumentations or []
        ...
        for instrumentation_config in self.SUPPORTED_INSTRUMENTATIONS:
            ...
            if instrumentation_name in blocked_set:
                logger.debug(f"Skipping {instrumentation_config.module_name} (blocked by configuration)")
                continue
...
def auto_instrument(blocked_instrumentations: list[str] | None = None) -> None:
    """Auto-instrument all available AI libraries.
    ...
    registry.auto_instrument_all(blocked_instrumentations=blocked_instrumentations)
