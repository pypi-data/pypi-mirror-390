...
@tool(
    requires_auth=OAuth2(id="arcade-intercom"),
...
async def create_or_update_company(
    ...
    dict[str, Any], "Response from the API endpoint 'createOrUpdateCompany'."
]:
...
async def get_company_details(
    context: ToolContext,
    company_id: Annotated[
        str, "The unique identifier for the company provided by Intercom."
    ],
) -> Annotated[
    dict[str, Any], "Response from the API endpoint 'RetrieveACompanyById'."
]:
...
async def delete_company(
    context: ToolContext,
    company_id: Annotated[
        str, "The unique identifier for the company to be deleted in Intercom."
    ],
...
async def fetch_company_contacts(
    ...
    dict[str, Any], "Response from the API endpoint 'ListAttachedContacts'."
]:
...
async def list_companies_intercom(
    ...
    response = await make_request(
        ...
        method="POST",
        params=remove_none_values(
            {"page": page_number, "per_page": results_per_page, "order": sort_order}
        ),
        headers=remove_none_values(
            {
                "Intercom-Version": "2.9",
...
async def scroll_through_all_companies(
    ...
    dict[str, Any], "Response from the API endpoint 'scrollOverAllCompanies'."
]:
...
async def attach_company_to_contact(
    ...
    dict[str, Any], "Response from the API endpoint 'attachContactToACompany'."
]:
...
async def fetch_contact_companies(
    ...
    dict[str, Any], "Response from the API endpoint 'listCompaniesForAContact'."
]:
...
async def detach_company_from_contact(
    ...
    dict[str, Any], "Response from the API endpoint 'detachContactFromACompany'."
]:
...
async def fetch_contact_notes(
    ...
    contact_id: Annotated[
        int, "The unique ID of the contact whose notes you want to fetch."
    ],
...
async def get_contact_segments(
    ...
    dict[str, Any], "Response from the API endpoint 'listSegmentsForAContact'."
]:
...
async def list_contact_subscriptions(
    ...
    dict[str, Any], "Response from the API endpoint 'listSubscriptionsForAContact'."
]:
...
async def manage_contact_subscription(
    ...
    dict[str, Any], "Response from the API endpoint 'attachSubscriptionTypeToContact'."
]:
...
async def remove_subscription_from_contact(
    ...
    dict[str, Any], "Response from the API endpoint 'detachSubscriptionTypeToContact'."
]:
...
async def remove_tag_from_contact(
    ...
    dict[str, Any], "Response from the API endpoint 'detachTagFromContact'."
]:
...
async def archive_contact(
    context: ToolContext,
    contact_id: Annotated[
        str, "The unique identifier of the contact to be archived in Intercom."
    ],
...
async def unarchive_contact(
    context: ToolContext,
    contact_id: Annotated[
        str, "The unique identifier of the contact to unarchive in Intercom."
    ],
...
async def tag_conversation(
    ...
    dict[str, Any], "Response from the API endpoint 'attachTagToConversation'."
]:
...
async def remove_tag_from_conversation(
    ...
    dict[str, Any], "Response from the API endpoint 'detachTagFromConversation'."
]:
...
async def fetch_conversation_list(
    ...
    response = await make_request(
        ...
        method="GET",
        params=remove_none_values(
            {"per_page": results_per_page, "starting_after": pagination_starting_cursor}
        ),
        headers=remove_none_values(
            {
                "Intercom-Version": "2.9",
...
async def get_conversation_details(
    ...
    dict[str, Any], "Response from the API endpoint 'retrieveConversation'."
]:
...
async def auto_assign_intercom_conversation(
    ...
    dict[str, Any], "Response from the API endpoint 'autoAssignConversation'."
]:
...
async def attach_contact_to_conversation(
    ...
    dict[str, Any], "Response from the API endpoint 'attachContactToConversation'."
]:
...
async def detach_contact_from_conversation(
    ...
    dict[str, Any], "Response from the API endpoint 'detachContactFromConversation'."
]:
...
async def get_news_item_details(
    ...
    news_item_id: Annotated[
        int, "The unique identifier for the news item provided by Intercom."
    ],
...
async def delete_news_item(
    context: ToolContext,
    news_item_id: Annotated[
        int, "The unique identifier for the news item to be deleted."
    ],
...
async def fetch_live_newsfeed_items(
    ...
    dict[str, Any], "Response from the API endpoint 'listLiveNewsfeedItems'."
]:
...
async def fetch_note_details(
    context: ToolContext,
    note_id: Annotated[
        int, "The unique identifier for the note you want to retrieve details for."
    ],
...
async def list_subscription_types(
    ...
    dict[str, Any], "Response from the API endpoint 'listSubscriptionTypes'."
]:
...
async def remove_tag(
    context: ToolContext,
    tag_id: Annotated[
        str, "The unique identifier of the tag to be deleted from the workspace."
    ],
...
async def create_ticket_attribute(
    ...
    dict[str, Any], "Response from the API endpoint 'createTicketTypeAttribute'."
]:
...
async def update_ticket_type_attribute(
    ...
    dict[str, Any], "Response from the API endpoint 'updateTicketTypeAttribute'."
]:
...
async def fetch_visitor_details(
    context: ToolContext,
    visitor_user_id: Annotated[
        str, "The user ID of the visitor you want to retrieve details for."
    ],
) -> Annotated[
    dict[str, Any], "Response from the API endpoint 'retrieveVisitorWithUserId'."
]:
