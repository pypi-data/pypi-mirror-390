...
``tendril-connector-auth0`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-connector-auth0
...
`github releases <https://github.com/tendril-framework/tendril-connector-auth0/releases>`_.
...
``tendril-connector-auth0``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-connector-auth0.git
    $ cd tendril-connector-auth0
    $ pip install -e .
