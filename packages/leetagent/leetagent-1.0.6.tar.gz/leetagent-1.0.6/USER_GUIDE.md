...
# You'll be prompted to paste your key - paste is now enabled!
...
**💡 Tip:** You can now paste values when prompted - no need to type them manually!
...
| Setting | Description | Example |
|---------|-------------|---------|
| `GEMINI_MODEL_NAME` | Gemini model to use (defaults to `gemini-2.5-flash`) | `gemini-2.5-flash`, `gemini-1.5-pro`, etc. |
| `TELEGRAM_TOKEN` | Telegram bot token for notifications | `123456:ABC...` |
| `CHAT_ID` | Your Telegram chat ID | `987654321` |

### Available Gemini Models

- **`gemini-2.5-flash`** ⭐ Latest and recommended (default)
- `gemini-2.0-flash-exp` - Experimental version
- `gemini-1.5-flash` - Fast and efficient
- `gemini-1.5-flash-8b` - Lightweight model
- `gemini-1.5-pro` - More capable for complex problems
- `gemini-pro` - Legacy model

**💡 Tip:** Choose the model based on your API tier and problem complexity. The wizard (`leetagent config`) lets you select interactively.
