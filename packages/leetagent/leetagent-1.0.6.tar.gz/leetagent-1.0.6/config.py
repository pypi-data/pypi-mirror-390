...
class Settings:
    ...
    def _load_credentials(self):
        ...
        self._gemini_model = config.get("GEMINI_MODEL_NAME") or os.getenv("GEMINI_MODEL_NAME", "gemini-2.0-flash-exp")
    ...
    def GEMINI_MODEL_NAME(self) -> str:
        """Get Gemini model name (reloads from config if needed)"""
    ...
    VERSION: str = os.getenv("VERSION", "1.0.6")
    AUTHOR: str = os.getenv("AUTHOR", "Satyam Yadav")
