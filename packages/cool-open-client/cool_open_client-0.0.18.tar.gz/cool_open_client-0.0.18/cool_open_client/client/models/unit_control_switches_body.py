...
class UnitControlSwitchesBody(BaseModel):
    """
    UnitControlSwitchesBody
    """ # noqa: E501
    operation_status: StrictInt = Field(description="requested operation status from the operation status enumeration", alias="operationStatus")
    __properties: ClassVar[List[str]] = ["operationStatus"]
