...
class UpdateUserRequestBody(BaseModel):
    ...
    """ # noqa: E501
    username: Optional[StrictStr] = Field(default=None, description="user identifier")
    temperature_scale: Optional[StrictInt] = Field(default=None, description="user preffered temperature scale from the temperature scale enumeration", alias="temperatureScale")
    ...
    __properties: ClassVar[List[str]] = ["username", "temperatureScale", "permissions", "firstName", "lastName", "email", "phone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "temperatureScale": obj.get("temperatureScale"),
