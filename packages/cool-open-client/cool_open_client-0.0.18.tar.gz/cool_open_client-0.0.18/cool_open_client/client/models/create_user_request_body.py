...
class CreateUserRequestBody(BaseModel):
    ...
    """ # noqa: E501
    username: StrictStr = Field(description="user identifier")
    password: StrictStr = Field(description="user password")
    temperature_scale: StrictInt = Field(description="user preffered temperature scale from the temperature scale enumeration", alias="temperatureScale")
    ...
    __properties: ClassVar[List[str]] = ["username", "password", "temperatureScale", "permissions", "firstName", "lastName", "email", "phone"]
