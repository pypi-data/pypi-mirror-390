...
class CreateSystemRequestBody(BaseModel):
    """
    CreateSystemRequestBody
    """ # noqa: E501
    name: StrictStr = Field(description="system name")
    description: Optional[StrictStr] = Field(default=None, description="system description")
