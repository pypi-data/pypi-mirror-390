...
class CreateDeviceRequestBody(BaseModel):
    """
    CreateDeviceRequestBody
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="device name")
    serial: StrictStr = Field(description="serial number of the device")
    pin: StrictStr = Field(description="device pin")
    __properties: ClassVar[List[str]] = ["name", "serial", "pin"]
