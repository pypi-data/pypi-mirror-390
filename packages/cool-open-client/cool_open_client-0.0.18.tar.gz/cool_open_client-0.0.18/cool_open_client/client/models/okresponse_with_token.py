...
class OkresponseWithToken(BaseModel):
    """
    OkresponseWithToken
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="success status")
    data: Optional[OkresponseWithTokenData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": OkresponseWithTokenData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
