...
class ControlTreeResponseDataCustomersCustomerIdSites(BaseModel):
    """
    dictionary of accessible customers
    """ # noqa: E501
    site_id: Optional[ControlTreeResponseDataCustomersCustomerIdSitesSiteId] = Field(default=None, alias="site id")
    __properties: ClassVar[List[str]] = ["site id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of site_id
        if self.site_id:
            _dict['site id'] = self.site_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "site id": ControlTreeResponseDataCustomersCustomerIdSitesSiteId.from_dict(obj["site id"]) if obj.get("site id") is not None else None
        })
        return _obj
