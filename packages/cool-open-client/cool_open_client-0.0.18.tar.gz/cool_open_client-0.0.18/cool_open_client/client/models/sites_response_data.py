...
class SitesResponseData(BaseModel):
    """
    map of sites
    """ # noqa: E501
    site_id: Optional[SiteResponseData] = Field(default=None, alias="<siteId>")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.site_id:
            _dict['<siteId>'] = self.site_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<siteId>": SiteResponseData.from_dict(obj["<siteId>"]) if obj.get("<siteId>") is not None else None
        })
        return _obj
