...
class CustomersResponseData(BaseModel):
    """
    map of customers
    """ # noqa: E501
    customer_id: Optional[CustomerResponseData] = Field(default=None, alias="<customerId>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<customerId>": CustomerResponseData.from_dict(obj["<customerId>"]) if obj.get("<customerId>") is not None else None
        })
        return _obj
