...
class ControlTreeResponseDataCustomersCustomerId(BaseModel):
    """
    ...
    role: Optional[StrictStr] = Field(default=None, description="user role for this customer")
    sites: Optional[ControlTreeResponseDataCustomersCustomerIdSites] = None
    __properties: ClassVar[List[str]] = ["name", "id", "role", "sites"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "role": obj.get("role"),
            "sites": ControlTreeResponseDataCustomersCustomerIdSites.from_dict(obj["sites"]) if obj.get("sites") is not None else None
        })
        return _obj
