...
class DevicesResponseData(BaseModel):
    """
    dictionary of devices
    """ # noqa: E501
    device_id: Optional[DeviceResponseData] = Field(default=None, alias="<deviceId>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<deviceId>": DeviceResponseData.from_dict(obj["<deviceId>"]) if obj.get("<deviceId>") is not None else None
        })
