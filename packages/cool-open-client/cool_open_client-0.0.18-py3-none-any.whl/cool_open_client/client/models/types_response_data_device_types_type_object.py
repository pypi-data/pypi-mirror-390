...
class TypesResponseDataDeviceTypesTypeObject(BaseModel):
    """
    TypesResponseDataDeviceTypesTypeObject
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="device name")
    short_name: Optional[StrictStr] = Field(default=None, description="device short name", alias="shortName")
    __properties: ClassVar[List[str]] = ["name", "shortName"]
