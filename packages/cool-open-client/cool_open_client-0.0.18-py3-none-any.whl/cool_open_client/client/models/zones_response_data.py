...
class ZonesResponseData(BaseModel):
    """
    dictionary of zones
    """ # noqa: E501
    zone_id: Optional[ZoneResponseData] = Field(default=None, alias="<zoneId>")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "<zoneId>": ZoneResponseData.from_dict(obj["<zoneId>"]) if obj.get("<zoneId>") is not None else None
        })
        return _obj
