...
class ControlTreeResponseData(BaseModel):
    """
    ControlTreeResponseData
    """ # noqa: E501
    customers: Optional[ControlTreeResponseDataCustomers] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": ControlTreeResponseDataCustomers.from_dict(obj["customers"]) if obj.get("customers") is not None else None
        })
        return _obj
