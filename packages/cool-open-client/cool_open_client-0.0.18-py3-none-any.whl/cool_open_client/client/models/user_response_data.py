...
class UserResponseData(BaseModel):
    ...
    role: Optional[Dict[str, Any]] = Field(default=None, description="caller permissions for this user")
    permissions: Optional[Dict[str, Any]] = Field(default=None, description="user permissions")
    __properties: ClassVar[List[str]] = ["id", "username", "email", "phone", "role", "permissions"]
