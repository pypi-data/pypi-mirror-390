...
class ControlTreeResponseDataCustomers(BaseModel):
    """
    dictionary of accessible customers
    """ # noqa: E501
    customer_id: Optional[ControlTreeResponseDataCustomersCustomerId] = Field(default=None, alias="customer id")
    __properties: ClassVar[List[str]] = ["customer id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.customer_id:
            _dict['customer id'] = self.customer_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer id": ControlTreeResponseDataCustomersCustomerId.from_dict(obj["customer id"]) if obj.get("customer id") is not None else None
        })
        return _obj
