...
from halfred.models import ModelsListResponse, ChatCompletion


class Models:
    """Models API endpoint."""
    
    def __init__(self, client: "Halfred"):
        self._client = client
    ...
    def list(self) -> ModelsListResponse:
        ...
        Returns:
            ModelsListResponse object with a 'data' attribute containing a list of models
            
        Raises:
            HalfredAPIError: If the API returns an error
            HalfredAuthenticationError: If authentication fails
        """
        response_data = self._client._request("GET", "/models")
        return ModelsListResponse(response_data)
...
class Completions:
    ...
    def create(
        ...
        **kwargs: Any
        ...
        Returns:
            ChatCompletion object containing the completion response
        ...
        response_data = self._client._request("POST", "/chat/completions", json=payload)
...
class Halfred:
    ...
    def __init__(
        ...
        self.base_url = base_url or "https://api.halfred.ai/v1"
