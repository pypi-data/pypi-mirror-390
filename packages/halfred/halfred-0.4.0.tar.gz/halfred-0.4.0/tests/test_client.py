...
def test_client_initialization():
    ...
    client = Halfred(api_key="test-key")
    assert client.api_key == "test-key"
    assert client.base_url == "https://api.halfred.ai/v1"
...
def test_client_custom_base_url():
    ...
    client = Halfred(api_key="test-key", base_url="https://custom.api.com")
...
def test_models_list(mock_request):
    ...
    assert result.data[1].id == "gpt-3.5-turbo"
    mock_request.assert_called_once()
    # Verify the endpoint
    call_args = mock_request.call_args
    assert call_args[1]["method"] == "GET"
    assert call_args[1]["url"] == "https://api.halfred.ai/v1/models"
...
def test_chat_completions_create(mock_request):
    ...
    assert call_args[1]["url"] == "https://api.halfred.ai/v1/chat/completions"
