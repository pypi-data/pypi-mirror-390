...
from .api.cases.create_case import asyncio_detailed as create_case_async
from .api.cases.delete_case import asyncio_detailed as delete_case_async
from .api.cases.delete_case_document import asyncio_detailed as delete_case_document_async
from .api.cases.get_case import asyncio_detailed as get_case_async
from .api.cases.get_case_document import asyncio_detailed as get_case_document_async
from .api.cases.list_case_documents import asyncio_detailed as list_case_documents_async
from .api.cases.list_cases import asyncio_detailed as list_cases_async
from .api.cases.update_case import asyncio_detailed as update_case_async
from .api.cases.upload_case_document import asyncio_detailed as upload_case_document_async
from .api.batch.create_batch import asyncio_detailed as create_batch_async
from .api.batch.process_batch import asyncio_detailed as process_batch_async
from .api.batch.upload_batch_document import asyncio_detailed as upload_batch_document_async
...
from .api.document.ocr_document import asyncio_detailed as ocr_document_async
from .api.document.process_document import (
    asyncio_detailed as process_document_async,
)
from .api.document.process_document_with_configuration import (
    asyncio_detailed as process_document_with_configuration_async,
)
from .api.document.upload_document import (
    asyncio_detailed as upload_document_async,
)
from .api.document.upload_files import asyncio_detailed as upload_files_async
from .api.document.upload_template import asyncio_detailed as upload_template_async
from .api.job import result, status
from .api.operations.create_generative_task import (
    asyncio as create_generative_task_async,
)
from .api.operations.get_operation_result import (
...
from .api.operations.submit_operation import (
    asyncio as submit_operation_async,
)
from .api.template import delete_template, fill, list_templates, metadata
from .client import AuthenticatedClient
from .models import UploadCommand, UploadDocumentBody, OcrCommand, OcrType, LlmType
from .models.map_reduce_header_command import MapReduceHeaderCommand
from .models.extraction_mode import check_extraction_mode
...
from .types import File, UNSET, Unset
...
class DocuDevsClient:
    ...
    async def create_batch(self, max_concurrency: int | None = None) -> str:
        ...
        """
        from .models.create_batch_body import CreateBatchBody
    ...
    async def process_batch(
        ...
        *,
        ...
        from .models.process_batch_body import ProcessBatchBody
        from .models.map_reduce_command import MapReduceCommand  # potential future reuse
    ...
    async def list_knowledge_bases(self):
        ...
        response = await self._client._async_client.get("/knowledge-bases")  # type: ignore[attr-defined]
    ...
    async def submit_and_ocr_document(
        ...
        if not guid:
            raise Exception("Upload response missing guid")
        from .models.ocr_type import check_ocr_type
