...
root.title('Label Frame Test')
root.style = Style(theme='flatly')

frame_1 = cw.LabelFrame(root, border_width=1, border_style='secondary', label_text='First Frame')
...
frame_2 = cw.LabelFrame(root, border_width=(1, 10, 1, 1), border_style='secondary', label_text='Second Frame')
frame_2.grid(row=1, column=0, sticky='nsew', padx=10, pady=10)
label = ttk.Label(frame_2, text='Border 2')
label.grid(row=0, column=0, sticky='nsew', padx=10, pady=10)

frame_3 = cw.LabelFrame(root, border_width=(2, 6, 2, 2), border_style='danger', frame_style='warning', label_text='Third Frame')
frame_3.grid(row=2, column=0, sticky='nsew', padx=10, pady=10)
label = ttk.Label(frame_3, text='Border 3')
label.grid(row=0, column=0, sticky='nsew', padx=10, pady=10)

frame_4 = cw.LabelFrame(root, border_width=(1, 5, 1, 5), border_style='primary', label_text='Fourth Frame')
