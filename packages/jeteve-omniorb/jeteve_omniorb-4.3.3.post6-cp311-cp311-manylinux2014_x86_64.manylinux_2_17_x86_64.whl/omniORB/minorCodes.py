...
BAD_PARAM_InvalidFile = OMNIORBMinorCode(139)
BAD_PARAM_InvalidKey = OMNIORBMinorCode(140)
...
NO_PERMISSION_UnknownClient = OMNIORBMinorCode(141)
NO_PERMISSION_ProxyRequiresAuth = OMNIORBMinorCode(142)
...
MARSHAL_HTTPBufferFull = OMNIORBMinorCode(132)
MARSHAL_HTTPHeaderInvalid = OMNIORBMinorCode(133)
MARSHAL_HTTPChunkInvalid = OMNIORBMinorCode(134)
MARSHAL_InvalidBase64Data = OMNIORBMinorCode(136)
MARSHAL_InvalidEncryptedData = OMNIORBMinorCode(137)
MARSHAL_InvalidGIOPMessage = OMNIORBMinorCode(143)
...
BAD_INV_ORDER_NotInitialised = OMNIORBMinorCode(138)
...
TRANSIENT_Renegotiate = OMNIORBMinorCode(135)
