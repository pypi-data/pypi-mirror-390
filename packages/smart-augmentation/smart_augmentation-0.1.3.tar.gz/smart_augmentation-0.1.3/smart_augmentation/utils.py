...
def generate_report_for_folder(folder_path: str, report_path: str) -> None:
    """
    Analyze every image in folder_path (non-recursive) and write a text report
    to report_path describing recommended augmentations per image.
    """
