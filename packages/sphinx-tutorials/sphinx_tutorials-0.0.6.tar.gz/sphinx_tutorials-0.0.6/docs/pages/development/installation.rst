...
The latest released version of :obj:`sphinx_tutorials` can be installed from `PyPI <https://pypi.org/project/sphinx_tutorials/>`_ using `pip`.
...
.. code-block:: console
   ...
   $ python3 -m pip install git+https://github.com/bernardodionisi/sphinx_tutorials.git

Or from a specific branch.

.. code-block:: console

   $ python3 -m pip install git+https://github.com/bernardodionisi/sphinx_tutorials.git@branch
...
fashion from a local folder. This allows any changes in the current directory to be immediately seen upon the next `import sphinx_tutorials`.

Clone the repo wherever you'd like.

.. code-block:: console

    $ git clone https://github.com/bernardodionisi/sphinx_tutorials.git

Install the local folder using the `-e` or `--editable` flag.

.. code-block:: console

    $ python3 -m pip install -e sphinx_tutorials/
...
.. code-block:: console
   ...
   $ python3 -m pip install sphinx_tutorials[dev]
