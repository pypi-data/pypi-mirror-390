...
A [Model Context Protocol (MCP)](https://modelcontextprotocol.io) server for generating professional PDF resumes from YAML/JSON data. Works seamlessly with Claude Desktop and other MCP-compatible AI assistants.
