...
class BunnyshellError(Exception):
    """Base exception for all Bunnyshell SDK errors."""
...
class APIError(BunnyshellError):
    """API request failed."""
...
class CodeExecutionError(AgentError):
    ...
    def __init__(self, message: str = "Code execution failed", language: Optional[str] = None, **kwargs):
        super().__init__(message, code="code_execution_failed", **kwargs)
...
class CommandExecutionError(AgentError):
    ...
    def __init__(self, message: str = "Command execution failed", command: Optional[str] = None, **kwargs):
        super().__init__(message, code="command_execution_failed", **kwargs)
...
class DesktopNotAvailableError(AgentError):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(message, code="desktop_not_available", **kwargs)
        self.missing_dependencies = missing_dependencies or []
        self.docs_url = "https://docs.bunnyshell.com/desktop-automation"
