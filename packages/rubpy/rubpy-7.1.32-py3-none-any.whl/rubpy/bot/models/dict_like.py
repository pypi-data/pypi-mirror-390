...
# from rubpy.bot.models.file import File
# from rubpy.bot.models.message import ForwardedFrom
...
class DictLike:
    ...
    def __post_init__(self):
        ...
        for field in fields(self):
            ...
            if isinstance(value, dict) and isinstance(target_type, type) and issubclass(target_type, DictLike):
