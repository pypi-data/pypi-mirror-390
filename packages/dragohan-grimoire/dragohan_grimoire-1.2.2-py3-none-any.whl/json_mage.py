...
class MageJSON:
    ...
    # ===================================================================
    # COUNTING & FILTERING POWERS (4 methods) - SMART_FILTER UPGRADED!
    # ===================================================================
    ...
    def _get_nested_value(self, obj: Any, search_key: str, depth: int = 0) -> Any:
        """
        Get value for a key at ANY depth (similar to smart_match but returns value)
        
        Patterns checked:
        1. Direct: obj[search_key]
        2. Nested object: obj[search_key].name or obj[search_key].value
        3. Plural array: obj[search_key + 's'][i][search_key].name
        ...
        if search_key in obj:
            ...
            if not isinstance(val, (dict, list)):
                return val
            # If it's a dict with 'name' or 'value', return that
...
# Convenience exports for direct class usage
List = list
Dict = dict
Counter = Counter
Any = Any

__all__ = ['modify', 'myjson', 'MageJSON', 'List', 'Dict', 'Counter', 'Any']
