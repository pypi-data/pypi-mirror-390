...
class Scan:
    ...
    def to_table(
        self, *, key_range: KeyRange | None = None, key_table: pa.Table | pa.RecordBatchReader | None = None, **kwargs
    ) -> pa.Table:
    ...
    def to_pandas(self, *, key_range: KeyRange | None = None, **kwargs) -> "pd.DataFrame":
        """Read into a Pandas DataFrame.

        Requires the `pandas` package to be installed.
        """
        return self.to_table(key_range=key_range, **kwargs).to_pandas()
