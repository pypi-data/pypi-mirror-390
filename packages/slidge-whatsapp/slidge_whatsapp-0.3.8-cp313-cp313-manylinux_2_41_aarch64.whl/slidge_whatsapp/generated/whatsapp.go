...
#cgo CFLAGS: "-I/root/.local/share/uv/python/cpython-3.13.9-linux-aarch64-gnu/include/python3.13" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: "-L/root/.local/share/uv/python/cpython-3.13.9-linux-aarch64-gnu/lib" "-lpython3.13" -lpthread -ldl -lutil -lm
