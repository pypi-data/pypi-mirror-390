"""
Ruan, J., Xie, M., Gao, J., Liu, T., Fu, Y. (2023). 
EGE-UNet: An Efficient Group Enhanced UNet for Skin Lesion Segmentation. 
In: Greenspan, H., et al. Medical Image Computing and Computer Assisted Intervention - MICCAI 2023. 
MICCAI 2023. Lecture Notes in Computer Science, vol 14223. Springer, Cham. 
...
if __name__ == "__main__":
    ...
    output = model(x)
    print(output[0][0].shape) # gt_pre5
    print(output[1].shape) # out0