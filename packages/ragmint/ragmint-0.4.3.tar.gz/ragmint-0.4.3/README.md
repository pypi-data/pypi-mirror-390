...
- ⚙️ **AutoTune** their RAG pipeline (Grid / Random / Bayesian search)  
- 🧠 **Compare runs** and see **LLM explanations** (Gemini / Claude)  
- 🏆 **Inspect the Leaderboard** with best runs, scores, and configurations  
- 📊 **Explore analytics** — charts for faithfulness, recall, latency, etc.  
- 🪄 **Visualize embeddings**, retriever performance, and trial stats  
