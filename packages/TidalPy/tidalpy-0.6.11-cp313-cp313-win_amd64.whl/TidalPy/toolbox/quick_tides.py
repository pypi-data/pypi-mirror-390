...
def quick_tidal_dissipation(
    ...
    unique_frequencies, tidal_results_by_frequency = \
        tidal_term_freq_calculator(
            spin_frequency, orbital_frequency, semi_major_axis, target_radius,
    ...
    if use_cpl_ctl:
        ...
        complex_compliance_by_freq = compliance_dict_helper(
            unique_frequencies,
            rheo_func,
    ...
    tidal_heating, dUdM, dUdw, dUdO, love_number_by_orderl, negative_imk_by_orderl, effective_q_by_orderl = \
        collapse_modes_func(
            target_gravity, target_radius, target_density, shear_modulus, tidal_scale, host_mass,
    ...
    if calculate_orbit_spin_derivatives:
        ...
        da_dt, de_dt = semia_eccen_derivatives(
            semi_major_axis, orbital_frequency, eccentricity,
    ...
    for world_i in range(2):
        ...
        dissipation_results_for_world = \
            quick_tidal_dissipation(
                host_mass, target_radius=radii[world_i], target_mass=masses[world_i],
