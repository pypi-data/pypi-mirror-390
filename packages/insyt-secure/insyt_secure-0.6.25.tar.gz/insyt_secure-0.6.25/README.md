# Insyt Secure (Created & Maintained by Temitope Oguntade)

A proprietary service for securely interacting with databases, APIs, and other services within a secure environment. Contact temitope @ insyt [dot] co for more information.
