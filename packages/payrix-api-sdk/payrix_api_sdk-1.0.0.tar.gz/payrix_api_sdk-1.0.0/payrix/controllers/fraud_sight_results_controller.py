...
from payrix.models.fraud_sight_results_response_result import FraudSightResultsResponseResult
from payrix.exceptions.error_four_hundred_exception import ErrorFourHundredException


class FraudSightResultsController(BaseController):

    """A Controller to access Endpoints in the payrix API."""
    def __init__(self, config):
        super(FraudSightResultsController, self).__init__(config)

    def get_fraud_sight_results_id(self,
                                   id,
                                   request_token=None):
        """Does a GET request to /valueAddedServices/fraudSightResults/{id}.

        Query a fraudSightResults.

        Args:
            id (str): Returns the results of a specific FraudSight evaluation
                using its unique identifier. This endpoint is typically used
                to review the outcome of a previously submitted transaction
                that was evaluated by the FraudSight service.
        ...
        Returns:
            FraudSightResultsResponseResult: Response from the API.
                Successfully retrieved the FraudSight Results.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/valueAddedServices/fraudSightResults/{id}')
            ...
            .deserialize_into(FraudSightResultsResponseResult.from_dictionary)
            .local_error('400', 'Error', ErrorFourHundredException)
        ).execute()

    def get_fraud_sight_results(self,
                                request_token=None,
                                search=None,
                                totals=None,
                                page_number=None,
                                page_limit=None):
        """Does a GET request to /valueAddedServices/fraudSightResults.
        ...
        Returns:
            FraudSightResultsResponseResult: Response from the API. Response
                for query on fraudSightResults resource
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.PAYRIX)
            .path('/valueAddedServices/fraudSightResults')
            .http_method(HttpMethodEnum.GET)
            .header_param(Parameter()
                          .key('request-token')
                          .value(request_token))
