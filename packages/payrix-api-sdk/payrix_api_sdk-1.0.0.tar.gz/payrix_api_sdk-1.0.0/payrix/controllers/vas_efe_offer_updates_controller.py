...
from payrix.models.vas_efe_offer_updates_response_result import VasEfeOfferUpdatesResponseResult
from payrix.exceptions.error_four_hundred_exception import ErrorFourHundredException


class VASEfeOfferUpdatesController(BaseController):

    """A Controller to access Endpoints in the payrix API."""
    def __init__(self, config):
        super(VASEfeOfferUpdatesController, self).__init__(config)

    def get_vas_efe_offer_updates_id(self,
                                     id,
                                     token=None,
                                     request_token=None):
        """Does a GET request to /vasEfeOfferUpdates/{id}.
        ...
        Returns:
            VasEfeOfferUpdatesResponseResult: Response from the API. Response
                for query on vasEfeOfferUpdates resource
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(VasEfeOfferUpdatesResponseResult.from_dictionary)
            .local_error('400', 'Error', ErrorFourHundredException)
        ).execute()

    def get_vas_efe_offer_updates(self,
                                  token=None,
                                  request_token=None,
                                  search=None,
                                  totals=None,
                                  page_number=None,
                                  page_limit=None):
        """Does a GET request to /vasEfeOfferUpdates.
