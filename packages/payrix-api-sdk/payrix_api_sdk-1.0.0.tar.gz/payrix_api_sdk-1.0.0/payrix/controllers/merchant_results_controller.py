...
class MerchantResultsController(BaseController):
    ...
    def get_merchant_results_id(self,
        ...
        Returns:
            MerchantResultsResponseResult: Response from the API. Retrieve
    ...
    def get_merchant_results(self,
        ...
        Returns:
            MerchantResultsResponseResult: Response from the API. Response for
                query on merchantResults resource
