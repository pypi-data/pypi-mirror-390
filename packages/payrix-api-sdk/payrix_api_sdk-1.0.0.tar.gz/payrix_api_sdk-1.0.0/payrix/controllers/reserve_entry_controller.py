...
class ReserveEntryController(BaseController):
    ...
    def get_reserve_entries_id(self,
        ...
        Returns:
            ReserveEntriesResponseResult: Response from the API. Retrieve a
                Reserve Entry Response for query on reserveEntries resource.
    ...
    def get_reserve_entries(self,
        ...
        Returns:
            ReserveEntriesResponseResult: Response from the API. Response for
                query on reserveEntries resource
    ...
    def post_reserve_entries(self,
        ...
        Returns:
            ReserveEntriesResponseResult: Response from the API. Response for
                create on reserveEntries resource
