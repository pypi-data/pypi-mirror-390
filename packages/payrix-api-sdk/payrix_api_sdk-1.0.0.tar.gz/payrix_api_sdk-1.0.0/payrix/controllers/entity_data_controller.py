...
class EntityDataController(BaseController):
    ...
    def get_entity_datas_id(self,
        ...
        Returns:
            EntityDatasResponseResult: Response from the API. Retrieve an
                Entity Data Response for query on entityDatas resource.
    ...
    def get_entity_datas(self,
        ...
        Returns:
            EntityDatasResponseResult: Response from the API. Retrieve an
                Entity Data Response for the query on entityDatas resource.
    ...
    def post_entity_datas(self,
        ...
        Returns:
            EntityDatasResponseResult: Response from the API. The create on
                entityDatas response.
