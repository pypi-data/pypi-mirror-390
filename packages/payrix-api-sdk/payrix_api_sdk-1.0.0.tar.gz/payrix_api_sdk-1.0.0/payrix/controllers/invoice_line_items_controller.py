...
class InvoiceLineItemsController(BaseController):
    ...
    def get_invoice_line_items_id(self,
        ...
        Returns:
            InvoiceLineItemsResponseResult: Response from the API. Retrieve
    ...
    def put_invoice_line_items_id(self,
        ...
        Returns:
            InvoiceLineItemsResponseResult: Response from the API. Response
    ...
    def delete_invoice_line_items_id(self,
        ...
        Returns:
            InvoiceLineItemsResponseResult: Response from the API. The
