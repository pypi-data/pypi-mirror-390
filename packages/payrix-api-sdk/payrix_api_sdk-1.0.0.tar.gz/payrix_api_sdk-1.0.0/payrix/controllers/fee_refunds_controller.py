...
class FeeRefundsController(BaseController):
    ...
    def get_refunds_id(self,
        ...
        Returns:
            RefundsResponseResult: Response from the API. Retrieve a Fee
                Refund Response for query on refunds resource.
    ...
    def get_refunds(self,
        ...
        Returns:
            RefundsResponseResult: Response from the API. Response for query
                on refunds resource
    ...
    def post_refunds(self,
        ...
        Returns:
            RefundsResponseResult: Response from the API. Response for create
                on refunds resource
