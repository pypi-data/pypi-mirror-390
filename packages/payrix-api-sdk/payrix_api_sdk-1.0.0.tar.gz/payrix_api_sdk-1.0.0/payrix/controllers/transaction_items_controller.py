...
class TransactionItemsController(BaseController):
    ...
    def get_items_id(self,
        ...
        Returns:
            ItemsResponseResult: Response from the API. Response for
                retrieving an item response.
    ...
    def put_items_id(self,
        ...
        Returns:
            ItemsResponseResult: Response from the API. Successful update of
                the items
    ...
    def delete_items_id(self,
        ...
        Returns:
            ItemsResponseResult: Response from the API. The response for
                deleting an item from the items resource.
    ...
    def get_items(self,
        ...
        Returns:
            ItemsResponseResult: Response from the API. Response for query on
                items resource
    ...
    def post_items(self,
        ...
        Returns:
            ItemsResponseResult: Response from the API. Response for creating
                an item.
