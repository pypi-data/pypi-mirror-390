...
class InvoiceResultsController(BaseController):
    ...
    def get_invoice_results_id(self,
        ...
        Returns:
            InvoiceResultsResponseResult: Response from the API. Response for
                retrieve invoice result response.
    ...
    def get_invoice_results(self,
        ...
        Returns:
            InvoiceResultsResponseResult: Response from the API. Response for
                query on invoiceResults resource
    ...
    def post_invoice_results(self,
        ...
        Returns:
            InvoiceResultsResponseResult: Response from the API. Response for
                create on invoiceResults resource
