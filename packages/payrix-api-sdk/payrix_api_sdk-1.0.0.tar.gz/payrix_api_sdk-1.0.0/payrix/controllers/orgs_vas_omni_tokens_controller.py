...
class OrgsVASOmniTokensController(BaseController):
    ...
    def get_orgs_vas_omni_tokens_id(self,
        ...
        Returns:
            OrgsVASOmniTokensResponseResult: Response from the API. Response
    ...
    def put_orgs_vas_omni_tokens_id(self,
        ...
        Returns:
            OrgsVASOmniTokensResponseResult: Response from the API. The
    ...
    def delete_orgs_vas_omni_tokens_id(self,
        ...
        Returns:
            OrgsVASOmniTokensResponseResult: Response from the API. A
                successful deletion
