...
class MessageThreadsController(BaseController):
    ...
    def get_message_threads_id(self,
        ...
        Returns:
            MessageThreadsResponseResult: Response from the API. Retrieve
    ...
    def put_message_threads_id(self,
        ...
        Returns:
            MessageThreadsResponseResult: Response from the API. Response for
                update on Message Threads resource: Update Message Thread
                Response.
    ...
    def get_message_threads(self,
        ...
        Returns:
            MessageThreadsResponseResult: Response from the API. Retrieve the
                Response for query on messageThreads resource.
