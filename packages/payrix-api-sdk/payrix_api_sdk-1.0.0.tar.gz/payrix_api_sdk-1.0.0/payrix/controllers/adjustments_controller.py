...
class AdjustmentsController(BaseController):
    ...
    def get_adjustments_id(self,
        ...
        Returns:
            AdjustmentsResponseResult: Response from the API. Retrieve the
                adjustment response for query on adjustments resource.
    ...
    def get_adjustments(self,
        ...
        Returns:
            AdjustmentsResponseResult: Response from the API. Retrieve the
                Response for query on adjustments resource.
