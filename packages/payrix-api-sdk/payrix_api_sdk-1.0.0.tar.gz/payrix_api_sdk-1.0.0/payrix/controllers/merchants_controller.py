...
from payrix.models.merchants_post_response_result import MerchantsPostResponseResult
...
class MerchantsController(BaseController):
    ...
    def get_merchants(self,
        ...
        Returns:
            MerchantsResponseResult: Response from the API. Response for query
                on merchants resource
    ...
    def post_merchants(self,
        ...
        Returns:
            MerchantsPostResponseResult: Response from the API. Response for
                update on merchant's response.
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(MerchantsPostResponseResult.from_dictionary)
            .local_error('400', 'Error', ErrorFourHundredException)
        ).execute()
    ...
    def get_merchants_id(self,
        ...
        Returns:
            MerchantsResponseResult: Response from the API. Response for
                retrieving merchant response.
