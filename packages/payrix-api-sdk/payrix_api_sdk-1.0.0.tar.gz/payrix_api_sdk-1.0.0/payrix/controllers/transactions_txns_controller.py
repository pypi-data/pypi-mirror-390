...
class TransactionsTxnsController(BaseController):
    ...
    def get_txns_id(self,
        ...
        Returns:
            TxnsResponseResult: Response from the API. Response for query on
                txns resource
    ...
    def put_txns_id(self,
        ...
        Returns:
            TxnsResponseResult: Response from the API. Response for update on
                txns resource
    ...
    def get_txns(self,
        ...
        Returns:
            TxnsResponseResult: Response from the API. The transactions
                resource returns multiple transaction (txns) objects in
                response to a query.
    ...
    def post_txns(self,
        ...
        Returns:
            TxnsPostResponseResult: Response from the API. Response for create
                on txns resource
