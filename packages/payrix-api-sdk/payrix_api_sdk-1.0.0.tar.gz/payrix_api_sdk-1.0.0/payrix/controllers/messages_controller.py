...
from payrix.models.messages_post_response_result import MessagesPostResponseResult
...
class MessagesController(BaseController):
    ...
    def get_messages_id(self,
        ...
        Returns:
            MessagesResponseResult: Response from the API. Response for
    ...
    def put_messages_id(self,
        ...
        Returns:
            MessagesResponseResult: Response from the API. Response for update
                on messages resource Update Message Response
    ...
    def get_messages(self,
        ...
        Returns:
            MessagesResponseResult: Response from the API. Response for query
                on messages resource
    ...
    def post_messages(self,
        ...
        Returns:
            MessagesPostResponseResult: Response from the API. The response
                for creating a message in the messages resource
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(MessagesPostResponseResult.from_dictionary)
            .local_error('400', 'Error', ErrorFourHundredException)
        ).execute()
