...
class SaferPaymentsController(BaseController):
    ...
    def get_safer_payments_id(self,
        ...
        Returns:
            SaferPaymentsResponseResult: Response from the API. Response for
                retrieve Safer Payment.
    ...
    def put_safer_payments_id(self,
        ...
        Returns:
            SaferPaymentsResponseResult: Response from the API. The response
                for update Safer Payment.
    ...
    def get_safer_payments(self,
        ...
        Returns:
            SaferPaymentsResponseResult: Response from the API. Response for
                query on Safer Payments resource
