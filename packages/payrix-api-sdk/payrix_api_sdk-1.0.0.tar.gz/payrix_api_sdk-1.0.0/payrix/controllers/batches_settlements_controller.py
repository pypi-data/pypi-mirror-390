...
class BatchesSettlementsController(BaseController):
    ...
    def get_batches_id(self,
        ...
        Returns:
            BatchesResponseResult: Response from the API. Response for
    ...
    def put_batches_id(self,
        ...
        Returns:
            BatchesResponseResult: Response from the API. Response for update
                on batches resource Update Batch Response
    ...
    def get_batches(self,
        ...
        Returns:
            BatchesResponseResult: Response from the API. Retrieve Response
                for query on batches resource.
    ...
    def post_batches(self,
        ...
        Returns:
            BatchesResponseResult: Response from the API. The response for
                creating batches is the Create Batch Response.
