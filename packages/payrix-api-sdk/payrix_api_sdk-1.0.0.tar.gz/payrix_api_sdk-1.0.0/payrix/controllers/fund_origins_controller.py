...
class FundOriginsController(BaseController):
    ...
    def get_fund_origins_id(self,
        ...
        Returns:
            FundOriginsResponseResult: Response from the API. Retrieve the
                Fund Origin Response for query on fundOrigins resource.
    ...
    def get_fund_origins(self,
        ...
        Returns:
            FundOriginsResponseResult: Response from the API. Response for
                query on fundOrigins resource
