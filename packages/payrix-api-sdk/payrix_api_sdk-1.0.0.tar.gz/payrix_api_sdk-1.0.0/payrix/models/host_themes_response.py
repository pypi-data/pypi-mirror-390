...
class HostThemesResponse(object):
    ...
    Attributes:
        ...
        modifier (str): The identifier of the Login that last modified this
            resource.
        host (str | HostsResponse | None): The model property of type str |
            HostsResponse | None.
        primary_color (str): The theme's custom primary color. It should be a
            valid hex color.
        default (HostThemesDefaultEnum): Determines if the themes is the
            default one for the host. <details> <summary>Valid
            Values</summary>    - `0` - **On**   - `1` - **Off** </details>
    ...
    def from_dictionary(cls,
        ...
        host = APIHelper.deserialize_union_type(UnionTypeLookUp.get('HostThemesResponseHost'), dictionary.get('host'), False) if dictionary.get('host') is not None else APIHelper.SKIP
