...
class OmniTokensResponse(object):
    ...
    Attributes:
        ...
        deleted (str): The date and time at which this resource was
            ...
            YYYY-MM-DD hh:mm:ss format, for example, '2023-06-01 01:00:00' for
            June 01, 2023. 1:00 am.
        deleter (str | LoginsResponse | None): The model property of type str
            | LoginsResponse | None.
    ...
    def from_dictionary(cls,
        ...
        org = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OmniTokensResponseOrg'), dictionary.get('org'), False) if dictionary.get('org') is not None else APIHelper.SKIP
        division = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OmniTokensResponseDivision'), dictionary.get('division'), False) if dictionary.get('division') is not None else APIHelper.SKIP
        partition = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OmniTokensResponsePartition'), dictionary.get('partition'), False) if dictionary.get('partition') is not None else APIHelper.SKIP
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OmniTokensResponseEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
        ...
        deleter = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OmniTokensResponseDeleter'), dictionary.get('deleter'), False) if dictionary.get('deleter') is not None else APIHelper.SKIP
