...
class PayoutPostRequest(object):
    ...
    Attributes:
        ...
        account (str | AccountsPostRequest): The model property of type str |
            AccountsPostRequest.
    ...
    def from_dictionary(cls,
        ...
        account = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutPostRequestAccount'), dictionary.get('account'), False) if dictionary.get('account') is not None else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return UnionTypeLookUp.get('PayoutPostRequestAccount').validate(dictionary.account).is_valid \
        ...
        return UnionTypeLookUp.get('PayoutPostRequestAccount').validate(dictionary.get('account')).is_valid \
