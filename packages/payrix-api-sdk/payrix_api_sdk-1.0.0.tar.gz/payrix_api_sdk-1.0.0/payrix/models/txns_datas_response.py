...
class TxnsDatasResponse(object):
    ...
    def from_dictionary(cls,
        ...
        txn = APIHelper.deserialize_union_type(UnionTypeLookUp.get('TxnsDatasResponseTxn'), dictionary.get('txn'), False) if dictionary.get('txn') is not None else APIHelper.SKIP
