...
class MessageThreadsPostRequest(object):
    ...
    Attributes:
        ...
        subject (str): Free-form text for adding a subject to a messageThread
            resource.
        messages (List[MessagesPostRequest]): The model property of type
            List[MessagesPostRequest].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('messages') is not None:
            messages = [MessagesPostRequest.from_dictionary(x) for x in dictionary.get('messages')]
        else:
            messages = APIHelper.SKIP
