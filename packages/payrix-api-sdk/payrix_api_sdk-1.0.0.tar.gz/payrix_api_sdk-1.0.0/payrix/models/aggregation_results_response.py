...
class AggregationResultsResponse(object):
    ...
    Attributes:
        ...
        modifier (str): The identifier of the Login that last modified this
            resource.
        aggregation_result_group (str | AggregationResultGroupsResponse |
            None): The model property of type str |
            AggregationResultGroupsResponse | None.
    ...
    def from_dictionary(cls,
        ...
        aggregation_result_group = APIHelper.deserialize_union_type(UnionTypeLookUp.get('AggregationResultsResponseAggregationResultGroup'), dictionary.get('aggregationResultGroup'), False) if dictionary.get('aggregationResultGroup') is not None else APIHelper.SKIP
