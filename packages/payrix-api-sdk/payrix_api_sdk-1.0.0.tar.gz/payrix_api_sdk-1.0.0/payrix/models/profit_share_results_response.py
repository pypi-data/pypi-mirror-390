...
class ProfitShareResultsResponse(object):
    ...
    def from_dictionary(cls,
        ...
        profit_share = APIHelper.deserialize_union_type(UnionTypeLookUp.get('ProfitShareResultsResponseProfitShare'), dictionary.get('profitShare'), False) if dictionary.get('profitShare') is not None else APIHelper.SKIP
        entry = APIHelper.deserialize_union_type(UnionTypeLookUp.get('ProfitShareResultsResponseEntry'), dictionary.get('entry'), False) if dictionary.get('entry') is not None else APIHelper.SKIP
