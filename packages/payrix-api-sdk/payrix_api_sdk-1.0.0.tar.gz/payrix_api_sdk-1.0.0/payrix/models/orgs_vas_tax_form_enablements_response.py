...
class OrgsVASTaxFormEnablementsResponse(object):

    """Implementation of the 'orgsVASTaxFormEnablementsResponse' model.
    ...
    Attributes:
        ...
        mtype (OrgsVASTaxFormEnablementsTypeEnum): This field contains the
            default tax form type that will be applied to automatic
            enrollments for merchants within the specified group for the Tax
            Forms Value Added Service.  <details> <summary>Valid
            Values</summary>  - `1099k` - **1099k**  </details>
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgsVASTaxFormEnablementsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgsVASTaxFormEnablementsResponseCreator'), dictionary.get('creator'), False) if dictionary.get('creator') is not None else APIHelper.SKIP
