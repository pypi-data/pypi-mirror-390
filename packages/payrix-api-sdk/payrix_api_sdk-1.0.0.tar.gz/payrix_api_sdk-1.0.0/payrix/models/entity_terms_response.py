...
class EntityTermsResponse(object):
    ...
    def from_dictionary(cls,
        ...
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('EntityTermsResponseEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
