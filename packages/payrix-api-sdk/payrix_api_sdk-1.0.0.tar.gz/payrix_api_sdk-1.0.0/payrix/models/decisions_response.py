...
from payrix.models.watchlists_response import WatchlistsResponse
...
class DecisionsResponse(object):
    ...
    Attributes:
        ...
        frozen (FrozenEnum): Whether this resource is marked as frozen. 
            ...
            - `1` - **Frozen**  </details>
        decision_actions (List[DecisionActionsResponse]): The model property
            of type List[DecisionActionsResponse].
        decision_rules (List[DecisionRulesResponse]): The model property of
            type List[DecisionRulesResponse].
        decisions (List[DecisionsResponse]): The model property of type
            List[DecisionsResponse].
        watchlist (List[WatchlistsResponse]): The model property of type
            List[WatchlistsResponse].
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0,
                 decision_actions=APIHelper.SKIP,
                 decision_rules=APIHelper.SKIP,
                 decisions=APIHelper.SKIP,
                 watchlist=APIHelper.SKIP):
        ...
        self.frozen = frozen 
        if decision_actions is not APIHelper.SKIP:
            self.decision_actions = decision_actions 
        if decision_rules is not APIHelper.SKIP:
            self.decision_rules = decision_rules 
        if decisions is not APIHelper.SKIP:
            self.decisions = decisions 
        if watchlist is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        org = APIHelper.deserialize_union_type(UnionTypeLookUp.get('DecisionsResponseOrg'), dictionary.get('org'), False) if dictionary.get('org') is not None else APIHelper.SKIP
        division = APIHelper.deserialize_union_type(UnionTypeLookUp.get('DecisionsResponseDivision'), dictionary.get('division'), False) if dictionary.get('division') is not None else APIHelper.SKIP
        partition = APIHelper.deserialize_union_type(UnionTypeLookUp.get('DecisionsResponsePartition'), dictionary.get('partition'), False) if dictionary.get('partition') is not None else APIHelper.SKIP
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('DecisionsResponseEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
        ...
        if dictionary.get('decisionActions') is not None:
            decision_actions = [DecisionActionsResponse.from_dictionary(x) for x in dictionary.get('decisionActions')]
        else:
            decision_actions = APIHelper.SKIP
        decision_rules = None
        if dictionary.get('decisionRules') is not None:
            decision_rules = [DecisionRulesResponse.from_dictionary(x) for x in dictionary.get('decisionRules')]
        else:
            decision_rules = APIHelper.SKIP
        decisions = None
        if dictionary.get('decisions') is not None:
            ...
            decisions = APIHelper.SKIP
        watchlist = None
        if dictionary.get('watchlist') is not None:
            watchlist = [WatchlistsResponse.from_dictionary(x) for x in dictionary.get('watchlist')]
        else:
            watchlist = APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'decision_actions={(self.decision_actions if hasattr(self, "decision_actions") else None)!r}, '
                f'decision_rules={(self.decision_rules if hasattr(self, "decision_rules") else None)!r}, '
                f'decisions={(self.decisions if hasattr(self, "decisions") else None)!r}, '
                f'watchlist={(self.watchlist if hasattr(self, "watchlist") else None)!r})')
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'decision_actions={(self.decision_actions if hasattr(self, "decision_actions") else None)!s}, '
                f'decision_rules={(self.decision_rules if hasattr(self, "decision_rules") else None)!s}, '
                f'decisions={(self.decisions if hasattr(self, "decisions") else None)!s}, '
                f'watchlist={(self.watchlist if hasattr(self, "watchlist") else None)!s})')
