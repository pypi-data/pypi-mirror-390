...
class OrgFlowRulesResponse(object):
    ...
    def from_dictionary(cls,
        ...
        org_flow = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgFlowRulesResponseOrgFlow'), dictionary.get('orgFlow'), False) if dictionary.get('orgFlow') is not None else APIHelper.SKIP
