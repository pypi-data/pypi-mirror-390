...
class InvoiceLineItemsResponse(object):
    ...
    Attributes:
        ...
        modifier (str): The identifier of the Login that last modified this
            resource.
        invoice (str | InvoicesResponse | None): The model property of type
            str | InvoicesResponse | None.
        invoice_item (str | InvoiceItemsResponse | None): The model property
            of type str | InvoiceItemsResponse | None.
    ...
    def from_dictionary(cls,
        ...
        invoice = APIHelper.deserialize_union_type(UnionTypeLookUp.get('InvoiceLineItemsResponseInvoice'), dictionary.get('invoice'), False) if dictionary.get('invoice') is not None else APIHelper.SKIP
        invoice_item = APIHelper.deserialize_union_type(UnionTypeLookUp.get('InvoiceLineItemsResponseInvoiceItem'), dictionary.get('invoiceItem'), False) if dictionary.get('invoiceItem') is not None else APIHelper.SKIP
