...
class EntityCustomFieldsPostRequest(object):
    ...
    Attributes:
        entity (str | EntitiesPostRequest | None): The model property of type
            str | EntitiesPostRequest | None.
    ...
    def from_dictionary(cls,
        ...
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('EntityCustomFieldsPostRequestEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
