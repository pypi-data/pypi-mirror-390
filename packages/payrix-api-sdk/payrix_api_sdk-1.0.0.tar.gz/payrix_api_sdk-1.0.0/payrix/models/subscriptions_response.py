...
class SubscriptionsResponse(object):
    ...
    Attributes:
        ...
        modifier (str): The identifier of the Login that last modified this
            resource.
        plan (str | PlansResponse | None): The model property of type str |
            PlansResponse | None.
        statement_entity (str | EntitiesResponse | None): The model property
            of type str | EntitiesResponse | None.
        first_txn (str | TxnsResponse | None): The model property of type str
            | TxnsResponse | None.
        ...
        subscription_tokens (List[SubscriptionTokensResponse]): The model
            property of type List[SubscriptionTokensResponse].
    ...
    def from_dictionary(cls,
        ...
        plan = APIHelper.deserialize_union_type(UnionTypeLookUp.get('SubscriptionsResponsePlan'), dictionary.get('plan'), False) if dictionary.get('plan') is not None else APIHelper.SKIP
        statement_entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('SubscriptionsResponseStatementEntity'), dictionary.get('statementEntity'), False) if dictionary.get('statementEntity') is not None else APIHelper.SKIP
        first_txn = APIHelper.deserialize_union_type(UnionTypeLookUp.get('SubscriptionsResponseFirstTxn'), dictionary.get('firstTxn'), False) if dictionary.get('firstTxn') is not None else APIHelper.SKIP
        ...
        if dictionary.get('subscriptionTokens') is not None:
            subscription_tokens = [SubscriptionTokensResponse.from_dictionary(x) for x in dictionary.get('subscriptionTokens')]
        else:
            subscription_tokens = APIHelper.SKIP
