...
class OrgFlowActionsResponse(object):
    ...
    Attributes:
        ...
        modifier (str): The identifier of the Login that last modified this
            resource.
        org_flow (str | OrgFlowsResponse | None): The model property of type
            str | OrgFlowsResponse | None.
    ...
    def from_dictionary(cls,
        ...
        org_flow = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgFlowActionsResponseOrgFlow'), dictionary.get('orgFlow'), False) if dictionary.get('orgFlow') is not None else APIHelper.SKIP
        org = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgFlowActionsResponseOrg'), dictionary.get('org'), False) if dictionary.get('org') is not None else APIHelper.SKIP
