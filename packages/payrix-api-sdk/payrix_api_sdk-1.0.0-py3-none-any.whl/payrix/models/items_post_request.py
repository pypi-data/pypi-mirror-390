...
class ItemsPostRequest(object):
    ...
    Attributes:
        txn (str | TxnsPostRequest): The model property of type str |
            TxnsPostRequest.
    ...
    def from_dictionary(cls,
        ...
        txn = APIHelper.deserialize_union_type(UnionTypeLookUp.get('ItemsPostRequestTxn'), dictionary.get('txn'), False) if dictionary.get('txn') is not None else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return UnionTypeLookUp.get('ItemsPostRequestTxn').validate(dictionary.txn).is_valid \
                and APIHelper.is_valid_type(value=dictionary.item,
                                            type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(value=dictionary.quantity,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.price,
                                            type_callable=lambda value: isinstance(value, int))

        if not isinstance(dictionary, dict):
            return False

        return UnionTypeLookUp.get('ItemsPostRequestTxn').validate(dictionary.get('txn')).is_valid \
            and APIHelper.is_valid_type(value=dictionary.get('item'),
                                        type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(value=dictionary.get('quantity'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('price'),
                                        type_callable=lambda value: isinstance(value, int))
