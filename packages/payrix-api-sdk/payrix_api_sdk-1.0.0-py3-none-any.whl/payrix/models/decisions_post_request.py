...
from payrix.models.watchlists_post_request import WatchlistsPostRequest
...
class DecisionsPostRequest(object):
    ...
    Attributes:
        ...
        frozen (FrozenEnum): Whether this resource is marked as frozen. 
            ...
            - `1` - **Frozen**  </details>
        decision_actions (List[DecisionActionsPostRequest]): The model
            property of type List[DecisionActionsPostRequest].
        decision_rules (List[DecisionRulesPostRequest]): The model property of
            type List[DecisionRulesPostRequest].
        decisions (List[DecisionsPostRequest]): The model property of type
            List[DecisionsPostRequest].
        watchlist (List[WatchlistsPostRequest]): The model property of type
            List[WatchlistsPostRequest].
    ...
    def from_dictionary(cls,
        ...
        org = APIHelper.deserialize_union_type(UnionTypeLookUp.get('DecisionsPostRequestOrg'), dictionary.get('org'), False) if dictionary.get('org') is not None else APIHelper.SKIP
        ...
        if dictionary.get('decisionActions') is not None:
            decision_actions = [DecisionActionsPostRequest.from_dictionary(x) for x in dictionary.get('decisionActions')]
        else:
            decision_actions = APIHelper.SKIP
        decision_rules = None
        if dictionary.get('decisionRules') is not None:
            decision_rules = [DecisionRulesPostRequest.from_dictionary(x) for x in dictionary.get('decisionRules')]
        else:
            decision_rules = APIHelper.SKIP
        decisions = None
        if dictionary.get('decisions') is not None:
            decisions = [DecisionsPostRequest.from_dictionary(x) for x in dictionary.get('decisions')]
        else:
            decisions = APIHelper.SKIP
        watchlist = None
        if dictionary.get('watchlist') is not None:
            watchlist = [WatchlistsPostRequest.from_dictionary(x) for x in dictionary.get('watchlist')]
        else:
            watchlist = APIHelper.SKIP
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.login,
                ...
                and APIHelper.is_valid_type(value=dictionary.application,
                                            type_callable=lambda value: ApplicationEnum.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.level,
                                            type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(value=dictionary.mtype,
                                            type_callable=lambda value: DecisionTypeEnum.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.target,
                                            type_callable=lambda value: TargetEnum.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.action,
                                            type_callable=lambda value: DescisionActionEnum.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.value,
                                            type_callable=lambda value: isinstance(value, str)) \
                and APIHelper.is_valid_type(value=dictionary.period,
                                            type_callable=lambda value: PeriodEnum.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.period_factor,
        ...
        return APIHelper.is_valid_type(value=dictionary.get('login'),
                                       type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(value=dictionary.get('application'),
                                        type_callable=lambda value: ApplicationEnum.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('level'),
                                        type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(value=dictionary.get('type'),
                                        type_callable=lambda value: DecisionTypeEnum.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('target'),
                                        type_callable=lambda value: TargetEnum.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('action'),
                                        type_callable=lambda value: DescisionActionEnum.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('value'),
                                        type_callable=lambda value: isinstance(value, str)) \
            and APIHelper.is_valid_type(value=dictionary.get('period'),
                                        type_callable=lambda value: PeriodEnum.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('periodFactor'),
                                        type_callable=lambda value: isinstance(value, int),
                                        is_value_nullable=True) \
