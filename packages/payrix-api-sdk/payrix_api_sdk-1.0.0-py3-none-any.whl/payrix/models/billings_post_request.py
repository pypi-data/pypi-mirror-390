...
class BillingsPostRequest(object):
    ...
    Attributes:
        ...
        frozen (FrozenEnum): Whether this resource is marked as frozen. 
            ...
            - `1` - **Frozen**  </details>
        billing_events (List[BillingEventsPostRequest]): The model property of
            type List[BillingEventsPostRequest].
        billing_modifiers (List[BillingModifiersPostRequest]): The model
            property of type List[BillingModifiersPostRequest].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('billingEvents') is not None:
            billing_events = [BillingEventsPostRequest.from_dictionary(x) for x in dictionary.get('billingEvents')]
        else:
            billing_events = APIHelper.SKIP
        billing_modifiers = None
        if dictionary.get('billingModifiers') is not None:
            billing_modifiers = [BillingModifiersPostRequest.from_dictionary(x) for x in dictionary.get('billingModifiers')]
        else:
            billing_modifiers = APIHelper.SKIP
