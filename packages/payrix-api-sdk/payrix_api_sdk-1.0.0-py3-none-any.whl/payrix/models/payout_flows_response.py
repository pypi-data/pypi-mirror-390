...
class PayoutFlowsResponse(object):
    ...
    Attributes:
        ...
        login (str | LoginsResponse | None): The model property of type str |
            LoginsResponse | None.
        payout_login (str | LoginsResponse | None): The model property of type
            str | LoginsResponse | None.
    ...
    def from_dictionary(cls,
        ...
        login = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutFlowsResponseLogin'), dictionary.get('login'), False) if dictionary.get('login') is not None else APIHelper.SKIP
        payout_login = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutFlowsResponsePayoutLogin'), dictionary.get('payoutLogin'), False) if dictionary.get('payoutLogin') is not None else APIHelper.SKIP
        org = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutFlowsResponseOrg'), dictionary.get('org'), False) if dictionary.get('org') is not None else APIHelper.SKIP
        division = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutFlowsResponseDivision'), dictionary.get('division'), False) if dictionary.get('division') is not None else APIHelper.SKIP
        partition = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutFlowsResponsePartition'), dictionary.get('partition'), False) if dictionary.get('partition') is not None else APIHelper.SKIP
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutFlowsResponseEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
        billing = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutFlowsResponseBilling'), dictionary.get('billing'), False) if dictionary.get('billing') is not None else APIHelper.SKIP
