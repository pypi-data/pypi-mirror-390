...
class FeeRulesResponse(object):
    ...
    def from_dictionary(cls,
        ...
        fee = APIHelper.deserialize_union_type(UnionTypeLookUp.get('FeeRulesResponseFee'), dictionary.get('fee'), False) if dictionary.get('fee') is not None else APIHelper.SKIP
