...
class BillingModifiersResponse(object):
    ...
    def from_dictionary(cls,
        ...
        billing = APIHelper.deserialize_union_type(UnionTypeLookUp.get('BillingModifiersResponseBilling'), dictionary.get('billing'), False) if dictionary.get('billing') is not None else APIHelper.SKIP
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('BillingModifiersResponseEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
        org = APIHelper.deserialize_union_type(UnionTypeLookUp.get('BillingModifiersResponseOrg'), dictionary.get('org'), False) if dictionary.get('org') is not None else APIHelper.SKIP
        division = APIHelper.deserialize_union_type(UnionTypeLookUp.get('BillingModifiersResponseDivision'), dictionary.get('division'), False) if dictionary.get('division') is not None else APIHelper.SKIP
        partition = APIHelper.deserialize_union_type(UnionTypeLookUp.get('BillingModifiersResponsePartition'), dictionary.get('partition'), False) if dictionary.get('partition') is not None else APIHelper.SKIP
        fromentity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('BillingModifiersResponseFromentity'), dictionary.get('fromentity'), False) if dictionary.get('fromentity') is not None else APIHelper.SKIP
