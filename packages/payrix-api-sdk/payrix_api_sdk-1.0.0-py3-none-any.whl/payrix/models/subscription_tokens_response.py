...
class SubscriptionTokensResponse(object):
    ...
    def from_dictionary(cls,
        ...
        subscription = APIHelper.deserialize_union_type(UnionTypeLookUp.get('SubscriptionTokensResponseSubscription'), dictionary.get('subscription'), False) if dictionary.get('subscription') is not None else APIHelper.SKIP
        token = APIHelper.deserialize_union_type(UnionTypeLookUp.get('SubscriptionTokensResponseToken'), dictionary.get('token'), False) if dictionary.get('token') is not None else APIHelper.SKIP
