...
class PlansResponse(object):
    ...
    def from_dictionary(cls,
        ...
        merchant = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PlansResponseMerchant'), dictionary.get('merchant'), False) if dictionary.get('merchant') is not None else APIHelper.SKIP
        billing = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PlansResponseBilling'), dictionary.get('billing'), False) if dictionary.get('billing') is not None else APIHelper.SKIP
