...
class ChargebackMessageResultResponse(object):
    ...
    def from_dictionary(cls,
        ...
        chargeback_message = APIHelper.deserialize_union_type(UnionTypeLookUp.get('ChargebackMessageResultResponseChargebackMessage'), dictionary.get('chargebackMessage'), False) if dictionary.get('chargebackMessage') is not None else APIHelper.SKIP
