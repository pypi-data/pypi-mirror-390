...
class RevenueBoostsResponse(object):
    ...
    Attributes:
        ...
        deleter (str | None | LoginsResponse): The model property of type str
            | None | LoginsResponse.
    ...
    def from_dictionary(cls,
        ...
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('RevenueBoostsResponseEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
        platform = dictionary.get("platform") if dictionary.get("platform") else APIHelper.SKIP
        org = APIHelper.deserialize_union_type(UnionTypeLookUp.get('RevenueBoostsResponseOrg'), dictionary.get('org'), False) if dictionary.get('org') is not None else APIHelper.SKIP
        division = APIHelper.deserialize_union_type(UnionTypeLookUp.get('RevenueBoostsResponseDivision'), dictionary.get('division'), False) if dictionary.get('division') is not None else APIHelper.SKIP
        partition = APIHelper.deserialize_union_type(UnionTypeLookUp.get('RevenueBoostsResponsePartition'), dictionary.get('partition'), False) if dictionary.get('partition') is not None else APIHelper.SKIP
        ...
        deleter = APIHelper.deserialize_union_type(UnionTypeLookUp.get('RevenueBoostsResponseDeleter'), dictionary.get('deleter'), False) if dictionary.get('deleter') is not None else APIHelper.SKIP
