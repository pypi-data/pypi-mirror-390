...
class BillingEventsResponse(object):
    ...
    def from_dictionary(cls,
        ...
        billing = APIHelper.deserialize_union_type(UnionTypeLookUp.get('BillingEventsResponseBilling'), dictionary.get('billing'), False) if dictionary.get('billing') is not None else APIHelper.SKIP
