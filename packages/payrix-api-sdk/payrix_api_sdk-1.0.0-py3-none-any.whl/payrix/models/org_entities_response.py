...
class OrgEntitiesResponse(object):
    ...
    def from_dictionary(cls,
        ...
        org = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgEntitiesResponseOrg'), dictionary.get('org'), False) if dictionary.get('org') is not None else APIHelper.SKIP
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgEntitiesResponseEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
