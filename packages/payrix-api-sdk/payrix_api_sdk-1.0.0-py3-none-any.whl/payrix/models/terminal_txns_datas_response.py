...
class TerminalTxnsDatasResponse(object):
    ...
    def from_dictionary(cls,
        ...
        terminal_txn = APIHelper.deserialize_union_type(UnionTypeLookUp.get('TerminalTxnsDatasResponseTerminalTxn'), dictionary.get('terminalTxn'), False) if dictionary.get('terminalTxn') is not None else APIHelper.SKIP
