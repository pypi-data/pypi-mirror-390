...
class HostsResponse(object):
    ...
    """Implementation of the 'hostsResponse' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the HostsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get('HostsResponseCreator'), dictionary.get('creator'), False) if dictionary.get('creator') is not None else APIHelper.SKIP
        modifier = dictionary.get("modifier") if dictionary.get("modifier") else APIHelper.SKIP
        partition = APIHelper.deserialize_union_type(UnionTypeLookUp.get('HostsResponsePartition'), dictionary.get('partition'), False) if dictionary.get('partition') is not None else APIHelper.SKIP
        division = APIHelper.deserialize_union_type(UnionTypeLookUp.get('HostsResponseDivision'), dictionary.get('division'), False) if dictionary.get('division') is not None else APIHelper.SKIP
        api = dictionary.get("api") if dictionary.get("api") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'api={(self.api if hasattr(self, "api") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'api={(self.api if hasattr(self, "api") else None)!s}, '
