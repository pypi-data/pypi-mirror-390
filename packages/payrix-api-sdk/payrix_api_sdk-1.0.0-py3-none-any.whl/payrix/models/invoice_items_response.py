...
class InvoiceItemsResponse(object):
    ...
    def from_dictionary(cls,
        ...
        login = APIHelper.deserialize_union_type(UnionTypeLookUp.get('InvoiceItemsResponseLogin'), dictionary.get('login'), False) if dictionary.get('login') is not None else APIHelper.SKIP
