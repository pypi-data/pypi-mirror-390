...
class PayoutsResponse(object):
    ...
    Attributes:
        ...
        payout_flow (str | PayoutFlowsResponse | None): The model property of
            type str | PayoutFlowsResponse | None.
    ...
    def from_dictionary(cls,
        ...
        login = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutsResponseLogin'), dictionary.get('login'), False) if dictionary.get('login') is not None else APIHelper.SKIP
        account = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutsResponseAccount'), dictionary.get('account'), False) if dictionary.get('account') is not None else APIHelper.SKIP
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutsResponseEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
        billing = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutsResponseBilling'), dictionary.get('billing'), False) if dictionary.get('billing') is not None else APIHelper.SKIP
        payout_flow = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PayoutsResponsePayoutFlow'), dictionary.get('payoutFlow'), False) if dictionary.get('payoutFlow') is not None else APIHelper.SKIP
