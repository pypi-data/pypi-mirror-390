...
class EmbeddedFinanceResponse(object):

    """Implementation of the 'embeddedFinanceResponse' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the EmbeddedFinanceResponse class"""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get('EmbeddedFinanceResponseCreator'), dictionary.get('creator'), False) if dictionary.get('creator') is not None else APIHelper.SKIP
        ...
        entity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('EmbeddedFinanceResponseEntity'), dictionary.get('entity'), False) if dictionary.get('entity') is not None else APIHelper.SKIP
