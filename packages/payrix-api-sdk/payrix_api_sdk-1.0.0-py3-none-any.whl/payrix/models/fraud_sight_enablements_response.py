...
class FraudSightEnablementsResponse(object):

    """Implementation of the 'fraudSightEnablementsResponse' model.
    ...
    Attributes:
        ...
        modifier (str): The identifier of the Login that last modified this
            resource.
        entity (str): The identifier of the Entity that is enabled for
            fraudSight.
        org (str): The identifier of the Org (group) that
            fraudSightEnablements is associated to.
        ...
        deleted (str): The date and time at which this resource was
            ...
            YYYY-MM-DD hh:mm:ss format, for example, '2023-06-01 01:00:00' for
            June 01, 2023. 1:00 am.
        deleter (str): The id of user who deleted the fraudSightEnablements.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the FraudSightEnablementsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get('FraudSightEnablementsResponseCreator'), dictionary.get('creator'), False) if dictionary.get('creator') is not None else APIHelper.SKIP
