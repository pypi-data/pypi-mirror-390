...
class OrgsVASFraudSightEnablementsResponse(object):

    """Implementation of the 'orgsVASFraudSightEnablementsResponse' model.
    ...
    def __init__(self,
                 ...
                 inactive=0,
                 frozen=0):
        """Constructor for the OrgsVASFraudSightEnablementsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        creator = APIHelper.deserialize_union_type(UnionTypeLookUp.get('OrgsVASFraudSightEnablementsResponseCreator'), dictionary.get('creator'), False) if dictionary.get('creator') is not None else APIHelper.SKIP
