...
class EntityDebtsController(BaseController):
    ...
    def get_entity_debts_id(self,
        ...
        Returns:
            EntityDebtsResponseResult: Response from the API. Retrieve an
                Entity Debt Response for the query on entityDebts resource.
    ...
    def get_entity_debts(self,
        ...
        Returns:
            EntityDebtsResponseResult: Response from the API. Retrieve an
                Entity Debts Response for the query on entityDebts resource.
