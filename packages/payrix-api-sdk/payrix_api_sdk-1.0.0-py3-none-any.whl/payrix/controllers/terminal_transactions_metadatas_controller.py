...
class TerminalTransactionsMetadatasController(BaseController):
    ...
    def get_terminal_txns_metadatas_id(self,
        ...
        Returns:
            TerminalTxnMetadatasResponseResult: Response from the API.
                Retrieve Terminal Transaction Metadata Response
    ...
    def post_terminal_txns_metadatas(self,
        ...
        Returns:
            TerminalTxnMetadatasResponseResult: Response from the API. Create
