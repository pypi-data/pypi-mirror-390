...
class AlertTriggersController(BaseController):
    ...
    def get_alert_triggers_id(self,
        ...
        Returns:
            AlertTriggersResponseResult: Response from the API. Response for
                retrieve Alert Trigger response.
    ...
    def put_alert_triggers_id(self,
        ...
        Returns:
            AlertTriggersResponseResult: Response from the API. Response for
                update on alertTriggers resource Update Alert Trigger Response
    ...
    def delete_alert_triggers_id(self,
        ...
        Returns:
            AlertTriggersResponseResult: Response from the API. The response
                for deleting an alert trigger on the alertTriggers resource is
                the Delete Alert Trigger Response.
    ...
    def get_alert_triggers(self,
        ...
        Returns:
            AlertTriggersResponseResult: Response from the API. Retrieve the
                Response for query on Alert Triggers.
    ...
    def post_alert_triggers(self,
        ...
        Returns:
            AlertTriggersResponseResult: Response from the API. The create
                operation on the alertTriggers resource successfully creates
                an Alert Trigger, and the response to this request includes
                the created Alert Trigger's details.
