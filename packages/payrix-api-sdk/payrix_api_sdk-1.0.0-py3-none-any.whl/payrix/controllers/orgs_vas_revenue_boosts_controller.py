...
class OrgsVASRevenueBoostsController(BaseController):
    ...
    def get_orgs_vas_revenue_boosts_id(self,
        ...
        Returns:
            OrgsVASRevenueBoostsResponseResult: Response from the API.
                Response for query on orgsVASRevenueBoosts resource
    ...
    def get_orgs_vas_revenue_boosts(self,
        ...
        Returns:
            OrgsVASRevenueBoostsResponseResult: Response from the API.
                Response for querying and retrieving all bank
    ...
    def post_orgs_vas_revenue_boosts(self,
        ...
        Returns:
            OrgsVASRevenueBoostsResponseResult: Response from the API. The
