...
class OrgFlowsController(BaseController):
    ...
    def get_org_flows_id(self,
        ...
        Returns:
            OrgFlowsResponseResult: Response from the API. Retrieve an Org
                Flow Response for query on orgFlows resource.
    ...
    def put_org_flows_id(self,
        ...
        Returns:
            OrgFlowsResponseResult: Response from the API. Update an Org Flow
                Response for orgFlows resource.
    ...
    def delete_org_flows_id(self,
        ...
        Returns:
            OrgFlowsResponseResult: Response from the API. The response for
                deleting an Org Flow resource.
    ...
    def get_org_flows(self,
        ...
        Returns:
            OrgFlowsResponseResult: Response from the API. Response for query
                on orgFlows resource
    ...
    def post_org_flows(self,
        ...
        Returns:
            OrgFlowsResponseResult: Response from the API. Response for create
                on orgFlows resource
