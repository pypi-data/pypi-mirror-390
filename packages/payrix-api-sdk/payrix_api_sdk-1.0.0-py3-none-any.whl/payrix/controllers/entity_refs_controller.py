...
class EntityRefsController(BaseController):
    ...
    def get_entity_refs_id(self,
        ...
        Returns:
            EntityRefsResponseResult: Response from the API. The response for
                retrieving an Entity Reference.
    ...
    def get_entity_refs(self,
        ...
        Returns:
            EntityRefsResponseResult: Response from the API. Response for
                retrieve an Entity References response.
