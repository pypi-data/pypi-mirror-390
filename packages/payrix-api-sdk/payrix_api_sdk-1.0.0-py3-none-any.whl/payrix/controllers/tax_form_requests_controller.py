...
class TaxFormRequestsController(BaseController):
    ...
    def get_tax_form_requests_id(self,
        ...
        Returns:
            TaxFormRequestsResponseResult: Response from the API. Response for
                retrieve Tax Form Requests response.
    ...
    def get_tax_form_requests(self,
        ...
        Returns:
            TaxFormRequestsResponseResult: Response from the API. Response for
                query on taxFormRequests resource
    ...
    def post_tax_form_requests(self,
        ...
        Returns:
            TaxFormRequestsResponseResult: Response from the API. Response for
                create on taxFormRequests resource
