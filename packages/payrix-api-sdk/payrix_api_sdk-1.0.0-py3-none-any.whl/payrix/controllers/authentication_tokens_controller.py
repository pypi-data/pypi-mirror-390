...
class AuthenticationTokensController(BaseController):
    ...
    def get_auth_tokens_id(self,
        ...
        Returns:
            AuthTokensResponseResult: Response from the API. The response for
                retrieve authentication token response.
    ...
    def put_auth_tokens_id(self,
        ...
        Returns:
            AuthTokensResponseResult: Response from the API. Response for
                update on authTokens resource Update Authentication Token
                Response
    ...
    def post_auth_tokens(self,
        ...
        Returns:
            AuthTokensResponseResult: Response from the API. The Response for
                creating an authentication token on the authTokens resource is
                a Create Authentication Token Response.
