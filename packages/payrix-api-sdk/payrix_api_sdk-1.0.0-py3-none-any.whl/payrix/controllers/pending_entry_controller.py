...
class PendingEntryController(BaseController):
    ...
    def get_pending_entries_id(self,
        ...
        Returns:
            PendingEntriesResponseResult: Response from the API. Retrieve the
                Response for the Query on the Pending Entries Resource.
    ...
    def get_pending_entries(self,
        ...
        Returns:
            PendingEntriesResponseResult: Response from the API. Retrieve
