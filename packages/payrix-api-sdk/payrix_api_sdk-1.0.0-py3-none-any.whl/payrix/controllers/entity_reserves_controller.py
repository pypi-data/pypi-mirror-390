...
class EntityReservesController(BaseController):
    ...
    def get_entity_reserves_id(self,
        ...
        Returns:
            EntityReservesResponseResult: Response from the API. Retrieve an
                Entity Reserve Response for query on entityReserves resource.
    ...
    def put_entity_reserves_id(self,
        ...
        Returns:
            EntityReservesResponseResult: Response from the API. Response for
                updating an Entity Reserve.
    ...
    def get_entity_reserves(self,
        ...
        Returns:
            EntityReservesResponseResult: Response from the API. Retrieve an
                Entity Reserves Response for the query on entityReserves
                resource.
    ...
    def post_entity_reserves(self,
        ...
        Returns:
            EntityReservesResponseResult: Response from the API. Response for
                create on entityReserves resource
