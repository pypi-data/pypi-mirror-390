...
class EntityReturnsController(BaseController):
    ...
    def get_entity_returns_id(self,
        ...
        Returns:
            EntityReturnsResponseResult: Response from the API. Retrieve an
                Entity Returns Response for query on entity.
    ...
    def get_entity_returns(self,
        ...
        Returns:
            EntityReturnsResponseResult: Response from the API. Response for
                query on entityReturns resource
