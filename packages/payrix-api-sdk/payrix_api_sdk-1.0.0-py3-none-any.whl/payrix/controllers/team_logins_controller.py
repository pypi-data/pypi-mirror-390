...
class TeamLoginsController(BaseController):
    ...
    def get_team_logins_id(self,
        ...
        Returns:
            TeamLoginResponseResult: Response from the API. Retrieve the
                Response for the query on the Team Logins resource.
    ...
    def put_team_logins_id(self,
        ...
        Returns:
            TeamLoginResponseResult: Response from the API. Response for
                update on Team Login Update Team Login Response.
    ...
    def get_team_logins(self,
        ...
        Returns:
            TeamLoginResponseResult: Response from the API. Response for query
                on teamLogins resource
