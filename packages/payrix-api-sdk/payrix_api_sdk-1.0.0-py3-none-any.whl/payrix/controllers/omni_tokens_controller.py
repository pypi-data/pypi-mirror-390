...
class OmniTokensController(BaseController):
    ...
    def get_omni_tokens_id(self,
        ...
        Returns:
            OmniTokensResponseResult: Response from the API. Response for
                retrieving OmniToken response.
