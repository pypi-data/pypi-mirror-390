...
class RevenueBoostsController(BaseController):
    ...
    def get_revenue_boosts_id(self,
        ...
        Returns:
            RevenueBoostsResponseResult: Response from the API. Response for
                query on revenueBoost resource
    ...
    def get_revenue_boosts(self,
        ...
        Returns:
            RevenueBoostsResponseResult: Response from the API. Response for
                querying and retrieving all revenueBoosts.
    ...
    def post_revenue_boosts(self,
        ...
        Returns:
            RevenueBoostsResponseResult: Response from the API. The response
                for creating revenueBoost on the revenueBoosts resource.
