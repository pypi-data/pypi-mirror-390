...
class ProfitShareRulesController(BaseController):
    ...
    def get_profit_share_rules_id(self,
        ...
        Returns:
            ProfitShareRulesResponseResult: Response from the API. Retrieve
    ...
    def put_profit_share_rules_id(self,
        ...
        Returns:
            ProfitShareRulesResponseResult: Response from the API. Response
    ...
    def delete_profit_share_rules_id(self,
        ...
        Returns:
            ProfitShareRulesResponseResult: Response from the API. The
