...
class FeeModifiersController(BaseController):
    ...
    def get_fee_modifiers_id(self,
        ...
        Returns:
            FeeModifiersResponseResult: Response from the API. Retrieve Fee
                Modifier Response for query on feeModifiers resource.
    ...
    def put_fee_modifiers_id(self,
        ...
        Returns:
            FeeModifiersResponseResult: Response from the API. Response for
                update on FeeModifiers resource: Update Fee Modifier Response
    ...
    def delete_fee_modifiers_id(self,
        ...
        Returns:
            FeeModifiersResponseResult: Response from the API. Response for
                delete on FeeModifiers response.
    ...
    def get_fee_modifiers(self,
        ...
        Returns:
            FeeModifiersResponseResult: Response from the API. Response for
                query on feeModifiers resource
    ...
    def post_fee_modifiers(self,
        ...
        Returns:
            FeeModifiersResponseResult: Response from the API. Response for
                create on feeModifiers resource
