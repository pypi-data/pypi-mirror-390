...
class OrgsVASEfeProductsController(BaseController):
    ...
    def get_orgs_vas_efe_products_id(self,
        ...
        Returns:
            OrgsVASEfeProductsResponseResult: Response from the API. Response
    ...
    def put_orgs_vas_efe_products_id(self,
        ...
        Returns:
            OrgsVASEfeProductsResponseResult: Response from the API. The
    ...
    def delete_orgs_vas_efe_products_id(self,
        ...
        Returns:
            OrgsVASEfeProductsResponseResult: Response from the API. A
                successful deletion
