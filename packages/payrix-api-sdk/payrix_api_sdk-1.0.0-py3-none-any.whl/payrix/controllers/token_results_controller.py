...
class TokenResultsController(BaseController):
    ...
    def get_token_results_id(self,
        ...
        Returns:
            TokenResultsResponseResult: Response from the API. Retrieve Token
                Results for query on tokenResults. resource.
    ...
    def get_token_results(self,
        ...
        Returns:
            TokenResultsResponseResult: Response from the API. Response for
                query on tokenResults resource.
