...
class BinsController(BaseController):
    ...
    def get_bins_id(self,
        ...
        Returns:
            BinsResponseResult: Response from the API. Retrieve BIN Response
                for query on bins resource.
    ...
    def get_bins(self,
        ...
        Returns:
            BinsResponseResult: Response from the API. Retrieve the Response
                for query on BINS resource.
