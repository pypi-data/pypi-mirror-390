...
class AccountsVerificationsController(BaseController):
    ...
    def get_account_verifications_id(self,
        ...
        Returns:
            AccountVerificationsResponseResult: Response from the API.
                Retrieve the Response for query on accountVerifications
                resource.
    ...
    def get_account_verifications(self,
        ...
        Returns:
            AccountVerificationsResponseResult: Response from the API.
                Response for querying the accountVerifications resource to
                retrieve account verifications.
