...
class MerchantPlatformStatusesController(BaseController):
    ...
    def get_merchant_platform_statuses_id(self,
        ...
        Returns:
            MerchantPlatformStatusesResponseResult: Response from the API.
                Retrieve Merchant Platform Statuses Response for query on
    ...
    def get_merchant_platform_statuses(self,
        ...
        Returns:
            MerchantPlatformStatusesResponseResult: Response from the API.
                Response for query on merchantPlatformStatuses resource
