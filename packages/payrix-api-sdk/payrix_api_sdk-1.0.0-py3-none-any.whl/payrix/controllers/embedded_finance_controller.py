...
class EmbeddedFinanceController(BaseController):
    ...
    def get_embedded_finance_id(self,
        ...
        Returns:
            EmbeddedFinanceResponseResult: Response from the API. Retrieve
    ...
    def put_embedded_finance_id(self,
        ...
        Returns:
            EmbeddedFinanceResponseResult: Response from the API. Response for
                update on embeddedFinance resource Update embeddedFinance
                Response
    ...
    def post_embedded_finance(self,
        ...
        Returns:
            EmbeddedFinanceResponseResult: Response from the API. Create
