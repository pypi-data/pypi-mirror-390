...
class AggregationsController(BaseController):
    ...
    def get_aggregations_id(self,
        ...
        Returns:
            AggregationsResponseResult: Response from the API. Retrieve
    ...
    def put_aggregations_id(self,
        ...
        Returns:
            AggregationsResponseResult: Response from the API. Response for
                update on aggregations resource Update Aggregation Response
    ...
    def delete_aggregations_id(self,
        ...
        Returns:
            AggregationsResponseResult: Response from the API. Response for
                delete on aggregations resource: Delete Aggregation Response
    ...
    def post_aggregations(self,
        ...
        Returns:
            AggregationsResponseResult: Response from the API. Response for
                creating an aggregation resource. Create Aggregation Response.
