...
class EntryOriginController(BaseController):
    ...
    def get_entry_origins_id(self,
        ...
        Returns:
            EntryOriginsResponseResult: Response from the API. Retrieve Entry
                Origin Response for query on entryOrigins resource.
    ...
    def get_entry_origins(self,
        ...
        Returns:
            EntryOriginsResponseResult: Response from the API. Response for
                query on entryOrigins resource
