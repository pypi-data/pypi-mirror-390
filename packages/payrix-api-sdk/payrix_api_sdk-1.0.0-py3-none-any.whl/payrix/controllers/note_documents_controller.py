...
class NoteDocumentsController(BaseController):
    ...
    def get_note_documents_id(self,
        ...
        Returns:
            NoteDocumentsResponseResult: Response from the API. Response for
                retrieve note document response.
    ...
    def put_note_documents_id(self,
        ...
        Returns:
            NoteDocumentsResponseResult: Response from the API. Response for
                update on noteDocuments resource: Update Note Document Response
    ...
    def delete_note_documents_id(self,
        ...
        Returns:
            NoteDocumentsResponseResult: Response from the API. The response
                for deleting a note document on the noteDocuments resource is
                the Delete Note Document Response.
    ...
    def get_note_documents(self,
        ...
        Returns:
            NoteDocumentsResponseResult: Response from the API. Response for
                query on noteDocuments resource
    ...
    def post_note_documents(self,
        ...
        Returns:
            NoteDocumentsResponseResult: Response from the API. The response
                for creating a note document on the noteDocuments resource.
