...
class FeeRulesController(BaseController):
    ...
    def get_fee_rules_id(self,
        ...
        Returns:
            FeeRulesResponseResult: Response from the API. Retrieve Fee Rule
                Response for query on feeRules resource.
    ...
    def put_fee_rules_id(self,
        ...
        Returns:
            FeeRulesResponseResult: Response from the API. Response for update
                on feeRules resource: Update a Fee Rule Response
    ...
    def delete_fee_rules_id(self,
        ...
        Returns:
            FeeRulesResponseResult: Response from the API. Delete Fee Rule
                Response for the feeRules resource.
    ...
    def get_fee_rules(self,
        ...
        Returns:
            FeeRulesResponseResult: Response from the API. Response for query
                on feeRules resource
    ...
    def post_fee_rules(self,
        ...
        Returns:
            FeeRulesResponseResult: Response from the API. Response for create
                on feeRules resource
