...
class DisbursementsController(BaseController):
    ...
    def get_disbursements_id(self,
        ...
        Returns:
            DisbursementsResponseResult: Response from the API. Retrieve the
                Response for the query on the Disbursements resource.
    ...
    def get_disbursements(self,
        ...
        Returns:
            DisbursementsResponseResult: Response from the API. Retrieve the
                Disbursements Response for query on disbursements resource.
