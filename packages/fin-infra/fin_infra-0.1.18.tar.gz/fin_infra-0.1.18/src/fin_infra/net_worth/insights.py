...
class WealthTrendAnalysis(BaseModel):
    ...
    summary: str = Field(
        ...,
        description="1-2 sentence trend summary with specific numbers"
    )
    period: str = Field(
        ...,
        description="Time period analyzed (e.g., '6 months', '1 year')"
    )
    change_amount: float = Field(
        ...,
        description="Net worth change in USD (can be negative)"
    )
    change_percent: float = Field(
        ...,
        description="Percentage change (0.15 = 15%)"
    )
    primary_drivers: list[str] = Field(
        ...,
        max_length=5,
        description="Top 5 drivers of net worth change (specific amounts)"
    )
    risk_factors: list[str] = Field(
        ...,
        max_length=3,
        description="Top 3 financial risk factors to monitor"
    )
    recommendations: list[str] = Field(
        ...,
        max_length=5,
        description="Actionable recommendations (be specific)"
    )
...
class DebtReductionPlan(BaseModel):
    ...
    summary: str = Field(
        ...,
        description="1-2 sentence strategy overview with key numbers"
    )
    ...
    estimated_payoff_months: int = Field(
        ...,
    ...
    recommendations: list[str] = Field(
        ...,
        max_length=5,
        description="Actionable debt reduction recommendations"
    )
...
class AlternativePath(BaseModel):
    ...
    investment_return_required: float = Field(
        ...,
        description="Required annual return (0.07 = 7%)"
    )
...
class GoalRecommendation(BaseModel):
    ...
    goal_type: str = Field(
        ...,
        description="retirement|home_purchase|debt_free|wealth_milestone"
    )
    ...
    alternative_paths: list[AlternativePath] = Field(
        ...,
        max_length=3,
        description="Up to 3 alternative approaches"
    )
    feasibility: str = Field(
        ...,
        description="feasible|challenging|unrealistic"
    )
    recommendations: list[str] = Field(
        ...,
        max_length=5,
...
class AssetAllocationAdvice(BaseModel):
    ...
    rebalancing_steps: list[str] = Field(
        ...,
        max_length=5,
        description="Specific rebalancing actions"
    )
    expected_return: float = Field(
        ...,
        description="Expected annual return (0.07 = 7%)"
    )
    expected_volatility: float = Field(
        ...,
        description="Expected annual volatility (std dev)"
    )
...
class NetWorthInsightsGenerator:
    ...
    async def generate_wealth_trends(
        ...
        change_percent = (
            change_amount / previous["total_net_worth"]
