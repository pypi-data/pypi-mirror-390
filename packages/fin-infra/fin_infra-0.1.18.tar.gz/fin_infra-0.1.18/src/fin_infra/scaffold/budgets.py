...
def scaffold_budgets_core(
    ...
    schemas_content = render_template("fin_infra.budgets.scaffold_templates", "schemas.py.tmpl", subs)
    ...
    if with_repository:
        repo_content = render_template("fin_infra.budgets.scaffold_templates", "repository.py.tmpl", subs)
