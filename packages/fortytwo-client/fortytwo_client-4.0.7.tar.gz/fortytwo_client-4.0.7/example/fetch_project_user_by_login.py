...
def main() -> None:
    ...
    project_users = client.project_users.get_by_user_id(
        users[0].id,
        page_size=1,
    )

    if not project_users:
        print("No project_users found for this user.")

    print(json.dumps(project_users, default=default_serializer, indent=4))
