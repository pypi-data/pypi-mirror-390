...
def main() -> None:
    ...
    campus_users = client.campus_users.get_by_user_id(
        users[0].id,
        page_size=10,
    )
    if not campus_users:
        print("No campus_users found for this user.")

    print(json.dumps(campus_users, default=default_serializer, indent=4))
