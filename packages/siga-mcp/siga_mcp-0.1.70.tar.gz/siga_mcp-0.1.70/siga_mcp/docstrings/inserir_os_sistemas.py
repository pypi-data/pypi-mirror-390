...
def docs() -> str:
    return f"""
        ...
        Args:
            ...
            matSolicitante: [OBRIGATÓRIO] Matrícula do usuário que está solicitando a OS.
            ...
            sistema: Sistema relacionado a OS, deve ser um dos valores válidos.
            equipe: Equipe responsável pela OS.
            linguagem: Linguagem/tecnologia da OS, deve ser um dos valores válidos.
