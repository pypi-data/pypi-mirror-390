...
async def concluir_os_siga_ia(
    codigo_os: str | int,
    tipo_conclusao: Literal["Concluída", "Concluída por Encaminhamento", "Concluída por substituição"] = "Concluída",
) -> str:
    """
...
async def cancelar_os_siga_ia(
    codigo_os: str | int,
    tipo_cancelamento: Literal["Cancelada-Usuário", "Cancelamento DTD | Arquivado"] = "Cancelada-Usuário",
) -> str:
    """
