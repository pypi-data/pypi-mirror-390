...
class TestWIFConversions:
    ...
    def test_wif_to_private_key_known_values(self):
        ...
        expected = bytes.fromhex('0c28fca386c7a227600b2fe50b7cae11ec86d3bf1fbe471be89827e19d72aa1d')
    ...
    def test_wif_multiple_formats(self):
        ...
        # Litecoin mainnet
        wif_ltc = private_key_to_wif(private_key_bytes, compressed=True, network='litecoin')
