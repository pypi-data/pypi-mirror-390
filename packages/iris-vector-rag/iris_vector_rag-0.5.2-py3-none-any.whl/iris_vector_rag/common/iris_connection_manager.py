...
class IRISConnectionManager:
    ...
    def _get_dbapi_connection(self, config: Optional[Dict[str, Any]] = None) -> Any:
        ...
        try:
            ...
            logger.debug("Successfully imported intersystems_iris.dbapi._DBAPI.connect")

            # Get connection parameters
            conn_params = self._get_connection_params(config)

            # Create an IRIS connection using the correct DBAPI method
            connection = iris_connect(
