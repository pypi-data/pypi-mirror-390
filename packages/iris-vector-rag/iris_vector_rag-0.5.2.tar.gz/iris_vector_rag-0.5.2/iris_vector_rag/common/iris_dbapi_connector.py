...
def get_iris_dbapi_connection():
    ...
    Uses the correct intersystems_iris.dbapi._DBAPI.connect() method.
    ...
    Returns:
        An IRIS DBAPI connection object or None if connection fails.
    """
    # Use correct DBAPI import
    try:
        ...
        logger.error("Install with: pip install intersystems-irispython")
        return None
    ...
    for attempt in range(max_retries):
        try:
            ...
            # Use correct DBAPI connect with keyword arguments
            conn = iris_connect(
                hostname=host,
                port=port,
                namespace=namespace,
