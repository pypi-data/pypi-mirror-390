...
#ifndef GLM_PRIMAL_SPARSE_LOGISTIC_REGRESSION
#define GLM_PRIMAL_SPARSE_LOGISTIC_REGRESSION
...
// Primal L_1 regularized Logistic Regresion
class PrimalSparseLogisticRegression : public Objective {
...
public:
    ...
    PrimalSparseLogisticRegression(double lambda, double w_pos, double w_neg)
    {
    ...
    {
        return 0.000001; // avoide den-0 in solver
    }
...
template <> struct is_primal<PrimalSparseLogisticRegression> {
    static const bool value = true;
};

template <> struct is_sparse<PrimalSparseLogisticRegression> {
    static const bool value = true;
};
