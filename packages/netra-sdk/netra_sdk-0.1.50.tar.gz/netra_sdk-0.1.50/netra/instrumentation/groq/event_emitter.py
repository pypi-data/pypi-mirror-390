...
@dont_throw
def emit_choice_events(response: ChatCompletion, event_logger: Optional[EventLogger]) -> None:
...
def emit_streaming_response_events(
    accumulated_content: str, finish_reason: Union[str, None], event_logger: Optional[EventLogger]
) -> None:
