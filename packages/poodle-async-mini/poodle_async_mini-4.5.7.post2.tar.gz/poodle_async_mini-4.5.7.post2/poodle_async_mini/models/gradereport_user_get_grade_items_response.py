...
"""
    ...
    The version of the OpenAPI document: 4.5.7 (Build: 20251006)
...
class GradereportUserGetGradeItemsResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GradereportUserGetGradeItemsResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in usergrades (list)
        _items = []
        if self.usergrades:
            for _item_usergrades in self.usergrades:
                if _item_usergrades:
                    _items.append(_item_usergrades.to_dict())
            _dict['usergrades'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GradereportUserGetGradeItemsResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "GradereportUserGetGradeItemsResponse" in settings.relaxed_models
