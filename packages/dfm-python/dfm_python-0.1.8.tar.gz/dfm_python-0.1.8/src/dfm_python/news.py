...
def _check_config_consistency(saved_config: Any, current_config: DFMConfig) -> None:
    ...
    try:
        ...
        saved_ids = saved_config.get_series_ids() if hasattr(saved_config, 'get_series_ids') else (saved_config.SeriesID if hasattr(saved_config, 'SeriesID') else [])
        current_ids = current_config.get_series_ids() if hasattr(current_config, 'get_series_ids') else (current_config.SeriesID if hasattr(current_config, 'SeriesID') else [])
...
def update_nowcast(X_old: np.ndarray, X_new: np.ndarray, Time: pd.DatetimeIndex,
    ...
    series_ids = config.get_series_ids() if hasattr(config, 'get_series_ids') else (config.SeriesID if hasattr(config, 'SeriesID') else [])
    if not series_ids:
    ...
    try:
        ...
        frequencies = config.get_frequencies() if hasattr(config, 'get_frequencies') else (config.Frequency if hasattr(config, 'Frequency') else [])
    ...
    series_names = config.get_series_names() if hasattr(config, 'get_series_names') else (config.SeriesName if hasattr(config, 'SeriesName') else [])
    frequencies = config.get_frequencies() if hasattr(config, 'get_frequencies') else (config.Frequency if hasattr(config, 'Frequency') else [])
