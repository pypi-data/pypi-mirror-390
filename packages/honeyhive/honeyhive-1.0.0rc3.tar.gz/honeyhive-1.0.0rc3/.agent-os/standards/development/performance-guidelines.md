# Performance Guidelines - HoneyHive Python SDK

**🎯 MISSION: Ensure optimal performance through profiling, optimization, and monitoring best practices**
...
- **[Testing Standards](testing-standards.md)** - Performance testing requirements
- **[Architecture Patterns](../coding/architecture-patterns.md)** - Performance-aware architecture
- **[Development Workflow](git-workflow.md)** - Performance validation in CI/CD

---

**📝 Next Steps**: Review [Testing Standards](testing-standards.md) for performance testing requirements.
