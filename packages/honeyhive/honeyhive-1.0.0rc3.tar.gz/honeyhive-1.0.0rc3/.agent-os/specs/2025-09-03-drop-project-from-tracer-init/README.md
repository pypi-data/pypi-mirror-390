...
- `.agent-os/specs/2025-09-03-ai-assistant-quality-framework/` - Quality standards
- `.agent-os/product/decisions.md` - Multi-instance architecture decisions
- `.agent-os/product/features.md` - Current feature set and usage patterns
