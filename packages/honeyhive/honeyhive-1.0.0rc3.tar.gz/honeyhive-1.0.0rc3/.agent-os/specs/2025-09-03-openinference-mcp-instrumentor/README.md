...
- `.agent-os/product/decisions.md` - BYOI architecture decisions
- `.agent-os/standards/tech-stack.md` - Integration standards
- `.agent-os/product/features.md` - Feature catalog
