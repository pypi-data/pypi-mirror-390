...
│  - 198 markdown files in .agent-os/                     │
│  - Indexed and chunked                                  │
...
class AgentOSVectorStore:
    ...
    def __init__(self, persist_directory: str = ".agent-os/.cache/chroma"):
    ...
    def register_tools(self):
        ...
        async def get_framework(
            ...
            if detail_level == "summary":
                ...
                file_map = {
                    "test_v2": ".agent-os/standards/ai-assistant/code-generation/tests/v2/framework-core.md",
                    "production_v2": ".agent-os/standards/ai-assistant/code-generation/production/v2/framework-core.md"
                }
...
1. **search_standards(query, n_results, category)**
   - Semantic search over all Agent OS content
   - Use when: Uncertain, need guidance, exploring requirements
   - Example: search_standards("test generation requirements", 5, "testing")
...
```bash
# Goals:
- Chunk and index .agent-os/ content
