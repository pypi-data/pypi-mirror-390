...
@self.server.tool()
@trace(event_type=EventType.tool)
async def search_standards(query, n_results, filter_phase, filter_tags):
    enrich_span({
        "mcp.tool": "search_standards",
        "mcp.query": query,
...
1. `.agent-os/mcp_servers/chunker.py` - Markdown chunking (516 lines)
2. `.agent-os/mcp_servers/rag_engine.py` - Semantic search (450 lines)
3. `.agent-os/mcp_servers/models.py` - Data models (350 lines)
4. `.agent-os/mcp_servers/state_manager.py` - State persistence (400 lines)
5. `.agent-os/mcp_servers/workflow_engine.py` - Phase gating (600 lines)
6. `.agent-os/mcp_servers/agent_os_rag.py` - MCP server (500 lines)
7. `.agent-os/scripts/build_rag_index.py` - Index builder (300 lines)
8. `.agent-os/scripts/validate_rag.py` - RAG validator (250 lines)
9. `.agent-os/scripts/benchmark_rag.py` - Benchmarks (350 lines)
10. `.agent-os/mcp_servers/README.md` - User docs (600 lines)
11. `.agent-os/mcp_servers/__init__.py` - Package init
12. `.agent-os/scripts/__init__.py` - Package init
13. `.agent-os/mcp_servers/requirements.txt` - Dependencies
