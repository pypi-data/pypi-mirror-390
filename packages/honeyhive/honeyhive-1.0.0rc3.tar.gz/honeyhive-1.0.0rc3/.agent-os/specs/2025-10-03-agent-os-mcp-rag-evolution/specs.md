...
async def search_standards(
    ...
    Examples:
        ...
        search_standards("Phase 1 method verification requirements", filter_phase=1)
        
        # Get mocking guidance
        search_standards("how to determine mocking boundaries", filter_tags=["mocking"])
        
        # General query
        search_standards("quality targets for test generation")
    """
```
...
# Added lines:
.agent-os/.cache/
.agent-os/mcp_servers/__pycache__/
```

### 5.2 Modified Files

```
.agent-os/mcp_servers/requirements.txt
# Added:
chromadb>=0.4.0
mcp>=1.0.0
...
// .cursor/mcp_servers.json
{
  "mcpServers": {
    "agent-os-rag": {
      "command": "python",
      "args": [
        ".agent-os/mcp_servers/agent_os_rag.py"
      ],
      "env": {
        "AGENT_OS_INDEX_PATH": ".agent-os/.cache/vector_index",
        "AGENT_OS_STATE_PATH": ".agent-os/.cache/state",
        "AGENT_OS_STANDARDS_PATH": ".agent-os/standards",
...
CONFIG = {
    "index_path": os.getenv("AGENT_OS_INDEX_PATH", ".agent-os/.cache/vector_index"),
    "state_path": os.getenv("AGENT_OS_STATE_PATH", ".agent-os/.cache/state"),
    "standards_path": os.getenv("AGENT_OS_STANDARDS_PATH", ".agent-os/standards"),
...
first_run_flow = {
    ...
    "step_2": {
        "action": "Build vector index from .agent-os/standards/",
        "duration": "45-60 seconds",
        "output": ".agent-os/.cache/vector_index/"
    },
