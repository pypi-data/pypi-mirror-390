...
**File:** `.agent-os/mcp_servers/chunker.py`
...
**File:** `.agent-os/scripts/build_rag_index.py`
...
**Acceptance:**
- Josh runs: `python .agent-os/scripts/build_rag_index.py`
- Builds in < 60 seconds
- Creates `.agent-os/.cache/vector_index/` directory
...
```python
# .agent-os/mcp_servers/workflow_engine.py
