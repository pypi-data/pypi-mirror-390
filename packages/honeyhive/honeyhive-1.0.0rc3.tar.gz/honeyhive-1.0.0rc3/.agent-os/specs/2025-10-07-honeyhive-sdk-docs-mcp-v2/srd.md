...
- **Original Spec:** `.agent-os/specs/2025-10-04-honeyhive-sdk-docs-mcp/`
...
```python
# .agent-os/config.json (user editable)
{
  "docs_mcp": {
...
- **Configuration**: `.agent-os/config.json` (single source of truth)
...
**Related Documents:**
- Original V1 Spec: `.agent-os/specs/2025-10-04-honeyhive-sdk-docs-mcp/`
