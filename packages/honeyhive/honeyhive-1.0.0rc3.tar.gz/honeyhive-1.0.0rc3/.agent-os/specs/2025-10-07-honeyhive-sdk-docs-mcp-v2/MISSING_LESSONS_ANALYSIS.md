...
**New Pattern:**
```json
# .agent-os/config.json (for docs MCP)
{
  "docs_mcp": {
...
- **agent-os-enhanced MCP Server Modular Redesign Spec**: `/Users/josh/src/github.com/honeyhiveai/agent-os-enhanced/.agent-os/specs/2025-10-07-mcp-server-modular-redesign/`
...
- **Agent OS Production Standards**: `.agent-os/standards/ai-assistant/code-generation/production/`
