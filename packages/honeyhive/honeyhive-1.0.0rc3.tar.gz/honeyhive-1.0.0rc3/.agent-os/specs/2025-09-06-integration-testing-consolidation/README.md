...
- **`.agent-os/standards/best-practices.md`**: Development practices and Agent OS spec standards
- **`.agent-os/standards/tech-stack.md`**: Technology choices and requirements
- **`.agent-os/standards/code-style.md`**: Coding standards and formatting rules
