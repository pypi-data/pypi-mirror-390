...
**Agent OS Standards**:
- `.agent-os/standards/best-practices.md` - Updated with comprehensive testing strategy
- `.agent-os/README.md` - Added critical rule about documentation testing
...
- `.agent-os/specs/2025-09-03-ai-assistant-quality-framework/` - AI assistant quality requirements
