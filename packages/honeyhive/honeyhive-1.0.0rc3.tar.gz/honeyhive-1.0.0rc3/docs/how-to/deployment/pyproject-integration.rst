...
.. code-block:: toml
   ...
   python = "^3.11"
   honeyhive = {extras = ["openai", "anthropic"], version = "^0.1.0"}
   fastapi = "^0.100.0"
...
.. code-block:: text
   ...
   honeyhive[openai,anthropic]>=0.1.0
   fastapi>=0.100.0
   uvicorn>=0.20.0
...
.. code-block:: toml
   ...
   [packages]
   honeyhive = {extras = ["openai"], version = "*"}
   fastapi = "*"
...
.. code-block:: toml
   ...
   [project.optional-dependencies]
   dev = ["honeyhive[openai,anthropic]"]  # More providers for testing
