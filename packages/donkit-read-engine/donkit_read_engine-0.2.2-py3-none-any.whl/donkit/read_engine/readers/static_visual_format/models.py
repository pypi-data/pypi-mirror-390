...
DEFAULT_PROMPT: str = "Analyze the image and extract objective information."
...
class LLMImageAnalysisService(ImageAnalysisService):
    ...
    def __init__(
        ...
        *,
        ...
        self.model = self._create_llm_from_env()
    ...
    def _create_llm_from_env(cls) -> LLMModelAbstract:
        ...
        model_name = os.getenv("RAGOPS_LLM_MODEL")
        ...
        raise ValueError(
            ...
            "variable to 'openai' or 'vertex' or 'azure_openai'"
        )
