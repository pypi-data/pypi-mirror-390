...
class GetWorkerEventsV2Response(BaseModel):
    ...
    """ # noqa: E501
    events: Optional[List[WorkerConversationEvent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [WorkerConversationEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
