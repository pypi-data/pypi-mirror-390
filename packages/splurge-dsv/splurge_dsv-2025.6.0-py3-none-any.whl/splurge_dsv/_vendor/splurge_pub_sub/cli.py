"""Command-line interface for the Splurge Pub-Sub framework.
...
def main(args: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="splurge-pub-sub",
        description="Splurge Pub-Sub - Python pub-sub framework",
    )
    ...
    parser.add_argument(
        "--version",
        action="version",
        version=f"splurge-pub-sub {__version__}",
    )
