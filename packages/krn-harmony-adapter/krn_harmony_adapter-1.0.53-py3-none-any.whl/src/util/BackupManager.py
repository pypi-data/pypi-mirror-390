...
from util.merge.CodeMergerPro import CodeMergerPro
        ...
        for original_path, backup_path in harmony_files.items():
            try:
                ...
                if os.path.exists(backup_path) and os.path.exists(full_original_path):
                    ...
                    print(f"⚠️ 恢复harmony文件，需要手动保留最新代码: {os.path.relpath(full_original_path, module_path)}")
