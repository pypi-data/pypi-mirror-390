...
const_twopi = 2.0 * const_pi
const_fourpi = 4.0 * const_pi
...
barssc0 = k_B / m_p / c**2
kappa = 8.0 * const_pi * G
a_rad = 8.0 * const_pi**5 * k_B**4 / 15 / c**3 / h_p**3

compton_cT = MPc_in_sec * (8.0 / 3.0) * (sigma_thomson / (m_e * c)) * a_rad
