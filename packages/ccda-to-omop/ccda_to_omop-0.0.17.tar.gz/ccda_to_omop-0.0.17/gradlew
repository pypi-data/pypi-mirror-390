...
then
    ...
    export ORG_GRADLE_PROJECT_mavenProxyRepoUri="${ORG_GRADLE_PROJECT_artifactsUri}/legacy/mrp/authz/all"
    wrapperAuthGradleOptions="-Dgradle.wrapperUser=${GIT_REMOTE_USERNAME} -Dgradle.wrapperPassword=${ORG_GRADLE_PROJECT_bearerToken}"
