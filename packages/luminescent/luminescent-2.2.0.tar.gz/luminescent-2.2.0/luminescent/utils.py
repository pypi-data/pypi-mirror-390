...
def View(field, prop="epsilon", x="halfway", y="halfway", z="halfway", saturation=1.0):
    """
    ...
    - field: eg 'Ey'
    - prop: eg 'epsilon'
    - x: num, 'halfway' or None
    - y:
    - z:
    - saturation: color saturation
    """
    return {"field": field, "prop": prop, "slices": [x, y, z], "saturation": saturation}
