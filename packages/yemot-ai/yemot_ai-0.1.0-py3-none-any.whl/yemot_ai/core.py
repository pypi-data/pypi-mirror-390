...
class YemotAI:
    ...
    def __init__(
        ...
        **provider_kwargs
        ...
        logger.info(f"יצירת YemotAI עם ספק {type(self.provider).__name__}")
...
def create_ai_manager(provider_type: str = "codex", **kwargs) -> YemotAI:
    """
    ...
    Returns:
        מנהל YemotAI מוכן לשימוש
    """
    return YemotAI(provider_type=provider_type, **kwargs)


def handle_yemot_hangup(ai_manager: YemotAI, params: Dict[str, Any]) -> None:
    """
