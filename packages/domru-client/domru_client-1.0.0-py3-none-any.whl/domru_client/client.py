...
class DomRuClient:
    ...
    def _extract_auth_code_from_redirect(resp) -> str:
    ...
    def _validate_access_token(self) -> None:
        ...
        if not self.authorization.access_token:
            raise AuthenticationError("The access token is unavailable - you need to call authorize() again.")
    ...
    def authorize(self, otp_callback) -> None:
        """
        Launches full authorization with OTP entry
        """
