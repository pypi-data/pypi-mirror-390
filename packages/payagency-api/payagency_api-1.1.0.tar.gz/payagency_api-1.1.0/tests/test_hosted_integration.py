"""
Integration tests for hosted payment operations - REAL API CALLS
"""
...
class TestHostedPaymentIntegration:
    """Integration tests for hosted payments using real API calls"""
    
    def test_create_hosted_payment(self):
        """Test creating a real hosted payment"""
        payload = {
            "first_name": "James",
            "last_name": "Dean",
        ...
        response = api.payment.hosted(payload)
        print(f"Hosted Payment API Response: {response}")
        ...
        # For hosted payments, usually expect REDIRECT status
