...
from redbrick.utils.common_utils import config_path, get_color, series_image_headers
        ...
        for task in my_iter:
            ...
            if isinstance(datapoint.get("seriesInfo"), list):
                ...
                for series in datapoint["seriesInfo"]:
                    ...
                    series_headers = series_image_headers(series)
                    if series_headers:
                        series_obj["imageHeaders"] = series_headers
