...
from netiob.utils.preprocessors import preprocessuserdata
...
- **API Communication**: `callapi(endpoint, payload)`
- **Datetime Handling**: `parseisoutc`, `toisozdt`, etc.
- **Profile Construction**: `getprofileinputs`, `getprofilesettings`
- **Pump History Utilities**: `getpumphistory`, `getcarbhistory`
- **Autosensitivity Calculation**: `getautosens`
- **Data Serialization**: `makejsonserializable()`
...
iob_series = calculatenetiob(basal_df, bolus_df, carbs_df, cgm_df, profile_df, autosens)
```
...
- Entry point: `preprocess_user_data(basal_df, bolus_df, carbs_df, cgm_df)`
...
processed_glucosedata = processor.glucosedata  # ready for API call
```
