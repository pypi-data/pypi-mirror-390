...
* **client:** automatic `/meter/` path normalization - SDK now automatically adds `/meter/` to base URLs when missing, improving developer experience while maintaining full backward compatibility.
