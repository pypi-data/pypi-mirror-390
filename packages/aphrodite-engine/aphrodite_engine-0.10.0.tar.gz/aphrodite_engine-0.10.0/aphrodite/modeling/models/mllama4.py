...
from transformers.models.llama4.image_processing_llama4_fast import find_supported_resolutions, get_best_fit
...
from .interfaces import MultiModalEmbeddings, SupportsEagle3, SupportsMultiModal, SupportsPP
...
class Llama4VisionAttention(nn.Module):
    def __init__(
        ...
        self.attn = MultiHeadAttention(self.num_local_heads, self.head_dim, self.scaling)
