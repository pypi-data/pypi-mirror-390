...
from transformers import BatchFeature, ChameleonConfig, ChameleonProcessor, ChameleonVQVAEConfig
...
class ChameleonForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP, SupportsQuant):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        self.model = ChameleonModel(aphrodite_config=aphrodite_config, prefix=maybe_prefix(prefix, "model"))
