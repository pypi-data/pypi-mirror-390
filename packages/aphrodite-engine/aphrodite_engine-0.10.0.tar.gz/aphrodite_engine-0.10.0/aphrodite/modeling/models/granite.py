...
from .utils import AutoWeightsLoader, PPMissingLayer, is_pp_missing_parameter, make_layers, maybe_prefix
...
class GraniteForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, aphrodite_config: AphroditeConfig, prefix: str = ""):
        ...
        if get_pp_group().is_last_rank:
            ...
            self.logits_processor = LogitsProcessor(self.unpadded_vocab_size, config.vocab_size, scale=logit_scale)
        else:
