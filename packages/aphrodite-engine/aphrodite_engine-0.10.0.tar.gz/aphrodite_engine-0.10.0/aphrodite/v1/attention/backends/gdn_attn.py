    ...
    def build(  # type: ignore[override]
        ...
        if (
            ...
            if num_spec_decodes == 0:
                ...
                spec_sequence_masks = spec_sequence_masks.to(query_start_loc.device, non_blocking=True)
        ...
        if spec_sequence_masks is None:
            ...
            num_spec_decode_tokens = query_lens.sum().item() - num_prefill_tokens - num_decode_tokens
            ...
            if num_prefills == 0 and num_decodes == 0:
                ...
                spec_state_indices_tensor = m.block_table_tensor[spec_sequence_masks, : self.num_spec + 1]
                non_spec_state_indices_tensor = m.block_table_tensor[~spec_sequence_masks, 0]
                ...
                torch.cumsum(query_lens[spec_sequence_masks], dim=0, out=spec_query_start_loc[1:])
        ...
        if num_prefills > 0:
            ...
            nums_dict, batch_ptr, token_chunk_offset_ptr = compute_causal_conv1d_metadata(non_spec_query_start_loc)
        else:
        ...
        if (
            ...
            self.spec_sequence_masks[:num_spec_decodes].copy_(spec_sequence_masks, non_blocking=True)
