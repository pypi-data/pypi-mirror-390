...
class Mamba1AttentionMetadataBuilder(BaseMambaAttentionMetadataBuilder[Mamba1AttentionMetadata]):
    ...
    def build(
        ...
        # TODO: Mamba1 and Mamba2 have a lot of code in common here.
        ...
        if num_prefills > 0:
            ...
            if self.aphrodite_config.cache_config.enable_prefix_caching:
                ...
                block_idx_last_scheduled_token = self.block_idx_last_scheduled_token[:padded_decodes]
                ...
                block_idx_last_computed_token = self.block_idx_last_computed_token[:padded_decodes]
