...
#ifndef APHRODITE_LAUNCH_BLOCKS_CAP
  #define APHRODITE_LAUNCH_BLOCKS_CAP 4
#endif

// Compile-time estimate of max threads per SM for launch bounds.
// Families: 1024, 1536, 2048 threads/SM.
#ifndef APHRODITE_MAX_THREADS_PER_SM
  #ifdef __CUDA_ARCH__

    /* 1024 thr/SM: Turing (sm_75) */
    #if (__CUDA_ARCH__ == 750)
      #define APHRODITE_MAX_THREADS_PER_SM 1024
    ...
    /* 1536 thr/SM: Ampere GA10x (sm_86/87), Ada (sm_89),
        ...
        (__CUDA_ARCH__ == 1210)
      #define APHRODITE_MAX_THREADS_PER_SM 1536
    ...
    /* 2048 thr/SM: Volta (sm_70/72), Ampere GA100 (sm_80),
      ...
      #define APHRODITE_MAX_THREADS_PER_SM 2048
...
static inline int aphrodite_runtime_blocks_per_sm(int block_threads) {
  ...
  return APHRODITE_CLAMP_BLOCKS_PER_SM(blocks);
}
