...
struct Impl {
  ...
  void Measure(T_BC* C, const uint* A, const T_BC* B, const T_Q* Q, int m,
               int n, int k, int group_size, Type type,
               std::vector<Metric>& metrics, cudaStream_t st,
  ...
  void Run(T_BC* C, const uint* A, const T_BC* B, const T_Q* Q, int m, int n,
           int k, int group_size, Type type, int algo_id, cudaStream_t st,
