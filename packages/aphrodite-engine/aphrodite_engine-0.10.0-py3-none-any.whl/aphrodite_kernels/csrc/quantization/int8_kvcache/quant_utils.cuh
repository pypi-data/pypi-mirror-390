...
// bf16 to int8
inline __device__ int8_t quant(__nv_bfloat16 a, const float scale,
                               const float zp) {
  int8_t int8;
  float b = to_float(a);
  int8 = quant(b, scale, zp);
...
// bf16x2 to int8x2
inline __device__ int16_t quant(__nv_bfloat162 a, const float scale,
                                const float zp) {
  union {
    int8_t int8[2];
    short int16;
...
// int8x4 to float32x4
inline __device__ Float4_ dequant(int32_t a, const float scale,
                                  const float zp) {
  union {
    int8_t int8[4];
    int32_t int32;
