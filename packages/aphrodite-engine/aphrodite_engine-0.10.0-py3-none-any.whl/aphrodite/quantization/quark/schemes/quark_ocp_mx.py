...
from aphrodite.quantization.utils.mxfp4_utils import dequant_mxfp4, quant_dequant_mxfp4
from aphrodite.quantization.utils.mxfp6_utils import dequant_mxfp6, quant_dequant_mxfp6
...
def is_rocm_aiter_fp4_asm_gemm_enabled() -> bool:
    return current_platform.is_rocm() and envs.APHRODITE_ROCM_USE_AITER_FP4_ASM_GEMM and envs.APHRODITE_ROCM_USE_AITER
...
try:
    ...
    def gemm_with_dynamic_quant(
        ...
        if rocm_use_aiter_fp4_asm_gemm:
            ...
            # gemm_a4w4 kernel
            y = torch.empty((M + 31) // 32 * 32, weight.shape[0], device=x_q.device, dtype=out_dtype)
