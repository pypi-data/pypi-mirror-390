...
def create_ubatch_slices(num_scheduled_tokens: np.ndarray, split_point: int) -> UBatchSlices:
    ...
    first_ubatch_req_stop = int(np.searchsorted(cu_num_tokens, split_point, side="left"))
    ...
    second_ubatch_req_start = int(np.searchsorted(cu_num_tokens, split_point, side="right") - 1)
