...
from aphrodite.modeling.layers.fused_moe import activation_without_mul, fused_topk
        ...
        self.pooler = DispatchPooler(
            {
                ...
                "score": ClassifierPooler(pooling=self.new.pooler, classifier=self.classifier, act_fn="score"),
            }
        )
