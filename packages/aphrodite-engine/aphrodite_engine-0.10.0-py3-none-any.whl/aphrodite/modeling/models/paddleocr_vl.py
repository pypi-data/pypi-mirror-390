        ...
        *,
        ...
        if self.is_flash_attn_backend:
            ...
            for i in range(1, len(cu_seqlens)):
                ...
                q_i, k_i, v_i = (rearrange(tensor, "b s h d -> b h s d") for tensor in (q_i, k_i, v_i))
            ...
            raise RuntimeError(f"PaddleOCR-VL does not support {self.attn_backend} backend now.")
