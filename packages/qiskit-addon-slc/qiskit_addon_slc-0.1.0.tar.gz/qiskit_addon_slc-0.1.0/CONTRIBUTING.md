...
Development of the `qiskit-addon-slc` package takes place [on GitHub](https://github.com/Qiskit/qiskit-addon-slc).
...
`tox` test environments is located at [`tests/README.md`](tests/README.md).  These environments are used in the
