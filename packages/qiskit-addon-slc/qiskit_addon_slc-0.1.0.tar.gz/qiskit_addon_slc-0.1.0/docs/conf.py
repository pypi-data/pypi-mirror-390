...
language = "en"
release = metadata_version("qiskit-addon-slc")
...
modindex_common_prefix = ["qiskit_addon_slc."]
...
intersphinx_mapping = {
    ...
    "pauli_prop": ("https://qiskit.github.io/pauli-prop/", None),
...
redirects = {
    "apidocs/qiskit_addon_slc": "./index.html",
    **{
...
def linkcode_resolve(domain, info):
    ...
    if module is None or "qiskit_addon_slc" not in module_name:
        return None
    ...
    try:
        ...
        return None
    if full_file_name is None or "/qiskit_addon_slc/" not in full_file_name:
        return None
    file_name = full_file_name.split("/qiskit_addon_slc/")[-1]
    ...
    return f"https://github.com/Qiskit/qiskit-addon-slc/tree/{GITHUB_BRANCH}/qiskit_addon_slc/{file_name}{linespec}"
