...
class Bottleneck(nn.Module):
    ...
    def __init__(
        self, c1: int, c2: int, shortcut: bool = True, g: int = 1, k: Tuple[int, int] = (1, 3), e: float = 0.5
    ):
        """
...
class C3k2(C2f):
    ...
    def __init__(
        ...
        self.m = nn.ModuleList(
            C3k(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck(self.c, self.c, shortcut, g, (1, 3)) for _ in range(n)
        )
...
class Proto(nn.Module):
    ...
    def __init__(self, c1: int, c_: int = 256, c2: int = 32, version: str = 'yolo11'):
        """
        ...
        if version in ['yolo11', 'yolov5u, yolov8']:
