...
if exists:
    ...
    if LGREZ_GCP_CREDENTIALS := os.getenv("LGREZ_GCP_CREDENTIALS"):
        ...
        print("    step 4 ok")
    if (
        (LGREZ_TDB_SHEET_ID := os.getenv("LGREZ_TDB_SHEET_ID"))
    ...
    input(f"Found ongoing installation on step {step + 1}/6. " "Press Enter to continue installation.")
...
When done, press Enter to continue."""
    ...
    input(
        """Now, you can add the bot to your server:
