# THIS FILE IS EXCLUSIVELY MAINTAINED by the project aedev.project_tpls v0.3.64
...
setup_kwargs = {
 ...
 '[![LatestPyPIrelease](\n'
 '    https://img.shields.io/gitlab/pipeline/ae-group/ae_console/release0.3.90?logo=python)](\n'
 '    https://gitlab.com/ae-group/ae_console/-/tree/release0.3.90)\n'
