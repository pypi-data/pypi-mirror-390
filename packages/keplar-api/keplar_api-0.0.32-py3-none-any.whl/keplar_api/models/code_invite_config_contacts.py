...
class CodeInviteConfigContacts(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["kind", "isTest", "showCallMetadata", "title", "description", "maxResponses", "maxResponsesPerParticipant"]

    @field_validator('kind')
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CONTACTS']):
            raise ValueError("must be one of enum values ('CONTACTS')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CodeInviteConfigContacts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CodeInviteConfigContacts from a dict"""
        if obj is None:
            return None
