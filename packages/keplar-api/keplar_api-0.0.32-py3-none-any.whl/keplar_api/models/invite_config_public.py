...
class InviteConfigPublic(BaseModel):
    """
    InviteConfigPublic
    """ # noqa: E501
    kind: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["kind", "allowedOrigins", "collectEmail", "requireEmail", "title", "description", "maxResponses", "maxResponsesPerParticipant"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InviteConfigPublic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InviteConfigPublic from a dict"""
        if obj is None:
            return None
