...
class Workspace(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "updatedAt", "name", "projects", "participants", "moderators", "files", "threads", "attributeKindGroups", "workspaceMembers", "notebooks", "defaultForUsers"]
