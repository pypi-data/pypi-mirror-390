...
class ProjectConversationConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["firstMessage", "endCallMessage", "maxDurationSeconds", "voice"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectConversationConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectConversationConfig from a dict"""
        if obj is None:
            return None
