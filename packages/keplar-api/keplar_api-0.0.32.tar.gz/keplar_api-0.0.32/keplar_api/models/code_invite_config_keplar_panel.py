...
class CodeInviteConfigKeplarPanel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["kind", "collectEmail", "requireEmail", "panelSettings", "title", "description", "maxResponses", "maxResponsesPerParticipant"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CodeInviteConfigKeplarPanel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CodeInviteConfigKeplarPanel from a dict"""
        if obj is None:
            return None
