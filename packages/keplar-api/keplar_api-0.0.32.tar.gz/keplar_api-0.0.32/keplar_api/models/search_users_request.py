...
class SearchUsersRequest(BaseModel):
    ...
    limit: Optional[Union[Annotated[float, Field(le=50, strict=True, ge=1)], Annotated[int, Field(le=50, strict=True, ge=1)]]] = 10
    __properties: ClassVar[List[str]] = ["query", "limit"]
