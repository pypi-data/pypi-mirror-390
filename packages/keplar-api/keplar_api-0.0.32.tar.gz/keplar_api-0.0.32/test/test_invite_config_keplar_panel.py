...
class TestInviteConfigKeplarPanel(unittest.TestCase):
    """InviteConfigKeplarPanel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteConfigKeplarPanel:
        """Test InviteConfigKeplarPanel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteConfigKeplarPanel`
        """
        model = InviteConfigKeplarPanel()
        if include_optional:
            return InviteConfigKeplarPanel(
                kind = 'KEPLAR_PANEL',
                allowed_origins = [
                    ''
                    ],
    ...
    def testInviteConfigKeplarPanel(self):
        """Test InviteConfigKeplarPanel"""
