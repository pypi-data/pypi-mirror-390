...
See the [Type Mapping Reference](reference/type-mapping.md) for complete details.

| ClickHouse Type                  | Python Type     | Notes                       |
| -------------------------------- | --------------- | --------------------------- |
| Int8, Int32, Int64, UInt32, etc. | `int`           | All integer types           |
| Float32, Float64                 | `float`         |                             |
| String, FixedString              | `str`           |                             |
| Enum8, Enum16                    | `str`           |                             |
| Bool                             | `bool`          |                             |
| Date, Date32                     | `date`          | Requires `datetime` import  |
| DateTime, DateTime64             | `datetime`      | Requires `datetime` import  |
| Time, Time64                     | `timedelta`     | Requires `datetime` import  |
| IPv4, IPv6                       | `str`           | IP addresses as strings     |
| UUID                             | `str`           |                             |
| Array(T)                         | `list[T]`       |                             |
| Nullable(T)                      | `T \| None`     |                             |
| Map(K, V)                        | `dict[K, V]`    |                             |
...
| Nested(...)                      | `list[dict]`    |                             |
| JSON, Object                     | `dict`          |                             |
| Variant, Dynamic                 | `Any`           | New ClickHouse v24.0+ types |
