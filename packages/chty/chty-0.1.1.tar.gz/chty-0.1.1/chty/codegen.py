...
def _generate_query_class(
    ...
    if has_parameters:
        execute_sig = f"parameters: {class_name}Params, **kwargs"
        query_call_args = "parameters=parameters, **kwargs"
    else:
        execute_sig = "**kwargs"
        query_call_args = "**kwargs"
...
def generate_python_code(
    ...
    """
    parts = [_generate_imports(parameters, result_schema)]
