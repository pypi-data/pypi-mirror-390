...
def demo_simple_query():
    ...
    try:
        ...
        print(
            ...
            "  chty generate examples/queries/*.sql -o examples/generated --db-url clickhouse://admin:admin@localhost:8123"
        )
...
def demo_user_search():
    ...
    try:
        ...
        print(
            "Generate types first: chty generate examples/queries/*.sql -o examples/generated"
        )
