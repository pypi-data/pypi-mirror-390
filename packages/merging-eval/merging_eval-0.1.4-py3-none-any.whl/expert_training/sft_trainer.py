...
class SFTTrainer(ABC):
        ...
        for epoch in range(start_epoch, self.epochs):
            ...
            for prompt_id_lens, inputs, attention_masks, infos in self.train_dataloader:
                ...
                if step % self.strategy.accumulated_gradient == 0:
                    ...
                    self.save_logs_and_checkpoints(args, global_step, step_bar, logs_dict, client_states, num_update_steps_per_epoch)
    ...
    # logs/checkpoints/evaluation
    def save_logs_and_checkpoints(self, args, global_step, step_bar, logs_dict={}, client_states={}, num_update_steps_per_epoch=200000):
