...
class SequenceOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, sequenceType, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_494')) else
      _ods_ir.AttrBuilder.get('anonymous_494')(sequenceType, context=_ods_context))
    results = []
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class TargetOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, target, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_538')) else
      _ods_ir.AttrBuilder.get('anonymous_538')(target, context=_ods_context))
    results = []
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class TestOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, templateName, targetType, *, target=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_538')) else
      _ods_ir.AttrBuilder.get('anonymous_538')(targetType, context=_ods_context))
