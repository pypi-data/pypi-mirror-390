...
class DockerBuilder:
    ...
    def get_miniconda3_version(self) -> str:
        ...
        version_map = {
            (3, 8): "condaforge/miniforge3:23.1.0-0",
            (3, 9): "condaforge/miniforge3:23.3.1-0",
            (3, 10): "condaforge/miniforge3:24.3.0-0",
            (3, 11): "condaforge/miniforge3:24.7.1-0",
            (3, 12): "condaforge/miniforge3:25.1.1-0",
