# Generated by Django 3.2.19 on 2023-08-23 13:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('payroll', '0007_auto_20230811_0734'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='HistoricalPaymentAdaptorHistory',
            fields=[
            ...
            options={
                'verbose_name': 'historical payment adaptor history',
                'verbose_name_plural': 'historical payment adaptor historys',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amount', models.CharField(blank=True, max_length=255, null=True)),
                ('user_created', models.ForeignKey(db_column='UserCreatedUUID', on_delete=django.db.models.deletion.DO_NOTHING, related_name='paymentadaptorhistory_user_created', to=settings.AUTH_USER_MODEL)),
                ('user_updated', models.ForeignKey(db_column='UserUpdatedUUID', on_delete=django.db.models.deletion.DO_NOTHING, related_name='paymentadaptorhistory_user_updated', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
