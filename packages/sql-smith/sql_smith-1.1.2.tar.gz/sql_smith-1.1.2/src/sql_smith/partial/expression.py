from sql_smith.interfaces import EngineInterface, ExpressionInterface
...
class Expression(ExpressionInterface):
    ...
    def append(
        self, pattern: str, *args: "StatementInterface"
    ) -> "ExpressionInterface":
        merged = [*self._replacements, *args]
        return Expression("{} {}".format(self._pattern, pattern), *merged)
