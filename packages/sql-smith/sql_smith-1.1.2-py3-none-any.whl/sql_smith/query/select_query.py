from sql_smith.capability import (
    CanUnionMixin,
    HasFromMixin,
    HasLimitMixin,
    HasOffsetMixin,
...
from sql_smith.functions import express, identify, identify_all, listing
...
class SelectQuery(
    ...
    def join(
        self, table: str, criteria: "CriteriaInterface", join_type: str = ""
    ) -> "SelectQuery":
        """Add a join."""
    ...
    def __apply_joins(self, query: "ExpressionInterface") -> "ExpressionInterface":
        return (
            query.append("{}", listing(self._joins, " "))
    ...
    def __apply_group_by(self, query: "ExpressionInterface") -> "ExpressionInterface":
        return (
            query.append("GROUP BY {}", listing(self._group_by, " "))
