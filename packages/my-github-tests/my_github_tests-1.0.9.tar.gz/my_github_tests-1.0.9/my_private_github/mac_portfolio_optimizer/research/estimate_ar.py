...
# universe data
from my_private_github.mac_portfolio_optimizer.data.excel_loader import load_mac_portfolio_universe
from my_private_github.mac_portfolio_optimizer.data.mac_universe import SaaPortfolio, TaaPortfolio
...
def run_unit_test(unit_test: UnitTests):
    ...
    import my_private_github.mac_portfolio_optimizer.local_path as lp
    ...
    elif unit_test == UnitTests.ADJUST_RETURNS:
    ...
    elif unit_test == UnitTests.ROLLING_BETA:
