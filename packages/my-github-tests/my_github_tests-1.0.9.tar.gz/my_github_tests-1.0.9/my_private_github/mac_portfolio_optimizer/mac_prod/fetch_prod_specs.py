...
from optimalportfolios import (CovarEstimator, LassoModel, LassoModelType, CovarEstimatorType,
                               OptimiserAlphaOverTreConfig, ConstraintEnforcementType)
...
def get_meta_params(saa_rebalancing_freq: str = 'QE') -> Dict[str, Any]:
    ...
    optimiser_alpha_over_tre_config = OptimiserAlphaOverTreConfig(constraint_enforcement_type=ConstraintEnforcementType.UTILITY_CONSTRAINTS,
