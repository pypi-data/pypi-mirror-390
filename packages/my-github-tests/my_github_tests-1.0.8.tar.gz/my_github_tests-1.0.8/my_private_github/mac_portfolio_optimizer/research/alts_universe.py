...
def run_local_test(local_test: LocalTests):
    ...
    time_period = qis.TimePeriod('31Dec2017','31Mar2025')
    ...
    if local_test == LocalTests.BBG_DATA:
        ...
        ac_prices = time_period.locate(ac_prices.dropna(axis=0, how='all'))
    ...
    elif local_test == LocalTests.PRIVATE_DEBT:
        mac_tickers = ['Ares Strategic Income Offshore Access Fund USD',
        ...
        ac_prices = pd.concat([prices['Private Debt'].rename('MSCI PD Index'),
                               basket_prices, prices[mac_tickers],
                               ], axis=1).asfreq('QE', method='ffill')

        ac_prices = time_period.locate(ac_prices.dropna(axis=0, how='all'))
        print(ac_prices)
        plot_basket(prices=ac_prices, benchmark_price=benchmark_price, title='Private Debt')
...
if __name__ == '__main__':
    ...
    run_local_test(local_test=LocalTests.REAL_ASSETS)
