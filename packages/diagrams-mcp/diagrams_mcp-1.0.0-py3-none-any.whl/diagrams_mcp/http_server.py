"""HTTP server entry point for containerised deployment.
...
def main():
    """Start the HTTP server with CORS support for containerised deployment.
    ...
    print(f"Diagrams MCP Server v{__version__} starting...")
