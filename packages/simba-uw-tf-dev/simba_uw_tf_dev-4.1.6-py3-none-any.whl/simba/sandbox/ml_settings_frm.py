...
class GetMLSettingsFrame():
    ...
    """
    Creates ML definition LabelFrame panel in ProjectCreatorPopUp interface.
    """
    ...
    def __init__(self,
        ...
        self.add_btn = SimbaButton(parent=self.ml_settings_frm, txt="", txt_clr='red', img='plus', cmd=self.add_entry_box)
        self.remove_btn = SimbaButton(parent=self.ml_settings_frm, txt="", txt_clr='red', img='minus', cmd=self.remove_entry_box)
        self.add_entry_box()
        self.fill_frm()
