...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "base_url", "name", "content_guard", "pulp_href", "prn", "hidden", "pulp_last_updated", "pulp_labels", "base_path", "pulp_created"]
