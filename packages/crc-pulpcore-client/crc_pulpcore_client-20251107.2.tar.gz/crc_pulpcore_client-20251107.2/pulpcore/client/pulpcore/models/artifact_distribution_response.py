...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "no_content_change_since", "pulp_labels", "name", "prn", "pulp_href", "base_path", "hidden", "pulp_created", "content_guard", "base_url"]
