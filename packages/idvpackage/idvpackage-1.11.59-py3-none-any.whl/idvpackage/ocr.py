...
class IdentityVerification:
    ...
    def extract_front_id_info(self, front_id, country):
        ...
        if country == 'QAT':
                ...
                try:
                    ...
                    st = time.time()
                    front_data_fields = qatar_front_id_extraction(self.client, compressed_image_data, front_id_text, front_id_text_desc, openai.api_key)
        ...
        if country == 'LBN':
                ...
                from idvpackage.ocr_utils import detect_logo, detect_photo_on_screen, detect_screenshot, document_on_printed_paper
                from idvpackage.lebanon_id_extraction import lebanon_front_id_extraction, is_valid_past_date
                from idvpackage.common import load_and_process_image_deepface
                from idvpackage.blur_detection import is_image_blur
                ...
                try:
                    ...
                    if not is_valid_past_date(front_data.get('dob','')):
                        front_data['error'] = 'invalid_dob'
                        return front_data
    ...
    def exract_passport_info(self, passport, country):
        ...
        if country.upper() == 'LBN':
                ...
                from idvpackage.ocr_utils import  detect_photo_on_screen, detect_screenshot, document_on_printed_paper
                from idvpackage.lebanon_passport_extraction import lebanon_passport_extraction, verify_lbn_pss_chain
                from idvpackage.common import load_and_process_image_deepface
                from idvpackage.blur_detection import is_image_blur
                ...
                try:
                    ...
                    is_valid_lbn_passport = verify_lbn_pss_chain(passport_text, openai.api_key)
