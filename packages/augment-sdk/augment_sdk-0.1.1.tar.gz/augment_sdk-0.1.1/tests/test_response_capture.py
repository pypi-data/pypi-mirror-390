...
from augment.listener import AgentListener
...
def test_with_listener(date: str, expected_count: int):
    """Test PR summary with response capturing."""
    print(f"\n{'='*80}")
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        agent = Agent(workspace_root=tmpdir, listener=listener)
...
def main():
    ...
    for date, expected_count in test_cases:
        test_with_listener(date, expected_count)
