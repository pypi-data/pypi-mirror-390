"""
End-to-end tests for ClaudeCodeACPClient.
...
By default, only quick sanity check tests run.
To run all tests including slow ones, use: pytest -m ""

To skip these tests if prerequisites aren't met:
...
from augment.acp import ClaudeCodeACPClient, AgentEventListener
