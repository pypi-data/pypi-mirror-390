...
class MemoryCardManager:
    ...
    async def amemory_card_merge(self, memory_cards: list[str],brithday: str, age: str):
        logger.info(f'函数输入 & {type(memory_cards)} &  {memory_cards} brithday: {brithday}, age: {age}')
        ...
        time = await self.get_time(result.get("content"),brithday = brithday,age = age)
