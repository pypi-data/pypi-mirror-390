   ...
   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@   
     @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@     
       @@@@@@@@@@@@@@@@@@@@@@@@@@       
        ...
        "cli_quiet_help": "Suppress non-error output (only errors will be printed)",
        ...
        "cli_history_export_help": "Export transfer history to a text file (optional directory path)",
        ...
        "cli_quiet_direct_error": "Quiet mode is only available when the required direct flags are provided.",
        ...
        "history_export_success": "History exported to {path}",
        "history_export_failed": "Failed to export history: {reason}",
        "history_export_exists": "History export already exists at {path}",
        ...
        "settings_options": "[1] Change language  [2] Change device name  [3] Change transfer port  [4] Change download directory  [5] Clear history  [6] Transfer encryption  [7] Auto-accept incoming transfers  [8] Clear trusted fingerprints  [9] Export transfer history  [10] Back",
        ...
        "settings_history_export_prompt": "Enter directory for exporting history (leave empty to use current directory: {cwd}): ",
   ...
   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@   
     @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@     
       @@@@@@@@@@@@@@@@@@@@@@@@@@       
        ...
        "cli_quiet_direct_error": "安静模式仅能与必需的直通参数一起使用。",
        ...
        "history_export_success": "传输记录已导出到 {path}",
        "history_export_failed": "导出传输记录失败：{reason}",
        "history_export_exists": "导出文件已存在：{path}",
        "settings_header": "设置 — 当前语言：{language_name} ({language_code})，设备名称：{device}，传输端口：{port}，传输加密：{encryption}，自动接收：{auto_accept}，本机 IP：{ips}",
        "settings_options": "[1] 更改语言  [2] 更改设备名称  [3] 更改传输端口  [4] 更改默认接收目录  [5] 清空传输记录  [6] 传输加密  [7] 自动接收传入文件  [8] 清空信任指纹  [9] 导出传输记录  [10] 返回",
        ...
        "settings_history_export_prompt": "请输入导出目录（留空则使用当前路径：{cwd}）：",
