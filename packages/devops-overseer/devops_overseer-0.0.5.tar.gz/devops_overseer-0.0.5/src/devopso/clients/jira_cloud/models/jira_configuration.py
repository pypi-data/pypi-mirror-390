...
class JiraConfiguration(BaseModel):
    ...
    attachments_enabled: Optional[StrictBool] = Field(
        default=None, description="Whether the ability to add attachments to issues is enabled.", alias="attachmentsEnabled"
    )
    ...
    sub_tasks_enabled: Optional[StrictBool] = Field(
        default=None, description="Whether the ability to create subtasks for issues is enabled.", alias="subTasksEnabled"
    )
    time_tracking_configuration: Optional[TimeTrackingConfiguration] = Field(
        default=None, description="The configuration of time tracking.", alias="timeTrackingConfiguration"
    )
    time_tracking_enabled: Optional[StrictBool] = Field(
        default=None, description="Whether the ability to track time is enabled. This property is deprecated.", alias="timeTrackingEnabled"
    )
    unassigned_issues_allowed: Optional[StrictBool] = Field(
        default=None,
    ...
    voting_enabled: Optional[StrictBool] = Field(
        default=None,
    ...
    watching_enabled: Optional[StrictBool] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "timeTrackingConfiguration": (
                    TimeTrackingConfiguration.from_dict(obj["timeTrackingConfiguration"]) if obj.get("timeTrackingConfiguration") is not None else None
                ),
