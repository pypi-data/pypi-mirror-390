...
def adjust_incore_datastructure_baseyear(baseyear):
    incore_v2_DataStructure = {
        ...
        {   'label' : 'Block ID' , 
            ...
            'zero_padded' : True,
            'notes' :
                f'1. {baseyear} Census Block ID'},
        'bgid'    : 
        {   'label' : f'{baseyear} Census Block Group ID', 
            'huiv3-0-0' : f'BlockGroup{baseyear}', 
            'formula' : "\n".join([
                            "output_df['blockid']."
                            "apply(lambda x :"
            ...
            'zero_padded' : True,
            'notes' : '\n'.join([
                f'1. 12 Character String that contains {baseyear} census block group ID. \n \n'
                '2. Foreign Key with Block Group Data for population dislocation model.'
                    ])},
        'tractid' : {
            'label' : f'{baseyear} Census Tract ID', 
            'huiv3-0-0' : f'Tract{baseyear}',
            'formula' : "\n".join([
                            "output_df['blockid']."
                            "apply(lambda x :"
            ...
            'zero_padded' : True,
            'notes' :
                f'1. 11 Character String that contains {baseyear} census tract ID.'},
        'FIPScounty': 
        {   'label' : 'County FIPS Code', 
            'huiv3-0-0' : f'County{baseyear}',
            'formula' : "\n".join([
                            "output_df['blockid']."
                            "apply(lambda x :"
