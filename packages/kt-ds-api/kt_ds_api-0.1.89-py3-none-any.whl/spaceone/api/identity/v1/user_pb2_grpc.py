...
class UserStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_by_id = channel.unary_unary(
                '/spaceone.api.identity.v1.User/get_by_id',
                request_serializer=spaceone_dot_api_dot_identity_dot_v1_dot_user__pb2.GetByUserIdRequest.SerializeToString,
                response_deserializer=spaceone_dot_api_dot_identity_dot_v1_dot_user__pb2.UserInfo.FromString,
                )
...
def add_UserServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'get_by_id': grpc.unary_unary_rpc_method_handler(
                    servicer.get_by_id,
                    request_deserializer=spaceone_dot_api_dot_identity_dot_v1_dot_user__pb2.GetByUserIdRequest.FromString,
                    response_serializer=spaceone_dot_api_dot_identity_dot_v1_dot_user__pb2.UserInfo.SerializeToString,
            ),
...
class User(object):
    ...
    def get_by_id(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.identity.v1.User/get_by_id',
            spaceone_dot_api_dot_identity_dot_v1_dot_user__pb2.GetByUserIdRequest.SerializeToString,
            spaceone_dot_api_dot_identity_dot_v1_dot_user__pb2.UserInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
