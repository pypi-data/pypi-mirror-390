...
class AlertStub(object):
    ...
    def __init__(self, channel):
        ...
        self.update_event_type = channel.unary_unary(
                '/spaceone.api.monitoring.v1.Alert/update_event_type',
                request_serializer=spaceone_dot_api_dot_monitoring_dot_v1_dot_alert__pb2.UpdateAlertEventTypeRequest.SerializeToString,
                response_deserializer=spaceone_dot_api_dot_monitoring_dot_v1_dot_alert__pb2.AlertInfo.FromString,
                )
...
class AlertServicer(object):
    ...
    def update_event_type(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_AlertServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'update_event_type': grpc.unary_unary_rpc_method_handler(
                    servicer.update_event_type,
                    request_deserializer=spaceone_dot_api_dot_monitoring_dot_v1_dot_alert__pb2.UpdateAlertEventTypeRequest.FromString,
                    response_serializer=spaceone_dot_api_dot_monitoring_dot_v1_dot_alert__pb2.AlertInfo.SerializeToString,
            ),
    }
...
class Alert(object):
    ...
    def update_event_type(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Alert/update_event_type',
            spaceone_dot_api_dot_monitoring_dot_v1_dot_alert__pb2.UpdateAlertEventTypeRequest.SerializeToString,
            spaceone_dot_api_dot_monitoring_dot_v1_dot_alert__pb2.AlertInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
