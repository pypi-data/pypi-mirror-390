...
class CostStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_aks_data = channel.unary_unary(
                '/spaceone.api.cost_analysis.plugin.Cost/get_aks_data',
                request_serializer=spaceone_dot_api_dot_cost__analysis_dot_plugin_dot_cost__pb2.GetAKSDataRequest.SerializeToString,
                response_deserializer=spaceone_dot_api_dot_cost__analysis_dot_plugin_dot_cost__pb2.AKSCostsInfo.FromString,
                )
...
class CostServicer(object):
    ...
    def get_aks_data(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CostServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'get_aks_data': grpc.unary_unary_rpc_method_handler(
                    servicer.get_aks_data,
                    request_deserializer=spaceone_dot_api_dot_cost__analysis_dot_plugin_dot_cost__pb2.GetAKSDataRequest.FromString,
                    response_serializer=spaceone_dot_api_dot_cost__analysis_dot_plugin_dot_cost__pb2.AKSCostsInfo.SerializeToString,
            ),
    }
...
class Cost(object):
    ...
    def get_aks_data(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.cost_analysis.plugin.Cost/get_aks_data',
            spaceone_dot_api_dot_cost__analysis_dot_plugin_dot_cost__pb2.GetAKSDataRequest.SerializeToString,
            spaceone_dot_api_dot_cost__analysis_dot_plugin_dot_cost__pb2.AKSCostsInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
