# Enhanced error messages with actionable suggestions for wazo.
...
def print_error(error_type: str, context: Optional[Dict] = None) -> None:
    ...
    if "docker" in error_lower and ("not found" in error_lower or "not running" in error_lower):
        ...
        console.print("\n  [dim]Or initialize a new project: wazo init python[/dim]")
        ...
        console.print("  [dim]wazo init wit[/dim]")
        ...
        console.print("  [dim]Try: wazo build . --verbose[/dim]")
