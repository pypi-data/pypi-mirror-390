# wazo build command for building projects to WASM
...
def _get_version():
    try:
        ...
        try:
            ...
            return importlib_metadata.version("wazo")
        except Exception:
...
def build(
    ...
    try:
        ...
        try:
            ...
            console.print("Error: Language not detected. Run: wazo init <language>")
            sys.exit(1)
        ...
        if "docker" in error_lower and ("not found" in error_lower or "not running" in error_lower):
            ...
            fix_command = "wazo build . --verbose"
