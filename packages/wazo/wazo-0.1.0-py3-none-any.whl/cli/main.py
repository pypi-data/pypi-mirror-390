...
@click.group()
@click.version_option(__version__, prog_name="wazo")
@click.pass_context
def cli(ctx):
    """wazo - Build any codebase to WebAssembly with zero setup."""
...
def main() -> None:
    cli.main(prog_name="wazo", standalone_mode=True)
