...
class WasmDevServer:
    ...
    def _start_http_server(self):
        ...
        if build_type == "standalone":
            ...
            if wasm_file:
                ...
                console.print(f"    wazo run {wasm_file.name}")
                console.print()
                console.print("  [bold]To create an HTTP API instead:[/bold]")
                console.print("    wazo init python --template api")
                console.print()
    ...
    def _build_project(self) -> tuple[bool, Optional[str]]:
        try:
            ...
            # Use the existing wazo build command
    ...
    def start(self):
        ...
        try:
            ...
            if self.debug:
                ...
                console.print(
                    f"  [bold]wazo[/bold] {mode} [dim]• {self.project_path.name} • :{self.port} • debug[/dim]"
                )
            else:
                console.print("  [bold]wazo[/bold] dev server")
            console.print()
