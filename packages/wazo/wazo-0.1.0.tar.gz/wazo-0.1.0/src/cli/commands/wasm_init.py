# wazo init command - Initialize a new WASM project.
...
def init(language: str, template: str, name: str):
    ...
    if language == "wit":
        ...
        console.print("  2. Run: wazo build")
        return
    ...
    console.print("  2. Run: wazo build")
    console.print("  3. Serve: wazo serve")
    console.print(
...
This component exports functions that can be called via HTTP using `wazo serve`.
