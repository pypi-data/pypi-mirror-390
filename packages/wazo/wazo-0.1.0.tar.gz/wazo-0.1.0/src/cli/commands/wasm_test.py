# wazo test - Run automated tests for WASM components
...
def test(path: str, function: str, load: bool, watch: bool, port: int):
    ...
    console.print()
    console.print("  [bold]wazo[/bold] test")
    console.print()
...
def run_tests_from_file(
    ...
    def start_server():
        ...
        server_process = subprocess.Popen(
            ["wazo", "dev", str(project_path), "--port", str(port), "--no-open"],
...
def run_discovery_tests(project_path: Path, target_function: str, load: bool, port: int):
    ...
    console.print()
    console.print("  [dim]Then run: wazo test[/dim]")
    console.print()
