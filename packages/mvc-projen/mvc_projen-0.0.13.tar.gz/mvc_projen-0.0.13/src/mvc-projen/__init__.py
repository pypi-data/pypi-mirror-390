...
class MvcCdkConstructLibrary(
    _projen_awscdk_04054675.AwsCdkConstructLibrary,
    metaclass=jsii.JSIIMeta,
    jsii_type="@mavogel/mvc-projen.MvcCdkConstructLibrary",
):
    '''TypeScript library.
    ...
    def __init__(
        self,
        *,
        base_assets_directory: typing.Optional[builtins.str] = None,
        integ_test_regions: typing.Optional[typing.Sequence[builtins.str]] = None,
        ...
        '''
        :param base_assets_directory: Base directory for the assets. Default: ${cwd()}/node_modules/mvc-projen/assets
        :param integ_test_regions: The regions to run the integ tests in. Default: eu-west-1 and eu-west-2
        ...
        '''
        options = MvcCdkConstructLibraryOptions(
            base_assets_directory=base_assets_directory,
            integ_test_regions=integ_test_regions,
...
@jsii.data_type(
    jsii_type="@mavogel/mvc-projen.MvcCdkConstructLibraryOptions",
    jsii_struct_bases=[_projen_awscdk_04054675.AwsCdkConstructLibraryOptions],
    name_mapping={
        "name": "name",
        ...
        "base_assets_directory": "baseAssetsDirectory",
        "integ_test_regions": "integTestRegions",
    },
)
class MvcCdkConstructLibraryOptions(
    _projen_awscdk_04054675.AwsCdkConstructLibraryOptions,
):
    def __init__(
        self,
        *,
        ...
        if isinstance(catalog, dict):
            catalog = _projen_cdk_04054675.Catalog(**catalog)
        if isinstance(lambda_options, dict):
            lambda_options = _projen_awscdk_04054675.LambdaFunctionCommonOptions(**lambda_options)
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8368d0dbd6deb7e23fc08d508379812112df0c4217bc6e3957b828e3e64b88ce)
            ...
            check_type(argname="argument base_assets_directory", value=base_assets_directory, expected_type=type_hints["base_assets_directory"])
            check_type(argname="argument integ_test_regions", value=integ_test_regions, expected_type=type_hints["integ_test_regions"])
        ...
        if base_assets_directory is not None:
            self._values["base_assets_directory"] = base_assets_directory
        if integ_test_regions is not None:
            self._values["integ_test_regions"] = integ_test_regions
    ...
    @builtins.property
    def catalog(self) -> typing.Optional[_projen_cdk_04054675.Catalog]:
        ...
        return typing.cast(typing.Optional[_projen_cdk_04054675.Catalog], result)
    ...
    @builtins.property
    def base_assets_directory(self) -> typing.Optional[builtins.str]:
        '''Base directory for the assets.

        :default: ${cwd()}/node_modules/mvc-projen/assets
        '''
        result = self._values.get("base_assets_directory")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def integ_test_regions(self) -> typing.Optional[typing.List[builtins.str]]:
        '''The regions to run the integ tests in.

        :default: eu-west-1 and eu-west-2
        '''
        result = self._values.get("integ_test_regions")
        return typing.cast(typing.Optional[typing.List[builtins.str]], result)
    ...
    def __repr__(self) -> str:
        return "MvcCdkConstructLibraryOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


__all__ = [
    "MvcCdkConstructLibrary",
    "MvcCdkConstructLibraryOptions",
]

publication.publish()

def _typecheckingstub__8368d0dbd6deb7e23fc08d508379812112df0c4217bc6e3957b828e3e64b88ce(
    *,
    name: builtins.str,
    commit_generated: typing.Optional[builtins.bool] = None,
    git_ignore_options: typing.Optional[typing.Union[_projen_04054675.IgnoreFileOptions, typing.Dict[builtins.str, typing.Any]]] = None,
