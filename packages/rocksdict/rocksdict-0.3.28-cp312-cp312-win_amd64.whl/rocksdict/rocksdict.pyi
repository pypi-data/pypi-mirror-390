...
class Options:
    ...
    def set_compression_per_level(
        self, level_types: List[DBCompressionType]
    ) -> None: ...
    def set_compression_type(self, t: DBCompressionType) -> None: ...
    def set_bottommost_compression_type(self, t: DBCompressionType) -> None: ...
    def set_bottommost_compression_options(
        self, w_bits: int, level: int, strategy: int, max_dict_bytes: int, enable: bool
    ) -> None: ...
    ...
    def add_compact_on_deletion_collector_factory(
        self, window_size: int, num_dels_trigger: int, deletion_ratio: float
    ) -> None: ...
    def set_write_buffer_manager(
        self, write_buffer_manager: WriteBufferManager
    ) -> None: ...
    def set_avoid_unnecessary_blocking_io(self, val: bool) -> None: ...
    def set_auto_tuned_ratelimiter(
        self, rate_bytes_per_sec: int, refill_period_us: int, fairness: int
    ) -> None: ...
...
class Rdict:
    ...
    def write(
        self, write_batch: WriteBatch, write_opt: Optional[WriteOptions] = None
    ) -> None: ...
    def delete_range(
        self,
...
class RdictEntities(
    Iterator[Tuple[Union[str, int, float, bytes, bool], List[Tuple[Any, Any]]]]
):
    def __iter__(self) -> RdictEntities: ...
    def __next__(
        self,
    ) -> Tuple[Union[str, int, float, bytes, bool], List[Tuple[Any, Any]]]: ...
...
class WriteBatch:
    ...
    def set_default_column_family(
        self, column_family: Optional[ColumnFamily]
    ) -> None: ...
    def len(self) -> int: ...
...
class WriteBufferManager:
    ...
    @staticmethod
    def new_write_buffer_manager_with_cache(
        buffer_size: int, allow_stall: bool, cache: Cache
    ) -> WriteBufferManager: ...
    def get_usage(self) -> int: ...
