...
class TransportNSWv2(object):
    ...
    def get_trip(self, name_origin, name_destination , api_key, journey_wait_time = 0, origin_transport_type = [0], destination_transport_type = [0], \
        ...
        for current_journey_index in range (0, retrieved_journeys, 1):
            ...
            legs, next_journey_index, first_leg, last_leg, changes, changes_list, locations_list = self._find_next_journey(result['journeys'], current_journey_index, origin_transport_type, destination_transport_type, strict_transport_type, route_filter, type_origin)
...
#                    return None
    ...
    def _get_location_info(self, leg, section, key):
        section_name = leg[section]["parent"]["name"]
        section_disassembled_name = leg[section]["parent"]["disassembledName"]
        section_coords = leg[section]["parent"]["coord"]
