...
Board stub for BlueMicro833
 ...
 - NVM size: 8192
 - Included modules: _bleio, _bleio (native), adafruit_pixelbuf, alarm, analogio, array, audiocore, board, builtins, busio, busio.SPI, busio.UART, collections, digitalio, keypad, keypad.KeyMatrix, keypad.Keys, keypad.ShiftRegisterKeys, math, microcontroller, neopixel_write, os, pulseio, pwmio, rainbowio, random, rotaryio, rtc, storage, struct, supervisor, sys, time, usb_cdc, usb_hid, usb_midi
 - Frozen libraries: 
"""
