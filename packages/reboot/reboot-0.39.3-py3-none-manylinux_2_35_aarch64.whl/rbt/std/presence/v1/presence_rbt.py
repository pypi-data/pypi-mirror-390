                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (PresenceWorkflowStub(
                            ...
                            PresenceSubscribeRequestFromProto(IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.SubscribeRequest, task.request)),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (PresenceWorkflowStub(
                            ...
                            PresenceListRequestFromProto(IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.ListRequest, task.request)),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await self.__Watch(
                            context,
                            PresenceWatchRequestFromProto(IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.WatchRequest, task.request)),
                            validating_effects=validating_effects,
                        )
                        await complete(task, (response, None))
                        return (response, None)
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await PresenceServicerTasks(
                    ...
                    PresenceSubscribeRequestFromProto(request),
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await PresenceServicerTasks(
                    ...
                    PresenceListRequestFromProto(request),
                    schedule=context._headers.task_schedule,
                )
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await PresenceServicerTasks(
                    ...
                    PresenceWatchRequestFromProto(request),
                    schedule=context._headers.task_schedule,
                )
...
class PresenceReaderStub(_PresenceStub):
    ...
    async def List(
        ...
        *,
        ...
        proto_request = PresenceListRequestToProto(request)
...
class PresenceWriterStub(_PresenceStub):
    ...
    async def Subscribe(
        ...
        *,
        ...
        proto_request = PresenceSubscribeRequestToProto(request)
    ...
    async def List(
        ...
        *,
        ...
        async with self._call(
            ...
            'List',
            self._rbt_std_presence_v1_presencemethods_stub.List,
            PresenceListRequestToProto(request),
            unary=True,
            reader=True,
            response_type=rbt.std.presence.v1.presence_pb2.ListResponse,
            aborted_type=Presence.ListAborted,
...
class PresenceTasksStub(_PresenceStub):
    ...
    async def Watch(
        ...
        *,
        ...
        idempotency_key: IMPORT_typing.Optional[IMPORT_uuid.UUID]
        proto_request = PresenceWatchRequestToProto(request)
    ...
    async def Subscribe(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            request=PresenceSubscribeRequestToProto(request),
    ...
    async def List(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='List',
            request=PresenceListRequestToProto(request),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
            ) else schedule,
        )
    ...
    async def Watch(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Watch',
            request=PresenceWatchRequestToProto(request),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
            ) else schedule,
        )
...
class PresenceSingletonServicer(PresenceBaseServicer):
    ...
    async def _Watch(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return PresenceWatchResponseToProto(await self.Watch(context, typed_request))
...
class Presence:
    ...
    class WeakReference(IMPORT_typing.Generic[Presence_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def List(
                ...
                __request_or_options__: Presence.ListRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[Presence.ListResponse]:
                ...
            ...
            async def List( # type: ignore[misc]
                ...
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __request_or_options__: IMPORT_typing.Optional[Presence.ListRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[Presence.ListResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=Presence.ListRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=Presence.ListRequest)
                ...
                __request__: IMPORT_typing.Optional[Presence.ListRequest] = None

                if isinstance(__request_or_options__, Presence.ListRequest):
                    ...
                    __request__ = Presence.ListRequest(
                    )
                        ...
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            __call__ = IMPORT_rbt_v1alpha1.react_pb2_grpc.ReactStub(
                                ...
                                IMPORT_rbt_v1alpha1.react_pb2.QueryRequest(
                                    method='List',
                                    request=PresenceListRequestToProto(
                                        __request__
                                    ).SerializeToString(),
                                ),
                            ...
                            async for __query_response__ in __call__:
                                ...
                                yield PresenceListResponseFromProto(__response__)
        ...
        class _Idempotently(IMPORT_typing.Generic[Presence_IdempotentlyScheduleTypeVar]):
            ...
            async def Subscribe(
                ...
                __request_or_options__: Presence.SubscribeRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> Presence.SubscribeResponse:
                ...
            ...
            async def Subscribe( # type: ignore[misc]
                ...
                __this__,
                __context__: IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
                __request_or_options__: IMPORT_typing.Optional[Presence.SubscribeRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                subscriber_id: IMPORT_typing.Optional[str] = None,
            ) -> Presence.SubscribeResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=Presence.SubscribeRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=Presence.SubscribeRequest)

                __request__: IMPORT_typing.Optional[Presence.SubscribeRequest] = None
                if isinstance(__request_or_options__, Presence.SubscribeRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    __options__ = __options__ or IMPORT_reboot_aio_call.Options()

                    assert subscriber_id is None
                    ...
                    # always non-None, when in reality they are optional.
                    __request__ = Presence.SubscribeRequest(
            ...
            async def Watch(
                ...
                __request_or_options__: Presence.WatchRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> Presence.WatchResponse:
                ...
            ...
            async def Watch( # type: ignore[misc]
                # In methods which are dealing with user input, (i.e.,
                # proto message field names), we should use '__double_underscored__'
                # variables to avoid any potential name conflicts with the method's
                # parameters.
                ...
                __this__,
                __context__: IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
                __request_or_options__: IMPORT_typing.Optional[Presence.WatchRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                subscriber_id: IMPORT_typing.Optional[str] = None,
            ) -> Presence.WatchResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=Presence.WatchRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=Presence.WatchRequest)
                ...
                if isinstance(__request_or_options__, Presence.WatchRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    __options__ = __options__ or IMPORT_reboot_aio_call.Options()
        ...
        class _Until:
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> Presence.WeakReference._UntilChangesSatisfies[Presence.State]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            async def List(
                ...
                __request_or_options__: Presence.ListRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> Presence.WeakReference._UntilChangesSatisfies[Presence.ListResponse]:
                ...
        ...
        class _Schedule:
            ...
            async def Watch( # type: ignore[misc]
                ...
                *,
                ...
                __request__: IMPORT_typing.Optional[Presence.WatchRequest] = None
                if isinstance(__request_or_options__, Presence.WatchRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    ...
                    # `IMPORT_google_protobuf_message.Message` constructor arguments are
                    # always non-None, when in reality they are optional.
                    __request__ = Presence.WatchRequest(
                        subscriber_id=subscriber_id, # type: ignore[arg-type]
                    )
    ...
    class _Forall:
        ...
        async def Subscribe(
            ...
            __request_or_options__: Presence.SubscribeRequest,
            __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
        ) -> list[Presence.SubscribeResponse]:
            ...
