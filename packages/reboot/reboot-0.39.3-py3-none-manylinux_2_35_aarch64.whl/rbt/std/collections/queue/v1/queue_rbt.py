                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await self.__Dequeue(
                            context,
                            QueueDequeueRequestFromProto(IMPORT_typing.cast(rbt.std.collections.queue.v1.queue_pb2.DequeueRequest, task.request)),
                            validating_effects=validating_effects,
                        )
                        await complete(task, (response, None))
                        return (response, None)
...
class QueueWriterStub(_QueueStub):
    ...
    async def Enqueue(
        ...
        *,
        ...
        proto_request = QueueEnqueueRequestToProto(request)
...
class QueueTasksStub(_QueueStub):
    ...
    async def Dequeue(
        ...
        *,
        ...
        idempotency_key: IMPORT_typing.Optional[IMPORT_uuid.UUID]
        proto_request = QueueDequeueRequestToProto(request)
    ...
    async def Enqueue(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            method_name='Enqueue',
            request=QueueEnqueueRequestToProto(request),
    ...
    async def Dequeue(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Dequeue',
            request=QueueDequeueRequestToProto(request),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
            ) else schedule,
        )
...
class QueueSingletonServicer(QueueBaseServicer):
    ...
    async def _Dequeue(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return QueueDequeueResponseToProto(await self.Dequeue(context, typed_request))
