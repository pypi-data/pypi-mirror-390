...
IMPORT_reboot_versioning.check_generated_code_compatible("0.39.3")
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            SortedMapInsertRequestFromProto(IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.InsertRequest, task.request)),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            SortedMapRemoveRequestFromProto(IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.RemoveRequest, task.request)),
                            bearer_token=__internal_magic_token__,
                            idempotency=IMPORT_reboot_aio_idempotency.Idempotency(
                                alias=f'Task {IMPORT_uuid.UUID(bytes=task.task_id.task_uuid)}',
                            ),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            SortedMapGetRequestFromProto(IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.GetRequest, task.request)),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            SortedMapRangeRequestFromProto(IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.RangeRequest, task.request)),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            SortedMapReverseRangeRequestFromProto(IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest, task.request)),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SortedMapServicerTasks(
                    ...
                    SortedMapInsertRequestFromProto(request),
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SortedMapServicerTasks(
                    ...
                    SortedMapRemoveRequestFromProto(request),
                    schedule=context._headers.task_schedule,
                )
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SortedMapServicerTasks(
                    ...
                    SortedMapGetRequestFromProto(request),
                    schedule=context._headers.task_schedule,
                )
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SortedMapServicerTasks(
                    ...
                    SortedMapRangeRequestFromProto(request),
                    schedule=context._headers.task_schedule,
                )
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SortedMapServicerTasks(
                    ...
                    SortedMapReverseRangeRequestFromProto(request),
                    schedule=context._headers.task_schedule,
                )
...
class SortedMapReaderStub(_SortedMapStub):
    ...
    async def Get(
        ...
        *,
        ...
        proto_request = SortedMapGetRequestToProto(request)
    ...
    async def Range(
        ...
        *,
        ...
        proto_request = SortedMapRangeRequestToProto(request)
    ...
    async def ReverseRange(
        ...
        *,
        ...
        proto_request = SortedMapReverseRangeRequestToProto(request)
...
class SortedMapWriterStub(_SortedMapStub):
    ...
    async def Insert(
        ...
        *,
        ...
        proto_request = SortedMapInsertRequestToProto(request)
    ...
    async def Remove(
        ...
        *,
        ...
        proto_request = SortedMapRemoveRequestToProto(request)
        with self._idempotency_manager.idempotently(
            state_type_name=IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            state_ref=self._headers.state_ref,
            service_name=IMPORT_reboot_aio_types.ServiceName('rbt.std.collections.v1.SortedMapMethods'),
    ...
    async def Get(
        ...
        *,
        ...
        async with self._call(
            ...
            'Get',
            self._rbt_std_collections_v1_sortedmapmethods_stub.Get,
            SortedMapGetRequestToProto(request),
            unary=True,
            reader=True,
            response_type=rbt.std.collections.v1.sorted_map_pb2.GetResponse,
            aborted_type=SortedMap.GetAborted,
    ...
    async def Range(
        ...
        *,
        ...
        async with self._call(
            ...
            'Range',
            self._rbt_std_collections_v1_sortedmapmethods_stub.Range,
            SortedMapRangeRequestToProto(request),
            unary=True,
            reader=True,
            response_type=rbt.std.collections.v1.sorted_map_pb2.RangeResponse,
            aborted_type=SortedMap.RangeAborted,
    ...
    async def ReverseRange(
        ...
        *,
        ...
        async with self._call(
            ...
            'ReverseRange',
            self._rbt_std_collections_v1_sortedmapmethods_stub.ReverseRange,
            SortedMapReverseRangeRequestToProto(request),
            unary=True,
            reader=True,
            response_type=rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse,
            aborted_type=SortedMap.ReverseRangeAborted,
    ...
    async def Insert(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            method_name='Insert',
            request=SortedMapInsertRequestToProto(request),
    ...
    async def Remove(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Remove',
            request=SortedMapRemoveRequestToProto(request),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
            ) else schedule,
        )
    ...
    async def Get(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Get',
            request=SortedMapGetRequestToProto(request),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
            ) else schedule,
        )
    ...
    async def Range(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Range',
            request=SortedMapRangeRequestToProto(request),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
            ) else schedule,
        )
    ...
    async def ReverseRange(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            request=SortedMapReverseRangeRequestToProto(request),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
            ) else schedule,
        )
...
class SortedMap:
    ...
    class WeakReference(IMPORT_typing.Generic[SortedMap_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def Get(
                ...
                __request_or_options__: SortedMap.GetRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[SortedMap.GetResponse]:
                ...
            ...
            async def Get( # type: ignore[misc]
                ...
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __request_or_options__: IMPORT_typing.Optional[SortedMap.GetRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                key: IMPORT_typing.Optional[str] = None,
            ) -> IMPORT_typing.AsyncIterator[SortedMap.GetResponse]:
                ...
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=SortedMap.GetRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=SortedMap.GetRequest)
                ...
                __request__: IMPORT_typing.Optional[SortedMap.GetRequest] = None

                if isinstance(__request_or_options__, SortedMap.GetRequest):
                    ...
                    __request__ = SortedMap.GetRequest(
                        ...
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            __call__ = IMPORT_rbt_v1alpha1.react_pb2_grpc.ReactStub(
                                ...
                                IMPORT_rbt_v1alpha1.react_pb2.QueryRequest(
                                    method='Get',
                                    request=SortedMapGetRequestToProto(
                                        __request__
                                    ).SerializeToString(),
                                ),
                            ...
                            async for __query_response__ in __call__:
                                ...
                                yield SortedMapGetResponseFromProto(__response__)
            ...
            async def Range(
                __this__,
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __request_or_options__: SortedMap.RangeRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[SortedMap.RangeResponse]:
                ...
            ...
            async def Range( # type: ignore[misc]
                ...
                # (B) methods that may reasonably run for a long time, which in Reboot means: readers or workflows.
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __request_or_options__: IMPORT_typing.Optional[SortedMap.RangeRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                start_key: IMPORT_typing.Optional[str] = None,
                end_key: IMPORT_typing.Optional[str] = None,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=SortedMap.RangeRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=SortedMap.RangeRequest)
                IMPORT_reboot_aio_types.assert_type(__context__, [IMPORT_reboot_aio_external.ExternalContext, IMPORT_reboot_aio_contexts.ReaderContext, IMPORT_reboot_aio_contexts.WorkflowContext])

                __request__: IMPORT_typing.Optional[SortedMap.RangeRequest] = None

                if isinstance(__request_or_options__, SortedMap.RangeRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    __request__ = __request_or_options__
                    ...
                    # `google.protobuf.message.Message` constructor arguments are
                    # always non-None, when in reality they are optional.
                    __request__ = SortedMap.RangeRequest(
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            __call__ = IMPORT_rbt_v1alpha1.react_pb2_grpc.ReactStub(
                                ...
                                IMPORT_rbt_v1alpha1.react_pb2.QueryRequest(
                                    method='Range',
                                    request=SortedMapRangeRequestToProto(
                                        __request__
                                    ).SerializeToString(),
                                ),
                                metadata=__metadata__,
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__.ParseFromString(__query_response__.response)
                                yield SortedMapRangeResponseFromProto(__response__)
            ...
            async def ReverseRange(
                __this__,
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __request_or_options__: SortedMap.ReverseRangeRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[SortedMap.ReverseRangeResponse]:
                ...
            ...
            async def ReverseRange( # type: ignore[misc]
                ...
                # (B) methods that may reasonably run for a long time, which in Reboot means: readers or workflows.
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __request_or_options__: IMPORT_typing.Optional[SortedMap.ReverseRangeRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                start_key: IMPORT_typing.Optional[str] = None,
                end_key: IMPORT_typing.Optional[str] = None,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=SortedMap.ReverseRangeRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=SortedMap.ReverseRangeRequest)
                IMPORT_reboot_aio_types.assert_type(__context__, [IMPORT_reboot_aio_external.ExternalContext, IMPORT_reboot_aio_contexts.ReaderContext, IMPORT_reboot_aio_contexts.WorkflowContext])

                __request__: IMPORT_typing.Optional[SortedMap.ReverseRangeRequest] = None

                if isinstance(__request_or_options__, SortedMap.ReverseRangeRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    __request__ = __request_or_options__
                    ...
                    # `google.protobuf.message.Message` constructor arguments are
                    # always non-None, when in reality they are optional.
                    __request__ = SortedMap.ReverseRangeRequest(
                        start_key=start_key, # type: ignore[arg-type]
                        end_key=end_key, # type: ignore[arg-type]
                        limit=limit, # type: ignore[arg-type]
                    )
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            __call__ = IMPORT_rbt_v1alpha1.react_pb2_grpc.ReactStub(
                                ...
                                IMPORT_rbt_v1alpha1.react_pb2.QueryRequest(
                                    method='ReverseRange',
                                    request=SortedMapReverseRangeRequestToProto(
                                        __request__
                                    ).SerializeToString(),
                                ),
                                metadata=__metadata__,
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__.ParseFromString(__query_response__.response)
                                yield SortedMapReverseRangeResponseFromProto(__response__)
        ...
        class _Idempotently(IMPORT_typing.Generic[SortedMap_IdempotentlyScheduleTypeVar]):
            ...
            async def Insert(
                ...
                __request_or_options__: SortedMap.InsertRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> SortedMap.InsertResponse:
                ...
            ...
            async def Insert( # type: ignore[misc]
                ...
                __this__,
                __context__: IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
                __request_or_options__: IMPORT_typing.Optional[SortedMap.InsertRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                entries: IMPORT_typing.Optional[dict[str, bytes]] = None,
            ) -> SortedMap.InsertResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=SortedMap.InsertRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=SortedMap.InsertRequest)

                __request__: IMPORT_typing.Optional[SortedMap.InsertRequest] = None
                if isinstance(__request_or_options__, SortedMap.InsertRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    ...
                    # always non-None, when in reality they are optional.
                    __request__ = SortedMap.InsertRequest(
            ...
            async def Remove(
                __this__,
                __context__: IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
                __request_or_options__: SortedMap.RemoveRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> SortedMap.RemoveResponse:
                ...
            ...
            async def Remove( # type: ignore[misc]
                ...
                __this__,
                __context__: IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
                __request_or_options__: IMPORT_typing.Optional[SortedMap.RemoveRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                keys: IMPORT_typing.Optional[IMPORT_typing.Iterable[str]] = None,
            ) -> SortedMap.RemoveResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=SortedMap.RemoveRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=SortedMap.RemoveRequest)

                __request__: IMPORT_typing.Optional[SortedMap.RemoveRequest] = None
                if isinstance(__request_or_options__, SortedMap.RemoveRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    __options__ = __options__ or IMPORT_reboot_aio_call.Options()
                    ...
                    # `IMPORT_google_protobuf_message.Message` constructor arguments are
                    # always non-None, when in reality they are optional.
                    __request__ = SortedMap.RemoveRequest(
        ...
        class _Until:
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> SortedMap.WeakReference._UntilChangesSatisfies[SortedMap.State]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
            ...
            async def Get(
                ...
                __request_or_options__: SortedMap.GetRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> SortedMap.WeakReference._UntilChangesSatisfies[SortedMap.GetResponse]:
                ...
            ...
            async def Range(
                ...
                __request_or_options__: SortedMap.RangeRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> SortedMap.WeakReference._UntilChangesSatisfies[SortedMap.RangeResponse]:
                ...
            ...
            async def ReverseRange(
                ...
                __request_or_options__: SortedMap.ReverseRangeRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> SortedMap.WeakReference._UntilChangesSatisfies[SortedMap.ReverseRangeResponse]:
                ...
            ...
            def ReverseRange( # type: ignore[misc]
                ...
                *,
                ...
                return SortedMap.WeakReference._UntilChangesSatisfies(
                    ...
                    context=__context__,
                    callable=callable,
                    type=SortedMap.ReverseRangeResponse,
                )
    ...
    class _Forall:
        ...
        async def ReverseRange(
            ...
            __request_or_options__: SortedMap.ReverseRangeRequest,
            __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
        ) -> list[SortedMap.ReverseRangeResponse]:
            ...
