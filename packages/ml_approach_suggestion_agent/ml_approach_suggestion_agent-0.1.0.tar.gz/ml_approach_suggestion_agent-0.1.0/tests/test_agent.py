...
mock_target_column_name = "churn"
mock_target_column_insights = "Binary target"
...
def test_suggest_approach_success(agent):
    ...
    result, cost = agent.suggest_approach(mock_domain.domain_name, mock_domain.domain_description, mock_use_case, mock_column_descriptions, mock_column_insights, mock_target_column_name, mock_target_column_insights)
...
def test_suggest_approach_failure_json(agent):
    ...
    result, cost = agent.suggest_approach(mock_domain.domain_name, mock_domain.domain_description, mock_use_case, mock_column_descriptions, mock_column_insights, mock_target_column_name, mock_target_column_insights, max_try=1)
...
def test_execute_task_success(mock_suggest_approach):
    ...
    task_data = {
        ...
        "target_column_name": mock_target_column_name,
        "target_column_insights": mock_target_column_insights
    }
