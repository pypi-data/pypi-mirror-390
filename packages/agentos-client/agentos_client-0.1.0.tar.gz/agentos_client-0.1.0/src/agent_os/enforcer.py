"""
Policy enforcement interface and HTTP client for Agent‑OS SDK.
...
class HTTPPolicyEnforcer(PolicyEnforcer):
    ...
    def check_policy(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Forward tags/policy if present to allow OPA to evaluate them
        check_request = {
        ...
        if "tags" in request:
            check_request["tags"] = request.get("tags") or []
