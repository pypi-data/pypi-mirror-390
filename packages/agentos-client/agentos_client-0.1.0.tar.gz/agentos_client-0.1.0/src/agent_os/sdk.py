"""
Agent‑OS SDK for policy‑enforced agent execution (remote‑only).
"""
import os
import uuid
import time
...
class Agent:
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"agentos.agent.{agent_id}")
        ...
        self.api_key = api_key or os.getenv("AGENTOS_API_KEY")
    ...
    def get_governance_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_decision": "deny" if denied else "allow",
        }
...
def tool(name: Optional[str] = None, tags: Optional[List[str]] = None):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        wrapper._agentos_tool_name = tool_name  # type: ignore[attr-defined]
        wrapper._agentos_tool_tags = _tool_tags  # type: ignore[attr-defined]
        return wrapper
