...
class APOGEESyn():
    ...
    def __call__(self,pars,snr=None,spobs=None,vrel=None,fluxed=None,wrange=None):
        ...
        # Convolve to APOGEE resolution and wavelength
        if spobs is None:
...
def monte(params=None,nmonte=50,snr=50,initgrid=True,fluxed=False,normalize=False,verbose=True):
    ...
    # Initialize APOGEE spectral simulation object
    bsyn = APOGEESyn(fluxed=fluxed)
...
def test():
    ...
    # Simulate fake APOGEE data with ANN model
    ...
    # need to convolve with the APOGEE LSF
