...
** This File: /bisos/git/bxRepos/bisos-pip/crypt/py3/bin/ucrypt.py
...
#+end_org """
import typing
csInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['ucrypt'], }
csInfo['version'] = '202502115048'
csInfo['status']  = 'inUse'
csInfo['panel'] = 'ucrypt-Panel.org'
...
(setq  b:py:cs:csuList
  (list
   ...
   "bisos.crypt.symCrypt"
 ))
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.crypt.symCrypt |
#+end_org """
...
csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.crypt.symCrypt', ]
