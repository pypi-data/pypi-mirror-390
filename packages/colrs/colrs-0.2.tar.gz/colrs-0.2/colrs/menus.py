...
def menu(title: str, choices: list[str], selected_color: str = "cyan", selected_prefix: str = "> ", unselected_prefix: str = "  ") -> str:
    """
    ...
    try:
        while True:
            ...
            for i, choice in enumerate(choices):
                if i == selected_index:
                    print(f"<{selected_color}>{selected_prefix}{choice}</>")
                else:
                    print(f"{unselected_prefix}{choice}")
