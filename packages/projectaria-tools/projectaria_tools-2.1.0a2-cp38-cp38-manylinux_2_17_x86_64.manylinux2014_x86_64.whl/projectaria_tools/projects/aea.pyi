...
class SentenceData:
    ...
    def words(self) -> dict[int, WordData]:
        ...
    @words.setter
    def words(self, arg0: collections.abc.Mapping[typing.SupportsInt, WordData]) -> None:
        ...
class SpeechDataProvider:
    ...
    def empty(self) -> bool:
        ...
    def get_sentence_data_by_timestamp_ns(self, device_timestamp_ns: typing.SupportsInt, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.project.aea.SentenceData | None:
        """
        ...
        """
    def get_word_data_by_timestamp_ns(self, device_timestamp_ns: typing.SupportsInt, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.project.aea.WordData | None:
        """
