...
class DeliverQueuedOptions(SubstreamSelector):
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __init__(self, arg0: typing.SupportsInt, arg1: typing.SupportsInt, arg2: collections.abc.Mapping[projectaria_tools.core.stream_id.StreamId, typing.SupportsInt]) -> None:
        ...
...
class VrsDataProvider:
    ...
    def get_als_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.AlsConfiguration:
        ...
    def get_als_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.AlsData:
        ...
    def get_als_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.AlsData:
        ...
    ...
    def get_eye_gaze_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.EyeGazeConfiguration:
        ...
    def get_eye_gaze_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> ...:
        ...
    def get_eye_gaze_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> ...:
        ...
    ...
    def get_hand_pose_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.HandPoseConfiguration:
        ...
    def get_hand_pose_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> ...:
        ...
    def get_hand_pose_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> ...:
        ...
    ...
    def get_index_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> int:
        ...
        """
    def get_interpolated_hand_pose_data(self, stream_id: projectaria_tools.core.stream_id.StreamId, timestamp_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain = ...) -> ... | None:
        """
    ...
    def get_ppg_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.PpgConfiguration:
        ...
    def get_ppg_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.PpgData:
        ...
    def get_ppg_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.PpgData:
        ...
    ...
    def get_temperature_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.TemperatureConfiguration:
        ...
    def get_temperature_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.TemperatureData:
        ...
    def get_temperature_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.TemperatureData:
        ...
    ...
    def get_vio_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.VioConfiguration:
        ...
    def get_vio_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.FrontendOutput:
        ...
    def get_vio_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.FrontendOutput:
        ...
    def get_vio_high_freq_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.VioHighFreqConfiguration:
        ...
    def get_vio_high_freq_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> ...:
        ...
    def get_vio_high_freq_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> ...:
        ...
