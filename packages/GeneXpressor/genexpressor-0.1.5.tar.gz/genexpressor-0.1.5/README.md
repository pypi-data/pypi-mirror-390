...
GeneXpressor is a pragmatic DESeq2 runner (Python + rpy2) for bulk RNA-seq differential expression analysis.
It automatically discovers your count and metadata files, runs the full DESeq2 workflow, and produces publication-ready plots and a reproducible HTML report — all from a single command.
