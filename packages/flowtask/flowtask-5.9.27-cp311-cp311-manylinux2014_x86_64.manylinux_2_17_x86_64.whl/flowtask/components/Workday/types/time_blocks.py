...
class TimeBlockType(WorkdayTypeBase):
    ...
    async def execute(self, **kwargs) -> pd.DataFrame:
        ...
        - time_block_id: Specific time block ID to fetch
        ...
        # Build Request_Criteria for filtering
        request_criteria = {}
        ...
        # Specific time block filter
        if time_block_id:
            request_criteria["Worker_Time_Block_Reference"] = [
                {"ID": {"type": "Worker_Time_Block_ID", "_value_1": time_block_id}}
            ]
