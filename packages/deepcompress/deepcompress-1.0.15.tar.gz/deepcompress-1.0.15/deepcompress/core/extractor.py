                    ...
                    if not hasattr(original_class, '_deepcompress_patched'):
                        ...
                        def create_wrapped_forward(orig_forward):
                            def wrapped_forward(self, hidden_states, attention_mask=None,
                                ...
                                if rotary_emb is not None and accepts_position_embeddings and position_embeddings is None:
                                    import torch
                                ...
                                if accepts_position_embeddings:
                                    kwargs_payload["position_embeddings"] = position_embeddings
