...
class MigManExtractFromDatabase:
    ...
    def extract_from_database(self) -> None:
        ...
        try:
            self.logger.info(f"Starting extraction for {self.cfg.setup.source_adapter} ...")
            ...
            match self.cfg.setup.source_adapter:
                ...
                case _:
                    raise ValueError(f"Unknown adapter: {self.cfg.setup.source_adapter}")
...
"""
            ...
            conn.close()
            self.logger.info(f"Completed extraction for {self.cfg.setup.source_adapter}.")
