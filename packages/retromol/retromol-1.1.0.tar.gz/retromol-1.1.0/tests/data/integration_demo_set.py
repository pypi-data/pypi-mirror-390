...
#    name,
#    smiles,
#    expected__coverage_score,
#    [ list_of_expected_optimal_mappings, ... ]
# ),
#
CASES: List[Tuple[str, str, float, List[List[str]]]] = [
    (
        "10-deoxymethynolide",
    ...
    ("2-deoxystreptamine", r"C1C(C(C(C(C1N)O)O)O)N", 1.0, [["glycosylation"], ["streptamine"]]),
    (
    ...
    (
        ...
        0.6,
        [["A2", "C1", "C1", "C1", "D2", "acetic acid", "oxidation"]],
    ),
    (
        "atrop-abyssocymin C",
    ...
    (
        ...
        1.0,
        [["A1", "A2", "B1", "B1", "B1", "B3", "C2", "C2", "D1", "D1", "acetic acid"]],
    ),
    (
        "aflatoxin G1",
    ...
    (
        ...
        1.0,
        [["B1", "B1", "C1", "C1", "C2", "D1", "D13", "D8", "D9", "acetic acid"]],
    ),
    (
        "amphidinolide P",
        r"C[C@@H]1C(=C)C[C@H]2[C@H]3[C@@H](O3)CC(=C)/C=C/[C@H](OC(=O)C[C@@]1(O2)O)[C@H](C)C(=C)C",
        1.0,
        [["2-methylprop-2-enoic acid", "A1", "A8", "A9", "B1", "C1", "C1", "D9", "oxidation"]],
    ),
    (
        "ansamitocin P-3 ",
    ...
    (
        ...
        1.0,
        [
            ["4-amino-2-hydroxybutanoic acid", "glycosylation", "glycosylation", "streptamine"],
            ["D5", "glycine", "glycosylation", "glycosylation", "streptamine"],
        ],
    ),
    (
        "butirosin B",
    ...
    (
        ...
        [["A2", "B1", "B2", "B5", "C1", "C2", "D2", "D2", "methylation"]],
    ),
    (
        "chaetoglobosin A",
    ...
    (
        ...
        1.0,
        [["C1", "D11", "D15", "glycine", "methylation"]],
    ),
    (
        "chlorotonil A",
    ...
    (
        ...
        [
            [
                ...
                "D1",
                "acetic acid",
                "artificial amino acid harzianic acid",
                "methylation",
            ]
        ],
    ),
    ...
    (
        # TODO: find fix for cases like this where it is unclear what the start of polyketide parsing is...
        "leiodermatolide",
    ...
    (
        ...
        1.0,
        [["2,3-diaminopropionate", "B1", "B12", "B5", "amination", "carbamic acid", "serine"]],
    ),
    (
        "enterobactin",
    ...
    (
        ...
        [
            [
                "3-hydroxy-2,2-dimethyldecanoic acid",
                "N6-formyl-N6-hydroxylysine",
                "N6-hydroxylysine",
                "salicylic acid",
                "threonine",
            ],
    ...
    (
        ...
        1.0,
        [["3-hydroxyquinaldic acid", "3-methylbutanoic acid", "5-hydroxylysine"]],
    ),
    (
        "NRP with intramolecular threoine-cysteine bridges",
