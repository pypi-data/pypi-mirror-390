...
from pytorch_lightning_enterprise.utils.imports import _NEPTUNE_AVAILABLE
from pytorch_lightning_enterprise.utils.logger import _add_prefix, _convert_params, _sanitize_callable_params
    ...
    **Details about Neptune run structure**
    ...
    def __init__(
        ...
        **neptune_run_kwargs: Any,
        ...
        if self._run_instance is not None:
            ...
            root_obj[_INTEGRATION_VERSION_KEY] = pl_version
    ...
    def run(self) -> "Run":
        ...
        if not self._run_instance:
            ...
            self._run_instance[_INTEGRATION_VERSION_KEY] = pl_version
    ...
    @staticmethod
    def _get_full_model_name(model_path: str, checkpoint_callback: ModelCheckpointProtocol) -> str:
