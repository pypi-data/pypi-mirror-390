...
from pytorch_lightning_enterprise.utils.imports import _MLFLOW_AVAILABLE, _MLFLOW_SYNCHRONOUS_AVAILABLE
...
class MLFlowLogger(Logger):
    ...
    def __init__(
        ...
        self._checkpoint_callback: Optional[ModelCheckpointProtocol] = None
        self._prefix = prefix
    ...
    def _log_checkpoint_artifact(
        ...
        artifact_path = Path(checkpoint_path).stem

        # Log the checkpoint
        self.experiment.log_artifact(self._run_id, checkpoint_path, artifact_path)
