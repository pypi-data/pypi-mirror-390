...
from pytorch_lightning_enterprise.utils.imports import _XLA_AVAILABLE, _XLA_GREATER_EQUAL_2_1, _XLA_GREATER_EQUAL_2_5
from pytorch_lightning_enterprise.utils.license_validation import LicenseValidator
from pytorch_lightning_enterprise.utils.types import _check_data_type


class XLAAccelerator(LicenseValidator):
