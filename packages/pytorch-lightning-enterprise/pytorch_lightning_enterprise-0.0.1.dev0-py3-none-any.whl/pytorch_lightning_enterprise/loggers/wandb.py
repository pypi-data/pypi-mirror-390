...
from pytorch_lightning_enterprise.utils.imports import _WANDB_AVAILABLE
from pytorch_lightning_enterprise.utils.logger import _add_prefix
    ...
    **Downloading and Using Artifacts**
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._checkpoint_callbacks: dict[int, ModelCheckpointProtocol] = {}
    ...
    def log_hyperparams(self, params: Union[dict[str, Any], Namespace]) -> None:
        # TODO: Resolve this (or should we handle conversion and sanitization in parent class?)
        # TODO: Should we have a generic logger class that handles this in PL, this is probably common
        #   functionality across loggers?
        try:
    ...
    def _scan_and_log_checkpoints(self, checkpoint_callback: ModelCheckpointProtocol) -> None:
        ...
        # TODO: Resolve this (potentially just have this in parent class?
        #   Seems like common functionality across loggers?)
        try:
