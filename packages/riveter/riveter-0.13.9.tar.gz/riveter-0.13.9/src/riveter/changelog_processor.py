...
class ChangelogProcessor:
    ...
    def find_unreleased_section(self, sections: list[ChangelogSection]) -> ChangelogSection | None:
    ...
    def update_changelog_for_release(self, version: str, release_date: str | None = None) -> str:
    ...
    def extract_release_notes(self, version: str, content: str | None = None) -> ReleaseNotes:
    ...
    def generate_fallback_release_notes(
        self, version: str, previous_version: str | None = None
    ) -> str:
