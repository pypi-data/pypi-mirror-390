...
def test_pr_summary(date: str, expected_count: int):
    """Test creating a PR summary for a specific date."""
    print(f"\n{'='*80}")
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        agent = Agent(workspace_root=tmpdir)
...
def main():
    ...
    for date, expected_count in test_cases:
        ...
        success = test_pr_summary(date, expected_count)
