...
def get_supabase_client() -> Client:
    ...
    if not supabase_url:
        raise ValueError(
            "SUPABASE_URL not configured. Set it in your .env file or environment variables.\n"
            "You can find it in your Supabase Dashboard: Settings → API → Project URL"
        )
    
    if not supabase_key:
        raise ValueError(
            "SUPABASE_KEY not configured. Set it in your .env file or environment variables.\n"
            "You can find it in your Supabase Dashboard: Settings → API → anon/public key"
        )
