                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await self.__HandleMessage(
                            context,
                            SessionHandleMessageRequestFromProto(IMPORT_typing.cast(rbt.mcp.v1.session_pb2.HandleMessageRequest, task.request)),
                            validating_effects=validating_effects,
                        )
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await self.__Run(
                            context,
                            SessionRunRequestFromProto(IMPORT_typing.cast(rbt.mcp.v1.session_pb2.RunRequest, task.request)),
                            validating_effects=validating_effects,
                        )
                        await complete(task, (response, None))
                        return (response, None)
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SessionWorkflowStub(
                            ...
                            SessionGetRequestFromProto(IMPORT_typing.cast(rbt.mcp.v1.session_pb2.GetRequest, task.request)),
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SessionServicerTasks(
                    ...
                    SessionHandleMessageRequestFromProto(request),
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SessionServicerTasks(
                    ...
                    SessionRunRequestFromProto(request),
                    schedule=context._headers.task_schedule,
                )
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SessionServicerTasks(
                    ...
                    SessionGetRequestFromProto(request),
                    schedule=context._headers.task_schedule,
                )
...
class SessionReaderStub(_SessionStub):
    ...
    async def Get(
        ...
        *,
        ...
        proto_request = SessionGetRequestToProto(request)
    ...
    async def Get(
        ...
        *,
        ...
        async with self._call(
            ...
            'Get',
            self._rbt_mcp_v1_sessionmethods_stub.Get,
            SessionGetRequestToProto(request),
            unary=True,
            reader=True,
            response_type=rbt.mcp.v1.session_pb2.GetResponse,
            aborted_type=Session.GetAborted,
...
class SessionTasksStub(_SessionStub):
    ...
    async def HandleMessage(
        ...
        *,
        ...
        proto_request = SessionHandleMessageRequestToProto(request)
    ...
    async def Run(
        ...
        *,
        ...
        idempotency_key: IMPORT_typing.Optional[IMPORT_uuid.UUID]
        proto_request = SessionRunRequestToProto(request)
    ...
    async def HandleMessage(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            request=SessionHandleMessageRequestToProto(request),
    ...
    async def Run(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Run',
            request=SessionRunRequestToProto(request),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
            ) else schedule,
        )
    ...
    async def Get(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Get',
            request=SessionGetRequestToProto(request),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
            ) else schedule,
        )
...
class SessionSingletonServicer(SessionBaseServicer):
    ...
    async def _HandleMessage(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return SessionHandleMessageResponseToProto(await self.HandleMessage(context, typed_request))
    ...
    async def _Run(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return SessionRunResponseToProto(await self.Run(context, typed_request))
    ...
    class WeakReference(IMPORT_typing.Generic[Session_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def Get(
                ...
                __request_or_options__: Session.GetRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[Session.GetResponse]:
                ...
            ...
            async def Get( # type: ignore[misc]
                ...
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __request_or_options__: IMPORT_typing.Optional[Session.GetRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[Session.GetResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=Session.GetRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=Session.GetRequest)
                ...
                __request__: IMPORT_typing.Optional[Session.GetRequest] = None

                if isinstance(__request_or_options__, Session.GetRequest):
                    ...
                    __request__ = Session.GetRequest(
                    )
                        ...
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            __call__ = IMPORT_rbt_v1alpha1.react_pb2_grpc.ReactStub(
                                ...
                                IMPORT_rbt_v1alpha1.react_pb2.QueryRequest(
                                    method='Get',
                                    request=SessionGetRequestToProto(
                                        __request__
                                    ).SerializeToString(),
                                ),
                            ...
                            async for __query_response__ in __call__:
                                ...
                                yield SessionGetResponseFromProto(__response__)
        ...
        class _Idempotently(IMPORT_typing.Generic[Session_IdempotentlyScheduleTypeVar]):
            ...
            async def HandleMessage(
                ...
                __request_or_options__: Session.HandleMessageRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> Session.HandleMessageResponse:
                ...
            ...
            async def HandleMessage(
                ...
                *,
                ...
                access_token: IMPORT_typing.Optional[google.protobuf.struct_pb2.Value] = None,
            ) -> Session.HandleMessageResponse:
                ...

            async def HandleMessage( # type: ignore[misc]
                # In methods which are dealing with user input, (i.e.,
                # proto message field names), we should use '__double_underscored__'
                # variables to avoid any potential name conflicts with the method's
                # parameters.
                ...
                __this__,
                __context__: IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
                __request_or_options__: IMPORT_typing.Optional[Session.HandleMessageRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                path: IMPORT_typing.Optional[str] = None,
                message_bytes: IMPORT_typing.Optional[bytes] = None,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=Session.HandleMessageRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=Session.HandleMessageRequest)
                ...
                if isinstance(__request_or_options__, Session.HandleMessageRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    ...
                    if access_token is not None and not isinstance(
                        access_token,
                        google.protobuf.struct_pb2.Value,
                    ):
                        raise TypeError(
                            f"Can not construct protobuf message of type "
                            f"'rbt.mcp.v1.session_pb2.HandleMessageRequest': field 'access_token' is not "
            ...
            async def Run(
                __this__,
                __context__: IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
                __request_or_options__: Session.RunRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> Session.RunResponse:
                ...
            ...
            async def Run( # type: ignore[misc]
                ...
                __this__,
                __context__: IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
                __request_or_options__: IMPORT_typing.Optional[Session.RunRequest | IMPORT_reboot_aio_call.Options] = None,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                path: IMPORT_typing.Optional[str] = None,
                message_bytes: IMPORT_typing.Optional[bytes] = None,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=Session.RunRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=Session.RunRequest)
                ...
                if isinstance(__request_or_options__, Session.RunRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    __options__ = __options__ or IMPORT_reboot_aio_call.Options()
                    ...
                    if access_token is not None and not isinstance(
                        ...
                        raise TypeError(
                            f"Can not construct protobuf message of type "
                            f"'rbt.mcp.v1.session_pb2.RunRequest': field 'access_token' is not "
                            f"of required type 'google.protobuf.struct_pb2.Value'"
                        )
        ...
        class _Until:
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> Session.WeakReference._UntilChangesSatisfies[Session.State]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            async def Get(
                ...
                __request_or_options__: Session.GetRequest,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> Session.WeakReference._UntilChangesSatisfies[Session.GetResponse]:
                ...
        ...
        class _Schedule:
            ...
            async def HandleMessage( # type: ignore[misc]
                ...
                *,
                ...
                __request__: IMPORT_typing.Optional[Session.HandleMessageRequest] = None
                if isinstance(__request_or_options__, Session.HandleMessageRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    ...
                    # `IMPORT_google_protobuf_message.Message` constructor arguments are
                    # always non-None, when in reality they are optional.
                    __request__ = Session.HandleMessageRequest(
            ...
            async def Run( # type: ignore[misc]
                ...
                *,
                ...
                __request__: IMPORT_typing.Optional[Session.RunRequest] = None
                if isinstance(__request_or_options__, Session.RunRequest):
                    assert __request_or_options__ is not None
                    assert __options__ is None or isinstance(__options__, IMPORT_reboot_aio_call.Options)
                    ...
                    # `IMPORT_google_protobuf_message.Message` constructor arguments are
                    # always non-None, when in reality they are optional.
                    __request__ = Session.RunRequest(
                        path=path, # type: ignore[arg-type]
                        message_bytes=message_bytes, # type: ignore[arg-type]
                        access_token=access_token, # type: ignore[arg-type]
                    )
