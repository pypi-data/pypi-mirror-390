...
class LegalCorpus:
    ...
    def _detect_corpus_type(self, dir_of_text_files):
        ...
        # Sample first folder to determine pattern
        sample = folders[0]
    ...
    def _read_coca_structure(self, dir_of_text_files, show_progress, show_file_progress, log_every):
        """Parse COCA corpus structure: text_GENRE_YEAR format.
        
        Returns: {genre: {year: DataFrame}}
        """
        coca_dict = {}
        ...
        for genre_folder in genre_iter:
            ...
            print(f"Processing COCA genre: {genre}")
            ...
            for filename in file_iter:
                ...
                text_rows = self._parse_corpus_file(os.path.join(genre_path, filename), log_every, genre, 0)
    ...
    def _read_glowbe_structure(self, dir_of_text_files, show_progress, show_file_progress, log_every):
        ...
        for folder in folder_iter:
            ...
            files = [fn for fn in os.listdir(folder_path) if fn.startswith('text_') and fn.endswith('.txt')]
