...
class CfnIndexProps:
    def __init__(
        ...
        *,
        ...
        :param data_type: The data type of the vectors to be inserted into the vector index.
        ...
        :param vector_bucket_arn: The Amazon Resource Name (ARN) of the vector bucket.
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_s3vectors.IIndexRef")
class IIndexRef(
...
class _IIndexRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_s3vectors.IIndexRef"
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_s3vectors.IVectorBucketPolicyRef")
...
class _IVectorBucketPolicyRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_s3vectors.IVectorBucketPolicyRef"
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_s3vectors.IVectorBucketRef")
...
class _IVectorBucketRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_s3vectors.IVectorBucketRef"
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_s3vectors.IndexReference",
    jsii_struct_bases=[],
...
class IndexReference:
    def __init__(self, *, index_arn: builtins.str) -> None:
        ...
        Example::
            ...
            index_reference = s3vectors.IndexReference(
                index_arn="indexArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__260624b6050b971d321119e01841a936ebc5185f1b3ecaa2d0a290a19c8969e5)
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_s3vectors.VectorBucketPolicyReference",
    jsii_struct_bases=[],
...
class VectorBucketPolicyReference:
    def __init__(self, *, vector_bucket_arn: builtins.str) -> None:
        ...
        Example::
            ...
            vector_bucket_policy_reference = s3vectors.VectorBucketPolicyReference(
                vector_bucket_arn="vectorBucketArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1f009a12768c476fdf2328dfd2f0f0820f0902514a8d86b51553c2a7b37b9c50)
            check_type(argname="argument vector_bucket_arn", value=vector_bucket_arn, expected_type=type_hints["vector_bucket_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_s3vectors.VectorBucketReference",
    jsii_struct_bases=[],
    name_mapping={"vector_bucket_arn": "vectorBucketArn"},
)
class VectorBucketReference:
    def __init__(self, *, vector_bucket_arn: builtins.str) -> None:
        ...
        Example::
            ...
            vector_bucket_reference = s3vectors.VectorBucketReference(
                vector_bucket_arn="vectorBucketArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fe9ec2df44bb982d09decb41d0644cea49f1b89bb7f7fecf2c19e83dae5c0604)
            check_type(argname="argument vector_bucket_arn", value=vector_bucket_arn, expected_type=type_hints["vector_bucket_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "vector_bucket_arn": vector_bucket_arn,
        }
...
@jsii.implements(_IInspectable_c2943556, IVectorBucketRef)
    ...
    class EncryptionConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            :param kms_key_arn: AWS Key Management Service (KMS) customer managed key ID to use for the encryption configuration. This parameter is allowed if and only if sseType is set to aws:kms
            :param sse_type: The server-side encryption type to use for the encryption configuration of the vector bucket. By default, if you don't specify, all new vectors in Amazon S3 vector buckets use server-side encryption with Amazon S3 managed keys (SSE-S3), specifically AES256. Default: - "AES256"
...
@jsii.implements(_IInspectable_c2943556, IVectorBucketPolicyRef)
...
def _typecheckingstub__260624b6050b971d321119e01841a936ebc5185f1b3ecaa2d0a290a19c8969e5(
    *,
...
def _typecheckingstub__1f009a12768c476fdf2328dfd2f0f0820f0902514a8d86b51553c2a7b37b9c50(
    *,
...
def _typecheckingstub__fe9ec2df44bb982d09decb41d0644cea49f1b89bb7f7fecf2c19e83dae5c0604(
    *,
    vector_bucket_arn: builtins.str,
) -> None:
    """Type checking stubs"""
