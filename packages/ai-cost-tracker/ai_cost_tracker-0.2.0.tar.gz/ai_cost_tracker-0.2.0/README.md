...
[![PyPI version](https://badge.fury.io/py/ai-cost-tracker.svg)](https://badge.fury.io/py/ai-cost-tracker)
...
### Other Languages
See [EXAMPLES.md](EXAMPLES.md) for Ruby, PHP, Go, Vue.js, and more!
...
- **[Setup Guide](SETUP_GUIDE.md)** - Complete setup instructions for all languages
- **[Examples](EXAMPLES.md)** - Code examples for Python, Node.js, React, Vue, Ruby, PHP, Go
- **[JavaScript SDK](js/README.md)** - Full documentation for npm package

## 🙏 Support

- **Issues**: GitHub Issues
- **Documentation**: See docs in repository
- **PyPI**: https://pypi.org/project/ai-cost-tracker/
- **npm**: Coming soon!
