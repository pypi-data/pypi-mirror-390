...
[![Changelog](https://img.shields.io/pypi/v/login-auth-tui?pypiBaseUrl=https://test.pypi.org)](https://git.sr.ht/~nwgh/login-auth-tui/log)
...
```bash
uv tool installl auth-manage --from login-auth-tui
```
