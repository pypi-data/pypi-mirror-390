...
class Engine:
    def __init__(self, width:int=500, height:int=500, name:str="GamEngine2D", resizable:bool=True, background_color:Color=Color.black, background_image:str=None, background_music:str=None, music_loops:int=-1, music_volume:float=.8) -> None:
        ...
        self._background_music_path = background_music
    ...
    def run(self, fps=60, dynamic_view=True, zoom=None, pan=None):
        ...
        if self.background_music_path is not None:
            pygame.mixer.music.play(loops=self.music_loops)
    ...
    @background_music_path.setter
    def background_music_path(self, path):
        self._background_music_path = path
