...
This project is a fork of [python-capture-device-list](https://github.com/yushulx/python-capture-device-list) by Xiao Ling (yushulx), optimized for microscope cameras on Windows with additional features and modern Python tooling.
