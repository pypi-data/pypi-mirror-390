...
> **Note:** This is a personal fork optimized for microscope cameras on Windows.
>
> **Original Project:** [python-capture-device-list](https://github.com/yushulx/python-capture-device-list) by [Xiao Ling (yushulx)](https://github.com/yushulx)
>
...
**Version bumping:**
```bash
python scripts/bump_version.py patch  # 1.1.2 -> 1.1.3 (bug fixes)
python scripts/bump_version.py minor  # 1.1.2 -> 1.2.0 (new features)
python scripts/bump_version.py major  # 1.1.2 -> 2.0.0 (breaking changes)
```
