...
class _NumpyPermuteArrayImpl:
    def __init__(self, **hyperparams):
        self._wrapped_model = autoai_libs.transformers.exportable.NumpyPermuteArray(**hyperparams)
...
NumpyPermuteArray = lale.operators.make_operator(_NumpyPermuteArrayImpl, _combined_schemas)
