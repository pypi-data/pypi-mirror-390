...
class _Word2VecTransformerImpl:
    def __init__(self, **hyperparams):
        ...
        self._wrapped_model = autoai_libs.transformers.text_transformers.Word2VecTransformer(**hyperparams)
...
Word2VecTransformer = lale.operators.make_operator(_Word2VecTransformerImpl, _combined_schemas)
