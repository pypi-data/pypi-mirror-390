...
class _OptStandardScalerImpl:
    def __init__(self, **hyperparams):
        self._wrapped_model = autoai_libs.transformers.exportable.OptStandardScaler(**hyperparams)
...
OptStandardScaler = lale.operators.make_operator(_OptStandardScalerImpl, _combined_schemas)
