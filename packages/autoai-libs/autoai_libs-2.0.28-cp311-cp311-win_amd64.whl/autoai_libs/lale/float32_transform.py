...
class _float32_transformImpl:
    def __init__(self, **hyperparams):
        ...
        self._wrapped_model = autoai_libs.transformers.exportable.float32_transform(**hyperparams)
...
float32_transform = lale.operators.make_operator(_float32_transformImpl, _combined_schemas)
