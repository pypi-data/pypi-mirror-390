...
def opt_standard_scaler_shape_calculator(operator: Operator):
...
def opt_standard_scaler_converter(scope: Scope, operator: Operator, container: ModelComponentContainer):
