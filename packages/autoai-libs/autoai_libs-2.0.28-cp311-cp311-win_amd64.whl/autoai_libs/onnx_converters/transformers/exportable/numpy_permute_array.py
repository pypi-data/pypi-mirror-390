...
def numpy_permute_array_transformer_shape_calculator(operator: Operator):
...
def numpy_permute_array_transformer_converter(scope: Scope, operator: Operator, container: ModelComponentContainer):
