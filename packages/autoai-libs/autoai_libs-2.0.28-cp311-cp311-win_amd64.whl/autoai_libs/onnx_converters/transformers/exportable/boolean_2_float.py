...
################################################################################
import onnx
from onnxconverter_common import apply_concat, apply_cast, apply_identity
...
def boolean2float_shape_calculator(operator: Operator):
...
def boolean2float_converter(scope: Scope, operator: Operator, container: ModelComponentContainer):
