...
from skl2onnx.common.data_types import FloatTensorType, guess_proto_type, Int64TensorType
...
def autoai_libs_xgb_converter_shape_calculator(operator: Operator):
...
def autoai_libs_xgb_converter(scope: Scope, operator: Operator, container: ModelComponentContainer):
