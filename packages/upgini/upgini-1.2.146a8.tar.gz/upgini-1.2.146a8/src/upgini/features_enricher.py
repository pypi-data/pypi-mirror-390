...
class FeaturesEnricher(TransformerMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.onehot_encoded_groups: dict[str, list[str]] = {}
        self.pseudo_one_hot_encoded_features: list[str] = []
    ...
    def __get_enriched_as_input(
        ...
        normalizer.onehot_encoded_groups = self.onehot_encoded_groups
        normalizer.pseudo_one_hot_encoded_features = self.pseudo_one_hot_encoded_features
...
"""
    ...
    def _selecting_input_and_generated_columns(
        ...
        onehot_encoded_features = [
            f for group in self.onehot_encoded_groups.values() for f in group
        ]
        new_columns_on_transform = [
            c
            for c in validated_Xy.columns
            if c not in fit_input_columns and c not in original_dropped_features and c not in onehot_encoded_features
        ]
        ...
        selected_onehot_encoded_features = [
            c
            for cat_feature, group in self.onehot_encoded_groups.items()
            for c in group
        ...
        return selected_input_columns + selected_generated_features + selected_onehot_encoded_features
    ...
    def __inner_fit(
        ...
        *,
        ...
        self.onehot_encoded_groups = normalizer.onehot_encoded_groups
        self.pseudo_one_hot_encoded_features = normalizer.pseudo_one_hot_encoded_features
        ...
        features_to_drop, feature_validator_warnings = FeaturesValidator(self.logger).validate(
            ...
            self.fit_columns_renaming,
            self.pseudo_one_hot_encoded_features,
        )
