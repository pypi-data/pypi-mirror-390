...
class SMTPProvider(BaseEmailProvider):
    ...
    def send_email(self, to: str, subject: str, body: str, bcc: list = None, attachments: list = None, **kwargs) -> bool:
        try:
            message, recipients = self._create_message(to, subject, body, bcc, attachments)
    ...
    def _create_message(self, to: str, subject: str, body: str, bcc: list = None, attachments: list = None) -> tuple:
        bcc = bcc or []
