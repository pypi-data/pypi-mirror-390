...
class WaterConsumptionSpider(scrapy.Spider):
    ...
    def handle_login_response(self, response):
        ...
        if response_parts[5] == "pageRedirect":
            ...
            yield scrapy.Request(url=main_info_url, callback=self.handle_main_info_response)
        else:
    ...
    def handle_main_info_response(self, response):
        ...
        yield scrapy.Request(url=suezsmartsolutions_login_url, callback=self.handle_suezsmartsolutions_login_response)
