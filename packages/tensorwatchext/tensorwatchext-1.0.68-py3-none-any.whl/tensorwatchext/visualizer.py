...
class Visualizer:
    ...
    def _get_vis_base(self, vis_type, cell:VisBase.widgets.Box, title, hover_images=None, hover_image_reshape=None, cell_width=None, cell_height=None, **vis_args)->VisBase:
        if vis_type is None or vis_type in ['line',
            ...
            return mpl.line_plot.LinePlot(cell=cell, title=title, cell_width=cell_width, cell_height=cell_height, #window_width=window_width, #window_width  added fro cutting old values
        ...
        if vis_type in ['line3d', 'scatter', 'scatter3d',
            ...
            return plotly.line_plot.LinePlot(cell=cell, title=title, cell_width=cell_width, cell_height=cell_height, #window_width=window_width,#window_width  added fro cutting old values
                                   is_3d=vis_type.endswith('3d'), **vis_args)
