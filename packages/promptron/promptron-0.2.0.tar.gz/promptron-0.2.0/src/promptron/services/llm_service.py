                ...
                for prompt_config in prompt_configs:
                    ...
                    if isinstance(prompt_config, dict):
                        for key, value in prompt_config.items():
                            if key not in ["category", "topic", "count"]:
