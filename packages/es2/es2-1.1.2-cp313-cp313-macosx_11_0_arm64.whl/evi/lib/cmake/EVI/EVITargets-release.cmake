...
set_target_properties(EVI::EVI PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libEVI.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libEVI.dylib"
  )

list(APPEND _cmake_import_check_targets EVI::EVI )
list(APPEND _cmake_import_check_files_for_EVI::EVI "${_IMPORT_PREFIX}/lib/libEVI.dylib" )
