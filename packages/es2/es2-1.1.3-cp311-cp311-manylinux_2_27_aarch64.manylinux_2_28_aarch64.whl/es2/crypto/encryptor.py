...
class Encryptor:
    ...
    def encrypt(self, msg: List[float], encoding: str):
        ...
        return self.encryptor.encrypt(msg, self._enc_key_path, enc_type.encoding_type, False)  # No considering qf now
    ...
    def encrypt_multiple(self, msg: List[List[float]], encoding: str):
        ...
        return self.encryptor.encrypt_bulk(msg, self._enc_key_path, enc_type.encoding_type, False)
