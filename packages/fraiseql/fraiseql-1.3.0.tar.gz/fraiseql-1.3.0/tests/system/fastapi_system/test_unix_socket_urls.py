...
class TestUnixSocketURLs:
    ...
    def test_validate_postgres_url_with_socket(self):
    ...
    def test_validate_postgres_url_with_regular_url(self):
    ...
    def test_validate_postgres_url_invalid(self):
    ...
    def test_fraiseql_config_with_socket_url(self):
    ...
    def test_fraiseql_config_env_var_socket_url(self, monkeypatch):
