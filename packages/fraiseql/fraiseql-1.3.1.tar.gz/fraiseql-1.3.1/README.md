...
**📍 You are here: Main FraiseQL Framework (v1.3.1) - Production Stable**
...
|---------|----------|--------|---------|------------|
| **v1.3.1** | Root level | Production Stable | Latest stable release | ✅ Recommended |
| **Rust Pipeline** | [`fraiseql_rs/`](fraiseql_rs/) | Integrated | Included in v1.0+ | ✅ Stable |
| **v1.3.0** | Superseded | Legacy | Use v1.3.1 | ⚠️ Migrate |
