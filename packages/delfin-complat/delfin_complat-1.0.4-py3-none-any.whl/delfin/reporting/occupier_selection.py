...
class OccupierSelector:
    ...
    def _load_parameters(self):
        ...
        # Window parameters
        self.EPS_AF = float(self.config.get('bs_override_window_h', 0.002))
        ...
        self.CLEAN_OVERRIDE_H = float(self.config.get('clean_override_window_h', 0.003))
        ...
        self.CLEAN_BIAS_H = float(self.config.get('clean_bias_window_h', 0.003))
