...
// video
#define PNANOVDB_COMPUTE_FORMAT_G8_B8R8_2PLANE_420_UNORM 40
#define PNANOVDB_COMPUTE_FORMAT_G8_B8_R8_3PLANE_420_UNORM 41
// Reserved maximum count
#define PNANOVDB_COMPUTE_FORMAT_COUNT 256

typedef pnanovdb_uint32_t pnanovdb_compute_texture_aspect_t;
#define PNANOVDB_COMPUTE_TEXTURE_ASPECT_NONE 0
#define PNANOVDB_COMPUTE_TEXTURE_ASPECT_COLOR 0x01
#define PNANOVDB_COMPUTE_TEXTURE_ASPECT_PLANE_0 0x10
#define PNANOVDB_COMPUTE_TEXTURE_ASPECT_PLANE_1 0x20
#define PNANOVDB_COMPUTE_TEXTURE_ASPECT_PLANE_2 0x40
...
typedef void(PNANOVDB_ABI* pnanovdb_compute_thread_pool_task_t)(pnanovdb_uint32_t task_idx,
...
typedef struct pnanovdb_compute_interface_t
{
    ...
    pnanovdb_bool_t(PNANOVDB_ABI* is_feature_supported)(pnanovdb_compute_context_t* context,
                                                        pnanovdb_compute_feature_t feature);
    ...
    void(PNANOVDB_ABI* execute_tasks)(pnanovdb_compute_context_t* context,
                                      pnanovdb_uint32_t task_count,
                                      pnanovdb_uint32_t task_granularity,
                                      pnanovdb_compute_thread_pool_task_t task,
                                      void* userdata);


    pnanovdb_compute_buffer_t*(PNANOVDB_ABI* create_buffer)(pnanovdb_compute_context_t* context,
                                                            pnanovdb_compute_memory_type_t memory_type,
    ...
    pnanovdb_compute_buffer_transient_t*(PNANOVDB_ABI* get_buffer_transient)(pnanovdb_compute_context_t* context,
                                                                             const pnanovdb_compute_buffer_desc_t* desc);

    pnanovdb_compute_buffer_transient_t*(PNANOVDB_ABI* register_buffer_as_transient)(pnanovdb_compute_context_t* context,
                                                                                     pnanovdb_compute_buffer_t* buffer);

    pnanovdb_compute_buffer_transient_t*(PNANOVDB_ABI* alias_buffer_transient)(pnanovdb_compute_context_t* context,
                                                                               pnanovdb_compute_buffer_transient_t* buffer,
                                                                               pnanovdb_compute_format_t format,
                                                                               pnanovdb_uint32_t structure_stride);

    pnanovdb_compute_buffer_acquire_t*(PNANOVDB_ABI* enqueue_acquire_buffer)(pnanovdb_compute_context_t* context,
                                                                             pnanovdb_compute_buffer_transient_t* buffer);

    pnanovdb_bool_t(PNANOVDB_ABI* get_acquired_buffer)(pnanovdb_compute_context_t* context,
                                                       pnanovdb_compute_buffer_acquire_t* acquire,
                                                       pnanovdb_compute_buffer_t** outBuffer);
    ...
    void(PNANOVDB_ABI* get_buffer_external_handle)(pnanovdb_compute_context_t* context,
                                                   pnanovdb_compute_buffer_t* buffer,
                                                   pnanovdb_compute_interop_handle_t* dstHandle);

    void(PNANOVDB_ABI* close_buffer_external_handle)(pnanovdb_compute_context_t* context,
                                                     pnanovdb_compute_buffer_t* buffer,
                                                     const pnanovdb_compute_interop_handle_t* srcHandle);

    pnanovdb_compute_buffer_t*(PNANOVDB_ABI* create_buffer_from_external_handle)(
    ...
    pnanovdb_compute_texture_t*(PNANOVDB_ABI* create_texture)(pnanovdb_compute_context_t* context,
                                                              const pnanovdb_compute_texture_desc_t* desc);

    void(PNANOVDB_ABI* destroy_texture)(pnanovdb_compute_context_t* context, pnanovdb_compute_texture_t* texture);

    pnanovdb_compute_texture_transient_t*(PNANOVDB_ABI* get_texture_transient)(pnanovdb_compute_context_t* context,
                                                                               const pnanovdb_compute_texture_desc_t* desc);

    pnanovdb_compute_texture_transient_t*(PNANOVDB_ABI* register_texture_as_transient)(
        pnanovdb_compute_context_t* context, pnanovdb_compute_texture_t* texture);

    pnanovdb_compute_texture_transient_t*(PNANOVDB_ABI* alias_texture_transient)(
        pnanovdb_compute_context_t* context,
        pnanovdb_compute_texture_transient_t* texture,
        pnanovdb_compute_format_t format,
        pnanovdb_compute_texture_aspect_t aspect);

    pnanovdb_compute_texture_acquire_t*(PNANOVDB_ABI* enqueue_acquire_texture)(
        pnanovdb_compute_context_t* context, pnanovdb_compute_texture_transient_t* texture);

    pnanovdb_bool_t(PNANOVDB_ABI* get_acquired_texture)(pnanovdb_compute_context_t* context,
                                                        pnanovdb_compute_texture_acquire_t* acquire,
                                                        pnanovdb_compute_texture_t** outTexture);


    pnanovdb_compute_sampler_t*(PNANOVDB_ABI* create_sampler)(pnanovdb_compute_context_t* context,
                                                              const pnanovdb_compute_sampler_desc_t* desc);
    ...
    pnanovdb_compute_pipeline_t*(PNANOVDB_ABI* create_compute_pipeline)(pnanovdb_compute_context_t* context,
                                                                        const pnanovdb_compute_pipeline_desc_t* desc);

    void(PNANOVDB_ABI* destroy_compute_pipeline)(pnanovdb_compute_context_t* context,
                                                 pnanovdb_compute_pipeline_t* pipeline);
...
struct pnanovdb_compute_encoder_desc_t;
typedef struct pnanovdb_compute_encoder_desc_t pnanovdb_compute_encoder_desc_t;

struct pnanovdb_compute_encoder_desc_t
{
    pnanovdb_uint32_t width;
    pnanovdb_uint32_t height;
    pnanovdb_uint32_t fps;
};
...
struct pnanovdb_compute_encoder_t;
typedef struct pnanovdb_compute_encoder_t pnanovdb_compute_encoder_t;
...
typedef void(PNANOVDB_ABI* pnanovdb_profiler_report_t)(void* userdata,
...
typedef struct pnanovdb_compute_device_interface_t
{
    ...
    pnanovdb_bool_t(PNANOVDB_ABI* enumerate_devices)(pnanovdb_compute_device_manager_t* manager,
                                                     pnanovdb_uint32_t device_index,
                                                     pnanovdb_compute_physical_device_desc_t* p_desc);


    pnanovdb_compute_device_t*(PNANOVDB_ABI* create_device)(pnanovdb_compute_device_manager_t* manager,
                                                            const pnanovdb_compute_device_desc_t* desc);

    void(PNANOVDB_ABI* destroy_device)(pnanovdb_compute_device_manager_t* manager, pnanovdb_compute_device_t* device);

    void(PNANOVDB_ABI* get_memory_stats)(pnanovdb_compute_device_t* device,
                                         pnanovdb_compute_device_memory_stats_t* dst_stats);
    ...
    void(PNANOVDB_ABI* get_semaphore_external_handle)(pnanovdb_compute_semaphore_t* semaphore,
                                                      void* dst_handle,
                                                      pnanovdb_uint64_t dst_handle_size);

    void(PNANOVDB_ABI* close_semaphore_external_handle)(pnanovdb_compute_semaphore_t* semaphore,
                                                        const void* src_handle,
                                                        pnanovdb_uint64_t src_handle_size);
    ...
    int(PNANOVDB_ABI* flush)(pnanovdb_compute_queue_t* queue,
                             ...
                             pnanovdb_compute_semaphore_t* signalSemaphore);
    ...
    pnanovdb_compute_swapchain_t*(PNANOVDB_ABI* create_swapchain)(pnanovdb_compute_queue_t* queue,
                                                                  const pnanovdb_compute_swapchain_desc_t* desc);

    void(PNANOVDB_ABI* destroy_swapchain)(pnanovdb_compute_swapchain_t* swapchain);

    void(PNANOVDB_ABI* resize_swapchain)(pnanovdb_compute_swapchain_t* swapchain,
                                         pnanovdb_uint32_t width,
                                         pnanovdb_uint32_t height);

    int(PNANOVDB_ABI* present_swapchain)(pnanovdb_compute_swapchain_t* swapchain,
                                         pnanovdb_bool_t vsync,
                                         pnanovdb_uint64_t* flushedFrameID);

    pnanovdb_compute_texture_t*(PNANOVDB_ABI* get_swapchain_front_texture)(pnanovdb_compute_swapchain_t* swapchain);


    pnanovdb_compute_encoder_t*(PNANOVDB_ABI* create_encoder)(pnanovdb_compute_queue_t* queue,
                                                              const pnanovdb_compute_encoder_desc_t* desc);

    void(PNANOVDB_ABI* destroy_encoder)(pnanovdb_compute_encoder_t* encoder);

    int(PNANOVDB_ABI* present_encoder)(pnanovdb_compute_encoder_t* encoder, pnanovdb_uint64_t* flushedFrameID);

    pnanovdb_compute_texture_t*(PNANOVDB_ABI* get_encoder_front_texture)(pnanovdb_compute_encoder_t* encoder);

    void*(PNANOVDB_ABI* map_encoder_data)(pnanovdb_compute_encoder_t* encoder, pnanovdb_uint64_t* p_mapped_byte_count);

    void(PNANOVDB_ABI* unmap_encoder_data)(pnanovdb_compute_encoder_t* encoder);


    void(PNANOVDB_ABI* enable_profiler)(pnanovdb_compute_context_t* context,
                                        void* userdata,
                                        pnanovdb_profiler_report_t report_entries);
...
PNANOVDB_REFLECT_FUNCTION_POINTER(create_encoder, 0, 0)
PNANOVDB_REFLECT_FUNCTION_POINTER(destroy_encoder, 0, 0)
PNANOVDB_REFLECT_FUNCTION_POINTER(present_encoder, 0, 0)
PNANOVDB_REFLECT_FUNCTION_POINTER(get_encoder_front_texture, 0, 0)
PNANOVDB_REFLECT_FUNCTION_POINTER(map_encoder_data, 0, 0)
PNANOVDB_REFLECT_FUNCTION_POINTER(unmap_encoder_data, 0, 0)
...
typedef pnanovdb_compute_device_interface_t*(PNANOVDB_ABI* PFN_pnanovdb_get_compute_device_interface)(
    pnanovdb_compute_api_t api);
...
typedef struct pnanovdb_compute_shader_interface_t
{
    ...
    pnanovdb_bool_t(PNANOVDB_ABI* map_shader_build)(pnanovdb_compute_shader_t* shader,
                                                    pnanovdb_compute_shader_build_t** out_build);
...
typedef struct pnanovdb_compute_t
{
    ...
    pnanovdb_compute_array_t*(PNANOVDB_ABI* create_array)(size_t element_size,
                                                          pnanovdb_uint64_t element_count,
                                                          const void* data);
...
static inline void pnanovdb_compute_load(pnanovdb_compute_t* compute, const pnanovdb_compiler_t* compiler)
{
    void* compute_module =
        pnanovdb_load_library("pnanovdbcompute.dll", "libpnanovdbcompute.so", "libpnanovdbcompute.dylib");
    if (!compute_module)
    {
#if defined(_WIN32)
    ...
    PFN_pnanovdb_get_compute get_compute =
        (PFN_pnanovdb_get_compute)pnanovdb_get_proc_address(compute_module, "pnanovdb_get_compute");
    if (!get_compute)
    {
    ...
    PFN_pnanovdb_get_compute_shader_interface get_compute_shader_interface =
        (PFN_pnanovdb_get_compute_shader_interface)pnanovdb_get_proc_address(
            compute_module, "pnanovdb_get_compute_shader_interface");
    ...
    PFN_pnanovdb_get_compute_device_interface get_compute_device_interface =
        (PFN_pnanovdb_get_compute_device_interface)pnanovdb_get_proc_address(
            compute_module, "pnanovdb_get_compute_device_interface");
    if (!get_compute_device_interface)
    {
        printf("Error: Failed to acquire compute device interface getter\n");
        return;
    }
    pnanovdb_compute_device_interface_t_duplicate(
        &compute->device_interface, get_compute_device_interface(PNANOVDB_COMPUTE_API_VULKAN));

    compute->module = compute_module;
    compute->compiler = compiler;
}

static inline void pnanovdb_compute_free(pnanovdb_compute_t* compute)
{
