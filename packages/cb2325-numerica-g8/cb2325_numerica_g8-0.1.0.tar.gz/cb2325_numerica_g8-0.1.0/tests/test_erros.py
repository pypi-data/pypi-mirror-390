...
def test_erro_quadratico_medio_listaas_vazias():
    """
    Verifica se a função 'erro quadratico medio' falha quando
    as listas de entrada estão vazias.
    """
    mensagem_erro = "Erro: As listas não dpodem ser vazias."
...
def test_erro_quadratico_medio_nao_numerico():
    ...
    """
    mensagem_erro = "Erro: Todos os valores da lista devem ser numéricos."
