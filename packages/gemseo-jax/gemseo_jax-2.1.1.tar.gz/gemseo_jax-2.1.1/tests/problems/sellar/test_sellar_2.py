...
"""Tests for the 2nd discipline Sellar problem in JAX."""
...
def input_data(n: int) -> dict[str, RealArray]:
    """An input value for [JAX]Sellar2."""
...
@pytest.fixture
def numpy_discipline(n: int) -> Sellar2:
    """The NumPy version of Sellar2."""
    return Sellar2(n=n)


@pytest.fixture
def jax_discipline(n: int) -> JAXSellar2:
    """The JAX version of Sellar2."""
    return JAXSellar2(n=n)


def test_execute(input_data, numpy_discipline, jax_discipline):
    """Check the execution of JAXSellar2."""
