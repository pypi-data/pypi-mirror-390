"""
Command-line interface for Shunya Labs transcription.
"""
...
from .transcriber import ShunyaTranscriber
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  shunyalabs audio.wav                          # Basic transcription (Shunya Labs model)
  shunyalabs audio.wav -o output.txt            # Save to file
  shunyalabs audio.wav --model shunyalabs/pingala-v1-en-verbatim  # Default Shunya Labs model
  shunyalabs audio.wav --backend transformers   # Use transformers backend
  shunyalabs audio.wav --model shunyalabs/pingala-v1-en-verbatim --backend transformers
  shunyalabs audio.wav --device cpu             # Use CPU instead of GPU
  shunyalabs audio.wav --beam-size 10           # Higher accuracy
  shunyalabs audio.wav --language en            # Specify language
  shunyalabs audio.wav --word-timestamps        # Include word-level timing
  shunyalabs audio.wav --show-confidence        # Show confidence scores
  shunyalabs audio.wav --vad                    # Enable voice activity detection
  shunyalabs audio.wav --detect-language        # Detect language only
...
def main():
    ...
    try:
        ...
        if args.backend == "transformers":
            print("  Hint: Install transformers dependencies with: pip install 'shunyalabs[transformers]'", file=sys.stderr)
        elif args.backend == "ct2":
            print("  Hint: Install CTranslate2 dependencies with: pip install 'shunyalabs'", file=sys.stderr)
        sys.exit(1)
