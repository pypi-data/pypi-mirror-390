...
def get_oss_address_with_retry(target_id, url, requestHeader, query_list_request_param=None, is_import=False,
    ...
    **kwargs 可传参：tries=10, delay=2, backoff=1
    ...
    # TODO 写死一个mtoken
    query_detail_request_param = {"id": target_id, "mToken": "123456"}
...
if __name__ == '__main__':
    head = {
        'cookie': 'osudb_appid=SMARTPUSH;osudb_oar=#01#SID0000140BMELjPAEKW6Ymz4gu619dF344GlhHbJptz/N3yjNCuIqyGWWURwbWiOPlY5jehK+np56z2ALCm8oqn8qYCFQZjf3yYBcvNJ1jtEEw8Kinn1Yarb56FOXlw3N9JA+iOX8hgkaLBnR3+3ll9JaPuTn;osudb_subappid=1;osudb_uid=4213785247;ecom_http_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..b5y5HIyOjuew9qstqQOyJ9L8vgEBQZ5l7itPAzH5NaI;',
        'Content-Type': 'application/json', 'accept-language': 'zh-CN'}
    get_oss_address_with_retry(24694, 'https://test.smartpushedm.com/bff/api-em-ec2', head)
