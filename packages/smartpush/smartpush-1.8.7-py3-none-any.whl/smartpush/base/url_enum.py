...
class URL(Enum):
    ...
    :type 素材收藏
    """
    saveUniversalContent = "/universalContent/saveUniversalContent"
    queryUniversalContent = "/universalContent/query"
    queryUsedDetail = "universalContent/queryUsedDetail"
    deleteUniversalContent = "universalContent/deleteUniversalContent"
