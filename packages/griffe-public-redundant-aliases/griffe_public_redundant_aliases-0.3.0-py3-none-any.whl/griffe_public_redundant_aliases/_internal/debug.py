...
def _get_version(dist: str = "griffe-public-redundant-aliases") -> str:
...
def _get_debug_info() -> _Environment:
    ...
    packages = ["griffe-public-redundant-aliases"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("GRIFFE_PUBLIC_REDUNDANT_ALIASES")]]
    return _Environment(
