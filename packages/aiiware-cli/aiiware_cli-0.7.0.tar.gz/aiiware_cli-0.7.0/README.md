...
> **What's New in v0.7.0:** Enhanced API reliability with structured error handling, automatic request tracing for debugging, improved CJK language support (Chinese/Japanese/Korean), and WebSocket stability improvements. [See CHANGELOG](CHANGELOG.md)
