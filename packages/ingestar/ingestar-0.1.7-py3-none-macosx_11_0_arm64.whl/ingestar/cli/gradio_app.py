...
from ingestar.cli.common import prepare_env, read_fn, aio_do_parse, pdf_suffixes, image_suffixes
from ingestar.utils.cli_parser import arg_parse
from ingestar.utils.hash_utils import str_sha256
...
def main(ctx,
    ...
    if vllm_engine_enable:
        try:
            ...
            from ingestar.backend.vlm.vlm_analyze import ModelSingleton
        ...
        with gr.Row():
            with gr.Column(variant='panel', scale=5):
                ...
                with gr.Row(visible=False) as client_options:
                    url = gr.Textbox(label='Server URL', value='http://localhost:38000', placeholder='http://localhost:38000')
