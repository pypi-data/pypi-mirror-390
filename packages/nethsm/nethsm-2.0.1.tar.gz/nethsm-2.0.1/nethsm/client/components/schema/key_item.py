...
class KeyItemDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        arg_.update(kwargs)
        used_arg_ = typing.cast(KeyItemDictInput, arg_)
        return KeyItem.validate(used_arg_, configuration=configuration_)
    ...
    def from_dict_(
        ...
        return KeyItem.validate(arg, configuration=configuration)
...
KeyItemDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class KeyItem(
    schemas.Schema[KeyItemDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: KeyItemDict
        }
    )
