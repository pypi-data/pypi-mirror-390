...
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/adios2-cxx-targets.cmake")
...
if(NOT ON)
  ...
  set(ADIOS2_HAVE_KVCACHE )
  if(ADIOS2_HAVE_KVCACHE)
    find_dependency(hiredis)
  endif()

  set(ADIOS2_HAVE_OpenSSL )
  if(ADIOS2_HAVE_OpenSSL)
...
if(NOT TARGET adios2::core)
  ...
  include("${CMAKE_CURRENT_LIST_DIR}/adios2-cxx-targets.cmake" OPTIONAL)
  include("${CMAKE_CURRENT_LIST_DIR}/adios2-fortran-targets.cmake" OPTIONAL)

  add_library(adios2::adios2 INTERFACE IMPORTED)
  foreach(_adios2_tgt adios2::c adios2::c_mpi adios2::cxx adios2::cxx_mpi)
  ...
  if(NOT CMAKE_CXX_COMPILER_LOADED)
    ...
    get_property(_adios2_link_libs TARGET adios2::adios2 PROPERTY INTERFACE_LINK_LIBRARIES)
    list(FILTER _adios2_link_libs EXCLUDE REGEX "^adios2::(cxx|cxx_mpi)$")
    set_property(TARGET adios2::adios2 PROPERTY INTERFACE_LINK_LIBRARIES "${_adios2_link_libs}")
    unset(_adios2_link_libs)
  endif()
endif()

if(${CMAKE_FIND_PACKAGE_NAME}_CXX_FOUND)
  add_library(adios2::cxx11 INTERFACE IMPORTED)
  target_link_libraries(adios2::cxx11 INTERFACE adios2::cxx)
  if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.17)
    set_target_properties(adios2::cxx11 PROPERTIES
      DEPRECATION "adios2::cxx11 target has been deprecated, please use adios2::cxx")
  endif()
