...
def create_cli_app():
    ...
    @click.version_option(version='2.0.17', prog_name='Ailoos CLI')
    @click.pass_context
    def cli(ctx, verbose, config):
        ...
        A comprehensive command-line tool for managing federated learning nodes,
        training sessions, models, and rewards in the Ailoos ecosystem.
