...
echo 6. Send error report (email)
echo 7. Forced MediCafe version rollback
echo 8. Process CSV Files
echo 9. Edit Config File (JSON Editor)
echo 10. Force Gmail re-auth (clear token)
...
if "%tchoice%"=="6" goto send_error_report
if "%tchoice%"=="7" goto forced_version_rollback
if "%tchoice%"=="8" goto process_csvs
if "%tchoice%"=="9" goto config_editor
if "%tchoice%"=="10" goto force_gmail_reauth
