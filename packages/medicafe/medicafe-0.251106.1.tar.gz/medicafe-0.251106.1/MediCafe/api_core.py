            ...
            if response.status_code == 401:
                ...
                try:
                    ...
                    if is_invalid_token:
                        ...
                        # Clear token cache for this endpoint
                        self.token_cache.clear(endpoint_name)
                        ...
                        # Other 401 error types
                        MediLink_ConfigLoader.log(
                            "401 Unauthorized error (type: {}) for endpoint {}. Trace ID: {}".format(
                                error_type or 'unknown', endpoint_name, trace_id or 'none'),
                            level="ERROR",
                            console_output=CONSOLE_LOGGING
                        )
